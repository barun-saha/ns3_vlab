...
# 8 "linux-2.6.26/kernel/rwsem.c" 2
...
# 9 "linux-2.6.26/kernel/rwsem.c" 2
...
typedef  const kernel_cap_t   _GLOBAL_13_T; extern  _GLOBAL_13_T  global___cap_empty_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_14_T; extern  _GLOBAL_14_T  global___cap_full_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_15_T; extern  _GLOBAL_15_T  global___cap_init_eff_set[NUM_STACKS];    
...
# 10 "linux-2.6.26/kernel/rwsem.c" 2
...
typedef  unsigned int   _GLOBAL_103_T; extern  _GLOBAL_103_T  global_vdso_enabled[NUM_STACKS];    
...
typedef  struct desc_ptr   _GLOBAL_104_T; extern  _GLOBAL_104_T  global_idt_descr[NUM_STACKS];    
extern gate_desc idt_table[];
# 54 "linux-2.6.26/include/asm/desc.h"
struct gdt_page {
 struct desc_struct gdt[32];
} __attribute__((aligned(((1UL) << 12)))) ;
typedef  __typeof__ ( struct gdt_page  )   _GLOBAL_105_T; extern  _GLOBAL_105_T  global_per_cpu__gdt_page[NUM_STACKS];    
...
{ }
# 11 "linux-2.6.26/kernel/rwsem.c" 2



# 1 "linux-2.6.26/include/asm/atomic.h" 1
# 15 "linux-2.6.26/kernel/rwsem.c" 2




void  __attribute__((__section__(".sched.text"))) down_read(struct rw_semaphore *sem)
{
...
void  __attribute__((__section__(".sched.text"))) down_write(struct rw_semaphore *sem)
{
 do { do { } while (0); } while (0);
 do { } while (0);
