...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/kernel/timer.c"
# 22 "linux-2.6.26/kernel/timer.c"
...
typedef  __typeof__ ( struct kernel_stat  )   _GLOBAL_103_T; extern  _GLOBAL_103_T  global_per_cpu__kstat[NUM_STACKS];    
...
# 23 "linux-2.6.26/kernel/timer.c" 2
...
typedef  unsigned int   _GLOBAL_104_T; extern  _GLOBAL_104_T  global_vdso_enabled[NUM_STACKS];    
...
typedef  struct desc_ptr   _GLOBAL_105_T; extern  _GLOBAL_105_T  global_idt_descr[NUM_STACKS];    
extern gate_desc idt_table[];
# 54 "linux-2.6.26/include/asm/desc.h"
struct gdt_page {
 struct desc_struct gdt[32];
} __attribute__((aligned(((1UL) << 12)))) ;
typedef  __typeof__ ( struct gdt_page  )   _GLOBAL_106_T; extern  _GLOBAL_106_T  global_per_cpu__gdt_page[NUM_STACKS];    
...
{ }
# 24 "linux-2.6.26/kernel/timer.c" 2
...
typedef  __typeof__ ( struct pt_regs  *  )   _GLOBAL_107_T; extern  _GLOBAL_107_T  global_per_cpu__irq_regs[NUM_STACKS];     
...
typedef  int  _GLOBAL_108_T; extern  _GLOBAL_108_T  global_prof_on[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))  ;    
...
typedef  unsigned long   _GLOBAL_109_T; extern  _GLOBAL_109_T  global_io_apic_irqs[NUM_STACKS];    

typedef  atomic_t  _GLOBAL_110_T; extern  _GLOBAL_110_T  global_irq_err_count[NUM_STACKS];   
typedef  atomic_t  _GLOBAL_111_T; extern  _GLOBAL_111_T  global_irq_mis_count[NUM_STACKS];   
...
typedef  __typeof__ ( irq_cpustat_t )   _GLOBAL_112_T; extern  _GLOBAL_112_T  global_per_cpu__irq_stat[NUM_STACKS];   
...
# 25 "linux-2.6.26/kernel/timer.c" 2
...
# 28 "linux-2.6.26/kernel/timer.c" 2
...
typedef  unsigned long   _GLOBAL_130_T; extern  _GLOBAL_130_T  global_totalram_pages[NUM_STACKS];    
typedef  unsigned long   _GLOBAL_131_T; extern  _GLOBAL_131_T  global_totalreserve_pages[NUM_STACKS];    
typedef  long  _GLOBAL_132_T; extern  _GLOBAL_132_T  global_nr_swap_pages[NUM_STACKS];   
...
typedef  int  _GLOBAL_133_T; extern  _GLOBAL_133_T  global_vm_swappiness[NUM_STACKS];   
extern int remove_mapping(struct address_space *mapping, struct page *page);
typedef  long  _GLOBAL_134_T; extern  _GLOBAL_134_T  global_vm_total_pages[NUM_STACKS];   
...
# 29 "linux-2.6.26/kernel/timer.c" 2
# 1 "linux-2.6.26/include/linux/pid_namespace.h" 1
...
typedef  struct nsproxy   _GLOBAL_135_T; extern  _GLOBAL_135_T  global_init_nsproxy[NUM_STACKS];    
...
# 8 "linux-2.6.26/include/linux/pid_namespace.h" 2
...
extern struct pid_namespace init_pid_ns;
# 51 "linux-2.6.26/include/linux/pid_namespace.h"
...
# 52 "linux-2.6.26/include/linux/pid_namespace.h" 2
...
static inline  __attribute__((always_inline)) struct pid_namespace *task_active_pid_ns(struct task_struct *tsk)
{
 return tsk->nsproxy->pid_ns;
}

static inline  __attribute__((always_inline)) struct task_struct *task_child_reaper(struct task_struct *tsk)
{
 do { if (__builtin_expect(!!(tsk != nsc_get_task()), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
 return tsk->nsproxy->pid_ns->child_reaper;
}
# 30 "linux-2.6.26/kernel/timer.c" 2




# 1 "linux-2.6.26/include/linux/posix-timers.h" 1
...
# 38 "linux-2.6.26/include/linux/posix-timers.h"
struct k_itimer {
 struct list_head list;
 spinlock_t it_lock;
 clockid_t it_clock;
...
# 35 "linux-2.6.26/kernel/timer.c" 2
...
typedef  void   ( *_GLOBAL_137_T  )  ( void  ) ; extern  _GLOBAL_137_T global_pm_idle[NUM_STACKS];   
typedef  void   ( *_GLOBAL_139_T  )  ( void  ) ; extern  _GLOBAL_139_T global_pm_power_off[NUM_STACKS];   
typedef  void   ( *_GLOBAL_141_T  )  ( void  ) ; extern  _GLOBAL_141_T global_pm_power_off_prepare[NUM_STACKS];   
...
typedef  unsigned int   _GLOBAL_142_T; extern  _GLOBAL_142_T  global_pm_flags[NUM_STACKS];    
...
typedef  struct sysdev_class   _GLOBAL_143_T; extern  _GLOBAL_143_T  global_cpu_sysdev_class[NUM_STACKS];    
...
# 36 "linux-2.6.26/kernel/timer.c" 2
...
struct robust_list_head;
struct getcpu_cache;
# 65 "linux-2.6.26/include/linux/syscalls.h"
...
typedef  spinlock_t  _GLOBAL_144_T; extern  _GLOBAL_144_T  global_dq_data_lock[NUM_STACKS];   
...
typedef  struct dqstats   _GLOBAL_145_T; extern  _GLOBAL_145_T  global_dqstats[NUM_STACKS];    
...
# 66 "linux-2.6.26/include/linux/syscalls.h" 2
# 1 "linux-2.6.26/include/linux/key.h" 1
# 22 "linux-2.6.26/include/linux/key.h"
...
# 23 "linux-2.6.26/include/linux/key.h" 2
# 1 "linux-2.6.26/include/asm/atomic.h" 1
...
struct key;
# 67 "linux-2.6.26/include/linux/syscalls.h" 2
  ...
  __attribute__((regparm(0))) long sys_fsetxattr(int fd, const char *name,
         const void *value, size_t size, int flags);
  __attribute__((regparm(0))) ssize_t sys_getxattr(const char *path, const char *name,
    void *value, size_t size);
  __attribute__((regparm(0))) ssize_t sys_lgetxattr(const char *path, const char *name,
    void *value, size_t size);
  __attribute__((regparm(0))) ssize_t sys_fgetxattr(int fd, const char *name,
    void *value, size_t size);
  __attribute__((regparm(0))) ssize_t sys_listxattr(const char *path, char *list,
    size_t size);
  __attribute__((regparm(0))) ssize_t sys_llistxattr(const char *path, char *list,
    size_t size);
...
# 37 "linux-2.6.26/kernel/timer.c" 2
...
# 38 "linux-2.6.26/kernel/timer.c" 2
...
# 39 "linux-2.6.26/kernel/timer.c" 2
...
# 40 "linux-2.6.26/kernel/timer.c" 2
...
# 42 "linux-2.6.26/kernel/timer.c" 2
# 1 "linux-2.6.26/include/asm/unistd.h" 1


# 1 "linux-2.6.26/include/asm/unistd_32.h" 1
# 4 "linux-2.6.26/include/asm/unistd.h" 2
# 43 "linux-2.6.26/kernel/timer.c" 2
...
typedef  rwlock_t  _GLOBAL_147_T; extern  _GLOBAL_147_T  global_vmlist_lock[NUM_STACKS];   
typedef  struct vm_struct   _GLOBAL_148_T; extern  _GLOBAL_148_T  * global_vmlist[NUM_STACKS];    
...
typedef  int  _GLOBAL_149_T; extern  _GLOBAL_149_T  global_io_delay_type[NUM_STACKS];   
...
# 46 "linux-2.6.26/kernel/timer.c" 2

typedef  u64 _GLOBAL_150_T;  _GLOBAL_150_T  global_jiffies_64[NUM_STACKS] = {  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  ( ( unsigned long  ) ( unsigned int  ) ( - 300  * 1000  )    ) ,  };       

;
# 61 "linux-2.6.26/kernel/timer.c"
struct tvec {
...
typedef  struct tvec_base  _GLOBAL_151_T;  _GLOBAL_151_T  _GLOBAL_0_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_1_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_2_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_3_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_4_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_5_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_6_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_7_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_8_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_9_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_10_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_11_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_12_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_13_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_14_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_15_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_16_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_17_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_18_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_19_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_20_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_21_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_22_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_23_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_24_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_25_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_26_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_27_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_28_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_29_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_30_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_31_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_32_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_33_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_34_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_35_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_36_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_37_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_38_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_39_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_40_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_41_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_42_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_43_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_44_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_45_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_46_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_47_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_48_boot_tvec_bases_I;  _GLOBAL_151_T  _GLOBAL_49_boot_tvec_bases_I; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_boot_tvec_bases_I) *_GLOBAL_boot_tvec_bases_6_A[NUM_STACKS] = { &_GLOBAL_0_boot_tvec_bases_I, &_GLOBAL_1_boot_tvec_bases_I, &_GLOBAL_2_boot_tvec_bases_I, &_GLOBAL_3_boot_tvec_bases_I, &_GLOBAL_4_boot_tvec_bases_I, &_GLOBAL_5_boot_tvec_bases_I, &_GLOBAL_6_boot_tvec_bases_I, &_GLOBAL_7_boot_tvec_bases_I, &_GLOBAL_8_boot_tvec_bases_I, &_GLOBAL_9_boot_tvec_bases_I, &_GLOBAL_10_boot_tvec_bases_I, &_GLOBAL_11_boot_tvec_bases_I, &_GLOBAL_12_boot_tvec_bases_I, &_GLOBAL_13_boot_tvec_bases_I, &_GLOBAL_14_boot_tvec_bases_I, &_GLOBAL_15_boot_tvec_bases_I, &_GLOBAL_16_boot_tvec_bases_I, &_GLOBAL_17_boot_tvec_bases_I, &_GLOBAL_18_boot_tvec_bases_I, &_GLOBAL_19_boot_tvec_bases_I, &_GLOBAL_20_boot_tvec_bases_I, &_GLOBAL_21_boot_tvec_bases_I, &_GLOBAL_22_boot_tvec_bases_I, &_GLOBAL_23_boot_tvec_bases_I, &_GLOBAL_24_boot_tvec_bases_I, &_GLOBAL_25_boot_tvec_bases_I, &_GLOBAL_26_boot_tvec_bases_I, &_GLOBAL_27_boot_tvec_bases_I, &_GLOBAL_28_boot_tvec_bases_I, &_GLOBAL_29_boot_tvec_bases_I, &_GLOBAL_30_boot_tvec_bases_I, &_GLOBAL_31_boot_tvec_bases_I, &_GLOBAL_32_boot_tvec_bases_I, &_GLOBAL_33_boot_tvec_bases_I, &_GLOBAL_34_boot_tvec_bases_I, &_GLOBAL_35_boot_tvec_bases_I, &_GLOBAL_36_boot_tvec_bases_I, &_GLOBAL_37_boot_tvec_bases_I, &_GLOBAL_38_boot_tvec_bases_I, &_GLOBAL_39_boot_tvec_bases_I, &_GLOBAL_40_boot_tvec_bases_I, &_GLOBAL_41_boot_tvec_bases_I, &_GLOBAL_42_boot_tvec_bases_I, &_GLOBAL_43_boot_tvec_bases_I, &_GLOBAL_44_boot_tvec_bases_I, &_GLOBAL_45_boot_tvec_bases_I, &_GLOBAL_46_boot_tvec_bases_I, &_GLOBAL_47_boot_tvec_bases_I, &_GLOBAL_48_boot_tvec_bases_I, &_GLOBAL_49_boot_tvec_bases_I, };  
;
typedef  __typeof__ ( struct tvec_base  *  )   _GLOBAL_152_T; static  _GLOBAL_152_T  global_per_cpu__tvec_bases[NUM_STACKS] = {  & _GLOBAL_0_boot_tvec_bases_I ,  & _GLOBAL_1_boot_tvec_bases_I ,  & _GLOBAL_2_boot_tvec_bases_I ,  & _GLOBAL_3_boot_tvec_bases_I ,  & _GLOBAL_4_boot_tvec_bases_I ,  & _GLOBAL_5_boot_tvec_bases_I ,  & _GLOBAL_6_boot_tvec_bases_I ,  & _GLOBAL_7_boot_tvec_bases_I ,  & _GLOBAL_8_boot_tvec_bases_I ,  & _GLOBAL_9_boot_tvec_bases_I ,  & _GLOBAL_10_boot_tvec_bases_I ,  & _GLOBAL_11_boot_tvec_bases_I ,  & _GLOBAL_12_boot_tvec_bases_I ,  & _GLOBAL_13_boot_tvec_bases_I ,  & _GLOBAL_14_boot_tvec_bases_I ,  & _GLOBAL_15_boot_tvec_bases_I ,  & _GLOBAL_16_boot_tvec_bases_I ,  & _GLOBAL_17_boot_tvec_bases_I ,  & _GLOBAL_18_boot_tvec_bases_I ,  & _GLOBAL_19_boot_tvec_bases_I ,  & _GLOBAL_20_boot_tvec_bases_I ,  & _GLOBAL_21_boot_tvec_bases_I ,  & _GLOBAL_22_boot_tvec_bases_I ,  & _GLOBAL_23_boot_tvec_bases_I ,  & _GLOBAL_24_boot_tvec_bases_I ,  & _GLOBAL_25_boot_tvec_bases_I ,  & _GLOBAL_26_boot_tvec_bases_I ,  & _GLOBAL_27_boot_tvec_bases_I ,  & _GLOBAL_28_boot_tvec_bases_I ,  & _GLOBAL_29_boot_tvec_bases_I ,  & _GLOBAL_30_boot_tvec_bases_I ,  & _GLOBAL_31_boot_tvec_bases_I ,  & _GLOBAL_32_boot_tvec_bases_I ,  & _GLOBAL_33_boot_tvec_bases_I ,  & _GLOBAL_34_boot_tvec_bases_I ,  & _GLOBAL_35_boot_tvec_bases_I ,  & _GLOBAL_36_boot_tvec_bases_I ,  & _GLOBAL_37_boot_tvec_bases_I ,  & _GLOBAL_38_boot_tvec_bases_I ,  & _GLOBAL_39_boot_tvec_bases_I ,  & _GLOBAL_40_boot_tvec_bases_I ,  & _GLOBAL_41_boot_tvec_bases_I ,  & _GLOBAL_42_boot_tvec_bases_I ,  & _GLOBAL_43_boot_tvec_bases_I ,  & _GLOBAL_44_boot_tvec_bases_I ,  & _GLOBAL_45_boot_tvec_bases_I ,  & _GLOBAL_46_boot_tvec_bases_I ,  & _GLOBAL_47_boot_tvec_bases_I ,  & _GLOBAL_48_boot_tvec_bases_I ,  & _GLOBAL_49_boot_tvec_bases_I ,  };       
# 92 "linux-2.6.26/kernel/timer.c"
static inline  __attribute__((always_inline)) unsigned int tbase_get_deferrable(struct tvec_base *base)
{
 return ((unsigned int)(unsigned long)base & (0x1));
}

static inline  __attribute__((always_inline)) struct tvec_base *tbase_get_base(struct tvec_base *base)
{
 return ((struct tvec_base *)((unsigned long)base & ~(0x1)));
}

static inline  __attribute__((always_inline)) void timer_set_deferrable(struct timer_list *timer)
{
...
# 135 "linux-2.6.26/kernel/timer.c"
unsigned long __round_jiffies(unsigned long j, int cpu)
{
 int rem;
 unsigned long original = j;
# 148 "linux-2.6.26/kernel/timer.c"
 j += cpu * 3;
 ...
 if (j <= global_jiffies[get_stack_id()])
  return original;
 return j;
}
;
# 192 "linux-2.6.26/kernel/timer.c"
unsigned long __round_jiffies_relative(unsigned long j, int cpu)
{
 ...
 return __round_jiffies(j + global_jiffies[get_stack_id()], cpu) - global_jiffies[get_stack_id()];
}
;
# 219 "linux-2.6.26/kernel/timer.c"
unsigned long round_jiffies(unsigned long j)
{
 return __round_jiffies(j, 0);
}
;
# 240 "linux-2.6.26/kernel/timer.c"
unsigned long round_jiffies_relative(unsigned long j)
{
 return __round_jiffies_relative(j, 0);
}
;


static inline  __attribute__((always_inline)) void set_running_timer(struct tvec_base *base,
     struct timer_list *timer)
{
...
# 320 "linux-2.6.26/kernel/timer.c"
static void timer_stats_account_timer(struct timer_list *timer) {}
# 441 "linux-2.6.26/kernel/timer.c"
static inline  __attribute__((always_inline)) void debug_timer_init(struct timer_list *timer) { }
static inline  __attribute__((always_inline)) void debug_timer_activate(struct timer_list *timer) { }
static inline  __attribute__((always_inline)) void debug_timer_deactivate(struct timer_list *timer) { }
...
# 464 "linux-2.6.26/kernel/timer.c"
void init_timer(struct timer_list *timer)
{
...
# 503 "linux-2.6.26/kernel/timer.c"
...

{
 ...
 for (;;) {
  ...
  if (__builtin_expect(!!(base != ((void *)0)), 1)) {
   ...
   if (__builtin_expect(!!(prelock_base == timer->base), 1))
    return base;
...
int __mod_timer(struct timer_list *timer, unsigned long expires)
{
 ...
 do { if (__builtin_expect(!!(!timer->function), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
...
;
# 577 "linux-2.6.26/kernel/timer.c"
void add_timer_on(struct timer_list *timer, int cpu)
{
 struct tvec_base *base = (*((void)(cpu), &global_per_cpu__tvec_bases[get_stack_id()]));
 unsigned long flags;

 timer_stats_timer_set_start_info(timer);
 do { if (__builtin_expect(!!(timer_pending(timer) || !timer->function), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
 do { (void)(flags); do { do { } while (0); (void)0; (void)(&base->lock); } while (0); } while (0);
 timer_set_base(timer, base);
 debug_timer_activate(timer);
 internal_add_timer(base, timer);
# 596 "linux-2.6.26/kernel/timer.c"
 wake_up_idle_cpu(cpu);
 do { (void)(flags); do { do { } while (0); (void)0; (void)(&base->lock); } while (0); } while (0);
}
# 620 "linux-2.6.26/kernel/timer.c"
...
;
# 649 "linux-2.6.26/kernel/timer.c"
...
;
# 734 "linux-2.6.26/kernel/timer.c"
static int cascade(struct tvec_base *base, struct tvec *tv, int index)
{
 ...
 for (timer = ({ const typeof( ((typeof(*timer) *)0)->entry ) *__mptr = ((&tv_list)->next); (typeof(*timer) *)( (char *)__mptr - __builtin_offsetof(typeof(*timer),entry) );}), tmp = ({ const typeof( ((typeof(*timer) *)0)->entry ) *__mptr = (timer->entry.next); (typeof(*timer) *)( (char *)__mptr - __builtin_offsetof(typeof(*timer),entry) );}); &timer->entry != (&tv_list); timer = tmp, tmp = ({ const typeof( ((typeof(*tmp) *)0)->entry ) *__mptr = (tmp->entry.next); (typeof(*tmp) *)( (char *)__mptr - __builtin_offsetof(typeof(*tmp),entry) );})) {
  do { if (__builtin_expect(!!(tbase_get_base(timer->base) != base), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
  internal_add_timer(base, timer);
 }

 return index;
}
# 763 "linux-2.6.26/kernel/timer.c"
static inline  __attribute__((always_inline)) void __run_timers(struct tvec_base *base)
{
 struct timer_list *timer;
...
# 961 "linux-2.6.26/kernel/timer.c"
void account_process_tick(struct task_struct *p, int user_tick)
{
 cputime_t one_jiffy = (1);

 if (user_tick) {
  account_user_time(p, one_jiffy);
  account_user_time_scaled(p, (one_jiffy));
 } else {
  account_system_time(p, (1UL << ((0 + 8) + 8)), one_jiffy);
  account_system_time_scaled(p, (one_jiffy));
 }
}
...
# 1009 "linux-2.6.26/kernel/timer.c"
typedef  unsigned long  _GLOBAL_153_T;  _GLOBAL_153_T  _GLOBAL_0_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_1_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_2_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_3_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_4_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_5_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_6_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_7_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_8_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_9_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_10_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_11_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_12_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_13_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_14_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_15_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_16_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_17_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_18_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_19_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_20_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_21_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_22_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_23_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_24_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_25_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_26_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_27_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_28_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_29_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_30_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_31_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_32_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_33_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_34_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_35_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_36_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_37_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_38_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_39_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_40_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_41_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_42_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_43_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_44_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_45_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_46_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_47_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_48_avenrun_I [ 3 ] ;  _GLOBAL_153_T  _GLOBAL_49_avenrun_I [ 3 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_avenrun_I) *_GLOBAL_avenrun_7_A[NUM_STACKS] = { &_GLOBAL_0_avenrun_I, &_GLOBAL_1_avenrun_I, &_GLOBAL_2_avenrun_I, &_GLOBAL_3_avenrun_I, &_GLOBAL_4_avenrun_I, &_GLOBAL_5_avenrun_I, &_GLOBAL_6_avenrun_I, &_GLOBAL_7_avenrun_I, &_GLOBAL_8_avenrun_I, &_GLOBAL_9_avenrun_I, &_GLOBAL_10_avenrun_I, &_GLOBAL_11_avenrun_I, &_GLOBAL_12_avenrun_I, &_GLOBAL_13_avenrun_I, &_GLOBAL_14_avenrun_I, &_GLOBAL_15_avenrun_I, &_GLOBAL_16_avenrun_I, &_GLOBAL_17_avenrun_I, &_GLOBAL_18_avenrun_I, &_GLOBAL_19_avenrun_I, &_GLOBAL_20_avenrun_I, &_GLOBAL_21_avenrun_I, &_GLOBAL_22_avenrun_I, &_GLOBAL_23_avenrun_I, &_GLOBAL_24_avenrun_I, &_GLOBAL_25_avenrun_I, &_GLOBAL_26_avenrun_I, &_GLOBAL_27_avenrun_I, &_GLOBAL_28_avenrun_I, &_GLOBAL_29_avenrun_I, &_GLOBAL_30_avenrun_I, &_GLOBAL_31_avenrun_I, &_GLOBAL_32_avenrun_I, &_GLOBAL_33_avenrun_I, &_GLOBAL_34_avenrun_I, &_GLOBAL_35_avenrun_I, &_GLOBAL_36_avenrun_I, &_GLOBAL_37_avenrun_I, &_GLOBAL_38_avenrun_I, &_GLOBAL_39_avenrun_I, &_GLOBAL_40_avenrun_I, &_GLOBAL_41_avenrun_I, &_GLOBAL_42_avenrun_I, &_GLOBAL_43_avenrun_I, &_GLOBAL_44_avenrun_I, &_GLOBAL_45_avenrun_I, &_GLOBAL_46_avenrun_I, &_GLOBAL_47_avenrun_I, &_GLOBAL_48_avenrun_I, &_GLOBAL_49_avenrun_I, };  
...
static inline  __attribute__((always_inline)) void calc_load(unsigned long ticks)
{
 ...
 typedef  int  _GLOBAL_154_T; static  _GLOBAL_154_T  global_count[NUM_STACKS] = {  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  ( 5 * 1000  + 1  ) ,  };      

 global_count[get_stack_id()] -= ticks;
 if (__builtin_expect(!!(global_count[get_stack_id()] < 0), 0)) {
  active_tasks = count_active_tasks();
  do {
   (*_GLOBAL_avenrun_7_A[get_stack_id()])[0] *= 1884; (*_GLOBAL_avenrun_7_A[get_stack_id()])[0] += active_tasks*((1<<11)-1884); (*_GLOBAL_avenrun_7_A[get_stack_id()])[0] >>= 11;;
   (*_GLOBAL_avenrun_7_A[get_stack_id()])[1] *= 2014; (*_GLOBAL_avenrun_7_A[get_stack_id()])[1] += active_tasks*((1<<11)-2014); (*_GLOBAL_avenrun_7_A[get_stack_id()])[1] >>= 11;;
   (*_GLOBAL_avenrun_7_A[get_stack_id()])[2] *= 2037; (*_GLOBAL_avenrun_7_A[get_stack_id()])[2] += active_tasks*((1<<11)-2037); (*_GLOBAL_avenrun_7_A[get_stack_id()])[2] >>= 11;;
   global_count[get_stack_id()] += (5*1000 +1);
  } while (global_count[get_stack_id()] < 0);
 }
}
...
{
 struct tvec_base *base = global_per_cpu__tvec_bases[get_stack_id()];
...
static inline  __attribute__((always_inline)) void update_times(unsigned long ticks)
{
 update_wall_time();
 calc_load(ticks);
}
...
{
 global_jiffies_64[get_stack_id()] += ticks;
 update_times(ticks);
}
...
# 1108 "linux-2.6.26/kernel/timer.c"
  __attribute__((regparm(0))) long sys_getpid(void)
{
 return task_tgid_vnr(nsc_get_task());
}
  ...
  __attribute__((regparm(0))) long sys_getppid(void)
{
 ...
 pid = task_tgid_vnr(nsc_get_task()->real_parent);
 do { do { } while (0); (void)0; do { } while (0); } while (0);
  ...
  __attribute__((regparm(0))) long sys_getuid(void)
{
 ...
 return nsc_get_task()->uid;
}

  __attribute__((regparm(0))) long sys_geteuid(void)
{

 return nsc_get_task()->euid;
}

  __attribute__((regparm(0))) long sys_getgid(void)
{

 return nsc_get_task()->gid;
}

  __attribute__((regparm(0))) long sys_getegid(void)
{

 return nsc_get_task()->egid;
}
...
# 1187 "linux-2.6.26/kernel/timer.c"
signed long  __attribute__((__section__(".sched.text"))) schedule_timeout(signed long timeout)
{
 ...
 setup_timer_on_stack(&timer, process_timeout, (unsigned long)nsc_get_task());
...
signed long  __attribute__((__section__(".sched.text"))) schedule_timeout_killable(signed long timeout)
{
 do { nsc_get_task()->state = ((128 | 2)); } while (0);
 return schedule_timeout(timeout);
}
;
...
{
 do { nsc_get_task()->state = (2); } while (0);
 return schedule_timeout(timeout);
}
;
  ...
  __attribute__((regparm(0))) long sys_gettid(void)
{
 return task_pid_vnr(nsc_get_task());
}
...
int do_sysinfo(struct sysinfo *info)
{
 ...
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(struct sysinfo))) ? __constant_c_and_count_memset(((info)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct sysinfo)))) : __constant_c_memset(((info)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct sysinfo))))) : (__builtin_constant_p((sizeof(struct sysinfo))) ? __memset_generic((((info))),(((0))),(((sizeof(struct sysinfo))))) : __memset_generic(((info)),((0)),((sizeof(struct sysinfo))))));

 do {
  struct timespec tp;
  seq = read_seqbegin(&global_xtime_lock[get_stack_id()]);
# 1292 "linux-2.6.26/kernel/timer.c"
  getnstimeofday(&tp);
  ...
  info->loads[0] = (*_GLOBAL_avenrun_7_A[get_stack_id()])[0] << (16 - 11);
  info->loads[1] = (*_GLOBAL_avenrun_7_A[get_stack_id()])[1] << (16 - 11);
  info->loads[2] = (*_GLOBAL_avenrun_7_A[get_stack_id()])[2] << (16 - 11);

  info->procs = global_nr_threads[get_stack_id()];
 } while (read_seqretry(&global_xtime_lock[get_stack_id()], seq));

 si_meminfo(info);
 do { (info)->freeswap = (info)->totalswap = 0; } while (0);
# 1321 "linux-2.6.26/kernel/timer.c"
...
# 1342 "linux-2.6.26/kernel/timer.c"
 info->mem_unit = 1;
...
static int   __attribute__ ((__section__(".cpuinit.text"))) __attribute__((__cold__)) init_timers_cpu(int cpu)
{
 int j;
 struct tvec_base *base;
 typedef  char   _GLOBAL_155_T; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_0_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_1_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_2_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_3_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_4_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_5_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_6_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_7_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_8_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_9_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_10_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_11_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_12_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_13_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_14_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_15_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_16_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_17_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_18_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_19_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_20_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_21_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_22_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_23_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_24_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_25_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_26_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_27_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_28_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_29_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_30_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_31_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_32_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_33_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_34_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_35_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_36_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_37_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_38_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_39_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_40_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_41_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_42_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_43_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_44_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_45_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_46_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_47_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_48_tvec_base_done_I [ 1 ] ; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_155_T  _GLOBAL_49_tvec_base_done_I [ 1 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_tvec_base_done_I) *_GLOBAL_tvec_base_done_8_A[NUM_STACKS] = { &_GLOBAL_0_tvec_base_done_I, &_GLOBAL_1_tvec_base_done_I, &_GLOBAL_2_tvec_base_done_I, &_GLOBAL_3_tvec_base_done_I, &_GLOBAL_4_tvec_base_done_I, &_GLOBAL_5_tvec_base_done_I, &_GLOBAL_6_tvec_base_done_I, &_GLOBAL_7_tvec_base_done_I, &_GLOBAL_8_tvec_base_done_I, &_GLOBAL_9_tvec_base_done_I, &_GLOBAL_10_tvec_base_done_I, &_GLOBAL_11_tvec_base_done_I, &_GLOBAL_12_tvec_base_done_I, &_GLOBAL_13_tvec_base_done_I, &_GLOBAL_14_tvec_base_done_I, &_GLOBAL_15_tvec_base_done_I, &_GLOBAL_16_tvec_base_done_I, &_GLOBAL_17_tvec_base_done_I, &_GLOBAL_18_tvec_base_done_I, &_GLOBAL_19_tvec_base_done_I, &_GLOBAL_20_tvec_base_done_I, &_GLOBAL_21_tvec_base_done_I, &_GLOBAL_22_tvec_base_done_I, &_GLOBAL_23_tvec_base_done_I, &_GLOBAL_24_tvec_base_done_I, &_GLOBAL_25_tvec_base_done_I, &_GLOBAL_26_tvec_base_done_I, &_GLOBAL_27_tvec_base_done_I, &_GLOBAL_28_tvec_base_done_I, &_GLOBAL_29_tvec_base_done_I, &_GLOBAL_30_tvec_base_done_I, &_GLOBAL_31_tvec_base_done_I, &_GLOBAL_32_tvec_base_done_I, &_GLOBAL_33_tvec_base_done_I, &_GLOBAL_34_tvec_base_done_I, &_GLOBAL_35_tvec_base_done_I, &_GLOBAL_36_tvec_base_done_I, &_GLOBAL_37_tvec_base_done_I, &_GLOBAL_38_tvec_base_done_I, &_GLOBAL_39_tvec_base_done_I, &_GLOBAL_40_tvec_base_done_I, &_GLOBAL_41_tvec_base_done_I, &_GLOBAL_42_tvec_base_done_I, &_GLOBAL_43_tvec_base_done_I, &_GLOBAL_44_tvec_base_done_I, &_GLOBAL_45_tvec_base_done_I, &_GLOBAL_46_tvec_base_done_I, &_GLOBAL_47_tvec_base_done_I, &_GLOBAL_48_tvec_base_done_I, &_GLOBAL_49_tvec_base_done_I, };   

 if (!(*_GLOBAL_tvec_base_done_8_A[get_stack_id()])[cpu]) {
  typedef  char  _GLOBAL_156_T; static  _GLOBAL_156_T  global_boot_done[NUM_STACKS];   
  ...
  if (global_boot_done[get_stack_id()]) {
   ...
   base = kmalloc_node(sizeof(*base),
      ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)) | (( gfp_t)0x8000u),
      ((void)(cpu),0));
   if (!base)
    return -12;
   ...
   if (tbase_get_deferrable(base)) {
    ({ int __ret_warn_on = !!(1); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_on_slowpath("linux-2.6.26/kernel/timer.c", 1389); __builtin_expect(!!(__ret_warn_on), 0); });
    kfree(base);
    return -12;
   }
   ...
   base = &(*_GLOBAL_boot_tvec_bases_6_A[get_stack_id()]);
  }
  (*_GLOBAL_tvec_base_done_8_A[get_stack_id()])[cpu] = 1;
 } else {
...
# 1469 "linux-2.6.26/kernel/timer.c"
static int   __attribute__ ((__section__(".cpuinit.text"))) __attribute__((__cold__)) timer_cpu_notify(struct notifier_block *self,
...
typedef  struct notifier_block    _GLOBAL_157_T; static  __attribute__ ((__section__(".cpuinit.data")))   _GLOBAL_157_T  global_timers_nb[NUM_STACKS] = {  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  { . notifier_call  = timer_cpu_notify  , } ,  };       
   



void   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) init_timers(void)
{
 int err = timer_cpu_notify(&global_timers_nb[get_stack_id()], (unsigned long)0x0003,
    (void *)(long)0);
...
unsigned long msleep_interruptible(unsigned int msecs)
{
 ...
 while (timeout && !signal_pending(nsc_get_task()))
