# 1 "linux-2.6.26/kernel/itimer.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/kernel/itimer.c"
# 9 "linux-2.6.26/kernel/itimer.c"
...
# 10 "linux-2.6.26/kernel/itimer.c" 2
...
typedef  __typeof__ ( struct pt_regs  *  )   _GLOBAL_120_T; extern  _GLOBAL_120_T  global_per_cpu__irq_regs[NUM_STACKS];     
...
typedef  int  _GLOBAL_121_T; extern  _GLOBAL_121_T  global_prof_on[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))  ;    
...
typedef  unsigned long   _GLOBAL_122_T; extern  _GLOBAL_122_T  global_io_apic_irqs[NUM_STACKS];    

typedef  atomic_t  _GLOBAL_123_T; extern  _GLOBAL_123_T  global_irq_err_count[NUM_STACKS];   
typedef  atomic_t  _GLOBAL_124_T; extern  _GLOBAL_124_T  global_irq_mis_count[NUM_STACKS];   
...
typedef  __typeof__ ( irq_cpustat_t )   _GLOBAL_125_T; extern  _GLOBAL_125_T  global_per_cpu__irq_stat[NUM_STACKS];   
...
# 11 "linux-2.6.26/kernel/itimer.c" 2
...
# 12 "linux-2.6.26/kernel/itimer.c" 2
...
# 14 "linux-2.6.26/kernel/itimer.c" 2
...
# 17 "linux-2.6.26/kernel/itimer.c" 2
# 26 "linux-2.6.26/kernel/itimer.c"
...
enum hrtimer_restart it_real_fn(struct hrtimer *timer)
{
 ...
 kill_pid_info(14, ((struct siginfo *) 1), sig->leader_pid);
...
int do_setitimer(int which, struct itimerval *value, struct itimerval *ovalue)
{
 ...
 if (!(((&value->it_value)->tv_sec >= 0) && (((unsigned long) (&value->it_value)->tv_usec) < 1000000L)) ||
     !(((&value->it_interval)->tv_sec >= 0) && (((unsigned long) (&value->it_interval)->tv_usec) < 1000000L)))
  return -22;
...
# 251 "linux-2.6.26/kernel/itimer.c"
