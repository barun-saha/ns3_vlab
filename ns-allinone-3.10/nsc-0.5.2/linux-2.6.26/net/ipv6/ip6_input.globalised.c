# 1 "linux-2.6.26/net/ipv6/ip6_input.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv6/ip6_input.c"
# 24 "linux-2.6.26/net/ipv6/ip6_input.c"
...
# 25 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 26 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 27 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
typedef  unsigned int   _GLOBAL_41_T; extern  _GLOBAL_41_T  global___invalid_size_argument_for_IOC[NUM_STACKS];    
...
typedef  int  _GLOBAL_42_T; extern  _GLOBAL_42_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_43_T; extern  _GLOBAL_43_T  global_net_msg_burst[NUM_STACKS];   
# 29 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 30 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
extern void icmpv6_flow_init(struct sock *sk,
        ...
        const struct in6_addr *daddr,
        int oif);
# 32 "linux-2.6.26/net/ipv6/ip6_input.c" 2
# 1 "linux-2.6.26/include/linux/mroute6.h" 1
# 34 "linux-2.6.26/include/linux/mroute6.h"
...
# 64 "linux-2.6.26/include/linux/mroute6.h"
struct mif6ctl {
 mifi_t mif6c_mifi;
...
# 126 "linux-2.6.26/include/linux/mroute6.h"
static inline  __attribute__((always_inline)) int ip6_mroute_opt(int opt)
{
 return 0;
}
...
extern int ip6_mroute_setsockopt(struct sock *, int, char *, int);
extern int ip6_mroute_getsockopt(struct sock *, int, char *, int *);
...
# 197 "linux-2.6.26/include/linux/mroute6.h"
struct rtmsg;
...
static inline  __attribute__((always_inline)) int ip6mr_sk_done(struct sock *sk) { return 0; }
# 217 "linux-2.6.26/include/linux/mroute6.h"
struct mrt6msg {
...
# 33 "linux-2.6.26/net/ipv6/ip6_input.c" 2

# 1 "linux-2.6.26/include/linux/netfilter.h" 1
# 10 "linux-2.6.26/include/linux/netfilter.h"
...
# 11 "linux-2.6.26/include/linux/netfilter.h" 2
...
# 35 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 36 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 38 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 39 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 41 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 42 "linux-2.6.26/net/ipv6/ip6_input.c" 2
# 1 "linux-2.6.26/include/net/transp_v6.h" 1
# 12 "linux-2.6.26/include/net/transp_v6.h"
typedef  struct proto   _GLOBAL_220_T; extern  _GLOBAL_220_T  global_rawv6_prot[NUM_STACKS];    
typedef  struct proto   _GLOBAL_221_T; extern  _GLOBAL_221_T  global_udpv6_prot[NUM_STACKS];    
typedef  struct proto   _GLOBAL_222_T; extern  _GLOBAL_222_T  global_udplitev6_prot[NUM_STACKS];    
typedef  struct proto   _GLOBAL_223_T; extern  _GLOBAL_223_T  global_tcpv6_prot[NUM_STACKS];    
...
typedef  struct inet_connection_sock_af_ops   _GLOBAL_224_T; extern  _GLOBAL_224_T  global_ipv4_specific[NUM_STACKS];    

extern int inet6_destroy_sock(struct sock *sk);
# 43 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
extern int rawv6_rcv(struct sock *sk,
       struct sk_buff *skb);
# 44 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
typedef  rwlock_t  _GLOBAL_225_T; extern  _GLOBAL_225_T  global_rt6_lock[NUM_STACKS];   
...
# 46 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
# 47 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
typedef  struct ip_ra_chain   _GLOBAL_226_T; extern  _GLOBAL_226_T  * global_ip_ra_chain[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_227_T; extern  _GLOBAL_227_T  global_ip_ra_lock[NUM_STACKS];   
...
typedef  struct ipv4_config   _GLOBAL_228_T; extern  _GLOBAL_228_T  global_ipv4_config[NUM_STACKS];    
typedef  __typeof__ ( struct ipstats_mib  )   _GLOBAL_229_T; extern  _GLOBAL_229_T  * _GLOBAL_0_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_1_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_2_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_3_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_4_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_5_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_6_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_7_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_8_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_9_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_10_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_11_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_12_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_13_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_14_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_15_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_16_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_17_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_18_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_19_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_20_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_21_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_22_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_23_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_24_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_25_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_26_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_27_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_28_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_29_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_30_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_31_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_32_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_33_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_34_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_35_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_36_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_37_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_38_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_39_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_40_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_41_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_42_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_43_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_44_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_45_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_46_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_47_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_48_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_229_T  * _GLOBAL_49_ip_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_statistics_I) *_GLOBAL_ip_statistics_19_A[NUM_STACKS];   




typedef  __typeof__ ( struct linux_mib  )   _GLOBAL_230_T; extern  _GLOBAL_230_T  * _GLOBAL_0_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_1_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_2_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_3_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_4_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_5_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_6_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_7_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_8_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_9_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_10_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_11_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_12_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_13_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_14_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_15_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_16_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_17_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_18_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_19_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_20_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_21_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_22_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_23_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_24_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_25_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_26_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_27_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_28_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_29_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_30_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_31_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_32_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_33_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_34_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_35_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_36_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_37_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_38_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_39_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_40_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_41_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_42_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_43_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_44_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_45_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_46_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_47_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_48_net_statistics_I [ 2 ]  ; extern  _GLOBAL_230_T  * _GLOBAL_49_net_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_statistics_I) *_GLOBAL_net_statistics_20_A[NUM_STACKS];   
...
typedef  int  _GLOBAL_231_T; extern  _GLOBAL_231_T  global_sysctl_ip_default_ttl[NUM_STACKS];   
typedef  int  _GLOBAL_232_T; extern  _GLOBAL_232_T  global_sysctl_ip_nonlocal_bind[NUM_STACKS];   

typedef  struct ctl_path   _GLOBAL_233_T; extern  _GLOBAL_233_T  _GLOBAL_0_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_1_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_2_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_3_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_4_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_5_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_6_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_7_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_8_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_9_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_10_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_11_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_12_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_13_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_14_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_15_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_16_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_17_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_18_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_19_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_20_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_21_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_22_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_23_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_24_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_25_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_26_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_27_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_28_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_29_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_30_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_31_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_32_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_33_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_34_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_35_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_36_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_37_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_38_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_39_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_40_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_41_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_42_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_43_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_44_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_45_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_46_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_47_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_48_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_233_T  _GLOBAL_49_net_ipv4_ctl_path_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_ipv4_ctl_path_I) *_GLOBAL_net_ipv4_ctl_path_21_A[NUM_STACKS];   


typedef  int  _GLOBAL_234_T; extern  _GLOBAL_234_T  global_inet_peer_threshold[NUM_STACKS];   
typedef  int  _GLOBAL_235_T; extern  _GLOBAL_235_T  global_inet_peer_minttl[NUM_STACKS];   
typedef  int  _GLOBAL_236_T; extern  _GLOBAL_236_T  global_inet_peer_maxttl[NUM_STACKS];   
typedef  int  _GLOBAL_237_T; extern  _GLOBAL_237_T  global_inet_peer_gc_mintime[NUM_STACKS];   
typedef  int  _GLOBAL_238_T; extern  _GLOBAL_238_T  global_inet_peer_gc_maxtime[NUM_STACKS];   


typedef  int  _GLOBAL_239_T; extern  _GLOBAL_239_T  global_sysctl_ip_dynaddr[NUM_STACKS];   
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      void *oldval, size_t *oldlenp,
      void *newval, size_t newlen);
# 19 "linux-2.6.26/include/net/xfrm.h" 2
# 51 "linux-2.6.26/include/net/xfrm.h"
typedef  struct sock   _GLOBAL_240_T; extern  _GLOBAL_240_T  * global_xfrm_nl[NUM_STACKS];    
typedef  u32  _GLOBAL_241_T; extern  _GLOBAL_241_T  global_sysctl_xfrm_aevent_etime[NUM_STACKS];   
typedef  u32  _GLOBAL_242_T; extern  _GLOBAL_242_T  global_sysctl_xfrm_aevent_rseqth[NUM_STACKS];   
typedef  int  _GLOBAL_243_T; extern  _GLOBAL_243_T  global_sysctl_xfrm_larval_drop[NUM_STACKS];   
typedef  u32  _GLOBAL_244_T; extern  _GLOBAL_244_T  global_sysctl_xfrm_acq_expires[NUM_STACKS];   

typedef  struct mutex   _GLOBAL_245_T; extern  _GLOBAL_245_T  global_xfrm_cfg_mutex[NUM_STACKS];    
...
typedef  unsigned int   _GLOBAL_246_T; extern  _GLOBAL_246_T  xfrm_policy_count [ XFRM_POLICY_MAX * 2  ] ;    
...
typedef  wait_queue_head_t  _GLOBAL_247_T; extern  _GLOBAL_247_T  global_km_waitq[NUM_STACKS];   
...
# 48 "linux-2.6.26/net/ipv6/ip6_input.c" 2
...
int ipv6_rcv(struct sk_buff *skb, struct net_device *dev, struct packet_type *pt, struct net_device *orig_dev)
{
 ...
 ({ struct inet6_dev *_idev = (idev); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_INRECEIVES)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_INRECEIVES)]++); });

 if ((skb = skb_share_check(skb, ((( gfp_t)0x20u)))) == ((void *)0)) {
  ({ struct inet6_dev *_idev = (idev); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_INDISCARDS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_INDISCARDS)]++); });
  do { do { } while (0); (void)0; do { } while (0); } while (0);
  goto out;
 }
...
# 95 "linux-2.6.26/net/ipv6/ip6_input.c"
 ((struct inet6_skb_parm*)((skb)->cb))->iif = skb->dst ? ip6_dst_idev(skb->dst)->dev->ifindex : dev->ifindex;
 ...
 pkt_len = __fswab16(( __u16)(__be16)(hdr->payload_len));


 if (pkt_len || hdr->nexthdr != 0) {
  if (pkt_len + sizeof(struct ipv6hdr) > skb->len) {
   ({ struct inet6_dev *_idev = (idev); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_INTRUNCATEDPKTS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_INTRUNCATEDPKTS)]++); });
   goto drop;
  }
  if (pskb_trim_rcsum(skb, pkt_len + sizeof(struct ipv6hdr))) {
   ({ struct inet6_dev *_idev = (idev); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_INHDRERRORS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_INHDRERRORS)]++); });
   goto drop;
  }
  hdr = ipv6_hdr(skb);
 }
...
resubmit:
 ...
 hash = nexthdr & (256 - 1);
 if ((ipprot = ({ typeof((*_GLOBAL_inet6_protos_18_A[get_stack_id()])[hash]) _________p1 = (*(volatile typeof((*_GLOBAL_inet6_protos_18_A[get_stack_id()])[hash]) *)&((*_GLOBAL_inet6_protos_18_A[get_stack_id()])[hash])); do { } while (0); (_________p1); })) != ((void *)0)) {
  int ret;
  ...
  if (ret > 0)
   ...
   ({ struct inet6_dev *_idev = (idev); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_INDELIVERS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_INDELIVERS)]++); });
 } else {
  if (!raw) {
   if (xfrm6_policy_check(((void *)0), XFRM_POLICY_IN, skb)) {
    ({ struct inet6_dev *_idev = (idev); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_INUNKNOWNPROTOS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_INUNKNOWNPROTOS)]++); });
    icmpv6_send(skb, 4,
         1, nhoff,
         skb->dev);
   }
...
int ip6_mc_input(struct sk_buff *skb)
{
 ...
 ({ struct inet6_dev *_idev = (ip6_dst_idev(skb->dst)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_INMCASTPKTS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_INMCASTPKTS)]++); });

 hdr = ipv6_hdr(skb);
 deliver = ipv6_chk_mcast_addr(skb->dev, &hdr->daddr, ((void *)0));
# 321 "linux-2.6.26/net/ipv6/ip6_input.c"
