# 1 "linux-2.6.26/net/ipv6/inet6_connection_sock.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv6/inet6_connection_sock.c"
# 16 "linux-2.6.26/net/ipv6/inet6_connection_sock.c"
...
{ }
# 17 "linux-2.6.26/net/ipv6/inet6_connection_sock.c" 2
...
# 18 "linux-2.6.26/net/ipv6/inet6_connection_sock.c" 2
...
# 19 "linux-2.6.26/net/ipv6/inet6_connection_sock.c" 2
...
# 22 "linux-2.6.26/net/ipv6/inet6_connection_sock.c" 2
...
# 24 "linux-2.6.26/net/ipv6/inet6_connection_sock.c" 2
# 1 "linux-2.6.26/include/net/inet_hashtables.h" 1
# 26 "linux-2.6.26/include/net/inet_hashtables.h"
...
typedef  rwlock_t  _GLOBAL_217_T; extern  _GLOBAL_217_T  global_vmlist_lock[NUM_STACKS];   
typedef  struct vm_struct   _GLOBAL_218_T; extern  _GLOBAL_218_T  * global_vmlist[NUM_STACKS];    
...
extern int inet_hash_connect(struct inet_timewait_death_row *death_row,
        struct sock *sk);
# 25 "linux-2.6.26/net/ipv6/inet6_connection_sock.c" 2
...
typedef  rwlock_t  _GLOBAL_219_T; extern  _GLOBAL_219_T  global_rt6_lock[NUM_STACKS];   
...
# 26 "linux-2.6.26/net/ipv6/inet6_connection_sock.c" 2

# 1 "linux-2.6.26/include/net/inet6_connection_sock.h" 1
# 18 "linux-2.6.26/include/net/inet6_connection_sock.h"
struct in6_addr;
struct inet_bind_bucket;
struct request_sock;
struct sk_buff;
...
# 28 "linux-2.6.26/net/ipv6/inet6_connection_sock.c" 2
...
{
 u32 a = ( u32)raddr->in6_u.u6_addr32[0];
 u32 b = ( u32)raddr->in6_u.u6_addr32[1];
 u32 c = ( u32)raddr->in6_u.u6_addr32[2];
...
static inline 
__attribute__((always_inline)) void __inet6_csk_dst_store(struct sock *sk, struct dst_entry *dst,
      struct in6_addr *daddr, struct in6_addr *saddr)
{
 __ip6_dst_store(sk, dst, daddr, saddr);
...
static inline 
__attribute__((always_inline)) struct dst_entry *__inet6_csk_dst_check(struct sock *sk, u32 cookie)
{
 struct dst_entry *dst;

 dst = __sk_dst_check(sk, cookie);
# 178 "linux-2.6.26/net/ipv6/inet6_connection_sock.c"
 return dst;
}
...
int inet6_csk_xmit(struct sk_buff *skb, int ipfragok)
{
 ...
 do { if (INET_ECN_is_capable(inet6_sk(sk)->tclass)) (fl.nl_u.ip6_u.flowlabel) |= (( __be32)__fswab32((INET_ECN_ECT_0 << 20))); } while (0);
