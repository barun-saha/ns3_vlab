# 1 "linux-2.6.26/net/ipv6/ip6_fib.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv6/ip6_fib.c"
# 23 "linux-2.6.26/net/ipv6/ip6_fib.c"
...
# 24 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
...
# 25 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
...
# 26 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
# 1 "linux-2.6.26/include/linux/route.h" 1
# 26 "linux-2.6.26/include/linux/route.h"
...
# 27 "linux-2.6.26/include/linux/route.h" 2
...
# 27 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
...
# 28 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
# 36 "linux-2.6.26/net/ipv6/ip6_fib.c"
...
# 37 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
...
# 39 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
...
# 41 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
...
# 42 "linux-2.6.26/net/ipv6/ip6_fib.c" 2
# 51 "linux-2.6.26/net/ipv6/ip6_fib.c"
typedef  struct kmem_cache   _GLOBAL_218_T; static  _GLOBAL_218_T  * global_fib6_node_kmem[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))  ;      
...
typedef  rwlock_t  _GLOBAL_219_T; static  _GLOBAL_219_T  global_fib6_walker_lock[NUM_STACKS] = {  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  };           
...
# 142 "linux-2.6.26/net/ipv6/ip6_fib.c"
static __inline__  __attribute__((always_inline)) __be32 addr_bit_set(void *token, int fn_bit)
{
 __be32 *addr = token;

 return (( __be32)__fswab32((1 << ((~fn_bit)&0x1F)))) & addr[fn_bit>>5];
}
...
static __inline__  __attribute__((always_inline)) struct fib6_node * node_alloc(void)
{
 ...
 fn = kmem_cache_zalloc(global_fib6_node_kmem[get_stack_id()], ((( gfp_t)0x20u)));
...
static void fib6_link_table(struct net *net, struct fib6_table *tb)
{
 ...
 do { *(&tb->tb6_lock) = (rwlock_t) { .raw_lock = { }, }; } while (0);
...
# 257 "linux-2.6.26/net/ipv6/ip6_fib.c"
      ...
      struct netlink_callback *cb)
{
 ...
 if (cb->args[4] == 0) {
  do { local_bh_disable(); do { do { } while (0); (void)0; (void)(&table->tb6_lock); } while (0); } while (0);
  res = fib6_walk(w);
  do { do { } while (0); local_bh_enable(); (void)0; (void)(&table->tb6_lock); } while (0);
  if (res > 0)
   cb->args[4] = 1;
 } else {
  do { local_bh_disable(); do { do { } while (0); (void)0; (void)(&table->tb6_lock); } while (0); } while (0);
...
static int inet6_dump_fib(struct sk_buff *skb, struct netlink_callback *cb)
{
 ...
 if (w == ((void *)0)) {
  ...
  w = kzalloc(sizeof(*w), ((( gfp_t)0x20u)));
  if (w == ((void *)0))
   return -12;
 ...
 for (h = s_h; h < 1; h++, s_e = 0) {
  e = 0;
  head = &net->ipv6.fib_table_hash[h];
  for (node = (head)->first; node && ({ prefetch(node->next); 1;}) && ({ tb = ({ const typeof( ((typeof(*tb) *)0)->tb6_hlist ) *__mptr = (node); (typeof(*tb) *)( (char *)__mptr - __builtin_offsetof(typeof(*tb),tb6_hlist) );}); 1;}); node = node->next) {
   if (e < s_e)
    goto next;
...
# 416 "linux-2.6.26/net/ipv6/ip6_fib.c"
...
insert_above:
# 501 "linux-2.6.26/net/ipv6/ip6_fib.c"
 pn = fn->parent;
...
# 536 "linux-2.6.26/net/ipv6/ip6_fib.c"
  in->fn_bit = bit;
...
static __inline__  __attribute__((always_inline)) void fib6_start_gc(struct net *net, struct rt6_info *rt)
{
 if (net->ipv6.ip6_fib_timer->expires == 0 &&
     (rt->rt6i_flags & (0x00400000|0x01000000)))
  mod_timer(net->ipv6.ip6_fib_timer, global_jiffies[get_stack_id()] +
...
int fib6_add(struct fib6_node *root, struct rt6_info *rt, struct nl_info *info)
{
 ...
 pn = fn;
# 760 "linux-2.6.26/net/ipv6/ip6_fib.c"
...
out:
 if (err) {
# 790 "linux-2.6.26/net/ipv6/ip6_fib.c"
  dst_free(&rt->u.dst);
 }
 return err;
# 804 "linux-2.6.26/net/ipv6/ip6_fib.c"
}
     ...
     struct lookup_args *args)
{
 ...
 if (__builtin_expect(!!(args->offset == 0), 0))
  return ((void *)0);
          ...
          struct in6_addr *saddr)
{
 ...
 struct lookup_args args[] = {
  {
   .offset = __builtin_offsetof(struct rt6_info,rt6i_dst),
   .addr = daddr,
  },
...
# 954 "linux-2.6.26/net/ipv6/ip6_fib.c"
 if (fn && fn->fn_flags&0x0004)
  return fn;
 ...
 *rtp = rt->u.dst.rt6_next;
 ...
 if (((&rt->rt6i_ref)->counter) != 1) {
  ...
  do { if (__builtin_expect(!!(((&rt->rt6i_ref)->counter) != 1), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
 }
...
int fib6_del(struct rt6_info *rt, struct nl_info *info)
{
 ...
 do { if (__builtin_expect(!!(!(fn->fn_flags&0x0004)), 0)) { printk("<3>" "KERNEL: assertion (%s) failed at %s (%d)\n", "fn->fn_flags&RTN_RTINFO", "linux-2.6.26/net/ipv6/ip6_fib.c" , 1166); } } while(0);

 if (!(rt->rt6i_flags&0x01000000)) {
  struct fib6_node *pn = fn;
# 1178 "linux-2.6.26/net/ipv6/ip6_fib.c"
  fib6_prune_clones(info->nl_net, pn, rt);
 }
...
# 1218 "linux-2.6.26/net/ipv6/ip6_fib.c"
static int fib6_walk_continue(struct fib6_walker_t *w)
{
 ...
 for (;;) {
  ...
  switch (w->state) {
# 1241 "linux-2.6.26/net/ipv6/ip6_fib.c"
  case FWS_L:
   if (fn->left) {
    w->node = fn->left;
    w->state = FWS_L;
...
static int fib6_clean_node(struct fib6_walker_t *w)
{
 int res;
 struct rt6_info *rt;
 struct fib6_cleaner_t *c = ({ const typeof( ((struct fib6_cleaner_t *)0)->w ) *__mptr = (w); (struct fib6_cleaner_t *)( (char *)__mptr - __builtin_offsetof(struct fib6_cleaner_t,w) );});
 struct nl_info info = {
  .nl_net = c->net,
 };
 ...
 for (rt = w->leaf; rt; rt = rt->u.dst.rt6_next) {
  ...
  do { if (__builtin_expect(!!(!(res==0)), 0)) { printk("<3>" "KERNEL: assertion (%s) failed at %s (%d)\n", "res==0", "linux-2.6.26/net/ipv6/ip6_fib.c" , 1328); } } while(0);
 }
 w->leaf = rt;
 return 0;
}
# 1345 "linux-2.6.26/net/ipv6/ip6_fib.c"
      ...
      int prune, void *arg)
{
 ...
 for (h = 0; h < 1; h++) {
  head = &net->ipv6.fib_table_hash[h];
  for (node = ({ typeof((head)->first) _________p1 = (*(volatile typeof((head)->first) *)&((head)->first)); do { } while (0); (_________p1); }); node && ({ prefetch(node->next); 1;}) && ({ table = ({ const typeof( ((typeof(*table) *)0)->tb6_hlist ) *__mptr = (node); (typeof(*table) *)( (char *)__mptr - __builtin_offsetof(typeof(*table),tb6_hlist) );}); 1;}); node = ({ typeof(node->next) _________p1 = (*(volatile typeof(node->next) *)&(node->next)); do { } while (0); (_________p1); })) {
   do { local_bh_disable(); do { do { } while (0); (void)0; (void)(&table->tb6_lock); } while (0); } while (0);
...
typedef  struct fib6_gc_args { int  timeout ;  int  more ;   }   _GLOBAL_222_T; static  _GLOBAL_222_T  global_gc_args[NUM_STACKS];   
...
# 1420 "linux-2.6.26/net/ipv6/ip6_fib.c"
...
typedef  spinlock_t  _GLOBAL_223_T; static  _GLOBAL_223_T  global_fib6_gc_lock[NUM_STACKS] = {  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  };           

void fib6_run_gc(unsigned long expires, struct net *net)
{
 if (expires != ~0UL) {
  do { local_bh_disable(); do { do { } while (0); (void)0; (void)(&global_fib6_gc_lock[get_stack_id()]); } while (0); } while (0);
  global_gc_args[get_stack_id()].timeout = expires ? (int)expires :
   net->ipv6.sysctl.ip6_rt_gc_interval;
 } else {
  local_bh_disable();
  if (!(({ do { do { } while (0); (void)0; (void)(&global_fib6_gc_lock[get_stack_id()]); } while (0); 1; }))) {
   mod_timer(net->ipv6.ip6_fib_timer, global_jiffies[get_stack_id()] + 1000);
   local_bh_enable();
   return;
  }
  global_gc_args[get_stack_id()].timeout = net->ipv6.sysctl.ip6_rt_gc_interval;
 }
 global_gc_args[get_stack_id()].more = 0;

 icmp6_dst_gc(&global_gc_args[get_stack_id()].more);
...
static int fib6_net_init(struct net *net)
{
 ...
 ret = -12;
 timer = kzalloc(sizeof(*timer), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!timer)
  goto out;
 ...
 net->ipv6.rt6_stats = kzalloc(sizeof(*net->ipv6.rt6_stats), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!net->ipv6.rt6_stats)
  goto out_timer;

 net->ipv6.fib_table_hash =
  kzalloc(sizeof(*net->ipv6.fib_table_hash)*1,
 ...
 net->ipv6.fib6_main_tbl->tb6_id = RT_TABLE_MAIN;
 net->ipv6.fib6_main_tbl->tb6_root.leaf = net->ipv6.ip6_null_entry;
 net->ipv6.fib6_main_tbl->tb6_root.fn_flags =
  0x0002 | 0x0001 | 0x0004;
# 1524 "linux-2.6.26/net/ipv6/ip6_fib.c"
...
typedef  struct pernet_operations   _GLOBAL_224_T; static  _GLOBAL_224_T  global_fib6_net_ops[NUM_STACKS] = {  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  { . init  = fib6_net_init  , . exit  = fib6_net_exit   , } ,  };      
   
   


int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) fib6_init(void)
{
 int ret = -12;
 ...
 ret = register_pernet_subsys(&global_fib6_net_ops[get_stack_id()]);
 if (ret)
  goto out_kmem_cache_create;

 ret = __rtnl_register(10, RTM_GETROUTE, ((void *)0), inet6_dump_fib);
 if (ret)
...
out_unregister_subsys:
 unregister_pernet_subsys(&global_fib6_net_ops[get_stack_id()]);
