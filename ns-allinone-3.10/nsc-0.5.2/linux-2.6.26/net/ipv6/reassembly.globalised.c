# 1 "linux-2.6.26/net/ipv6/reassembly.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv6/reassembly.c"
# 31 "linux-2.6.26/net/ipv6/reassembly.c"
...
# 32 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
# 33 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
# 34 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
# 35 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
# 5 "linux-2.6.26/include/linux/jiffies.h" 2
...
# 6 "linux-2.6.26/include/linux/jiffies.h" 2
...
# 13 "linux-2.6.26/include/asm/thread_info_32.h"
...
# 102 "linux-2.6.26/include/asm/page_32.h"
...
typedef  unsigned long   _GLOBAL_15_T; extern  _GLOBAL_15_T  global_max_pfn_mapped[NUM_STACKS];    
...
# 14 "linux-2.6.26/include/asm/thread_info_32.h" 2
...
typedef  char  _GLOBAL_16_T; extern  _GLOBAL_16_T  * global_saved_command_line[NUM_STACKS];   
typedef  unsigned int   _GLOBAL_17_T; extern  _GLOBAL_17_T  global_reset_devices[NUM_STACKS];    


void setup_arch(char **);
void prepare_namespace(void);

typedef  void   ( *_GLOBAL_19_T  )  ( void  ) ; extern  _GLOBAL_19_T global_late_time_init[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_20_T; static  _GLOBAL_20_T  global___force_order[NUM_STACKS];    
...
typedef  int  _GLOBAL_21_T; extern  _GLOBAL_21_T  global_es7000_plat[NUM_STACKS];   
...
# 17 "linux-2.6.26/include/asm/thread_info_32.h" 2
...
typedef  struct timespec   _GLOBAL_41_T; extern  _GLOBAL_41_T  global_xtime[NUM_STACKS];    
typedef  struct timespec   _GLOBAL_42_T; extern  _GLOBAL_42_T  global_wall_to_monotonic[NUM_STACKS];    
typedef  seqlock_t  _GLOBAL_43_T; extern  _GLOBAL_43_T  global_xtime_lock[NUM_STACKS];   

extern unsigned long read_persistent_clock(void);
extern int update_persistent_clock(struct timespec now);
typedef  int  _GLOBAL_44_T; extern  _GLOBAL_44_T  global_no_sync_cmos_clock[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))  ;    
...
# 8 "linux-2.6.26/include/linux/jiffies.h" 2
...
typedef  unsigned int   _GLOBAL_46_T; extern  _GLOBAL_46_T  global_tsc_khz[NUM_STACKS];    
...
typedef  int  _GLOBAL_50_T; extern  _GLOBAL_50_T  global_time_status[NUM_STACKS];   
...
typedef  long  _GLOBAL_53_T; extern  _GLOBAL_53_T  global_time_adjust[NUM_STACKS];   
...
typedef  u64  _GLOBAL_54_T; extern  _GLOBAL_54_T  global_tick_length[NUM_STACKS];   
...
typedef  u64   _GLOBAL_55_T; extern  __attribute__((section(".data")))   _GLOBAL_55_T  global_jiffies_64[NUM_STACKS];    
typedef  unsigned long    _GLOBAL_56_T; extern volatile  __attribute__((section(".data")))   _GLOBAL_56_T  global_jiffies[NUM_STACKS];      


u64 get_jiffies_64(void);
# 173 "linux-2.6.26/include/linux/jiffies.h"
typedef  unsigned long   _GLOBAL_57_T; extern  _GLOBAL_57_T  global_preset_lpj[NUM_STACKS];    
...
# 37 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
typedef  unsigned int   _GLOBAL_58_T; extern  _GLOBAL_58_T  global___invalid_size_argument_for_IOC[NUM_STACKS];    
...
typedef  int  _GLOBAL_59_T; extern  _GLOBAL_59_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_60_T; extern  _GLOBAL_60_T  global_net_msg_burst[NUM_STACKS];   
# 38 "linux-2.6.26/net/ipv6/reassembly.c" 2

# 1 "linux-2.6.26/include/linux/netdevice.h" 1
# 28 "linux-2.6.26/include/linux/netdevice.h"
# 1 "linux-2.6.26/include/linux/if.h" 1
# 27 "linux-2.6.26/include/linux/if.h"
...
typedef  unsigned int   _GLOBAL_61_T; extern  _GLOBAL_61_T  global_vdso_enabled[NUM_STACKS];    
...
typedef  struct desc_ptr   _GLOBAL_62_T; extern  _GLOBAL_62_T  global_idt_descr[NUM_STACKS];    
extern gate_desc idt_table[];
# 54 "linux-2.6.26/include/asm/desc.h"
struct gdt_page {
 struct desc_struct gdt[32];
} __attribute__((aligned(((1UL) << 12)))) ;
typedef  __typeof__ ( struct gdt_page  )   _GLOBAL_63_T; extern  _GLOBAL_63_T  global_per_cpu__gdt_page[NUM_STACKS];    
...
typedef  char  _GLOBAL_64_T; extern  _GLOBAL_64_T  _GLOBAL_0_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_1_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_2_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_3_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_4_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_5_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_6_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_7_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_8_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_9_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_10_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_11_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_12_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_13_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_14_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_15_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_16_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_17_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_18_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_19_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_20_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_21_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_22_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_23_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_24_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_25_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_26_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_27_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_28_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_29_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_30_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_31_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_32_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_33_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_34_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_35_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_36_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_37_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_38_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_39_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_40_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_41_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_42_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_43_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_44_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_45_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_46_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_47_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_48_uevent_helper_I [ ] ; extern  _GLOBAL_64_T  _GLOBAL_49_uevent_helper_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_uevent_helper_I) *_GLOBAL_uevent_helper_2_A[NUM_STACKS];  


typedef  u64  _GLOBAL_65_T; extern  _GLOBAL_65_T  global_uevent_seqnum[NUM_STACKS];   
...
typedef  struct sysfs_ops   _GLOBAL_66_T; extern  _GLOBAL_66_T  global_kobj_sysfs_ops[NUM_STACKS];    
...
typedef  struct kobject   _GLOBAL_67_T; extern  _GLOBAL_67_T  * global_kernel_kobj[NUM_STACKS];    

typedef  struct kobject   _GLOBAL_68_T; extern  _GLOBAL_68_T  * global_hypervisor_kobj[NUM_STACKS];    

typedef  struct kobject   _GLOBAL_69_T; extern  _GLOBAL_69_T  * global_power_kobj[NUM_STACKS];    

typedef  struct kobject   _GLOBAL_70_T; extern  _GLOBAL_70_T  * global_firmware_kobj[NUM_STACKS];    
...
typedef  nodemask_t  _GLOBAL_71_T; extern  _GLOBAL_71_T  global__unused_nodemask_arg_[NUM_STACKS];   
...
typedef  nodemask_t  _GLOBAL_72_T; extern  _GLOBAL_72_T  node_states [ NR_NODE_STATES ] ;   
...
typedef  int  _GLOBAL_73_T; extern  _GLOBAL_73_T  global_page_group_by_mobility_disabled[NUM_STACKS];   
...
typedef  struct blocking_notifier_head   _GLOBAL_74_T; extern  _GLOBAL_74_T  global_reboot_notifier_list[NUM_STACKS];    
...
typedef  int  _GLOBAL_75_T; extern  _GLOBAL_75_T  global_movable_zone[NUM_STACKS];   
...
int min_free_kbytes_sysctl_handler(struct ctl_table *, int, struct file *,
     void *, size_t *, loff_t *);
typedef  int  _GLOBAL_76_T; extern  _GLOBAL_76_T  _GLOBAL_0_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_1_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_2_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_3_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_4_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_5_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_6_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_7_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_8_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_9_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_10_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_11_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_12_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_13_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_14_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_15_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_16_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_17_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_18_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_19_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_20_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_21_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_22_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_23_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_24_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_25_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_26_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_27_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_28_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_29_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_30_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_31_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_32_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_33_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_34_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_35_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_36_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_37_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_38_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_39_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_40_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_41_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_42_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_43_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_44_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_45_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_46_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_47_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_48_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; extern  _GLOBAL_76_T  _GLOBAL_49_sysctl_lowmem_reserve_ratio_I [ 3 - 1  ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_lowmem_reserve_ratio_I) *_GLOBAL_sysctl_lowmem_reserve_ratio_3_A[NUM_STACKS];   
...
typedef  struct pglist_data   _GLOBAL_77_T; extern  _GLOBAL_77_T  global_contig_page_data[NUM_STACKS];    
...
{
 typedef  const ktime_t   _GLOBAL_78_T; static  _GLOBAL_78_T  global_ktime_zero[NUM_STACKS] = {  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  { . tv64  = 0  } ,  };          
...
typedef  const struct in6_addr    _GLOBAL_80_T; extern  _GLOBAL_80_T  global_in6addr_any[NUM_STACKS];     

typedef  const struct in6_addr    _GLOBAL_81_T; extern  _GLOBAL_81_T  global_in6addr_loopback[NUM_STACKS];     


typedef  const struct in6_addr    _GLOBAL_82_T; extern  _GLOBAL_82_T  global_in6addr_linklocal_allnodes[NUM_STACKS];     


typedef  const struct in6_addr    _GLOBAL_83_T; extern  _GLOBAL_83_T  global_in6addr_linklocal_allrouters[NUM_STACKS];     
...
# 5 "linux-2.6.26/include/asm/checksum_32.h" 2
...
typedef  __typeof__ ( struct rcu_data  )   _GLOBAL_84_T; extern  _GLOBAL_84_T  global_per_cpu__rcu_data[NUM_STACKS];    
typedef  __typeof__ ( struct rcu_data  )   _GLOBAL_85_T; extern  _GLOBAL_85_T  global_per_cpu__rcu_bh_data[NUM_STACKS];    
...
typedef  struct resource   _GLOBAL_86_T; extern  _GLOBAL_86_T  global_ioport_resource[NUM_STACKS];    
typedef  struct resource   _GLOBAL_87_T; extern  _GLOBAL_87_T  global_iomem_resource[NUM_STACKS];    
...
typedef  void   ( *_GLOBAL_89_T  )  ( void  ) ; extern  _GLOBAL_89_T global_pm_idle[NUM_STACKS];   
typedef  void   ( *_GLOBAL_91_T  )  ( void  ) ; extern  _GLOBAL_91_T global_pm_power_off[NUM_STACKS];   
typedef  void   ( *_GLOBAL_93_T  )  ( void  ) ; extern  _GLOBAL_93_T global_pm_power_off_prepare[NUM_STACKS];   
...
typedef  unsigned int   _GLOBAL_94_T; extern  _GLOBAL_94_T  global_pm_flags[NUM_STACKS];    
...
{
 typedef  struct lock_class_key   _GLOBAL_95_T; static  _GLOBAL_95_T  global___key[NUM_STACKS];    
...
typedef  int   ( *_GLOBAL_97_T  )  ( struct device   * dev   ) ; extern  _GLOBAL_97_T global_platform_notify[NUM_STACKS];     

typedef  int   ( *_GLOBAL_99_T  )  ( struct device   * dev   ) ; extern  _GLOBAL_99_T global_platform_notify_remove[NUM_STACKS];     
...
typedef  struct ctl_table   _GLOBAL_100_T; extern  _GLOBAL_100_T  _GLOBAL_0_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_1_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_2_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_3_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_4_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_5_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_6_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_7_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_8_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_9_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_10_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_11_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_12_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_13_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_14_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_15_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_16_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_17_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_18_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_19_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_20_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_21_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_22_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_23_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_24_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_25_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_26_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_27_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_28_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_29_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_30_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_31_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_32_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_33_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_34_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_35_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_36_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_37_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_38_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_39_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_40_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_41_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_42_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_43_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_44_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_45_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_46_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_47_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_48_ether_table_I [ ] ; extern  _GLOBAL_100_T  _GLOBAL_49_ether_table_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ether_table_I) *_GLOBAL_ether_table_5_A[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_101_T; extern  _GLOBAL_101_T  global_loops_per_jiffy[NUM_STACKS];    
...
struct net;
typedef  struct net   _GLOBAL_102_T; extern  _GLOBAL_102_T  global_init_net[NUM_STACKS];    
...
typedef  struct list_head   _GLOBAL_104_T; extern  _GLOBAL_104_T  global_net_namespace_list[NUM_STACKS];    
...
typedef  __typeof__ ( struct netif_rx_stats  )   _GLOBAL_105_T; extern  _GLOBAL_105_T  global_per_cpu__netdev_rx_stat[NUM_STACKS];    
...
typedef  const kernel_cap_t   _GLOBAL_106_T; extern  _GLOBAL_106_T  global___cap_empty_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_107_T; extern  _GLOBAL_107_T  global___cap_full_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_108_T; extern  _GLOBAL_108_T  global___cap_init_eff_set[NUM_STACKS];    
...
typedef  int  _GLOBAL_109_T; extern  _GLOBAL_109_T  global_show_unhandled_signals[NUM_STACKS];   
...
typedef  struct pid   _GLOBAL_110_T; extern  _GLOBAL_110_T  global_init_struct_pid[NUM_STACKS];    
...
typedef  unsigned long   _GLOBAL_111_T; extern  _GLOBAL_111_T  _GLOBAL_0_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_1_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_2_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_3_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_4_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_5_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_6_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_7_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_8_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_9_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_10_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_11_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_12_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_13_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_14_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_15_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_16_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_17_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_18_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_19_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_20_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_21_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_22_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_23_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_24_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_25_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_26_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_27_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_28_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_29_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_30_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_31_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_32_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_33_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_34_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_35_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_36_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_37_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_38_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_39_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_40_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_41_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_42_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_43_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_44_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_45_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_46_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_47_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_48_avenrun_I [ ] ; extern  _GLOBAL_111_T  _GLOBAL_49_avenrun_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_avenrun_I) *_GLOBAL_avenrun_6_A[NUM_STACKS];   
# 129 "linux-2.6.26/include/linux/sched.h"
typedef  unsigned long   _GLOBAL_112_T; extern  _GLOBAL_112_T  global_total_forks[NUM_STACKS];    
typedef  int  _GLOBAL_113_T; extern  _GLOBAL_113_T  global_nr_threads[NUM_STACKS];   
typedef  __typeof__ ( unsigned long  )   _GLOBAL_114_T; extern  _GLOBAL_114_T  global_per_cpu__process_counts[NUM_STACKS];    
...
typedef  unsigned long long    _GLOBAL_115_T; extern  _GLOBAL_115_T  global_time_sync_thresh[NUM_STACKS];     
# 238 "linux-2.6.26/include/linux/sched.h"
typedef  rwlock_t  _GLOBAL_116_T; extern  _GLOBAL_116_T  global_tasklist_lock[NUM_STACKS];   
typedef  spinlock_t  _GLOBAL_117_T; extern  _GLOBAL_117_T  global_mmlist_lock[NUM_STACKS];   
...
typedef  cpumask_t  _GLOBAL_118_T; extern  _GLOBAL_118_T  global_nohz_cpu_mask[NUM_STACKS];   
...
typedef  int  _GLOBAL_119_T; extern  _GLOBAL_119_T  global_sysctl_max_map_count[NUM_STACKS];   
...
typedef  unsigned  _GLOBAL_120_T; extern  _GLOBAL_120_T  global_aio_max_size[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_121_T; extern  _GLOBAL_121_T  global_aio_nr[NUM_STACKS];    
typedef  unsigned long   _GLOBAL_122_T; extern  _GLOBAL_122_T  global_aio_max_nr[NUM_STACKS];    
...
typedef  struct user_struct   _GLOBAL_123_T; extern  _GLOBAL_123_T  global_root_user[NUM_STACKS];    
...
typedef  struct pid   _GLOBAL_124_T; extern  _GLOBAL_124_T  * global_cad_pid[NUM_STACKS];    
...
typedef  unsigned int   _GLOBAL_125_T; extern  _GLOBAL_125_T  global_sysctl_sched_rt_period[NUM_STACKS];    
typedef  int  _GLOBAL_126_T; extern  _GLOBAL_126_T  global_sysctl_sched_rt_runtime[NUM_STACKS];   

int sched_rt_handler(struct ctl_table *table, int write,
  struct file *filp, void *buffer, size_t *lenp,
  loff_t *ppos);

typedef  unsigned int   _GLOBAL_127_T; extern  _GLOBAL_127_T  global_sysctl_sched_compat_yield[NUM_STACKS];    
...
typedef  struct exec_domain   _GLOBAL_128_T; extern  _GLOBAL_128_T  global_default_exec_domain[NUM_STACKS];    
...
typedef  union thread_union   _GLOBAL_129_T; extern  _GLOBAL_129_T  global_init_thread_union[NUM_STACKS];    
typedef  struct task_struct   _GLOBAL_130_T; extern  _GLOBAL_130_T  global_init_task[NUM_STACKS];    

typedef  struct mm_struct   _GLOBAL_131_T; extern  _GLOBAL_131_T  global_init_mm[NUM_STACKS];    
...
typedef  int  _GLOBAL_132_T; extern  _GLOBAL_132_T  global_sched_mc_power_savings[NUM_STACKS]; extern  _GLOBAL_132_T  global_sched_smt_power_savings[NUM_STACKS];    
...
typedef  __typeof__ ( struct pt_regs  *  )   _GLOBAL_133_T; extern  _GLOBAL_133_T  global_per_cpu__irq_regs[NUM_STACKS];     
...
typedef  int  _GLOBAL_134_T; extern  _GLOBAL_134_T  global_prof_on[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))  ;    
...
typedef  unsigned long   _GLOBAL_135_T; extern  _GLOBAL_135_T  global_io_apic_irqs[NUM_STACKS];    

typedef  atomic_t  _GLOBAL_136_T; extern  _GLOBAL_136_T  global_irq_err_count[NUM_STACKS];   
typedef  atomic_t  _GLOBAL_137_T; extern  _GLOBAL_137_T  global_irq_mis_count[NUM_STACKS];   
...
typedef  __typeof__ ( irq_cpustat_t )   _GLOBAL_138_T; extern  _GLOBAL_138_T  global_per_cpu__irq_stat[NUM_STACKS];   
...
typedef  rwlock_t  _GLOBAL_139_T; extern  _GLOBAL_139_T  global_dev_base_lock[NUM_STACKS];   
...
typedef  __typeof__ ( struct softnet_data  )   _GLOBAL_140_T; extern  _GLOBAL_140_T  global_per_cpu__softnet_data[NUM_STACKS];    
...
typedef  int  _GLOBAL_141_T; extern  _GLOBAL_141_T  global_netdev_budget[NUM_STACKS];   
...
typedef  int  _GLOBAL_142_T; extern  _GLOBAL_142_T  global_netdev_max_backlog[NUM_STACKS];   
typedef  int  _GLOBAL_143_T; extern  _GLOBAL_143_T  global_weight_p[NUM_STACKS];   
...
# 40 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
# 51 "linux-2.6.26/include/net/sock.h"
...
typedef  int  _GLOBAL_144_T; extern  _GLOBAL_144_T  global_debug_locks[NUM_STACKS];   
typedef  int  _GLOBAL_145_T; extern  _GLOBAL_145_T  global_debug_locks_silent[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_151_T; extern  _GLOBAL_151_T  global_mmap_min_addr[NUM_STACKS];    


# 1 "linux-2.6.26/include/asm/pgtable.h" 1
# 92 "linux-2.6.26/include/asm/pgtable.h"
typedef  pteval_t  _GLOBAL_152_T; extern  _GLOBAL_152_T  global___PAGE_KERNEL[NUM_STACKS]; extern  _GLOBAL_152_T  global___PAGE_KERNEL_EXEC[NUM_STACKS];    
# 155 "linux-2.6.26/include/asm/pgtable.h"
extern unsigned long empty_zero_page[((1UL) << 12) / sizeof(unsigned long)];


typedef  spinlock_t  _GLOBAL_153_T; extern  _GLOBAL_153_T  global_pgd_lock[NUM_STACKS];   
typedef  struct list_head   _GLOBAL_154_T; extern  _GLOBAL_154_T  global_pgd_list[NUM_STACKS];    
...
typedef  pteval_t  _GLOBAL_155_T; extern  _GLOBAL_155_T  global___supported_pte_mask[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_156_T; extern  _GLOBAL_156_T  global___FIXADDR_TOP[NUM_STACKS];    
...
typedef  struct kmem_cache   _GLOBAL_157_T; extern  _GLOBAL_157_T  * global_vm_area_cachep[NUM_STACKS];    
...
typedef  struct rb_root   _GLOBAL_158_T; extern  _GLOBAL_158_T  global_nommu_vma_tree[NUM_STACKS];    
typedef  struct rw_semaphore   _GLOBAL_159_T; extern  _GLOBAL_159_T  global_nommu_vma_sem[NUM_STACKS];    
...
typedef  int  _GLOBAL_161_T; extern  _GLOBAL_161_T  global_sysctl_nr_open[NUM_STACKS];   
...
typedef  struct files_stat_struct   _GLOBAL_162_T; extern  _GLOBAL_162_T  global_files_stat[NUM_STACKS];    
...
typedef  struct inodes_stat_t   _GLOBAL_163_T; extern  _GLOBAL_163_T  global_inodes_stat[NUM_STACKS];    

typedef  int  _GLOBAL_164_T; extern  _GLOBAL_164_T  global_leases_enable[NUM_STACKS]; extern  _GLOBAL_164_T  global_lease_break_time[NUM_STACKS];    
...
typedef  struct dentry_stat_t   _GLOBAL_165_T; extern  _GLOBAL_165_T  global_dentry_stat[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_166_T; extern  _GLOBAL_166_T  global_dcache_lock[NUM_STACKS];   
typedef  seqlock_t  _GLOBAL_167_T; extern  _GLOBAL_167_T  global_rename_lock[NUM_STACKS];   
...
typedef  int  _GLOBAL_168_T; extern  _GLOBAL_168_T  global_sysctl_vfs_cache_pressure[NUM_STACKS];   
...
typedef  spinlock_t  _GLOBAL_169_T; extern  _GLOBAL_169_T  global_dq_data_lock[NUM_STACKS];   
...
typedef  struct dqstats   _GLOBAL_170_T; extern  _GLOBAL_170_T  global_dqstats[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_171_T; extern  _GLOBAL_171_T  global_files_lock[NUM_STACKS];   
...
typedef  struct list_head   _GLOBAL_172_T; extern  _GLOBAL_172_T  global_super_blocks[NUM_STACKS];    
typedef  spinlock_t  _GLOBAL_173_T; extern  _GLOBAL_173_T  global_sb_lock[NUM_STACKS];   
...
typedef  struct kobject   _GLOBAL_174_T; extern  _GLOBAL_174_T  * global_fs_kobj[NUM_STACKS];    
...
typedef  struct kmem_cache   _GLOBAL_175_T; extern  _GLOBAL_175_T  * global_names_cachep[NUM_STACKS];    
# 1632 "linux-2.6.26/include/linux/fs.h"
static inline  __attribute__((always_inline)) void bd_forget(struct inode *inode) {}

typedef  const struct file_operations    _GLOBAL_176_T; extern  _GLOBAL_176_T  global_def_blk_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_177_T; extern  _GLOBAL_177_T  global_def_chr_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_178_T; extern  _GLOBAL_178_T  global_bad_sock_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_179_T; extern  _GLOBAL_179_T  global_def_fifo_fops[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_180_T; extern  _GLOBAL_180_T  global_read_fifo_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_181_T; extern  _GLOBAL_181_T  global_write_fifo_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_182_T; extern  _GLOBAL_182_T  global_rdwr_fifo_fops[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_183_T; extern  _GLOBAL_183_T  global_generic_ro_fops[NUM_STACKS];     
...
typedef  const struct inode_operations    _GLOBAL_184_T; extern  _GLOBAL_184_T  global_page_symlink_inode_operations[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_185_T; extern  _GLOBAL_185_T  global_simple_dir_operations[NUM_STACKS];     
typedef  const struct inode_operations    _GLOBAL_186_T; extern  _GLOBAL_186_T  global_simple_dir_inode_operations[NUM_STACKS];     
...
typedef  int  _GLOBAL_187_T; extern  _GLOBAL_187_T  global_suid_dumpable[NUM_STACKS];   
...
# 11 "linux-2.6.26/include/net/flow.h"
# 1 "linux-2.6.26/include/asm/atomic.h" 1
...
typedef  atomic_t  _GLOBAL_188_T; extern  _GLOBAL_188_T  global_flow_cache_genid[NUM_STACKS];   
...
# 178 "linux-2.6.26/include/linux/tcp.h" 2
...
# 24 "linux-2.6.26/include/net/inet_connection_sock.h" 2
...
typedef  const char   _GLOBAL_203_T; extern  _GLOBAL_203_T  _GLOBAL_0_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_1_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_2_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_3_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_4_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_5_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_6_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_7_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_8_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_9_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_10_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_11_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_12_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_13_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_14_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_15_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_16_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_17_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_18_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_19_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_20_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_21_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_22_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_23_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_24_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_25_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_26_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_27_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_28_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_29_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_30_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_31_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_32_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_33_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_34_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_35_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_36_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_37_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_38_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_39_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_40_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_41_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_42_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_43_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_44_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_45_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_46_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_47_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_48_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_203_T  _GLOBAL_49_inet_csk_timer_bug_msg_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet_csk_timer_bug_msg_I) *_GLOBAL_inet_csk_timer_bug_msg_10_A[NUM_STACKS] = { &_GLOBAL_0_inet_csk_timer_bug_msg_I, &_GLOBAL_1_inet_csk_timer_bug_msg_I, &_GLOBAL_2_inet_csk_timer_bug_msg_I, &_GLOBAL_3_inet_csk_timer_bug_msg_I, &_GLOBAL_4_inet_csk_timer_bug_msg_I, &_GLOBAL_5_inet_csk_timer_bug_msg_I, &_GLOBAL_6_inet_csk_timer_bug_msg_I, &_GLOBAL_7_inet_csk_timer_bug_msg_I, &_GLOBAL_8_inet_csk_timer_bug_msg_I, &_GLOBAL_9_inet_csk_timer_bug_msg_I, &_GLOBAL_10_inet_csk_timer_bug_msg_I, &_GLOBAL_11_inet_csk_timer_bug_msg_I, &_GLOBAL_12_inet_csk_timer_bug_msg_I, &_GLOBAL_13_inet_csk_timer_bug_msg_I, &_GLOBAL_14_inet_csk_timer_bug_msg_I, &_GLOBAL_15_inet_csk_timer_bug_msg_I, &_GLOBAL_16_inet_csk_timer_bug_msg_I, &_GLOBAL_17_inet_csk_timer_bug_msg_I, &_GLOBAL_18_inet_csk_timer_bug_msg_I, &_GLOBAL_19_inet_csk_timer_bug_msg_I, &_GLOBAL_20_inet_csk_timer_bug_msg_I, &_GLOBAL_21_inet_csk_timer_bug_msg_I, &_GLOBAL_22_inet_csk_timer_bug_msg_I, &_GLOBAL_23_inet_csk_timer_bug_msg_I, &_GLOBAL_24_inet_csk_timer_bug_msg_I, &_GLOBAL_25_inet_csk_timer_bug_msg_I, &_GLOBAL_26_inet_csk_timer_bug_msg_I, &_GLOBAL_27_inet_csk_timer_bug_msg_I, &_GLOBAL_28_inet_csk_timer_bug_msg_I, &_GLOBAL_29_inet_csk_timer_bug_msg_I, &_GLOBAL_30_inet_csk_timer_bug_msg_I, &_GLOBAL_31_inet_csk_timer_bug_msg_I, &_GLOBAL_32_inet_csk_timer_bug_msg_I, &_GLOBAL_33_inet_csk_timer_bug_msg_I, &_GLOBAL_34_inet_csk_timer_bug_msg_I, &_GLOBAL_35_inet_csk_timer_bug_msg_I, &_GLOBAL_36_inet_csk_timer_bug_msg_I, &_GLOBAL_37_inet_csk_timer_bug_msg_I, &_GLOBAL_38_inet_csk_timer_bug_msg_I, &_GLOBAL_39_inet_csk_timer_bug_msg_I, &_GLOBAL_40_inet_csk_timer_bug_msg_I, &_GLOBAL_41_inet_csk_timer_bug_msg_I, &_GLOBAL_42_inet_csk_timer_bug_msg_I, &_GLOBAL_43_inet_csk_timer_bug_msg_I, &_GLOBAL_44_inet_csk_timer_bug_msg_I, &_GLOBAL_45_inet_csk_timer_bug_msg_I, &_GLOBAL_46_inet_csk_timer_bug_msg_I, &_GLOBAL_47_inet_csk_timer_bug_msg_I, &_GLOBAL_48_inet_csk_timer_bug_msg_I, &_GLOBAL_49_inet_csk_timer_bug_msg_I, };   
...
static inline  __attribute__((always_inline)) void inet_csk_clear_xmit_timer(struct sock *sk, const int what)
{
 ...
 if (what == 1 || what == 3) {
  ...
  ({ if (0) printk("<7>" "%s", (*_GLOBAL_inet_csk_timer_bug_msg_10_A[get_stack_id()])); 0; });
 }
...
# 42 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
# 49 "linux-2.6.26/net/ipv6/reassembly.c" 2

# 1 "linux-2.6.26/include/net/ipv6.h" 1
# 20 "linux-2.6.26/include/net/ipv6.h"
...
typedef  struct ipv6_devconf   _GLOBAL_204_T; extern  _GLOBAL_204_T  global_ipv6_devconf[NUM_STACKS];    
...
# 21 "linux-2.6.26/include/net/ipv6.h" 2
...
typedef  struct neigh_table   _GLOBAL_205_T; extern  _GLOBAL_205_T  global_nd_tbl[NUM_STACKS];    
...
typedef  int  _GLOBAL_206_T; extern  _GLOBAL_206_T  global_sysctl_mld_max_msf[NUM_STACKS];   
typedef  struct ctl_path   _GLOBAL_207_T; extern  _GLOBAL_207_T  _GLOBAL_0_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_1_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_2_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_3_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_4_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_5_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_6_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_7_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_8_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_9_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_10_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_11_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_12_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_13_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_14_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_15_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_16_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_17_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_18_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_19_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_20_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_21_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_22_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_23_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_24_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_25_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_26_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_27_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_28_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_29_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_30_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_31_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_32_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_33_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_34_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_35_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_36_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_37_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_38_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_39_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_40_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_41_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_42_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_43_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_44_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_45_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_46_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_47_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_48_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_49_net_ipv6_ctl_path_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_ipv6_ctl_path_I) *_GLOBAL_net_ipv6_ctl_path_11_A[NUM_STACKS] = { &_GLOBAL_0_net_ipv6_ctl_path_I, &_GLOBAL_1_net_ipv6_ctl_path_I, &_GLOBAL_2_net_ipv6_ctl_path_I, &_GLOBAL_3_net_ipv6_ctl_path_I, &_GLOBAL_4_net_ipv6_ctl_path_I, &_GLOBAL_5_net_ipv6_ctl_path_I, &_GLOBAL_6_net_ipv6_ctl_path_I, &_GLOBAL_7_net_ipv6_ctl_path_I, &_GLOBAL_8_net_ipv6_ctl_path_I, &_GLOBAL_9_net_ipv6_ctl_path_I, &_GLOBAL_10_net_ipv6_ctl_path_I, &_GLOBAL_11_net_ipv6_ctl_path_I, &_GLOBAL_12_net_ipv6_ctl_path_I, &_GLOBAL_13_net_ipv6_ctl_path_I, &_GLOBAL_14_net_ipv6_ctl_path_I, &_GLOBAL_15_net_ipv6_ctl_path_I, &_GLOBAL_16_net_ipv6_ctl_path_I, &_GLOBAL_17_net_ipv6_ctl_path_I, &_GLOBAL_18_net_ipv6_ctl_path_I, &_GLOBAL_19_net_ipv6_ctl_path_I, &_GLOBAL_20_net_ipv6_ctl_path_I, &_GLOBAL_21_net_ipv6_ctl_path_I, &_GLOBAL_22_net_ipv6_ctl_path_I, &_GLOBAL_23_net_ipv6_ctl_path_I, &_GLOBAL_24_net_ipv6_ctl_path_I, &_GLOBAL_25_net_ipv6_ctl_path_I, &_GLOBAL_26_net_ipv6_ctl_path_I, &_GLOBAL_27_net_ipv6_ctl_path_I, &_GLOBAL_28_net_ipv6_ctl_path_I, &_GLOBAL_29_net_ipv6_ctl_path_I, &_GLOBAL_30_net_ipv6_ctl_path_I, &_GLOBAL_31_net_ipv6_ctl_path_I, &_GLOBAL_32_net_ipv6_ctl_path_I, &_GLOBAL_33_net_ipv6_ctl_path_I, &_GLOBAL_34_net_ipv6_ctl_path_I, &_GLOBAL_35_net_ipv6_ctl_path_I, &_GLOBAL_36_net_ipv6_ctl_path_I, &_GLOBAL_37_net_ipv6_ctl_path_I, &_GLOBAL_38_net_ipv6_ctl_path_I, &_GLOBAL_39_net_ipv6_ctl_path_I, &_GLOBAL_40_net_ipv6_ctl_path_I, &_GLOBAL_41_net_ipv6_ctl_path_I, &_GLOBAL_42_net_ipv6_ctl_path_I, &_GLOBAL_43_net_ipv6_ctl_path_I, &_GLOBAL_44_net_ipv6_ctl_path_I, &_GLOBAL_45_net_ipv6_ctl_path_I, &_GLOBAL_46_net_ipv6_ctl_path_I, &_GLOBAL_47_net_ipv6_ctl_path_I, &_GLOBAL_48_net_ipv6_ctl_path_I, &_GLOBAL_49_net_ipv6_ctl_path_I, };   
# 132 "linux-2.6.26/include/net/ipv6.h"
typedef  __typeof__ ( struct ipstats_mib  )   _GLOBAL_208_T; extern  _GLOBAL_208_T  * _GLOBAL_0_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_1_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_2_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_3_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_4_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_5_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_6_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_7_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_8_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_9_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_10_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_11_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_12_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_13_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_14_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_15_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_16_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_17_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_18_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_19_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_20_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_21_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_22_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_23_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_24_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_25_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_26_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_27_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_28_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_29_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_30_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_31_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_32_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_33_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_34_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_35_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_36_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_37_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_38_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_39_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_40_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_41_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_42_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_43_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_44_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_45_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_46_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_47_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_48_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_49_ipv6_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_statistics_I) *_GLOBAL_ipv6_statistics_12_A[NUM_STACKS] = { &_GLOBAL_0_ipv6_statistics_I, &_GLOBAL_1_ipv6_statistics_I, &_GLOBAL_2_ipv6_statistics_I, &_GLOBAL_3_ipv6_statistics_I, &_GLOBAL_4_ipv6_statistics_I, &_GLOBAL_5_ipv6_statistics_I, &_GLOBAL_6_ipv6_statistics_I, &_GLOBAL_7_ipv6_statistics_I, &_GLOBAL_8_ipv6_statistics_I, &_GLOBAL_9_ipv6_statistics_I, &_GLOBAL_10_ipv6_statistics_I, &_GLOBAL_11_ipv6_statistics_I, &_GLOBAL_12_ipv6_statistics_I, &_GLOBAL_13_ipv6_statistics_I, &_GLOBAL_14_ipv6_statistics_I, &_GLOBAL_15_ipv6_statistics_I, &_GLOBAL_16_ipv6_statistics_I, &_GLOBAL_17_ipv6_statistics_I, &_GLOBAL_18_ipv6_statistics_I, &_GLOBAL_19_ipv6_statistics_I, &_GLOBAL_20_ipv6_statistics_I, &_GLOBAL_21_ipv6_statistics_I, &_GLOBAL_22_ipv6_statistics_I, &_GLOBAL_23_ipv6_statistics_I, &_GLOBAL_24_ipv6_statistics_I, &_GLOBAL_25_ipv6_statistics_I, &_GLOBAL_26_ipv6_statistics_I, &_GLOBAL_27_ipv6_statistics_I, &_GLOBAL_28_ipv6_statistics_I, &_GLOBAL_29_ipv6_statistics_I, &_GLOBAL_30_ipv6_statistics_I, &_GLOBAL_31_ipv6_statistics_I, &_GLOBAL_32_ipv6_statistics_I, &_GLOBAL_33_ipv6_statistics_I, &_GLOBAL_34_ipv6_statistics_I, &_GLOBAL_35_ipv6_statistics_I, &_GLOBAL_36_ipv6_statistics_I, &_GLOBAL_37_ipv6_statistics_I, &_GLOBAL_38_ipv6_statistics_I, &_GLOBAL_39_ipv6_statistics_I, &_GLOBAL_40_ipv6_statistics_I, &_GLOBAL_41_ipv6_statistics_I, &_GLOBAL_42_ipv6_statistics_I, &_GLOBAL_43_ipv6_statistics_I, &_GLOBAL_44_ipv6_statistics_I, &_GLOBAL_45_ipv6_statistics_I, &_GLOBAL_46_ipv6_statistics_I, &_GLOBAL_47_ipv6_statistics_I, &_GLOBAL_48_ipv6_statistics_I, &_GLOBAL_49_ipv6_statistics_I, };   
...
typedef  __typeof__ ( struct icmpv6_mib  )   _GLOBAL_209_T; extern  _GLOBAL_209_T  * _GLOBAL_0_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_1_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_2_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_3_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_4_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_5_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_6_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_7_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_8_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_9_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_10_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_11_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_12_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_13_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_14_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_15_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_16_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_17_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_18_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_19_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_20_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_21_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_22_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_23_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_24_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_25_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_26_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_27_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_28_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_29_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_30_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_31_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_32_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_33_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_34_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_35_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_36_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_37_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_38_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_39_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_40_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_41_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_42_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_43_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_44_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_45_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_46_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_47_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_48_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_49_icmpv6_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmpv6_statistics_I) *_GLOBAL_icmpv6_statistics_13_A[NUM_STACKS];   
typedef  __typeof__ ( struct icmpv6msg_mib  )   _GLOBAL_210_T; extern  _GLOBAL_210_T  * _GLOBAL_0_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_1_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_2_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_3_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_4_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_5_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_6_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_7_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_8_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_9_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_10_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_11_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_12_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_13_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_14_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_15_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_16_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_17_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_18_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_19_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_20_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_21_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_22_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_23_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_24_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_25_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_26_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_27_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_28_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_29_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_30_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_31_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_32_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_33_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_34_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_35_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_36_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_37_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_38_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_39_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_40_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_41_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_42_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_43_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_44_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_45_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_46_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_47_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_48_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_49_icmpv6msg_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmpv6msg_statistics_I) *_GLOBAL_icmpv6msg_statistics_14_A[NUM_STACKS];   
...
typedef  struct ip6_ra_chain   _GLOBAL_211_T; extern  _GLOBAL_211_T  * global_ip6_ra_chain[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_212_T; extern  _GLOBAL_212_T  global_ip6_ra_lock[NUM_STACKS];   
...
typedef  const struct proto_ops    _GLOBAL_213_T; extern  _GLOBAL_213_T  global_inet6_stream_ops[NUM_STACKS];     
typedef  const struct proto_ops    _GLOBAL_214_T; extern  _GLOBAL_214_T  global_inet6_dgram_ops[NUM_STACKS];     
...
typedef  ctl_table  _GLOBAL_215_T; extern  _GLOBAL_215_T  _GLOBAL_0_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_1_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_2_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_3_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_4_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_5_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_6_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_7_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_8_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_9_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_10_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_11_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_12_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_13_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_14_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_15_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_16_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_17_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_18_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_19_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_20_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_21_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_22_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_23_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_24_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_25_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_26_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_27_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_28_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_29_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_30_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_31_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_32_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_33_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_34_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_35_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_36_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_37_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_38_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_39_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_40_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_41_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_42_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_43_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_44_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_45_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_46_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_47_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_48_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_215_T  _GLOBAL_49_ipv6_route_table_template_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_route_table_template_I) *_GLOBAL_ipv6_route_table_template_15_A[NUM_STACKS];  
typedef  ctl_table  _GLOBAL_216_T; extern  _GLOBAL_216_T  _GLOBAL_0_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_1_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_2_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_3_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_4_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_5_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_6_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_7_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_8_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_9_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_10_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_11_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_12_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_13_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_14_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_15_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_16_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_17_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_18_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_19_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_20_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_21_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_22_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_23_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_24_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_25_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_26_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_27_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_28_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_29_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_30_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_31_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_32_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_33_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_34_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_35_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_36_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_37_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_38_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_39_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_40_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_41_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_42_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_43_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_44_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_45_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_46_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_47_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_48_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_216_T  _GLOBAL_49_ipv6_icmp_table_template_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_icmp_table_template_I) *_GLOBAL_ipv6_icmp_table_template_16_A[NUM_STACKS];  

extern struct ctl_table *ipv6_icmp_sysctl_init(struct net *net);
extern struct ctl_table *ipv6_route_sysctl_init(struct net *net);
extern int ipv6_sysctl_register(void);
extern void ipv6_sysctl_unregister(void);
# 51 "linux-2.6.26/net/ipv6/reassembly.c" 2
# 1 "linux-2.6.26/include/net/ip6_route.h" 1
...
# 1 "linux-2.6.26/include/net/ip6_fib.h" 1
# 18 "linux-2.6.26/include/net/ip6_fib.h"
# 1 "linux-2.6.26/include/linux/ipv6_route.h" 1
# 42 "linux-2.6.26/include/linux/ipv6_route.h"
struct in6_rtmsg {
...
# 19 "linux-2.6.26/include/net/ip6_fib.h" 2
...
# 75 "linux-2.6.26/include/net/ip6_fib.h"
struct rt6key
{
 struct in6_addr addr;
 int plen;
...
static inline  __attribute__((always_inline)) struct inet6_dev *ip6_dst_idev(struct dst_entry *dst)
{
...
# 154 "linux-2.6.26/include/net/ip6_fib.h"
struct fib6_table {
...
# 177 "linux-2.6.26/include/net/ip6_fib.h"
...
static inline  __attribute__((always_inline)) int fib6_rules_init(void)
{
 return 0;
}
static inline  __attribute__((always_inline)) void fib6_rules_cleanup(void)
{
 return ;
}
# 29 "linux-2.6.26/include/net/ip6_route.h" 2
# 46 "linux-2.6.26/include/net/ip6_route.h"
...
typedef  rwlock_t  _GLOBAL_217_T; extern  _GLOBAL_217_T  global_rt6_lock[NUM_STACKS];   
...
# 52 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
typedef  struct net_protocol   _GLOBAL_218_T; extern  _GLOBAL_218_T  * global_inet_protocol_base[NUM_STACKS];    
typedef  struct net_protocol   _GLOBAL_219_T; extern  _GLOBAL_219_T  * _GLOBAL_0_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_1_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_2_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_3_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_4_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_5_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_6_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_7_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_8_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_9_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_10_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_11_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_12_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_13_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_14_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_15_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_16_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_17_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_18_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_19_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_20_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_21_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_22_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_23_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_24_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_25_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_26_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_27_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_28_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_29_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_30_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_31_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_32_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_33_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_34_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_35_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_36_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_37_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_38_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_39_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_40_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_41_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_42_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_43_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_44_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_45_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_46_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_47_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_48_inet_protos_I [ 256 ]  ; extern  _GLOBAL_219_T  * _GLOBAL_49_inet_protos_I [ 256 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet_protos_I) *_GLOBAL_inet_protos_17_A[NUM_STACKS];   


typedef  struct inet6_protocol   _GLOBAL_220_T; extern  _GLOBAL_220_T  * _GLOBAL_0_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_1_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_2_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_3_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_4_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_5_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_6_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_7_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_8_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_9_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_10_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_11_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_12_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_13_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_14_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_15_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_16_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_17_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_18_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_19_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_20_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_21_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_22_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_23_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_24_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_25_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_26_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_27_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_28_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_29_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_30_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_31_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_32_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_33_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_34_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_35_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_36_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_37_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_38_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_39_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_40_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_41_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_42_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_43_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_44_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_45_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_46_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_47_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_48_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_220_T  * _GLOBAL_49_inet6_protos_I [ 256 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet6_protos_I) *_GLOBAL_inet6_protos_18_A[NUM_STACKS];   
...
# 53 "linux-2.6.26/net/ipv6/reassembly.c" 2
# 1 "linux-2.6.26/include/net/transp_v6.h" 1
# 12 "linux-2.6.26/include/net/transp_v6.h"
typedef  struct proto   _GLOBAL_221_T; extern  _GLOBAL_221_T  global_rawv6_prot[NUM_STACKS];    
typedef  struct proto   _GLOBAL_222_T; extern  _GLOBAL_222_T  global_udpv6_prot[NUM_STACKS];    
typedef  struct proto   _GLOBAL_223_T; extern  _GLOBAL_223_T  global_udplitev6_prot[NUM_STACKS];    
typedef  struct proto   _GLOBAL_224_T; extern  _GLOBAL_224_T  global_tcpv6_prot[NUM_STACKS];    
...
typedef  struct inet_connection_sock_af_ops   _GLOBAL_225_T; extern  _GLOBAL_225_T  global_ipv4_specific[NUM_STACKS];    

extern int inet6_destroy_sock(struct sock *sk);
# 54 "linux-2.6.26/net/ipv6/reassembly.c" 2
# 1 "linux-2.6.26/include/net/rawv6.h" 1
...
extern int rawv6_rcv(struct sock *sk,
       struct sk_buff *skb);
# 55 "linux-2.6.26/net/ipv6/reassembly.c" 2

# 1 "linux-2.6.26/include/net/addrconf.h" 1
# 20 "linux-2.6.26/include/net/addrconf.h"
...
# 21 "linux-2.6.26/include/net/addrconf.h" 2
...
# 55 "linux-2.6.26/include/net/addrconf.h"
...
# 57 "linux-2.6.26/net/ipv6/reassembly.c" 2
...
# 72 "linux-2.6.26/net/ipv6/reassembly.c"
struct frag_queue
{
...
typedef  struct inet_frags   _GLOBAL_226_T; static  _GLOBAL_226_T  global_ip6_frags[NUM_STACKS];    
...
int ip6_frag_mem(struct net *net)
{
 return ((&net->ipv6.frags.mem)->counter);
}
          ...
          struct in6_addr *daddr)
{
 ...
 a = ( u32)saddr->in6_u.u6_addr32[0];
 b = ( u32)saddr->in6_u.u6_addr32[1];
 c = ( u32)saddr->in6_u.u6_addr32[2];

 a += 0x9e3779b9;
 b += 0x9e3779b9;
 c += global_ip6_frags[get_stack_id()].rnd;
 { a -= b; a -= c; a ^= (c>>13); b -= c; b -= a; b ^= (a<<8); c -= a; c -= b; c ^= (b>>13); a -= b; a -= c; a ^= (c>>12); b -= c; b -= a; b ^= (a<<16); c -= a; c -= b; c ^= (b>>5); a -= b; a -= c; a ^= (c>>3); b -= c; b -= a; b ^= (a<<10); c -= a; c -= b; c ^= (b>>15); };

 a += ( u32)saddr->in6_u.u6_addr32[3];
 b += ( u32)daddr->in6_u.u6_addr32[0];
 c += ( u32)daddr->in6_u.u6_addr32[1];
 { a -= b; a -= c; a ^= (c>>13); b -= c; b -= a; b ^= (a<<8); c -= a; c -= b; c ^= (b>>13); a -= b; a -= c; a ^= (c>>12); b -= c; b -= a; b ^= (a<<16); c -= a; c -= b; c ^= (b>>5); a -= b; a -= c; a ^= (c>>3); b -= c; b -= a; b ^= (a<<10); c -= a; c -= b; c ^= (b>>15); };

 a += ( u32)daddr->in6_u.u6_addr32[2];
 b += ( u32)daddr->in6_u.u6_addr32[3];
 c += ( u32)id;
 { a -= b; a -= c; a ^= (c>>13); b -= c; b -= a; b ^= (a<<8); c -= a; c -= b; c ^= (b>>13); a -= b; a -= c; a ^= (c>>12); b -= c; b -= a; b ^= (a<<16); c -= a; c -= b; c ^= (b>>5); a -= b; a -= c; a ^= (c>>3); b -= c; b -= a; b ^= (a<<10); c -= a; c -= b; c ^= (b>>15); };
...
static unsigned int ip6_hashfn(struct inet_frag_queue *q)
{
 ...
 fq = ({ const typeof( ((struct frag_queue *)0)->q ) *__mptr = (q); (struct frag_queue *)( (char *)__mptr - __builtin_offsetof(struct frag_queue,q) );});
...
static inline  __attribute__((always_inline)) void frag_kfree_skb(struct netns_frags *nf,
...
void ip6_frag_init(struct inet_frag_queue *q, void *a)
{
 struct frag_queue *fq = ({ const typeof( ((struct frag_queue *)0)->q ) *__mptr = (q); (struct frag_queue *)( (char *)__mptr - __builtin_offsetof(struct frag_queue,q) );});
 struct ip6_create_arg *arg = a;
...
static __inline__  __attribute__((always_inline)) void fq_put(struct frag_queue *fq)
{
 inet_frag_put(&fq->q, &global_ip6_frags[get_stack_id()]);
}
...
{
 inet_frag_kill(&fq->q, &global_ip6_frags[get_stack_id()]);
}
...
static void ip6_evictor(struct net *net, struct inet6_dev *idev)
{
 ...
 evicted = inet_frag_evictor(&net->ipv6.frags, &global_ip6_frags[get_stack_id()]);
 if (evicted)
  ({ struct inet6_dev *_idev = (idev); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_REASMFAILS)] += (evicted)); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_REASMFAILS)] += (evicted));});
}
...
static void ip6_frag_expire(unsigned long data)
{
 ...
 fq = ({ const typeof( ((struct frag_queue *)0)->q ) *__mptr = ((struct inet_frag_queue *)data); (struct frag_queue *)( (char *)__mptr - __builtin_offsetof(struct frag_queue,q) );});

 do { do { } while (0); (void)0; (void)(&fq->q.lock); } while (0);
 ...
 net = ({ const typeof( ((struct net *)0)->ipv6.frags ) *__mptr = (fq->q.net); (struct net *)( (char *)__mptr - __builtin_offsetof(struct net,ipv6.frags) );});
 dev = dev_get_by_index(net, fq->iif);
 if (!dev)
  goto out;

 do { do { } while (0); (void)0; do { } while (0); } while (0);
 ({ struct inet6_dev *_idev = (__in6_dev_get(dev)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_REASMTIMEOUT)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_REASMTIMEOUT)]++); });
 ({ struct inet6_dev *_idev = (__in6_dev_get(dev)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_REASMFAILS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_REASMFAILS)]++); });
 do { do { } while (0); (void)0; do { } while (0); } while (0);


 if (!(fq->q.last_in & 2) || !fq->q.fragments)
  goto out;
 ...
 icmpv6_send(fq->q.fragments, 3, 1, 0, dev);
out:
 if (dev)
  dev_put(dev);
 do { do { } while (0); (void)0; (void)(&fq->q.lock); } while (0);
 ...
 struct inet6_dev *idev)
{
 ...
 do { do { } while (0); (void)0; (void)(&global_ip6_frags[get_stack_id()].lock); } while (0);
 hash = ip6qhashfn(id, src, dst);

 q = inet_frag_find(&net->ipv6.frags, &global_ip6_frags[get_stack_id()], &arg, hash);
 if (q == ((void *)0))
  goto oom;

 return ({ const typeof( ((struct frag_queue *)0)->q ) *__mptr = (q); (struct frag_queue *)( (char *)__mptr - __builtin_offsetof(struct frag_queue,q) );});

oom:
 ({ struct inet6_dev *_idev = (idev); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_REASMFAILS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_REASMFAILS)]++); });
 return ((void *)0);
}
      ...
      struct frag_hdr *fhdr, int nhoff)
{
 ...
 offset = __fswab16(( __u16)(__be16)(fhdr->frag_off)) & ~0x7;
 end = offset + (__fswab16(( __u16)(__be16)(ipv6_hdr(skb)->payload_len)) -
   ((u8 *)(fhdr + 1) - (u8 *)(ipv6_hdr(skb) + 1)));

 if ((unsigned int)end > 65535) {
  ({ struct inet6_dev *_idev = (ip6_dst_idev(skb->dst)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_INHDRERRORS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_INHDRERRORS)]++); });
 ...
 if (!(fhdr->frag_off & (( __be16)__fswab16((0x0001))))) {



  if (end < fq->q.len ||
      ((fq->q.last_in & 1) && end != fq->q.len))
   goto err;
  fq->q.last_in |= 1;
  fq->q.len = end;
 } else {
 ...
 prev = ((void *)0);
 for(next = fq->q.fragments; next != ((void *)0); next = next->next) {
 ...
 while (next && ((struct ip6frag_skb_cb*)((next)->cb))->offset < end) {
  ...
  if (i < next->len) {
   ...
   frag_kfree_skb(fq->q.net, free_it, ((void *)0));
  }
 }
...
err:
 ({ struct inet6_dev *_idev = (ip6_dst_idev(skb->dst)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) do { ({ (void)((({ do { } while (0); 0; }))); (((_idev)->stats.ipv6[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])); })->mibs[(IPSTATS_MIB_REASMFAILS)]++; do { } while (0); } while (0); do { ({ (void)((({ do { } while (0); 0; }))); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])); })->mibs[(IPSTATS_MIB_REASMFAILS)]++; do { } while (0); } while (0); });
 kfree_skb(skb);
 return -1;
}
# 451 "linux-2.6.26/net/ipv6/reassembly.c"
static int ip6_frag_reasm(struct frag_queue *fq, struct sk_buff *prev,
     struct net_device *dev)
{
 ...
 if (((struct skb_shared_info *)(skb_end_pointer(head)))->frag_list) {
  ...
  head->next = clone;
  ((struct skb_shared_info *)(skb_end_pointer(clone)))->frag_list = ((struct skb_shared_info *)(skb_end_pointer(head)))->frag_list;
  ((struct skb_shared_info *)(skb_end_pointer(head)))->frag_list = ((void *)0);
  for (i=0; i<((struct skb_shared_info *)(skb_end_pointer(head)))->nr_frags; i++)
   plen += ((struct skb_shared_info *)(skb_end_pointer(head)))->frags[i].size;
 ...
 ((struct skb_shared_info *)(skb_end_pointer(head)))->frag_list = head->next;
 ...
 ipv6_hdr(head)->payload_len = (( __be16)__fswab16((payload_len)));
 ...
 do { do { } while (0); (void)0; do { } while (0); } while (0);
 ({ struct inet6_dev *_idev = (__in6_dev_get(dev)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_REASMOKS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_REASMOKS)]++); });
 do { do { } while (0); (void)0; do { } while (0); } while (0);
 fq->q.fragments = ((void *)0);
 return 1;
...
static int ipv6_frag_rcv(struct sk_buff *skb)
{
 ...
 ({ struct inet6_dev *_idev = (ip6_dst_idev(skb->dst)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_REASMREQDS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_REASMREQDS)]++); });


 if (hdr->payload_len==0) {
  ({ struct inet6_dev *_idev = (ip6_dst_idev(skb->dst)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) do { ({ (void)((({ do { } while (0); 0; }))); (((_idev)->stats.ipv6[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])); })->mibs[(IPSTATS_MIB_INHDRERRORS)]++; do { } while (0); } while (0); do { ({ (void)((({ do { } while (0); 0; }))); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[!(((current_thread_info()->preempt_count) & (((1UL << (8))-1) << (0 + 8))))])); })->mibs[(IPSTATS_MIB_INHDRERRORS)]++; do { } while (0); } while (0); });
  icmpv6_param_prob(skb, 0,
 ...
 if (!(fhdr->frag_off & (( __be16)__fswab16((0xFFF9))))) {

  skb->transport_header += sizeof(struct frag_hdr);
  ({ struct inet6_dev *_idev = (ip6_dst_idev(skb->dst)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_REASMOKS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_REASMOKS)]++); });
 ...
 net = dev_net(skb->dev);
 if (((&net->ipv6.frags.mem)->counter) > net->ipv6.frags.high_thresh)
  ip6_evictor(net, ip6_dst_idev(skb->dst));

 if ((fq = fq_find(net, fhdr->identification, &hdr->saddr, &hdr->daddr,
     ip6_dst_idev(skb->dst))) != ((void *)0)) {
  int ret;
 ...
 ({ struct inet6_dev *_idev = (ip6_dst_idev(skb->dst)); if (__builtin_expect(!!(_idev != ((void *)0)), 1)) (({ (void)((0)); (((_idev)->stats.ipv6[0])); })->mibs[(IPSTATS_MIB_REASMFAILS)]++); (({ (void)((0)); (((*_GLOBAL_ipv6_statistics_12_A[get_stack_id()])[0])); })->mibs[(IPSTATS_MIB_REASMFAILS)]++); });
 kfree_skb(skb);
 return -1;
}

typedef  struct inet6_protocol   _GLOBAL_227_T; static  _GLOBAL_227_T  global_frag_protocol[NUM_STACKS] = {  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  { . handler  = ipv6_frag_rcv  , . flags  = 0x1   , } ,  };     
...
typedef  struct ctl_table   _GLOBAL_228_T; static  _GLOBAL_228_T  _GLOBAL_0_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[0] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[0] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[0] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[0] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_1_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[1] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[1] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[1] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[1] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_2_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[2] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[2] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[2] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[2] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_3_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[3] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[3] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[3] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[3] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_4_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[4] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[4] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[4] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[4] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_5_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[5] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[5] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[5] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[5] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_6_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[6] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[6] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[6] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[6] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_7_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[7] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[7] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[7] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[7] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_8_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[8] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[8] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[8] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[8] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_9_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[9] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[9] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[9] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[9] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_10_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[10] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[10] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[10] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[10] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_11_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[11] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[11] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[11] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[11] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_12_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[12] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[12] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[12] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[12] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_13_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[13] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[13] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[13] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[13] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_14_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[14] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[14] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[14] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[14] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_15_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[15] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[15] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[15] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[15] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_16_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[16] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[16] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[16] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[16] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_17_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[17] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[17] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[17] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[17] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_18_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[18] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[18] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[18] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[18] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_19_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[19] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[19] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[19] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[19] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_20_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[20] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[20] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[20] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[20] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_21_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[21] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[21] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[21] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[21] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_22_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[22] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[22] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[22] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[22] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_23_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[23] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[23] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[23] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[23] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_24_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[24] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[24] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[24] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[24] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_25_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[25] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[25] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[25] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[25] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_26_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[26] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[26] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[26] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[26] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_27_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[27] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[27] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[27] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[27] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_28_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[28] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[28] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[28] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[28] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_29_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[29] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[29] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[29] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[29] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_30_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[30] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[30] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[30] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[30] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_31_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[31] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[31] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[31] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[31] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_32_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[32] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[32] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[32] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[32] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_33_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[33] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[33] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[33] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[33] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_34_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[34] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[34] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[34] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[34] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_35_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[35] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[35] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[35] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[35] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_36_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[36] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[36] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[36] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[36] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_37_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[37] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[37] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[37] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[37] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_38_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[38] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[38] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[38] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[38] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_39_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[39] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[39] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[39] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[39] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_40_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[40] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[40] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[40] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[40] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_41_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[41] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[41] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[41] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[41] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_42_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[42] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[42] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[42] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[42] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_43_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[43] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[43] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[43] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[43] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_44_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[44] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[44] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[44] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[44] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_45_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[45] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[45] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[45] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[45] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_46_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[46] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[46] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[46] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[46] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_47_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[47] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[47] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[47] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[47] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_48_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[48] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[48] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[48] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[48] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static  _GLOBAL_228_T  _GLOBAL_49_ip6_frags_ctl_table_I [ ]  = { { . ctl_name  = NET_IPV6_IP6FRAG_HIGH_THRESH  , . procname  = "ip6frag_high_thresh"   , . data  = & global_init_net[49] . ipv6  . frags  . high_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }  , { . ctl_name  = NET_IPV6_IP6FRAG_LOW_THRESH  , . procname  = "ip6frag_low_thresh"   , . data  = & global_init_net[49] . ipv6  . frags  . low_thresh     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec    }   , { . ctl_name  = NET_IPV6_IP6FRAG_TIME  , . procname  = "ip6frag_time"   , . data  = & global_init_net[49] . ipv6  . frags  . timeout     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    , }   , { . ctl_name  = NET_IPV6_IP6FRAG_SECRET_INTERVAL  , . procname  = "ip6frag_secret_interval"   , . data  = & global_ip6_frags[49] . secret_interval     , . maxlen  = sizeof ( int )    , . mode  = 0644   , . proc_handler  = & proc_dointvec_jiffies    , . strategy  = & sysctl_jiffies    }   , { }   }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip6_frags_ctl_table_I) *_GLOBAL_ip6_frags_ctl_table_19_A[NUM_STACKS] = { &_GLOBAL_0_ip6_frags_ctl_table_I, &_GLOBAL_1_ip6_frags_ctl_table_I, &_GLOBAL_2_ip6_frags_ctl_table_I, &_GLOBAL_3_ip6_frags_ctl_table_I, &_GLOBAL_4_ip6_frags_ctl_table_I, &_GLOBAL_5_ip6_frags_ctl_table_I, &_GLOBAL_6_ip6_frags_ctl_table_I, &_GLOBAL_7_ip6_frags_ctl_table_I, &_GLOBAL_8_ip6_frags_ctl_table_I, &_GLOBAL_9_ip6_frags_ctl_table_I, &_GLOBAL_10_ip6_frags_ctl_table_I, &_GLOBAL_11_ip6_frags_ctl_table_I, &_GLOBAL_12_ip6_frags_ctl_table_I, &_GLOBAL_13_ip6_frags_ctl_table_I, &_GLOBAL_14_ip6_frags_ctl_table_I, &_GLOBAL_15_ip6_frags_ctl_table_I, &_GLOBAL_16_ip6_frags_ctl_table_I, &_GLOBAL_17_ip6_frags_ctl_table_I, &_GLOBAL_18_ip6_frags_ctl_table_I, &_GLOBAL_19_ip6_frags_ctl_table_I, &_GLOBAL_20_ip6_frags_ctl_table_I, &_GLOBAL_21_ip6_frags_ctl_table_I, &_GLOBAL_22_ip6_frags_ctl_table_I, &_GLOBAL_23_ip6_frags_ctl_table_I, &_GLOBAL_24_ip6_frags_ctl_table_I, &_GLOBAL_25_ip6_frags_ctl_table_I, &_GLOBAL_26_ip6_frags_ctl_table_I, &_GLOBAL_27_ip6_frags_ctl_table_I, &_GLOBAL_28_ip6_frags_ctl_table_I, &_GLOBAL_29_ip6_frags_ctl_table_I, &_GLOBAL_30_ip6_frags_ctl_table_I, &_GLOBAL_31_ip6_frags_ctl_table_I, &_GLOBAL_32_ip6_frags_ctl_table_I, &_GLOBAL_33_ip6_frags_ctl_table_I, &_GLOBAL_34_ip6_frags_ctl_table_I, &_GLOBAL_35_ip6_frags_ctl_table_I, &_GLOBAL_36_ip6_frags_ctl_table_I, &_GLOBAL_37_ip6_frags_ctl_table_I, &_GLOBAL_38_ip6_frags_ctl_table_I, &_GLOBAL_39_ip6_frags_ctl_table_I, &_GLOBAL_40_ip6_frags_ctl_table_I, &_GLOBAL_41_ip6_frags_ctl_table_I, &_GLOBAL_42_ip6_frags_ctl_table_I, &_GLOBAL_43_ip6_frags_ctl_table_I, &_GLOBAL_44_ip6_frags_ctl_table_I, &_GLOBAL_45_ip6_frags_ctl_table_I, &_GLOBAL_46_ip6_frags_ctl_table_I, &_GLOBAL_47_ip6_frags_ctl_table_I, &_GLOBAL_48_ip6_frags_ctl_table_I, &_GLOBAL_49_ip6_frags_ctl_table_I, };     
...
static int ip6_frags_sysctl_register(struct net *net)
{
 ...
 table = (*_GLOBAL_ip6_frags_ctl_table_19_A[get_stack_id()]);
 if (net != &global_init_net[get_stack_id()]) {
  table = kmemdup(table, sizeof((*_GLOBAL_ip6_frags_ctl_table_19_A[get_stack_id()])), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (table == ((void *)0))
   goto err_alloc;
 ...
 hdr = register_net_sysctl_table(net, (*_GLOBAL_net_ipv6_ctl_path_11_A[get_stack_id()]), table);
 if (hdr == ((void *)0))
  goto err_reg;
...
# 725 "linux-2.6.26/net/ipv6/reassembly.c"
static int ipv6_frags_init_net(struct net *net)
{
 net->ipv6.frags.high_thresh = 256 * 1024;
 net->ipv6.frags.low_thresh = 192 * 1024;
 net->ipv6.frags.timeout = (60*1000);
...
static void ipv6_frags_exit_net(struct net *net)
{
 ...
 inet_frags_exit_net(&net->ipv6.frags, &global_ip6_frags[get_stack_id()]);
}

typedef  struct pernet_operations   _GLOBAL_229_T; static  _GLOBAL_229_T  global_ip6_frags_ops[NUM_STACKS] = {  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  { . init  = ipv6_frags_init_net  , . exit  = ipv6_frags_exit_net   , } ,  };      
   
   


int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) ipv6_frag_init(void)
{
 int ret;

 ret = inet6_add_protocol(&global_frag_protocol[get_stack_id()], 44);
 if (ret)
  goto out;

 register_pernet_subsys(&global_ip6_frags_ops[get_stack_id()]);

 global_ip6_frags[get_stack_id()].hashfn = ip6_hashfn;
 global_ip6_frags[get_stack_id()].constructor = ip6_frag_init;
 global_ip6_frags[get_stack_id()].destructor = ((void *)0);
 global_ip6_frags[get_stack_id()].skb_free = ((void *)0);
 global_ip6_frags[get_stack_id()].qsize = sizeof(struct frag_queue);
 global_ip6_frags[get_stack_id()].match = ip6_frag_match;
 global_ip6_frags[get_stack_id()].frag_expire = ip6_frag_expire;
 global_ip6_frags[get_stack_id()].secret_interval = 10 * 60 * 1000;
 inet_frags_init(&global_ip6_frags[get_stack_id()]);
out:
 return ret;
}
...
{
 inet_frags_fini(&global_ip6_frags[get_stack_id()]);
 unregister_pernet_subsys(&global_ip6_frags_ops[get_stack_id()]);
 inet6_del_protocol(&global_frag_protocol[get_stack_id()], 44);
}
