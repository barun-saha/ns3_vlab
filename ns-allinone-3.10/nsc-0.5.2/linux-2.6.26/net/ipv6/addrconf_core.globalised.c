# 1 "linux-2.6.26/net/ipv6/addrconf_core.c"
...
# 24 "linux-2.6.26/include/linux/in6.h"
...
# 25 "linux-2.6.26/include/linux/in6.h" 2
...
typedef  const struct in6_addr    _GLOBAL_1_T; extern  _GLOBAL_1_T  global_in6addr_any[NUM_STACKS];     

typedef  const struct in6_addr    _GLOBAL_2_T; extern  _GLOBAL_2_T  global_in6addr_loopback[NUM_STACKS];     


typedef  const struct in6_addr    _GLOBAL_3_T; extern  _GLOBAL_3_T  global_in6addr_linklocal_allnodes[NUM_STACKS];     


typedef  const struct in6_addr    _GLOBAL_4_T; extern  _GLOBAL_4_T  global_in6addr_linklocal_allrouters[NUM_STACKS];     
...
# 6 "linux-2.6.26/include/linux/ipv6.h" 2
...
typedef  unsigned int   _GLOBAL_17_T; extern  _GLOBAL_17_T  global___VMALLOC_RESERVE[NUM_STACKS];    
typedef  int  _GLOBAL_18_T; extern  _GLOBAL_18_T  global_sysctl_legacy_va_layout[NUM_STACKS];   
...
typedef  char  _GLOBAL_20_T; extern  _GLOBAL_20_T  * global_saved_command_line[NUM_STACKS];   
typedef  unsigned int   _GLOBAL_21_T; extern  _GLOBAL_21_T  global_reset_devices[NUM_STACKS];    


void setup_arch(char **);
void prepare_namespace(void);

typedef  void   ( *_GLOBAL_23_T  )  ( void  ) ; extern  _GLOBAL_23_T global_late_time_init[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_24_T; static  _GLOBAL_24_T  global___force_order[NUM_STACKS];    
...
typedef  int  _GLOBAL_25_T; extern  _GLOBAL_25_T  global_es7000_plat[NUM_STACKS];   
...
typedef  __typeof__ ( unsigned long  )   _GLOBAL_26_T; extern  _GLOBAL_26_T  global_per_cpu__this_cpu_off[NUM_STACKS];    
...
typedef  cpumask_t  _GLOBAL_27_T; extern  _GLOBAL_27_T  global_cpu_possible_map[NUM_STACKS];   
typedef  cpumask_t  _GLOBAL_28_T; extern  _GLOBAL_28_T  global_cpu_online_map[NUM_STACKS];   
typedef  cpumask_t  _GLOBAL_29_T; extern  _GLOBAL_29_T  global_cpu_present_map[NUM_STACKS];   
...
typedef  struct cpuinfo_x86   _GLOBAL_30_T; extern  _GLOBAL_30_T  global_boot_cpu_data[NUM_STACKS];    
typedef  struct cpuinfo_x86   _GLOBAL_31_T; extern  _GLOBAL_31_T  global_new_cpu_data[NUM_STACKS];    
...
typedef  unsigned short   _GLOBAL_32_T; extern  _GLOBAL_32_T  global_num_cache_leaves[NUM_STACKS];    
...
typedef  __typeof__ ( struct tss_struct  )   _GLOBAL_33_T; extern  _GLOBAL_33_T  global_per_cpu__init_tss[NUM_STACKS];    
...
typedef  unsigned int   _GLOBAL_49_T; extern  _GLOBAL_49_T  global___invalid_size_argument_for_IOC[NUM_STACKS];    
...
typedef  int  _GLOBAL_50_T; extern  _GLOBAL_50_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_51_T; extern  _GLOBAL_51_T  global_net_msg_burst[NUM_STACKS];   
...
# 7 "linux-2.6.26/net/ipv6/addrconf_core.c" 2



static inline  __attribute__((always_inline)) unsigned ipv6_addr_scope2type(unsigned scope)
{
 switch(scope) {
 case 0x01:
  return (((0x01) << 16) |
...
int __ipv6_addr_type(const struct in6_addr *addr)
{
 ...
 if ((st & (( __be32)__fswab32((0xE0000000)))) != (( __be32)__fswab32((0x00000000))) &&
     (st & (( __be32)__fswab32((0xE0000000)))) != (( __be32)__fswab32((0xE0000000))))
  return (0x0001U |
   ((0x0e) << 16));

 if ((st & (( __be32)__fswab32((0xFF000000)))) == (( __be32)__fswab32((0xFF000000)))) {


  return (0x0002U |
   ipv6_addr_scope2type(((addr)->in6_u.u6_addr8[1] & 0x0f)));
 }

 if ((st & (( __be32)__fswab32((0xFFC00000)))) == (( __be32)__fswab32((0xFE800000))))
  return (0x0020U | 0x0001U |
   ((0x02) << 16));
 if ((st & (( __be32)__fswab32((0xFFC00000)))) == (( __be32)__fswab32((0xFEC00000))))
  return (0x0040U | 0x0001U |
   ((0x05) << 16));
 if ((st & (( __be32)__fswab32((0xFE000000)))) == (( __be32)__fswab32((0xFC000000))))
  return (0x0001U |
   ((0x0e) << 16));

 if ((addr->in6_u.u6_addr32[0] | addr->in6_u.u6_addr32[1]) == 0) {
  if (addr->in6_u.u6_addr32[2] == 0) {
   if (addr->in6_u.u6_addr32[3] == 0)
    return 0x0000U;

   if (addr->in6_u.u6_addr32[3] == (( __be32)__fswab32((0x00000001))))
    return (0x0010U | 0x0001U |
     ((0x02) << 16));

   return (0x0080U | 0x0001U |
    ((0x0e) << 16));
  }

  if (addr->in6_u.u6_addr32[2] == (( __be32)__fswab32((0x0000ffff))))
   return (0x1000U |
    ((0x0e) << 16));
 }
