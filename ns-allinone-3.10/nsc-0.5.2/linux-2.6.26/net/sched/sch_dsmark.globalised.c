# 1 "linux-2.6.26/net/sched/sch_dsmark.c"
...
{ }
# 7 "linux-2.6.26/net/sched/sch_dsmark.c" 2
...
# 12 "linux-2.6.26/net/sched/sch_dsmark.c" 2
...
typedef  const kernel_cap_t   _GLOBAL_100_T; extern  _GLOBAL_100_T  global___cap_empty_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_101_T; extern  _GLOBAL_101_T  global___cap_full_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_102_T; extern  _GLOBAL_102_T  global___cap_init_eff_set[NUM_STACKS];    
...
# 13 "linux-2.6.26/net/sched/sch_dsmark.c" 2
...
# 5 "linux-2.6.26/include/net/sch_generic.h" 2
...
# 12 "linux-2.6.26/include/net/sch_generic.h" 2
...
typedef  struct Qdisc   _GLOBAL_145_T; extern  _GLOBAL_145_T  global_noop_qdisc[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_146_T; extern  _GLOBAL_146_T  global_noop_qdisc_ops[NUM_STACKS];    
...
typedef  struct Qdisc_ops   _GLOBAL_147_T; extern  _GLOBAL_147_T  global_pfifo_qdisc_ops[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_148_T; extern  _GLOBAL_148_T  global_bfifo_qdisc_ops[NUM_STACKS];    
...
# 15 "linux-2.6.26/net/sched/sch_dsmark.c" 2
# 1 "linux-2.6.26/include/net/dsfield.h" 1
# 10 "linux-2.6.26/include/net/dsfield.h"
...
# 11 "linux-2.6.26/include/net/dsfield.h" 2
...
typedef  int  _GLOBAL_149_T; extern  _GLOBAL_149_T  global_debug_locks[NUM_STACKS];   
typedef  int  _GLOBAL_150_T; extern  _GLOBAL_150_T  global_debug_locks_silent[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_156_T; extern  _GLOBAL_156_T  global_mmap_min_addr[NUM_STACKS];    


# 1 "linux-2.6.26/include/asm/pgtable.h" 1
# 92 "linux-2.6.26/include/asm/pgtable.h"
typedef  pteval_t  _GLOBAL_157_T; extern  _GLOBAL_157_T  global___PAGE_KERNEL[NUM_STACKS]; extern  _GLOBAL_157_T  global___PAGE_KERNEL_EXEC[NUM_STACKS];    
...
typedef  struct list_head   _GLOBAL_159_T; extern  _GLOBAL_159_T  global_pgd_list[NUM_STACKS];    
...
typedef  pteval_t  _GLOBAL_160_T; extern  _GLOBAL_160_T  global___supported_pte_mask[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_161_T; extern  _GLOBAL_161_T  global___FIXADDR_TOP[NUM_STACKS];    
...
typedef  struct kmem_cache   _GLOBAL_162_T; extern  _GLOBAL_162_T  * global_vm_area_cachep[NUM_STACKS];    
...
typedef  struct rb_root   _GLOBAL_163_T; extern  _GLOBAL_163_T  global_nommu_vma_tree[NUM_STACKS];    
typedef  struct rw_semaphore   _GLOBAL_164_T; extern  _GLOBAL_164_T  global_nommu_vma_sem[NUM_STACKS];    
...
typedef  int  _GLOBAL_166_T; extern  _GLOBAL_166_T  global_sysctl_nr_open[NUM_STACKS];   
...
typedef  struct files_stat_struct   _GLOBAL_167_T; extern  _GLOBAL_167_T  global_files_stat[NUM_STACKS];    
...
typedef  struct inodes_stat_t   _GLOBAL_168_T; extern  _GLOBAL_168_T  global_inodes_stat[NUM_STACKS];    

typedef  int  _GLOBAL_169_T; extern  _GLOBAL_169_T  global_leases_enable[NUM_STACKS]; extern  _GLOBAL_169_T  global_lease_break_time[NUM_STACKS];    
...
typedef  struct dentry_stat_t   _GLOBAL_170_T; extern  _GLOBAL_170_T  global_dentry_stat[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_171_T; extern  _GLOBAL_171_T  global_dcache_lock[NUM_STACKS];   
typedef  seqlock_t  _GLOBAL_172_T; extern  _GLOBAL_172_T  global_rename_lock[NUM_STACKS];   
...
typedef  int  _GLOBAL_173_T; extern  _GLOBAL_173_T  global_sysctl_vfs_cache_pressure[NUM_STACKS];   
...
typedef  spinlock_t  _GLOBAL_174_T; extern  _GLOBAL_174_T  global_dq_data_lock[NUM_STACKS];   
...
typedef  struct dqstats   _GLOBAL_175_T; extern  _GLOBAL_175_T  global_dqstats[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_176_T; extern  _GLOBAL_176_T  global_files_lock[NUM_STACKS];   
...
typedef  struct list_head   _GLOBAL_177_T; extern  _GLOBAL_177_T  global_super_blocks[NUM_STACKS];    
typedef  spinlock_t  _GLOBAL_178_T; extern  _GLOBAL_178_T  global_sb_lock[NUM_STACKS];   
...
typedef  struct kobject   _GLOBAL_179_T; extern  _GLOBAL_179_T  * global_fs_kobj[NUM_STACKS];    
...
typedef  struct kmem_cache   _GLOBAL_180_T; extern  _GLOBAL_180_T  * global_names_cachep[NUM_STACKS];    
# 1632 "linux-2.6.26/include/linux/fs.h"
static inline  __attribute__((always_inline)) void bd_forget(struct inode *inode) {}

typedef  const struct file_operations    _GLOBAL_181_T; extern  _GLOBAL_181_T  global_def_blk_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_182_T; extern  _GLOBAL_182_T  global_def_chr_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_183_T; extern  _GLOBAL_183_T  global_bad_sock_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_184_T; extern  _GLOBAL_184_T  global_def_fifo_fops[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_185_T; extern  _GLOBAL_185_T  global_read_fifo_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_186_T; extern  _GLOBAL_186_T  global_write_fifo_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_187_T; extern  _GLOBAL_187_T  global_rdwr_fifo_fops[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_188_T; extern  _GLOBAL_188_T  global_generic_ro_fops[NUM_STACKS];     
...
typedef  const struct inode_operations    _GLOBAL_189_T; extern  _GLOBAL_189_T  global_page_symlink_inode_operations[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_190_T; extern  _GLOBAL_190_T  global_simple_dir_operations[NUM_STACKS];     
typedef  const struct inode_operations    _GLOBAL_191_T; extern  _GLOBAL_191_T  global_simple_dir_inode_operations[NUM_STACKS];     
...
typedef  atomic_t  _GLOBAL_193_T; extern  _GLOBAL_193_T  global_flow_cache_genid[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_194_T; extern  _GLOBAL_194_T  global_mmap_min_addr[NUM_STACKS];    
...
typedef  int  _GLOBAL_195_T; extern  _GLOBAL_195_T  global_net_msg_warn[NUM_STACKS];   
...
typedef  int  _GLOBAL_198_T; extern  _GLOBAL_198_T  global_sysctl_optmem_max[NUM_STACKS];   

typedef  __u32  _GLOBAL_199_T; extern  _GLOBAL_199_T  global_sysctl_wmem_default[NUM_STACKS];   
typedef  __u32  _GLOBAL_200_T; extern  _GLOBAL_200_T  global_sysctl_rmem_default[NUM_STACKS];   
...
typedef  int  _GLOBAL_201_T; extern  _GLOBAL_201_T  global_sysctl_max_syn_backlog[NUM_STACKS];   
...
typedef  spinlock_t  _GLOBAL_202_T; extern  _GLOBAL_202_T  global_inet_peer_idlock[NUM_STACKS];   
...
typedef  struct ip_rt_acct   _GLOBAL_203_T; extern  _GLOBAL_203_T  * global_ip_rt_acct[NUM_STACKS];    
...
typedef  const __u8   _GLOBAL_204_T; extern  _GLOBAL_204_T  _GLOBAL_0_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_1_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_2_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_3_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_4_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_5_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_6_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_7_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_8_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_9_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_10_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_11_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_12_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_13_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_14_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_15_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_16_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_17_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_18_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_19_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_20_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_21_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_22_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_23_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_24_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_25_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_26_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_27_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_28_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_29_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_30_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_31_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_32_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_33_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_34_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_35_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_36_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_37_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_38_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_39_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_40_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_41_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_42_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_43_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_44_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_45_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_46_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_47_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_48_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_204_T  _GLOBAL_49_ip_tos2prio_I [ 16 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_tos2prio_I) *_GLOBAL_ip_tos2prio_8_A[NUM_STACKS] = { &_GLOBAL_0_ip_tos2prio_I, &_GLOBAL_1_ip_tos2prio_I, &_GLOBAL_2_ip_tos2prio_I, &_GLOBAL_3_ip_tos2prio_I, &_GLOBAL_4_ip_tos2prio_I, &_GLOBAL_5_ip_tos2prio_I, &_GLOBAL_6_ip_tos2prio_I, &_GLOBAL_7_ip_tos2prio_I, &_GLOBAL_8_ip_tos2prio_I, &_GLOBAL_9_ip_tos2prio_I, &_GLOBAL_10_ip_tos2prio_I, &_GLOBAL_11_ip_tos2prio_I, &_GLOBAL_12_ip_tos2prio_I, &_GLOBAL_13_ip_tos2prio_I, &_GLOBAL_14_ip_tos2prio_I, &_GLOBAL_15_ip_tos2prio_I, &_GLOBAL_16_ip_tos2prio_I, &_GLOBAL_17_ip_tos2prio_I, &_GLOBAL_18_ip_tos2prio_I, &_GLOBAL_19_ip_tos2prio_I, &_GLOBAL_20_ip_tos2prio_I, &_GLOBAL_21_ip_tos2prio_I, &_GLOBAL_22_ip_tos2prio_I, &_GLOBAL_23_ip_tos2prio_I, &_GLOBAL_24_ip_tos2prio_I, &_GLOBAL_25_ip_tos2prio_I, &_GLOBAL_26_ip_tos2prio_I, &_GLOBAL_27_ip_tos2prio_I, &_GLOBAL_28_ip_tos2prio_I, &_GLOBAL_29_ip_tos2prio_I, &_GLOBAL_30_ip_tos2prio_I, &_GLOBAL_31_ip_tos2prio_I, &_GLOBAL_32_ip_tos2prio_I, &_GLOBAL_33_ip_tos2prio_I, &_GLOBAL_34_ip_tos2prio_I, &_GLOBAL_35_ip_tos2prio_I, &_GLOBAL_36_ip_tos2prio_I, &_GLOBAL_37_ip_tos2prio_I, &_GLOBAL_38_ip_tos2prio_I, &_GLOBAL_39_ip_tos2prio_I, &_GLOBAL_40_ip_tos2prio_I, &_GLOBAL_41_ip_tos2prio_I, &_GLOBAL_42_ip_tos2prio_I, &_GLOBAL_43_ip_tos2prio_I, &_GLOBAL_44_ip_tos2prio_I, &_GLOBAL_45_ip_tos2prio_I, &_GLOBAL_46_ip_tos2prio_I, &_GLOBAL_47_ip_tos2prio_I, &_GLOBAL_48_ip_tos2prio_I, &_GLOBAL_49_ip_tos2prio_I, };   
...
typedef  ctl_table  _GLOBAL_205_T; extern  _GLOBAL_205_T  _GLOBAL_0_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_1_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_2_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_3_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_4_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_5_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_6_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_7_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_8_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_9_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_10_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_11_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_12_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_13_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_14_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_15_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_16_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_17_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_18_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_19_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_20_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_21_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_22_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_23_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_24_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_25_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_26_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_27_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_28_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_29_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_30_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_31_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_32_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_33_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_34_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_35_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_36_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_37_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_38_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_39_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_40_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_41_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_42_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_43_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_44_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_45_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_46_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_47_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_48_ipv4_route_table_I [ ] ; extern  _GLOBAL_205_T  _GLOBAL_49_ipv4_route_table_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv4_route_table_I) *_GLOBAL_ipv4_route_table_9_A[NUM_STACKS];  
...
typedef  u32  _GLOBAL_206_T; extern  _GLOBAL_206_T  global_inet_ehash_secret[NUM_STACKS];   
...
typedef  const char   _GLOBAL_207_T; extern  _GLOBAL_207_T  _GLOBAL_0_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_1_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_2_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_3_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_4_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_5_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_6_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_7_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_8_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_9_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_10_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_11_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_12_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_13_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_14_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_15_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_16_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_17_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_18_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_19_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_20_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_21_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_22_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_23_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_24_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_25_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_26_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_27_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_28_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_29_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_30_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_31_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_32_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_33_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_34_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_35_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_36_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_37_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_38_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_39_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_40_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_41_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_42_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_43_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_44_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_45_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_46_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_47_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_48_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_207_T  _GLOBAL_49_inet_csk_timer_bug_msg_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet_csk_timer_bug_msg_I) *_GLOBAL_inet_csk_timer_bug_msg_10_A[NUM_STACKS] = { &_GLOBAL_0_inet_csk_timer_bug_msg_I, &_GLOBAL_1_inet_csk_timer_bug_msg_I, &_GLOBAL_2_inet_csk_timer_bug_msg_I, &_GLOBAL_3_inet_csk_timer_bug_msg_I, &_GLOBAL_4_inet_csk_timer_bug_msg_I, &_GLOBAL_5_inet_csk_timer_bug_msg_I, &_GLOBAL_6_inet_csk_timer_bug_msg_I, &_GLOBAL_7_inet_csk_timer_bug_msg_I, &_GLOBAL_8_inet_csk_timer_bug_msg_I, &_GLOBAL_9_inet_csk_timer_bug_msg_I, &_GLOBAL_10_inet_csk_timer_bug_msg_I, &_GLOBAL_11_inet_csk_timer_bug_msg_I, &_GLOBAL_12_inet_csk_timer_bug_msg_I, &_GLOBAL_13_inet_csk_timer_bug_msg_I, &_GLOBAL_14_inet_csk_timer_bug_msg_I, &_GLOBAL_15_inet_csk_timer_bug_msg_I, &_GLOBAL_16_inet_csk_timer_bug_msg_I, &_GLOBAL_17_inet_csk_timer_bug_msg_I, &_GLOBAL_18_inet_csk_timer_bug_msg_I, &_GLOBAL_19_inet_csk_timer_bug_msg_I, &_GLOBAL_20_inet_csk_timer_bug_msg_I, &_GLOBAL_21_inet_csk_timer_bug_msg_I, &_GLOBAL_22_inet_csk_timer_bug_msg_I, &_GLOBAL_23_inet_csk_timer_bug_msg_I, &_GLOBAL_24_inet_csk_timer_bug_msg_I, &_GLOBAL_25_inet_csk_timer_bug_msg_I, &_GLOBAL_26_inet_csk_timer_bug_msg_I, &_GLOBAL_27_inet_csk_timer_bug_msg_I, &_GLOBAL_28_inet_csk_timer_bug_msg_I, &_GLOBAL_29_inet_csk_timer_bug_msg_I, &_GLOBAL_30_inet_csk_timer_bug_msg_I, &_GLOBAL_31_inet_csk_timer_bug_msg_I, &_GLOBAL_32_inet_csk_timer_bug_msg_I, &_GLOBAL_33_inet_csk_timer_bug_msg_I, &_GLOBAL_34_inet_csk_timer_bug_msg_I, &_GLOBAL_35_inet_csk_timer_bug_msg_I, &_GLOBAL_36_inet_csk_timer_bug_msg_I, &_GLOBAL_37_inet_csk_timer_bug_msg_I, &_GLOBAL_38_inet_csk_timer_bug_msg_I, &_GLOBAL_39_inet_csk_timer_bug_msg_I, &_GLOBAL_40_inet_csk_timer_bug_msg_I, &_GLOBAL_41_inet_csk_timer_bug_msg_I, &_GLOBAL_42_inet_csk_timer_bug_msg_I, &_GLOBAL_43_inet_csk_timer_bug_msg_I, &_GLOBAL_44_inet_csk_timer_bug_msg_I, &_GLOBAL_45_inet_csk_timer_bug_msg_I, &_GLOBAL_46_inet_csk_timer_bug_msg_I, &_GLOBAL_47_inet_csk_timer_bug_msg_I, &_GLOBAL_48_inet_csk_timer_bug_msg_I, &_GLOBAL_49_inet_csk_timer_bug_msg_I, };   
...
# 12 "linux-2.6.26/include/net/dsfield.h" 2
...
# 16 "linux-2.6.26/net/sched/sch_dsmark.c" 2
# 1 "linux-2.6.26/include/net/inet_ecn.h" 1
# 10 "linux-2.6.26/include/net/inet_ecn.h"
enum {
 INET_ECN_NOT_ECT = 0,
 INET_ECN_ECT_1 = 1,
 INET_ECN_ECT_0 = 2,
...
# 17 "linux-2.6.26/net/sched/sch_dsmark.c" 2
# 37 "linux-2.6.26/net/sched/sch_dsmark.c"
...
static inline  __attribute__((always_inline)) int dsmark_valid_index(struct dsmark_qdisc_data *p, u16 index)
{
   ...
   struct Qdisc *new, struct Qdisc **old)
{
 ...
 ({ if (0) printk("<7>" "dsmark_graft(sch %p,[qdisc %p],new %p,old %p)\n", sch, p, new, old); 0; });


 if (new == ((void *)0)) {
  new = qdisc_create_dflt(sch->dev, &global_pfifo_qdisc_ops[get_stack_id()],
     sch->handle);
  if (new == ((void *)0))
 ...
 *old = ((__typeof__(*(&p->q)))__xchg((unsigned long)(new), (&p->q), sizeof(*(&p->q))));
...
{
 ({ if (0) printk("<7>" "dsmark_get(sch %p,[qdisc %p],classid %x)\n", sch, qdisc_priv(sch), classid); 0; });


 return ((classid)&(0x0000FFFFU)) + 1;
}
...
typedef  const struct nla_policy    _GLOBAL_208_T; static  _GLOBAL_208_T  _GLOBAL_0_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_1_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_2_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_3_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_4_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_5_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_6_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_7_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_8_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_9_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_10_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_11_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_12_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_13_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_14_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_15_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_16_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_17_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_18_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_19_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_20_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_21_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_22_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_23_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_24_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_25_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_26_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_27_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_28_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_29_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_30_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_31_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_32_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_33_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_34_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_35_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_36_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_37_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_38_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_39_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_40_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_41_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_42_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_43_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_44_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_45_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_46_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_47_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_48_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_49_dsmark_policy_I [ ( __TCA_DSMARK_MAX - 1  )  + 1  ]  = { [ TCA_DSMARK_INDICES ] = { . type  = NLA_U16  }  , [ TCA_DSMARK_DEFAULT_INDEX ] = { . type  = NLA_U16  }   , [ TCA_DSMARK_SET_TC_INDEX ] = { . type  = NLA_FLAG  }   , [ TCA_DSMARK_MASK ] = { . type  = NLA_U8  }   , [ TCA_DSMARK_VALUE ] = { . type  = NLA_U8  }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_dsmark_policy_I) *_GLOBAL_dsmark_policy_11_A[NUM_STACKS] = { &_GLOBAL_0_dsmark_policy_I, &_GLOBAL_1_dsmark_policy_I, &_GLOBAL_2_dsmark_policy_I, &_GLOBAL_3_dsmark_policy_I, &_GLOBAL_4_dsmark_policy_I, &_GLOBAL_5_dsmark_policy_I, &_GLOBAL_6_dsmark_policy_I, &_GLOBAL_7_dsmark_policy_I, &_GLOBAL_8_dsmark_policy_I, &_GLOBAL_9_dsmark_policy_I, &_GLOBAL_10_dsmark_policy_I, &_GLOBAL_11_dsmark_policy_I, &_GLOBAL_12_dsmark_policy_I, &_GLOBAL_13_dsmark_policy_I, &_GLOBAL_14_dsmark_policy_I, &_GLOBAL_15_dsmark_policy_I, &_GLOBAL_16_dsmark_policy_I, &_GLOBAL_17_dsmark_policy_I, &_GLOBAL_18_dsmark_policy_I, &_GLOBAL_19_dsmark_policy_I, &_GLOBAL_20_dsmark_policy_I, &_GLOBAL_21_dsmark_policy_I, &_GLOBAL_22_dsmark_policy_I, &_GLOBAL_23_dsmark_policy_I, &_GLOBAL_24_dsmark_policy_I, &_GLOBAL_25_dsmark_policy_I, &_GLOBAL_26_dsmark_policy_I, &_GLOBAL_27_dsmark_policy_I, &_GLOBAL_28_dsmark_policy_I, &_GLOBAL_29_dsmark_policy_I, &_GLOBAL_30_dsmark_policy_I, &_GLOBAL_31_dsmark_policy_I, &_GLOBAL_32_dsmark_policy_I, &_GLOBAL_33_dsmark_policy_I, &_GLOBAL_34_dsmark_policy_I, &_GLOBAL_35_dsmark_policy_I, &_GLOBAL_36_dsmark_policy_I, &_GLOBAL_37_dsmark_policy_I, &_GLOBAL_38_dsmark_policy_I, &_GLOBAL_39_dsmark_policy_I, &_GLOBAL_40_dsmark_policy_I, &_GLOBAL_41_dsmark_policy_I, &_GLOBAL_42_dsmark_policy_I, &_GLOBAL_43_dsmark_policy_I, &_GLOBAL_44_dsmark_policy_I, &_GLOBAL_45_dsmark_policy_I, &_GLOBAL_46_dsmark_policy_I, &_GLOBAL_47_dsmark_policy_I, &_GLOBAL_48_dsmark_policy_I, &_GLOBAL_49_dsmark_policy_I, };          
    ...
    struct nlattr **tca, unsigned long *arg)
{
 ...
 struct nlattr *tb[(__TCA_DSMARK_MAX - 1) + 1];
 int err = -22;
 u8 mask = 0;

 ({ if (0) printk("<7>" "dsmark_change(sch %p,[qdisc %p],classid %x,parent %x)," "arg 0x%lx\n", sch, p, classid, parent, *arg); 0; });
 ...
 err = nla_parse_nested(tb, (__TCA_DSMARK_MAX - 1), opt, (*_GLOBAL_dsmark_policy_11_A[get_stack_id()]));
 if (err < 0)
  goto errout;
...
static void dsmark_walk(struct Qdisc *sch, struct qdisc_walker *walker)
{
 ...
 ({ if (0) printk("<7>" "dsmark_walk(sch %p,[qdisc %p],walker %p)\n", sch, p, walker); 0; });
...
static inline  __attribute__((always_inline)) struct tcf_proto **dsmark_find_tcf(struct Qdisc *sch,
       unsigned long cl)
{
 struct dsmark_qdisc_data *p = qdisc_priv(sch);
...
static int dsmark_enqueue(struct sk_buff *skb, struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "dsmark_enqueue(skb %p,sch %p,[qdisc %p])\n", skb, sch, p); 0; });
 ...
 if (((skb->priority)&(0xFFFF0000U)) == sch->handle)
  skb->tc_index = ((skb->priority)&(0x0000FFFFU));
 else {
  struct tcf_result res;
  int result = tc_classify(skb, p->filter_list, &res);

  ({ if (0) printk("<7>" "result %d class 0x%04x\n", result, res.classid); 0; });

  switch (result) {
# 243 "linux-2.6.26/net/sched/sch_dsmark.c"
  case 0:
   skb->tc_index = ((res.classid)&(0x0000FFFFU));
   break;

  default:
   if (p->default_index != (1 << 16))
...
static struct sk_buff *dsmark_dequeue(struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "dsmark_dequeue(sch %p,[qdisc %p])\n", sch, p); 0; });
 ...
 ({ if (0) printk("<7>" "index %d->%d\n", skb->tc_index, index); 0; });
 ...
 default:
  ...
  if (p->mask[index] != 0xff || p->value[index])
   printk("<4>"
          ...
          __fswab16(( __u16)(__be16)(skb->protocol)));
  break;
 }
...
static int dsmark_requeue(struct sk_buff *skb, struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "dsmark_requeue(skb %p,sch %p,[qdisc %p])\n", skb, sch, p); 0; });
...
static unsigned int dsmark_drop(struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "dsmark_reset(sch %p,[qdisc %p])\n", sch, p); 0; });
...
static int dsmark_init(struct Qdisc *sch, struct nlattr *opt)
{
 ...
 struct nlattr *tb[(__TCA_DSMARK_MAX - 1) + 1];
 int err = -22;
 u32 default_index = (1 << 16);
 u16 indices;
 u8 *mask;

 ({ if (0) printk("<7>" "dsmark_init(sch %p,[qdisc %p],opt %p)\n", sch, p, opt); 0; });
 ...
 mask = kmalloc(indices * 2, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (mask == ((void *)0)) {
  err = -12;
  goto errout;
 }
 ...
 p->mask = mask;
 (__builtin_constant_p(0xff) ? (__builtin_constant_p((indices)) ? __constant_c_and_count_memset(((p->mask)),((0x01010101UL*(unsigned char)(0xff))),((indices))) : __constant_c_memset(((p->mask)),((0x01010101UL*(unsigned char)(0xff))),((indices)))) : (__builtin_constant_p((indices)) ? __memset_generic((((p->mask))),(((0xff))),(((indices)))) : __memset_generic(((p->mask)),((0xff)),((indices)))));

 p->value = p->mask + indices;
 (__builtin_constant_p(0) ? (__builtin_constant_p((indices)) ? __constant_c_and_count_memset(((p->value)),((0x01010101UL*(unsigned char)(0))),((indices))) : __constant_c_memset(((p->value)),((0x01010101UL*(unsigned char)(0))),((indices)))) : (__builtin_constant_p((indices)) ? __memset_generic((((p->value))),(((0))),(((indices)))) : __memset_generic(((p->value)),((0)),((indices)))));

 p->indices = indices;
 p->default_index = default_index;
 p->set_tc_index = nla_get_flag(tb[TCA_DSMARK_SET_TC_INDEX]);

 p->q = qdisc_create_dflt(sch->dev, &global_pfifo_qdisc_ops[get_stack_id()], sch->handle);
 if (p->q == ((void *)0))
  p->q = &global_noop_qdisc[get_stack_id()];

 ({ if (0) printk("<7>" "dsmark_init: qdisc %p\n", p->q); 0; });
...
static void dsmark_destroy(struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "dsmark_destroy(sch %p,[qdisc %p])\n", sch, p); 0; });
        ...
        struct sk_buff *skb, struct tcmsg *tcm)
{
 ...
 ({ if (0) printk("<7>" "dsmark_dump_class(sch %p,[qdisc %p],class %ld\n", sch, p, cl); 0; });

 if (!dsmark_valid_index(p, cl))
  return -22;

 tcm->tcm_handle = (((((sch->handle)&(0xFFFF0000U)))&(0xFFFF0000U))|((cl-1)&(0x0000FFFFU)));
 tcm->tcm_info = p->q->handle;

 opts = nla_nest_start(skb, TCA_OPTIONS);
 if (opts == ((void *)0))
  goto nla_put_failure;
 do { u8 __tmp = p->mask[cl-1]; do { if (__builtin_expect(!!(nla_put(skb, TCA_DSMARK_MASK, sizeof(u8), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
 do { u8 __tmp = p->value[cl-1]; do { if (__builtin_expect(!!(nla_put(skb, TCA_DSMARK_VALUE, sizeof(u8), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
...
static int dsmark_dump(struct Qdisc *sch, struct sk_buff *skb)
{
 ...
 if (opts == ((void *)0))
  goto nla_put_failure;
 do { u16 __tmp = p->indices; do { if (__builtin_expect(!!(nla_put(skb, TCA_DSMARK_INDICES, sizeof(u16), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);

 if (p->default_index != (1 << 16))
  do { u16 __tmp = p->default_index; do { if (__builtin_expect(!!(nla_put(skb, TCA_DSMARK_DEFAULT_INDEX, sizeof(u16), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);

 if (p->set_tc_index)
  do { if (__builtin_expect(!!(nla_put(skb, TCA_DSMARK_SET_TC_INDEX, 0, ((void *)0)) < 0), 0)) goto nla_put_failure; } while(0);
...
typedef  const struct Qdisc_class_ops    _GLOBAL_209_T; static  _GLOBAL_209_T  global_dsmark_class_ops[NUM_STACKS] = {  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  { . graft  = dsmark_graft  , . leaf  = dsmark_leaf   , . get  = dsmark_get   , . put  = dsmark_put   , . change  = dsmark_change   , . delete  = dsmark_delete   , . walk  = dsmark_walk   , . tcf_chain  = dsmark_find_tcf   , . bind_tcf  = dsmark_bind_filter   , . unbind_tcf  = dsmark_put   , . dump  = dsmark_dump_class   , } ,  };       
...
typedef  struct Qdisc_ops   _GLOBAL_210_T; static  _GLOBAL_210_T  global_dsmark_qdisc_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[0]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[1]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[2]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[3]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[4]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[5]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[6]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[7]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[8]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[9]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[10]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[11]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[12]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[13]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[14]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[15]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[16]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[17]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[18]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[19]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[20]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[21]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[22]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[23]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[24]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[25]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[26]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[27]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[28]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[29]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[30]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[31]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[32]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[33]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[34]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[35]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[36]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[37]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[38]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[39]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[40]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[41]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[42]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[43]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[44]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[45]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[46]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[47]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[48]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_dsmark_class_ops[49]    , . id  = "dsmark"   , . priv_size  = sizeof ( struct dsmark_qdisc_data  )    , . enqueue  = dsmark_enqueue   , . dequeue  = dsmark_dequeue   , . requeue  = dsmark_requeue   , . drop  = dsmark_drop   , . init  = dsmark_init   , . reset  = dsmark_reset   , . destroy  = dsmark_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = dsmark_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) dsmark_module_init(void)
{
 return register_qdisc(&global_dsmark_qdisc_ops[get_stack_id()]);
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) dsmark_module_exit(void)
{
 unregister_qdisc(&global_dsmark_qdisc_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_211_T; static  _GLOBAL_211_T  __initcall_dsmark_module_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = dsmark_module_init ;       
typedef  exitcall_t  _GLOBAL_212_T; static  _GLOBAL_212_T  global___exitcall_dsmark_module_exit[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  dsmark_module_exit,  };       
