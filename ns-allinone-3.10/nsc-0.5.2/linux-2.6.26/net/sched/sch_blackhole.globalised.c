# 1 "linux-2.6.26/net/sched/sch_blackhole.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/sch_blackhole.c"
# 14 "linux-2.6.26/net/sched/sch_blackhole.c"
...
{ }
# 15 "linux-2.6.26/net/sched/sch_blackhole.c" 2
...
# 18 "linux-2.6.26/net/sched/sch_blackhole.c" 2
...
# 19 "linux-2.6.26/net/sched/sch_blackhole.c" 2
...
typedef  struct Qdisc_ops   _GLOBAL_149_T; static  _GLOBAL_149_T  global_blackhole_qdisc_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "blackhole"  , . priv_size  = 0   , . enqueue  = blackhole_enqueue   , . dequeue  = blackhole_dequeue   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) blackhole_module_init(void)
{
 return register_qdisc(&global_blackhole_qdisc_ops[get_stack_id()]);
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) blackhole_module_exit(void)
{
 unregister_qdisc(&global_blackhole_qdisc_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_150_T; static  _GLOBAL_150_T  __initcall_blackhole_module_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = blackhole_module_init ;       
typedef  exitcall_t  _GLOBAL_151_T; static  _GLOBAL_151_T  global___exitcall_blackhole_module_exit[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  blackhole_module_exit,  };       
