# 1 "linux-2.6.26/net/sched/sch_sfq.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/sch_sfq.c"
# 12 "linux-2.6.26/net/sched/sch_sfq.c"
...
{ }
# 13 "linux-2.6.26/net/sched/sch_sfq.c" 2
...
# 18 "linux-2.6.26/net/sched/sch_sfq.c" 2
...
typedef  const struct in6_addr    _GLOBAL_77_T; extern  _GLOBAL_77_T  global_in6addr_any[NUM_STACKS];     

typedef  const struct in6_addr    _GLOBAL_78_T; extern  _GLOBAL_78_T  global_in6addr_loopback[NUM_STACKS];     


typedef  const struct in6_addr    _GLOBAL_79_T; extern  _GLOBAL_79_T  global_in6addr_linklocal_allnodes[NUM_STACKS];     


typedef  const struct in6_addr    _GLOBAL_80_T; extern  _GLOBAL_80_T  global_in6addr_linklocal_allrouters[NUM_STACKS];     
...
# 5 "linux-2.6.26/include/linux/ipv6.h" 2
...
typedef  unsigned int   _GLOBAL_81_T; extern  _GLOBAL_81_T  global___invalid_size_argument_for_IOC[NUM_STACKS];    
...
typedef  int  _GLOBAL_82_T; extern  _GLOBAL_82_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_83_T; extern  _GLOBAL_83_T  global_net_msg_burst[NUM_STACKS];   
...
# 21 "linux-2.6.26/net/sched/sch_sfq.c" 2


# 1 "linux-2.6.26/include/net/ip.h" 1
# 31 "linux-2.6.26/include/net/ip.h"
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      void *oldval, size_t *oldlenp,
      void *newval, size_t newlen);
# 24 "linux-2.6.26/net/sched/sch_sfq.c" 2
...
typedef  struct Qdisc   _GLOBAL_218_T; extern  _GLOBAL_218_T  global_noop_qdisc[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_219_T; extern  _GLOBAL_219_T  global_noop_qdisc_ops[NUM_STACKS];    
...
typedef  struct Qdisc_ops   _GLOBAL_220_T; extern  _GLOBAL_220_T  global_pfifo_qdisc_ops[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_221_T; extern  _GLOBAL_221_T  global_bfifo_qdisc_ops[NUM_STACKS];    
...
# 26 "linux-2.6.26/net/sched/sch_sfq.c" 2
# 82 "linux-2.6.26/net/sched/sch_sfq.c"
...
{
 return jhash_2words(h, h1, q->perturbation) & (1024 - 1);
}
...
static unsigned sfq_hash(struct sfq_sched_data *q, struct sk_buff *skb)
{
 ...
 case (( __be16)((__u16)( (((__u16)((0x0800)) & (__u16)0x00ffU) << 8) | (((__u16)((0x0800)) & (__u16)0xff00U) >> 8) ))):
 {
  ...
  if (!(iph->frag_off&(( __be16)__fswab16((0x2000|0x1FFF)))) &&
     ...
     int *qerr)
{
 ...
 if (((skb->priority)&(0xFFFF0000U)) == sch->handle &&
     ((skb->priority)&(0x0000FFFFU)) > 0 &&
     ((skb->priority)&(0x0000FFFFU)) <= 1024)
  return ((skb->priority)&(0x0000FFFFU));
 ...
 *qerr = 4;
 ...
 if (result >= 0) {
# 186 "linux-2.6.26/net/sched/sch_sfq.c"
  if (((res.classid)&(0x0000FFFFU)) <= 1024)
   return ((res.classid)&(0x0000FFFFU));
 }
 return 0;
}
...
static void sfq_perturbation(unsigned long arg)
{
 ...
 if (q->perturb_period)
  mod_timer(&q->perturb_timer, global_jiffies[get_stack_id()] + q->perturb_period);
}
...
static int sfq_change(struct Qdisc *sch, struct nlattr *opt)
{
 ...
 if (ctl->limit)
  q->limit = ({ u32 __min1 = (ctl->limit); u32 __min2 = (128 - 1); __min1 < __min2 ? __min1: __min2; });
...
static int sfq_dump(struct Qdisc *sch, struct sk_buff *skb)
{
 ...
 do { if (__builtin_expect(!!(nla_put(skb, TCA_OPTIONS, sizeof(opt), &opt) < 0), 0)) goto nla_put_failure; } while(0);
...
typedef  const struct Qdisc_class_ops    _GLOBAL_222_T; static  _GLOBAL_222_T  global_sfq_class_ops[NUM_STACKS] = {  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  { . get  = sfq_get  , . change  = sfq_change_class   , . tcf_chain  = sfq_find_tcf   , . dump  = sfq_dump_class   , . dump_stats  = sfq_dump_class_stats   , . walk  = sfq_walk   , } ,  };       
...
typedef  struct Qdisc_ops   _GLOBAL_223_T; static  _GLOBAL_223_T  global_sfq_qdisc_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . cl_ops  = & global_sfq_class_ops[0]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[1]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[2]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[3]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[4]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[5]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[6]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[7]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[8]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[9]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[10]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[11]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[12]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[13]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[14]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[15]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[16]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[17]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[18]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[19]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[20]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[21]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[22]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[23]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[24]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[25]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[26]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[27]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[28]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[29]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[30]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[31]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[32]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[33]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[34]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[35]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[36]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[37]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[38]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[39]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[40]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[41]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[42]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[43]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[44]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[45]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[46]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[47]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[48]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_sfq_class_ops[49]   , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
