# 1 "linux-2.6.26/net/sched/sch_red.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/sch_red.c"
# 17 "linux-2.6.26/net/sched/sch_red.c"
...
{ }
# 18 "linux-2.6.26/net/sched/sch_red.c" 2
...
# 21 "linux-2.6.26/net/sched/sch_red.c" 2
...
# 22 "linux-2.6.26/net/sched/sch_red.c" 2
...
# 5 "linux-2.6.26/include/net/inet_ecn.h" 2
...
# 8 "linux-2.6.26/include/net/inet_ecn.h" 2
# 1 "linux-2.6.26/include/net/dsfield.h" 1
# 11 "linux-2.6.26/include/net/dsfield.h"
...
# 23 "linux-2.6.26/net/sched/sch_red.c" 2
# 1 "linux-2.6.26/include/net/red.h" 1
# 93 "linux-2.6.26/include/net/red.h"
struct red_stats
{
 u32 prob_drop;
 u32 prob_mark;
...
static inline  __attribute__((always_inline)) u32 red_rmask(u8 Plog)
{
 return Plog < 32 ? ((1 << Plog) - 1) : ~0UL;
}

static inline  __attribute__((always_inline)) void red_set_parms(struct red_parms *p,
     ...
     u8 Scell_log, u8 *stab)
{
 ...
 (__builtin_constant_p(sizeof(p->Stab)) ? __constant_memcpy((p->Stab),(stab),(sizeof(p->Stab))) : __memcpy((p->Stab),(stab),(sizeof(p->Stab))));
}

static inline  __attribute__((always_inline)) int red_is_idling(struct red_parms *p)
{
 return p->qidlestart != 0;
}

static inline  __attribute__((always_inline)) void red_start_of_idle_period(struct red_parms *p)
{
 p->qidlestart = psched_get_time();
}

static inline  __attribute__((always_inline)) void red_end_of_idle_period(struct red_parms *p)
{
 p->qidlestart = 0;
}

static inline  __attribute__((always_inline)) void red_restart(struct red_parms *p)
{
...
static inline  __attribute__((always_inline)) unsigned long red_calc_qavg_from_idle_time(struct red_parms *p)
{
 psched_time_t now;
 long us_idle;
 int shift;
...
# 203 "linux-2.6.26/include/net/red.h"
 shift = p->Stab[(us_idle >> p->Scell_log) & (256 - 1)];
...
static inline  __attribute__((always_inline)) unsigned long red_calc_qavg_no_idle_time(struct red_parms *p,
             unsigned int backlog)
{
# 236 "linux-2.6.26/include/net/red.h"
 return p->qavg + (backlog - (p->qavg >> p->Wlog));
}

static inline  __attribute__((always_inline)) unsigned long red_calc_qavg(struct red_parms *p,
       unsigned int backlog)
{
 if (!red_is_idling(p))
...
static inline  __attribute__((always_inline)) u32 red_random(struct red_parms *p)
{
 return random32() & p->Rmask;
}

static inline  __attribute__((always_inline)) int red_mark_probability(struct red_parms *p, unsigned long qavg)
{
# 271 "linux-2.6.26/include/net/red.h"
...
static inline  __attribute__((always_inline)) int red_cmp_thresh(struct red_parms *p, unsigned long qavg)
{
 if (qavg < p->qth_min)
...
static inline  __attribute__((always_inline)) int red_action(struct red_parms *p, unsigned long qavg)
{
...
# 24 "linux-2.6.26/net/sched/sch_red.c" 2
# 39 "linux-2.6.26/net/sched/sch_red.c"
...
static inline  __attribute__((always_inline)) int red_use_ecn(struct red_sched_data *q)
{
 return q->flags & 1;
}

static inline  __attribute__((always_inline)) int red_use_harddrop(struct red_sched_data *q)
{
 return q->flags & 2;
}
...
static struct Qdisc *red_create_dflt(struct Qdisc *sch, u32 limit)
{
 ...
 q = qdisc_create_dflt(sch->dev, &global_bfifo_qdisc_ops[get_stack_id()],
         (((sch->handle)&(0xFFFF0000U))|((1)&(0x0000FFFFU))));
 if (q) {
...
typedef  const struct nla_policy    _GLOBAL_208_T; static  _GLOBAL_208_T  _GLOBAL_0_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_1_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_2_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_3_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_4_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_5_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_6_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_7_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_8_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_9_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_10_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_11_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_12_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_13_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_14_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_15_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_16_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_17_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_18_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_19_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_20_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_21_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_22_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_23_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_24_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_25_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_26_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_27_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_28_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_29_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_30_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_31_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_32_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_33_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_34_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_35_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_36_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_37_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_38_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_39_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_40_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_41_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_42_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_43_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_44_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_45_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_46_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_47_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_48_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static  _GLOBAL_208_T  _GLOBAL_49_red_policy_I [ ( __TCA_RED_MAX - 1  )  + 1  ]  = { [ TCA_RED_PARMS ] = { . len  = sizeof ( struct tc_red_qopt  )   }  , [ TCA_RED_STAB ] = { . len  = 256  }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_red_policy_I) *_GLOBAL_red_policy_11_A[NUM_STACKS] = { &_GLOBAL_0_red_policy_I, &_GLOBAL_1_red_policy_I, &_GLOBAL_2_red_policy_I, &_GLOBAL_3_red_policy_I, &_GLOBAL_4_red_policy_I, &_GLOBAL_5_red_policy_I, &_GLOBAL_6_red_policy_I, &_GLOBAL_7_red_policy_I, &_GLOBAL_8_red_policy_I, &_GLOBAL_9_red_policy_I, &_GLOBAL_10_red_policy_I, &_GLOBAL_11_red_policy_I, &_GLOBAL_12_red_policy_I, &_GLOBAL_13_red_policy_I, &_GLOBAL_14_red_policy_I, &_GLOBAL_15_red_policy_I, &_GLOBAL_16_red_policy_I, &_GLOBAL_17_red_policy_I, &_GLOBAL_18_red_policy_I, &_GLOBAL_19_red_policy_I, &_GLOBAL_20_red_policy_I, &_GLOBAL_21_red_policy_I, &_GLOBAL_22_red_policy_I, &_GLOBAL_23_red_policy_I, &_GLOBAL_24_red_policy_I, &_GLOBAL_25_red_policy_I, &_GLOBAL_26_red_policy_I, &_GLOBAL_27_red_policy_I, &_GLOBAL_28_red_policy_I, &_GLOBAL_29_red_policy_I, &_GLOBAL_30_red_policy_I, &_GLOBAL_31_red_policy_I, &_GLOBAL_32_red_policy_I, &_GLOBAL_33_red_policy_I, &_GLOBAL_34_red_policy_I, &_GLOBAL_35_red_policy_I, &_GLOBAL_36_red_policy_I, &_GLOBAL_37_red_policy_I, &_GLOBAL_38_red_policy_I, &_GLOBAL_39_red_policy_I, &_GLOBAL_40_red_policy_I, &_GLOBAL_41_red_policy_I, &_GLOBAL_42_red_policy_I, &_GLOBAL_43_red_policy_I, &_GLOBAL_44_red_policy_I, &_GLOBAL_45_red_policy_I, &_GLOBAL_46_red_policy_I, &_GLOBAL_47_red_policy_I, &_GLOBAL_48_red_policy_I, &_GLOBAL_49_red_policy_I, };          
...
{
 struct red_sched_data *q = qdisc_priv(sch);
 struct nlattr *tb[(__TCA_RED_MAX - 1) + 1];
 ...
 err = nla_parse_nested(tb, (__TCA_RED_MAX - 1), opt, (*_GLOBAL_red_policy_11_A[get_stack_id()]));
 if (err < 0)
  return err;
...
static int red_dump(struct Qdisc *sch, struct sk_buff *skb)
{
 ...
 do { if (__builtin_expect(!!(nla_put(skb, TCA_RED_PARMS, sizeof(opt), &opt) < 0), 0)) goto nla_put_failure; } while(0);
...
typedef  const struct Qdisc_class_ops    _GLOBAL_209_T; static  _GLOBAL_209_T  global_red_class_ops[NUM_STACKS] = {  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  };       
...
typedef  struct Qdisc_ops   _GLOBAL_210_T; static  _GLOBAL_210_T  global_red_qdisc_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[0]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[1]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[2]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[3]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[4]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[5]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[6]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[7]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[8]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[9]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[10]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[11]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[12]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[13]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[14]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[15]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[16]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[17]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[18]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[19]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[20]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[21]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[22]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[23]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[24]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[25]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[26]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[27]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[28]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[29]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[30]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[31]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[32]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[33]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[34]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[35]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[36]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[37]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[38]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[39]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[40]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[41]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[42]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[43]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[44]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[45]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[46]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[47]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[48]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . id  = "red"  , . priv_size  = sizeof ( struct red_sched_data  )    , . cl_ops  = & global_red_class_ops[49]    , . enqueue  = red_enqueue   , . dequeue  = red_dequeue   , . requeue  = red_requeue   , . drop  = red_drop   , . init  = red_init   , . reset  = red_reset   , . destroy  = red_destroy   , . change  = red_change   , . dump  = red_dump   , . dump_stats  = red_dump_stats   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) red_module_init(void)
{
 return register_qdisc(&global_red_qdisc_ops[get_stack_id()]);
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) red_module_exit(void)
{
 unregister_qdisc(&global_red_qdisc_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_211_T; static  _GLOBAL_211_T  __initcall_red_module_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = red_module_init ;       
typedef  exitcall_t  _GLOBAL_212_T; static  _GLOBAL_212_T  global___exitcall_red_module_exit[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  red_module_exit,  };       
