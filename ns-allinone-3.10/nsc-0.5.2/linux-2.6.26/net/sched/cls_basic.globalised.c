# 1 "linux-2.6.26/net/sched/cls_basic.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/cls_basic.c"
# 12 "linux-2.6.26/net/sched/cls_basic.c"
...
{ }
# 13 "linux-2.6.26/net/sched/cls_basic.c" 2
...
# 18 "linux-2.6.26/net/sched/cls_basic.c" 2
...
# 20 "linux-2.6.26/net/sched/cls_basic.c" 2
...
# 21 "linux-2.6.26/net/sched/cls_basic.c" 2
...
# 22 "linux-2.6.26/net/sched/cls_basic.c" 2
...
typedef  const struct tcf_ext_map    _GLOBAL_149_T; static  _GLOBAL_149_T  global_basic_ext_map[NUM_STACKS] = {  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  { . action  = TCA_BASIC_ACT  , . police  = TCA_BASIC_POLICE   } ,  };       
...
typedef  const struct nla_policy    _GLOBAL_150_T; static  _GLOBAL_150_T  _GLOBAL_0_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_1_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_2_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_3_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_4_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_5_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_6_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_7_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_8_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_9_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_10_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_11_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_12_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_13_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_14_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_15_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_16_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_17_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_18_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_19_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_20_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_21_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_22_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_23_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_24_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_25_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_26_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_27_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_28_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_29_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_30_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_31_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_32_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_33_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_34_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_35_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_36_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_37_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_38_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_39_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_40_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_41_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_42_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_43_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_44_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_45_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_46_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_47_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_48_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_49_basic_policy_I [ ( __TCA_BASIC_MAX - 1  )  + 1  ]  = { [ TCA_BASIC_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_BASIC_EMATCHES ] = { . type  = NLA_NESTED  }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_basic_policy_I) *_GLOBAL_basic_policy_8_A[NUM_STACKS] = { &_GLOBAL_0_basic_policy_I, &_GLOBAL_1_basic_policy_I, &_GLOBAL_2_basic_policy_I, &_GLOBAL_3_basic_policy_I, &_GLOBAL_4_basic_policy_I, &_GLOBAL_5_basic_policy_I, &_GLOBAL_6_basic_policy_I, &_GLOBAL_7_basic_policy_I, &_GLOBAL_8_basic_policy_I, &_GLOBAL_9_basic_policy_I, &_GLOBAL_10_basic_policy_I, &_GLOBAL_11_basic_policy_I, &_GLOBAL_12_basic_policy_I, &_GLOBAL_13_basic_policy_I, &_GLOBAL_14_basic_policy_I, &_GLOBAL_15_basic_policy_I, &_GLOBAL_16_basic_policy_I, &_GLOBAL_17_basic_policy_I, &_GLOBAL_18_basic_policy_I, &_GLOBAL_19_basic_policy_I, &_GLOBAL_20_basic_policy_I, &_GLOBAL_21_basic_policy_I, &_GLOBAL_22_basic_policy_I, &_GLOBAL_23_basic_policy_I, &_GLOBAL_24_basic_policy_I, &_GLOBAL_25_basic_policy_I, &_GLOBAL_26_basic_policy_I, &_GLOBAL_27_basic_policy_I, &_GLOBAL_28_basic_policy_I, &_GLOBAL_29_basic_policy_I, &_GLOBAL_30_basic_policy_I, &_GLOBAL_31_basic_policy_I, &_GLOBAL_32_basic_policy_I, &_GLOBAL_33_basic_policy_I, &_GLOBAL_34_basic_policy_I, &_GLOBAL_35_basic_policy_I, &_GLOBAL_36_basic_policy_I, &_GLOBAL_37_basic_policy_I, &_GLOBAL_38_basic_policy_I, &_GLOBAL_39_basic_policy_I, &_GLOBAL_40_basic_policy_I, &_GLOBAL_41_basic_policy_I, &_GLOBAL_42_basic_policy_I, &_GLOBAL_43_basic_policy_I, &_GLOBAL_44_basic_policy_I, &_GLOBAL_45_basic_policy_I, &_GLOBAL_46_basic_policy_I, &_GLOBAL_47_basic_policy_I, &_GLOBAL_48_basic_policy_I, &_GLOBAL_49_basic_policy_I, };          
   ...
   struct nlattr **tca, unsigned long *arg)
{
 int err;
 struct basic_head *head = (struct basic_head *) tp->root;
 struct nlattr *tb[(__TCA_BASIC_MAX - 1) + 1];
 struct basic_filter *f = (struct basic_filter *) *arg;

 if (tca[TCA_OPTIONS] == ((void *)0))
  return -22;

 err = nla_parse_nested(tb, (__TCA_BASIC_MAX - 1), tca[TCA_OPTIONS],
          (*_GLOBAL_basic_policy_8_A[get_stack_id()]));
 if (err < 0)
  return err;
        ...
        struct sk_buff *skb, struct tcmsg *t)
{
 ...
 if (f->res.classid)
  do { u32 __tmp = f->res.classid; do { if (__builtin_expect(!!(nla_put(skb, TCA_BASIC_CLASSID, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
...
typedef  struct tcf_proto_ops   _GLOBAL_151_T; static  _GLOBAL_151_T  global_cls_basic_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "basic"  , . classify  = basic_classify   , . init  = basic_init   , . destroy  = basic_destroy   , . get  = basic_get   , . put  = basic_put   , . change  = basic_change   , . delete  = basic_delete   , . walk  = basic_walk   , . dump  = basic_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
