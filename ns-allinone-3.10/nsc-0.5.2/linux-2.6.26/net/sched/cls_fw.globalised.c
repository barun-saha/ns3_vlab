# 1 "linux-2.6.26/net/sched/cls_fw.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/cls_fw.c"
# 21 "linux-2.6.26/net/sched/cls_fw.c"
...
{ }
# 22 "linux-2.6.26/net/sched/cls_fw.c" 2
...
# 27 "linux-2.6.26/net/sched/cls_fw.c" 2
...
# 28 "linux-2.6.26/net/sched/cls_fw.c" 2
...
# 29 "linux-2.6.26/net/sched/cls_fw.c" 2
...
# 30 "linux-2.6.26/net/sched/cls_fw.c" 2
...
typedef  const struct tcf_ext_map    _GLOBAL_149_T; static  _GLOBAL_149_T  global_fw_ext_map[NUM_STACKS] = {  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  };       
...
typedef  const struct nla_policy    _GLOBAL_150_T; static  _GLOBAL_150_T  _GLOBAL_0_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_1_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_2_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_3_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_4_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_5_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_6_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_7_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_8_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_9_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_10_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_11_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_12_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_13_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_14_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_15_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_16_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_17_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_18_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_19_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_20_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_21_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_22_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_23_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_24_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_25_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_26_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_27_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_28_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_29_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_30_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_31_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_32_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_33_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_34_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_35_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_36_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_37_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_38_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_39_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_40_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_41_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_42_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_43_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_44_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_45_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_46_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_47_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_48_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_150_T  _GLOBAL_49_fw_policy_I [ ( __TCA_FW_MAX - 1  )  + 1  ]  = { [ TCA_FW_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_FW_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_FW_MASK ] = { . type  = NLA_U32  }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_fw_policy_I) *_GLOBAL_fw_policy_8_A[NUM_STACKS] = { &_GLOBAL_0_fw_policy_I, &_GLOBAL_1_fw_policy_I, &_GLOBAL_2_fw_policy_I, &_GLOBAL_3_fw_policy_I, &_GLOBAL_4_fw_policy_I, &_GLOBAL_5_fw_policy_I, &_GLOBAL_6_fw_policy_I, &_GLOBAL_7_fw_policy_I, &_GLOBAL_8_fw_policy_I, &_GLOBAL_9_fw_policy_I, &_GLOBAL_10_fw_policy_I, &_GLOBAL_11_fw_policy_I, &_GLOBAL_12_fw_policy_I, &_GLOBAL_13_fw_policy_I, &_GLOBAL_14_fw_policy_I, &_GLOBAL_15_fw_policy_I, &_GLOBAL_16_fw_policy_I, &_GLOBAL_17_fw_policy_I, &_GLOBAL_18_fw_policy_I, &_GLOBAL_19_fw_policy_I, &_GLOBAL_20_fw_policy_I, &_GLOBAL_21_fw_policy_I, &_GLOBAL_22_fw_policy_I, &_GLOBAL_23_fw_policy_I, &_GLOBAL_24_fw_policy_I, &_GLOBAL_25_fw_policy_I, &_GLOBAL_26_fw_policy_I, &_GLOBAL_27_fw_policy_I, &_GLOBAL_28_fw_policy_I, &_GLOBAL_29_fw_policy_I, &_GLOBAL_30_fw_policy_I, &_GLOBAL_31_fw_policy_I, &_GLOBAL_32_fw_policy_I, &_GLOBAL_33_fw_policy_I, &_GLOBAL_34_fw_policy_I, &_GLOBAL_35_fw_policy_I, &_GLOBAL_36_fw_policy_I, &_GLOBAL_37_fw_policy_I, &_GLOBAL_38_fw_policy_I, &_GLOBAL_39_fw_policy_I, &_GLOBAL_40_fw_policy_I, &_GLOBAL_41_fw_policy_I, &_GLOBAL_42_fw_policy_I, &_GLOBAL_43_fw_policy_I, &_GLOBAL_44_fw_policy_I, &_GLOBAL_45_fw_policy_I, &_GLOBAL_46_fw_policy_I, &_GLOBAL_47_fw_policy_I, &_GLOBAL_48_fw_policy_I, &_GLOBAL_49_fw_policy_I, };          
 ...
 struct nlattr **tb, struct nlattr **tca, unsigned long base)
{
 ...
 err = tcf_exts_validate(tp, tb, tca[TCA_RATE], &e, &global_fw_ext_map[get_stack_id()]);
 if (err < 0)
  return err;
...
# 222 "linux-2.6.26/net/sched/cls_fw.c"
 if (tb[TCA_FW_MASK]) {
       ...
       unsigned long *arg)
{
 ...
 struct nlattr *tb[(__TCA_FW_MAX - 1) + 1];
 int err;

 if (!opt)
  return handle ? -22 : 0;

 err = nla_parse_nested(tb, (__TCA_FW_MAX - 1), opt, (*_GLOBAL_fw_policy_8_A[get_stack_id()]));
 if (err < 0)
  return err;
     ...
     struct sk_buff *skb, struct tcmsg *t)
{
 ...
 if (f->res.classid)
  do { u32 __tmp = f->res.classid; do { if (__builtin_expect(!!(nla_put(skb, TCA_FW_CLASSID, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);




 if (head->mask != 0xFFFFFFFF)
  do { u32 __tmp = head->mask; do { if (__builtin_expect(!!(nla_put(skb, TCA_FW_MASK, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
...
typedef  struct tcf_proto_ops   _GLOBAL_151_T; static  _GLOBAL_151_T  global_cls_fw_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "fw"  , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
