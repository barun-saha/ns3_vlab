# 1 "linux-2.6.26/net/sched/sch_hfsc.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/sch_hfsc.c"
# 52 "linux-2.6.26/net/sched/sch_hfsc.c"
...
# 53 "linux-2.6.26/net/sched/sch_hfsc.c" 2
...
{ }
# 54 "linux-2.6.26/net/sched/sch_hfsc.c" 2
...
# 59 "linux-2.6.26/net/sched/sch_hfsc.c" 2
...
# 65 "linux-2.6.26/net/sched/sch_hfsc.c" 2
...
# 66 "linux-2.6.26/net/sched/sch_hfsc.c" 2
...
# 67 "linux-2.6.26/net/sched/sch_hfsc.c" 2
...
# 68 "linux-2.6.26/net/sched/sch_hfsc.c" 2
...
# 11 "linux-2.6.26/include/net/act_api.h"
struct tcf_common {
...
# 7 "linux-2.6.26/include/net/pkt_cls.h" 2
...
# 69 "linux-2.6.26/net/sched/sch_hfsc.c" 2
# 84 "linux-2.6.26/net/sched/sch_hfsc.c"
struct internal_sc
{
 u64 sm1;
 u64 ism1;
...
# 202 "linux-2.6.26/net/sched/sch_hfsc.c"
static void
eltree_insert(struct hfsc_class *cl)
{
 ...
 while (*p != ((void *)0)) {
  parent = *p;
  cl1 = ({ const typeof( ((struct hfsc_class *)0)->el_node ) *__mptr = (parent); (struct hfsc_class *)( (char *)__mptr - __builtin_offsetof(struct hfsc_class,el_node) );});
  if (cl->cl_e >= cl1->cl_e)
   p = &parent->rb_right;
  else
   p = &parent->rb_left;
...
static inline  __attribute__((always_inline)) struct hfsc_class *
eltree_get_mindl(struct hfsc_sched *q, u64 cur_time)
{
 struct hfsc_class *p, *cl = ((void *)0);
 struct rb_node *n;

 for (n = rb_first(&q->eligible); n != ((void *)0); n = rb_next(n)) {
  p = ({ const typeof( ((struct hfsc_class *)0)->el_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - __builtin_offsetof(struct hfsc_class,el_node) );});
  if (p->cl_e > cur_time)
   break;
  if (cl == ((void *)0) || p->cl_d < cl->cl_d)
   cl = p;
 }
 return cl;
}
...
eltree_get_minel(struct hfsc_sched *q)
{
 ...
 if (n == ((void *)0))
  return ((void *)0);
 return ({ const typeof( ((struct hfsc_class *)0)->el_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - __builtin_offsetof(struct hfsc_class,el_node) );});
}
...
vttree_insert(struct hfsc_class *cl)
{
 ...
 while (*p != ((void *)0)) {
  parent = *p;
  cl1 = ({ const typeof( ((struct hfsc_class *)0)->vt_node ) *__mptr = (parent); (struct hfsc_class *)( (char *)__mptr - __builtin_offsetof(struct hfsc_class,vt_node) );});
...
vttree_firstfit(struct hfsc_class *cl, u64 cur_time)
{
 ...
 for (n = rb_first(&cl->vt_tree); n != ((void *)0); n = rb_next(n)) {
  p = ({ const typeof( ((struct hfsc_class *)0)->vt_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - __builtin_offsetof(struct hfsc_class,vt_node) );});
  if (p->cl_f <= cur_time)
   return p;
 }
 return ((void *)0);
...
cftree_insert(struct hfsc_class *cl)
{
 ...
 while (*p != ((void *)0)) {
  parent = *p;
  cl1 = ({ const typeof( ((struct hfsc_class *)0)->cf_node ) *__mptr = (parent); (struct hfsc_class *)( (char *)__mptr - __builtin_offsetof(struct hfsc_class,cf_node) );});
  if (cl->cl_f >= cl1->cl_f)
   p = &parent->rb_right;
  else
   p = &parent->rb_left;
...
# 397 "linux-2.6.26/net/sched/sch_hfsc.c"
...
seg_y2x(u64 y, u64 ism)
{
 ...
 if (y == 0)
  x = 0;
 else if (ism == 0xffffffffffffffffULL)
...
m2sm(u32 m)
{
 ...
 sm = ((u64)m << 20);
 sm += ((1000000000L) >> 10) - 1;
 ({ unsigned long __upper, __low, __high, __mod, __base; __base = (((1000000000L) >> 10)); asm("":"=a" (__low), "=d" (__high) : "A" (sm)); __upper = __high; if (__high) { __upper = __high % (__base); __high = __high / (__base); } asm("divl %2":"=a" (__low), "=d" (__mod) : "rm" (__base), "0" (__low), "1" (__upper)); asm("":"=A" (sm) : "a" (__low), "d" (__high)); __mod; });
 return sm;
}
...
m2ism(u32 m)
{
 ...
 if (m == 0)
  ism = 0xffffffffffffffffULL;
 else {
  ism = ((u64)((1000000000L) >> 10) << 18);
  ism += m - 1;
  ({ unsigned long __upper, __low, __high, __mod, __base; __base = (m); asm("":"=a" (__low), "=d" (__high) : "A" (ism)); __upper = __high; if (__high) { __upper = __high % (__base); __high = __high / (__base); } asm("divl %2":"=a" (__low), "=d" (__mod) : "rm" (__base), "0" (__low), "1" (__upper)); asm("":"=A" (ism) : "a" (__low), "d" (__high)); __mod; });
 }
 return ism;
}
...
d2dx(u32 d)
{
 ...
 dx = ((u64)d * ((1000000000L) >> 10));
 dx += 1000000L - 1;
 ({ unsigned long __upper, __low, __high, __mod, __base; __base = (1000000L); asm("":"=a" (__low), "=d" (__high) : "A" (dx)); __upper = __high; if (__high) { __upper = __high % (__base); __high = __high / (__base); } asm("divl %2":"=a" (__low), "=d" (__mod) : "rm" (__base), "0" (__low), "1" (__upper)); asm("":"=A" (dx) : "a" (__low), "d" (__high)); __mod; });
 return dx;
}
...
dx2d(u64 dx)
{
 ...
 d = dx * 1000000L;
 ({ unsigned long __upper, __low, __high, __mod, __base; __base = (((1000000000L) >> 10)); asm("":"=a" (__low), "=d" (__high) : "A" (d)); __upper = __high; if (__high) { __upper = __high % (__base); __high = __high / (__base); } asm("divl %2":"=a" (__low), "=d" (__mod) : "rm" (__base), "0" (__low), "1" (__upper)); asm("":"=A" (d) : "a" (__low), "d" (__high)); __mod; });
 return (u32)d;
}
...
rtsc_min(struct runtime_sc *rtsc, struct internal_sc *isc, u64 x, u64 y)
{
 ...
 dx = (y1 - y) << 20;
 dsm = isc->sm1 - isc->sm2;
 ({ unsigned long __upper, __low, __high, __mod, __base; __base = (dsm); asm("":"=a" (__low), "=d" (__high) : "A" (dx)); __upper = __high; if (__high) { __upper = __high % (__base); __high = __high / (__base); } asm("divl %2":"=a" (__low), "=d" (__mod) : "rm" (__base), "0" (__low), "1" (__upper)); asm("":"=A" (dx) : "a" (__low), "d" (__high)); __mod; });
...
update_cfmin(struct hfsc_class *cl)
{
 ...
 p = ({ const typeof( ((struct hfsc_class *)0)->cf_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - __builtin_offsetof(struct hfsc_class,cf_node) );});
 cl->cl_cfmin = p->cl_f;
}
...
init_vf(struct hfsc_class *cl, unsigned int len)
{
 ...
 cur_time = 0;
 go_active = 1;
 for (; cl->cl_parent != ((void *)0); cl = cl->cl_parent) {
  ...
  if (go_active) {
   ...
   if (n != ((void *)0)) {
    max_cl = ({ const typeof( ((struct hfsc_class *)0)->vt_node ) *__mptr = (n); (struct hfsc_class *)( (char *)__mptr - __builtin_offsetof(struct hfsc_class,vt_node) );});
  ...
  f = ({ typeof(cl->cl_myf) _max1 = (cl->cl_myf); typeof(cl->cl_cfmin) _max2 = (cl->cl_cfmin); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
  if (f != cl->cl_f) {
   cl->cl_f = f;
   cftree_update(cl);
 ...
 for (; cl->cl_parent != ((void *)0); cl = cl->cl_parent) {
  ...
  if (cl->cl_flags & HFSC_USC) {
   cl->cl_myf = cl->cl_myfadj + rtsc_y2x(&cl->cl_ulimit,
             cl->cl_total);
# 850 "linux-2.6.26/net/sched/sch_hfsc.c"
  }
...
qdisc_peek_len(struct Qdisc *sch)
{
 ...
 len = skb->len;
 if (__builtin_expect(!!(sch->ops->requeue(skb, sch) != 0), 0)) {
  if (net_ratelimit())
...
hfsc_adjust_levels(struct hfsc_class *cl)
{
 ...
 do {
  level = 0;
  for (p = ({ const typeof( ((typeof(*p) *)0)->siblings ) *__mptr = ((&cl->children)->next); (typeof(*p) *)( (char *)__mptr - __builtin_offsetof(typeof(*p),siblings) );}); prefetch(p->siblings.next), &p->siblings != (&cl->children); p = ({ const typeof( ((typeof(*p) *)0)->siblings ) *__mptr = (p->siblings.next); (typeof(*p) *)( (char *)__mptr - __builtin_offsetof(typeof(*p),siblings) );})) {
   if (p->level >= level)
    level = p->level + 1;
  }
  cl->level = level;
 } while ((cl = cl->cl_parent) != ((void *)0));
}
...
hfsc_find_class(u32 classid, struct Qdisc *sch)
{
 ...
 for (cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = ((&q->clhash[hfsc_hash(classid)])->next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),hlist) );}); prefetch(cl->hlist.next), &cl->hlist != (&q->clhash[hfsc_hash(classid)]); cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = (cl->hlist.next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),hlist) );})) {
...
typedef  const struct nla_policy    _GLOBAL_149_T; static  _GLOBAL_149_T  _GLOBAL_0_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_1_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_2_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_3_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_4_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_5_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_6_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_7_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_8_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_9_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_10_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_11_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_12_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_13_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_14_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_15_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_16_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_17_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_18_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_19_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_20_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_21_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_22_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_23_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_24_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_25_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_26_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_27_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_28_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_29_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_30_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_31_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_32_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_33_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_34_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_35_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_36_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_37_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_38_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_39_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_40_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_41_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_42_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_43_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_44_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_45_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_46_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_47_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_48_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_49_hfsc_policy_I [ ( __TCA_HFSC_MAX - 1  )  + 1  ]  = { [ TCA_HFSC_RSC ] = { . len  = sizeof ( struct tc_service_curve  )   }  , [ TCA_HFSC_FSC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , [ TCA_HFSC_USC ] = { . len  = sizeof ( struct tc_service_curve  )   }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_hfsc_policy_I) *_GLOBAL_hfsc_policy_8_A[NUM_STACKS] = { &_GLOBAL_0_hfsc_policy_I, &_GLOBAL_1_hfsc_policy_I, &_GLOBAL_2_hfsc_policy_I, &_GLOBAL_3_hfsc_policy_I, &_GLOBAL_4_hfsc_policy_I, &_GLOBAL_5_hfsc_policy_I, &_GLOBAL_6_hfsc_policy_I, &_GLOBAL_7_hfsc_policy_I, &_GLOBAL_8_hfsc_policy_I, &_GLOBAL_9_hfsc_policy_I, &_GLOBAL_10_hfsc_policy_I, &_GLOBAL_11_hfsc_policy_I, &_GLOBAL_12_hfsc_policy_I, &_GLOBAL_13_hfsc_policy_I, &_GLOBAL_14_hfsc_policy_I, &_GLOBAL_15_hfsc_policy_I, &_GLOBAL_16_hfsc_policy_I, &_GLOBAL_17_hfsc_policy_I, &_GLOBAL_18_hfsc_policy_I, &_GLOBAL_19_hfsc_policy_I, &_GLOBAL_20_hfsc_policy_I, &_GLOBAL_21_hfsc_policy_I, &_GLOBAL_22_hfsc_policy_I, &_GLOBAL_23_hfsc_policy_I, &_GLOBAL_24_hfsc_policy_I, &_GLOBAL_25_hfsc_policy_I, &_GLOBAL_26_hfsc_policy_I, &_GLOBAL_27_hfsc_policy_I, &_GLOBAL_28_hfsc_policy_I, &_GLOBAL_29_hfsc_policy_I, &_GLOBAL_30_hfsc_policy_I, &_GLOBAL_31_hfsc_policy_I, &_GLOBAL_32_hfsc_policy_I, &_GLOBAL_33_hfsc_policy_I, &_GLOBAL_34_hfsc_policy_I, &_GLOBAL_35_hfsc_policy_I, &_GLOBAL_36_hfsc_policy_I, &_GLOBAL_37_hfsc_policy_I, &_GLOBAL_38_hfsc_policy_I, &_GLOBAL_39_hfsc_policy_I, &_GLOBAL_40_hfsc_policy_I, &_GLOBAL_41_hfsc_policy_I, &_GLOBAL_42_hfsc_policy_I, &_GLOBAL_43_hfsc_policy_I, &_GLOBAL_44_hfsc_policy_I, &_GLOBAL_45_hfsc_policy_I, &_GLOBAL_46_hfsc_policy_I, &_GLOBAL_47_hfsc_policy_I, &_GLOBAL_48_hfsc_policy_I, &_GLOBAL_49_hfsc_policy_I, };          
    ...
    struct nlattr **tca, unsigned long *arg)
{
 ...
 struct nlattr *tb[(__TCA_HFSC_MAX - 1) + 1];
 ...
 err = nla_parse_nested(tb, (__TCA_HFSC_MAX - 1), opt, (*_GLOBAL_hfsc_policy_8_A[get_stack_id()]));
 if (err < 0)
  return err;
 ...
 if (cl != ((void *)0)) {
  if (parentid) {
   if (cl->cl_parent && cl->cl_parent->classid != parentid)
    return -22;
   if (cl->cl_parent == ((void *)0) && parentid != (0xFFFFFFFFU))
    return -22;
  }
  cur_time = psched_get_time();
 ...
 if (classid == 0 || ((classid ^ sch->handle)&(0xFFFF0000U)) != 0)
  return -22;
 ...
 cl = kzalloc(sizeof(struct hfsc_class), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (cl == ((void *)0))
  return -105;
 ...
 cl->sched = q;
 cl->cl_parent = parent;
 cl->qdisc = qdisc_create_dflt(sch->dev, &global_pfifo_qdisc_ops[get_stack_id()], classid);
 if (cl->qdisc == ((void *)0))
  cl->qdisc = &global_noop_qdisc[get_stack_id()];
 INIT_LIST_HEAD(&cl->children);
 cl->vt_tree = (struct rb_root) { ((void *)0), };
 cl->cf_tree = (struct rb_root) { ((void *)0), };
...
hfsc_classify(struct sk_buff *skb, struct Qdisc *sch, int *qerr)
{
 ...
 if (((skb->priority ^ sch->handle)&(0xFFFF0000U)) == 0 &&
...
# 1183 "linux-2.6.26/net/sched/sch_hfsc.c"
 ...
 cl = hfsc_find_class((((((sch->handle)&(0xFFFF0000U)))&(0xFFFF0000U))|((q->defcls)&(0x0000FFFFU))), sch);
   ...
   struct Qdisc **old)
{
 ...
 qdisc_lock_tree((sch)->dev);
 hfsc_purge_queue(sch, cl);
 *old = ((__typeof__(*(&cl->qdisc)))__xchg((unsigned long)(new), (&cl->qdisc), sizeof(*(&cl->qdisc))));
 qdisc_unlock_tree((sch)->dev);
 return 0;
}
...
hfsc_dump_sc(struct sk_buff *skb, int attr, struct internal_sc *sc)
{
 ...
 tsc.d = dx2d(sc->dx);
 tsc.m2 = sm2m(sc->sm2);
 do { if (__builtin_expect(!!(nla_put(skb, attr, sizeof(tsc), &tsc) < 0), 0)) goto nla_put_failure; } while(0);
  ...
  struct tcmsg *tcm)
{
 ...
 tcm->tcm_parent = cl->cl_parent ? cl->cl_parent->classid : (0xFFFFFFFFU);
...
hfsc_walk(struct Qdisc *sch, struct qdisc_walker *arg)
{
 ...
 for (i = 0; i < 16; i++) {
  for (cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = ((&q->clhash[i])->next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),hlist) );}); prefetch(cl->hlist.next), &cl->hlist != (&q->clhash[i]); cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = (cl->hlist.next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),hlist) );})) {
...
hfsc_schedule_watchdog(struct Qdisc *sch)
{
 ...
 ({ int __ret_warn_on = !!(next_time == 0); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_on_slowpath("linux-2.6.26/net/sched/sch_hfsc.c", 1427); __builtin_expect(!!(__ret_warn_on), 0); });
...
hfsc_init_qdisc(struct Qdisc *sch, struct nlattr *opt)
{
 ...
 q->eligible = (struct rb_root) { ((void *)0), };
 ...
 q->root.sched = q;
 q->root.qdisc = qdisc_create_dflt(sch->dev, &global_pfifo_qdisc_ops[get_stack_id()],
       sch->handle);
 if (q->root.qdisc == ((void *)0))
  q->root.qdisc = &global_noop_qdisc[get_stack_id()];
 INIT_LIST_HEAD(&q->root.children);
 q->root.vt_tree = (struct rb_root) { ((void *)0), };
 q->root.cf_tree = (struct rb_root) { ((void *)0), };
...
hfsc_destroy_qdisc(struct Qdisc *sch)
{
 ...
 for (i = 0; i < 16; i++) {
  for (cl = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = ((&q->clhash[i])->next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),hlist) );}), next = ({ const typeof( ((typeof(*cl) *)0)->hlist ) *__mptr = (cl->hlist.next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),hlist) );}); &cl->hlist != (&q->clhash[i]); cl = next, next = ({ const typeof( ((typeof(*next) *)0)->hlist ) *__mptr = (next->hlist.next); (typeof(*next) *)( (char *)__mptr - __builtin_offsetof(typeof(*next),hlist) );}))
   hfsc_destroy_class(sch, cl);
 }
 __skb_queue_purge(&q->requeue);
 qdisc_watchdog_cancel(&q->watchdog);
...
hfsc_dump_qdisc(struct Qdisc *sch, struct sk_buff *skb)
{
 ...
 do { if (__builtin_expect(!!(nla_put(skb, TCA_OPTIONS, sizeof(qopt), &qopt) < 0), 0)) goto nla_put_failure; } while(0);
 return skb->len;
...
hfsc_drop(struct Qdisc *sch)
{
 ...
 for (cl = ({ const typeof( ((typeof(*cl) *)0)->dlist ) *__mptr = ((&q->droplist)->next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),dlist) );}); prefetch(cl->dlist.next), &cl->dlist != (&q->droplist); cl = ({ const typeof( ((typeof(*cl) *)0)->dlist ) *__mptr = (cl->dlist.next); (typeof(*cl) *)( (char *)__mptr - __builtin_offsetof(typeof(*cl),dlist) );})) {
  if (cl->qdisc->ops->drop != ((void *)0) &&
...
typedef  const struct Qdisc_class_ops    _GLOBAL_150_T; static  _GLOBAL_150_T  global_hfsc_class_ops[NUM_STACKS] = {  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  { . change  = hfsc_change_class  , . delete  = hfsc_delete_class   , . graft  = hfsc_graft_class   , . leaf  = hfsc_class_leaf   , . qlen_notify  = hfsc_qlen_notify   , . get  = hfsc_get_class   , . put  = hfsc_put_class   , . bind_tcf  = hfsc_bind_tcf   , . unbind_tcf  = hfsc_unbind_tcf   , . tcf_chain  = hfsc_tcf_chain   , . dump  = hfsc_dump_class   , . dump_stats  = hfsc_dump_class_stats   , . walk  = hfsc_walk   } ,  };       
...
typedef  struct Qdisc_ops   _GLOBAL_151_T; static  _GLOBAL_151_T  global_hfsc_qdisc_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[0]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[1]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[2]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[3]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[4]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[5]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[6]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[7]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[8]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[9]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[10]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[11]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[12]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[13]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[14]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[15]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[16]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[17]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[18]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[19]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[20]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[21]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[22]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[23]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[24]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[25]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[26]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[27]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[28]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[29]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[30]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[31]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[32]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[33]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[34]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[35]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[36]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[37]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[38]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[39]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[40]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[41]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[42]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[43]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[44]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[45]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[46]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[47]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[48]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  { . id  = "hfsc"  , . init  = hfsc_init_qdisc   , . change  = hfsc_change_qdisc   , . reset  = hfsc_reset_qdisc   , . destroy  = hfsc_destroy_qdisc   , . dump  = hfsc_dump_qdisc   , . enqueue  = hfsc_enqueue   , . dequeue  = hfsc_dequeue   , . requeue  = hfsc_requeue   , . drop  = hfsc_drop   , . cl_ops  = & global_hfsc_class_ops[49]    , . priv_size  = sizeof ( struct hfsc_sched  )    , . owner  = ( ( struct module  *  ) 0  )    } ,  };       
...
static int  
__attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) hfsc_init(void)
{
 return register_qdisc(&global_hfsc_qdisc_ops[get_stack_id()]);
}

static void   
__attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) hfsc_cleanup(void)
{
 unregister_qdisc(&global_hfsc_qdisc_ops[get_stack_id()]);
}

;
typedef  initcall_t  _GLOBAL_152_T; static  _GLOBAL_152_T  __initcall_hfsc_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = hfsc_init ;       ;
typedef  exitcall_t  _GLOBAL_153_T; static  _GLOBAL_153_T  global___exitcall_hfsc_cleanup[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  hfsc_cleanup,  };       ;
