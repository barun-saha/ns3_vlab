# 1 "linux-2.6.26/net/sched/sch_atm.c"
...
{ }
# 6 "linux-2.6.26/net/sched/sch_atm.c" 2
...
# 10 "linux-2.6.26/net/sched/sch_atm.c" 2
# 1 "linux-2.6.26/include/linux/atmdev.h" 1
# 10 "linux-2.6.26/include/linux/atmdev.h"
# 1 "linux-2.6.26/include/linux/atmapi.h" 1
# 27 "linux-2.6.26/include/linux/atmapi.h"
typedef struct { unsigned char _[8]; } atm_kptr_t;
# 11 "linux-2.6.26/include/linux/atmdev.h" 2
# 1 "linux-2.6.26/include/linux/atm.h" 1
# 21 "linux-2.6.26/include/linux/atm.h"
# 1 "linux-2.6.26/include/linux/atmsap.h" 1
# 103 "linux-2.6.26/include/linux/atmsap.h"
struct atm_blli {
...
# 22 "linux-2.6.26/include/linux/atm.h" 2
# 1 "linux-2.6.26/include/linux/atmioc.h" 1
# 15 "linux-2.6.26/include/linux/atmioc.h"
# 1 "linux-2.6.26/include/asm/ioctl.h" 1
# 16 "linux-2.6.26/include/linux/atmioc.h" 2
# 23 "linux-2.6.26/include/linux/atm.h" 2
# 135 "linux-2.6.26/include/linux/atm.h"
struct atm_trafprm {
...
# 175 "linux-2.6.26/include/linux/atm.h"
...
# 205 "linux-2.6.26/include/linux/atm.h"
...
# 12 "linux-2.6.26/include/linux/atmdev.h" 2
# 40 "linux-2.6.26/include/linux/atmdev.h"
...
# 155 "linux-2.6.26/include/linux/atmdev.h"
struct atm_iobuf {
 int length;
 void *buffer;
};
...
# 218 "linux-2.6.26/include/linux/atmdev.h"
...
# 219 "linux-2.6.26/include/linux/atmdev.h" 2
# 1 "linux-2.6.26/include/asm/atomic.h" 1
# 220 "linux-2.6.26/include/linux/atmdev.h" 2
# 228 "linux-2.6.26/include/linux/atmdev.h"
...
# 276 "linux-2.6.26/include/linux/atmdev.h"
enum {
 ATM_DF_REMOVED,
};
# 287 "linux-2.6.26/include/linux/atmdev.h"
struct atm_vcc {
...
# 377 "linux-2.6.26/include/linux/atmdev.h"
struct atmdev_ops {
...
typedef  rwlock_t  _GLOBAL_197_T; extern  _GLOBAL_197_T  global_vcc_sklist_lock[NUM_STACKS];   
...
{
 return ((((size) + ((1 << (5)) - 1)) & ~((1 << (5)) - 1)) + sizeof(struct skb_shared_info));
}
...
static inline  __attribute__((always_inline)) void atm_dev_put(struct atm_dev *dev)
{
 if (atomic_dec_and_test(&dev->refcnt)) {
  do { if (__builtin_expect(!!(!(__builtin_constant_p((ATM_DF_REMOVED)) ? constant_test_bit((ATM_DF_REMOVED), (&dev->flags)) : variable_test_bit((ATM_DF_REMOVED), (&dev->flags)))), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
...
# 491 "linux-2.6.26/include/linux/atmdev.h"
...
# 11 "linux-2.6.26/net/sched/sch_atm.c" 2
# 1 "linux-2.6.26/include/linux/atmclip.h" 1
# 12 "linux-2.6.26/net/sched/sch_atm.c" 2

# 1 "linux-2.6.26/include/linux/file.h" 1
# 12 "linux-2.6.26/include/linux/file.h"
struct file;
...
# 14 "linux-2.6.26/net/sched/sch_atm.c" 2
...
typedef  struct Qdisc   _GLOBAL_198_T; extern  _GLOBAL_198_T  global_noop_qdisc[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_199_T; extern  _GLOBAL_199_T  global_noop_qdisc_ops[NUM_STACKS];    
...
typedef  struct Qdisc_ops   _GLOBAL_200_T; extern  _GLOBAL_200_T  global_pfifo_qdisc_ops[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_201_T; extern  _GLOBAL_201_T  global_bfifo_qdisc_ops[NUM_STACKS];    
...
# 16 "linux-2.6.26/net/sched/sch_atm.c" 2

extern struct socket *sockfd_lookup(int fd, int *err);
# 42 "linux-2.6.26/net/sched/sch_atm.c"
...
static int find_flow(struct atm_qdisc_data *qdisc, struct atm_flow_data *flow)
{
 ...
 ({ if (0) printk("<7>" "find_flow(qdisc %p,flow %p)\n", qdisc, flow); 0; });
 for (walk = qdisc->flows; walk; walk = walk->next)
  if (walk == flow)
   return 1;
 ({ if (0) printk("<7>" "find_flow: not found\n"); 0; });
 return 0;
}

static inline  __attribute__((always_inline)) struct atm_flow_data *lookup_flow(struct Qdisc *sch, u32 classid)
{
   ...
   struct Qdisc *new, struct Qdisc **old)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_graft(sch %p,[qdisc %p],flow %p,new %p,old %p)\n", sch, p, flow, new, old); 0; });
...
static struct Qdisc *atm_tc_leaf(struct Qdisc *sch, unsigned long cl)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_leaf(sch %p,flow %p)\n", sch, flow); 0; });
...
static unsigned long atm_tc_get(struct Qdisc *sch, u32 classid)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_get(sch %p,[qdisc %p],classid %x)\n", sch, p, classid); 0; });
 flow = lookup_flow(sch, classid);
 if (flow)
  flow->ref++;
 ({ if (0) printk("<7>" "atm_tc_get: flow %p\n", flow); 0; });
...
static void atm_tc_put(struct Qdisc *sch, unsigned long cl)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_put(sch %p,[qdisc %p],flow %p)\n", sch, p, flow); 0; });
 if (--flow->ref)
  return;
 ({ if (0) printk("<7>" "atm_tc_put: destroying\n"); 0; });
 ...
 *prev = flow->next;
 ({ if (0) printk("<7>" "atm_tc_put: qdisc %p\n", flow->q); 0; });
 qdisc_destroy(flow->q);
 tcf_destroy_chain(&flow->filter_list);
 if (flow->sock) {
  ({ if (0) printk("<7>" "atm_tc_put: f_count %d\n", ((&(flow->sock->file)->f_count)->counter)); 0; });
...
static void sch_atm_pop(struct atm_vcc *vcc, struct sk_buff *skb)
{
 ...
 ({ if (0) printk("<7>" "sch_atm_pop(vcc %p,skb %p,[qdisc %p])\n", vcc, skb, p); 0; });
 ((struct atm_flow_data *) ((vcc)->user_back))->old_pop(vcc, skb);
 tasklet_schedule(&p->task);
}

typedef  const u8   _GLOBAL_202_T; static  _GLOBAL_202_T  _GLOBAL_0_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_1_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_2_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_3_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_4_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_5_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_6_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_7_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_8_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_9_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_10_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_11_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_12_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_13_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_14_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_15_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_16_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_17_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_18_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_19_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_20_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_21_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_22_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_23_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_24_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_25_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_26_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_27_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_28_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_29_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_30_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_31_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_32_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_33_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_34_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_35_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_36_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_37_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_38_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_39_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_40_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_41_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_42_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_43_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_44_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_45_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_46_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_47_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_48_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static  _GLOBAL_202_T  _GLOBAL_49_llc_oui_ip_I [ ]  = { 0xaa , 0xaa  , 0x03  , 0x00  , 0x00  , 0x00  , 0x08  , 0x00  }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_llc_oui_ip_I) *_GLOBAL_llc_oui_ip_8_A[NUM_STACKS] = { &_GLOBAL_0_llc_oui_ip_I, &_GLOBAL_1_llc_oui_ip_I, &_GLOBAL_2_llc_oui_ip_I, &_GLOBAL_3_llc_oui_ip_I, &_GLOBAL_4_llc_oui_ip_I, &_GLOBAL_5_llc_oui_ip_I, &_GLOBAL_6_llc_oui_ip_I, &_GLOBAL_7_llc_oui_ip_I, &_GLOBAL_8_llc_oui_ip_I, &_GLOBAL_9_llc_oui_ip_I, &_GLOBAL_10_llc_oui_ip_I, &_GLOBAL_11_llc_oui_ip_I, &_GLOBAL_12_llc_oui_ip_I, &_GLOBAL_13_llc_oui_ip_I, &_GLOBAL_14_llc_oui_ip_I, &_GLOBAL_15_llc_oui_ip_I, &_GLOBAL_16_llc_oui_ip_I, &_GLOBAL_17_llc_oui_ip_I, &_GLOBAL_18_llc_oui_ip_I, &_GLOBAL_19_llc_oui_ip_I, &_GLOBAL_20_llc_oui_ip_I, &_GLOBAL_21_llc_oui_ip_I, &_GLOBAL_22_llc_oui_ip_I, &_GLOBAL_23_llc_oui_ip_I, &_GLOBAL_24_llc_oui_ip_I, &_GLOBAL_25_llc_oui_ip_I, &_GLOBAL_26_llc_oui_ip_I, &_GLOBAL_27_llc_oui_ip_I, &_GLOBAL_28_llc_oui_ip_I, &_GLOBAL_29_llc_oui_ip_I, &_GLOBAL_30_llc_oui_ip_I, &_GLOBAL_31_llc_oui_ip_I, &_GLOBAL_32_llc_oui_ip_I, &_GLOBAL_33_llc_oui_ip_I, &_GLOBAL_34_llc_oui_ip_I, &_GLOBAL_35_llc_oui_ip_I, &_GLOBAL_36_llc_oui_ip_I, &_GLOBAL_37_llc_oui_ip_I, &_GLOBAL_38_llc_oui_ip_I, &_GLOBAL_39_llc_oui_ip_I, &_GLOBAL_40_llc_oui_ip_I, &_GLOBAL_41_llc_oui_ip_I, &_GLOBAL_42_llc_oui_ip_I, &_GLOBAL_43_llc_oui_ip_I, &_GLOBAL_44_llc_oui_ip_I, &_GLOBAL_45_llc_oui_ip_I, &_GLOBAL_46_llc_oui_ip_I, &_GLOBAL_47_llc_oui_ip_I, &_GLOBAL_48_llc_oui_ip_I, &_GLOBAL_49_llc_oui_ip_I, };     
...
typedef  const struct nla_policy    _GLOBAL_203_T; static  _GLOBAL_203_T  _GLOBAL_0_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_1_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_2_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_3_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_4_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_5_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_6_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_7_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_8_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_9_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_10_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_11_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_12_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_13_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_14_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_15_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_16_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_17_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_18_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_19_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_20_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_21_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_22_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_23_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_24_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_25_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_26_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_27_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_28_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_29_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_30_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_31_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_32_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_33_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_34_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_35_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_36_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_37_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_38_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_39_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_40_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_41_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_42_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_43_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_44_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_45_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_46_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_47_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_48_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static  _GLOBAL_203_T  _GLOBAL_49_atm_policy_I [ ( __TCA_ATM_MAX - 1  )  + 1  ]  = { [ TCA_ATM_FD ] = { . type  = NLA_U32  }  , [ TCA_ATM_EXCESS ] = { . type  = NLA_U32  }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_atm_policy_I) *_GLOBAL_atm_policy_9_A[NUM_STACKS] = { &_GLOBAL_0_atm_policy_I, &_GLOBAL_1_atm_policy_I, &_GLOBAL_2_atm_policy_I, &_GLOBAL_3_atm_policy_I, &_GLOBAL_4_atm_policy_I, &_GLOBAL_5_atm_policy_I, &_GLOBAL_6_atm_policy_I, &_GLOBAL_7_atm_policy_I, &_GLOBAL_8_atm_policy_I, &_GLOBAL_9_atm_policy_I, &_GLOBAL_10_atm_policy_I, &_GLOBAL_11_atm_policy_I, &_GLOBAL_12_atm_policy_I, &_GLOBAL_13_atm_policy_I, &_GLOBAL_14_atm_policy_I, &_GLOBAL_15_atm_policy_I, &_GLOBAL_16_atm_policy_I, &_GLOBAL_17_atm_policy_I, &_GLOBAL_18_atm_policy_I, &_GLOBAL_19_atm_policy_I, &_GLOBAL_20_atm_policy_I, &_GLOBAL_21_atm_policy_I, &_GLOBAL_22_atm_policy_I, &_GLOBAL_23_atm_policy_I, &_GLOBAL_24_atm_policy_I, &_GLOBAL_25_atm_policy_I, &_GLOBAL_26_atm_policy_I, &_GLOBAL_27_atm_policy_I, &_GLOBAL_28_atm_policy_I, &_GLOBAL_29_atm_policy_I, &_GLOBAL_30_atm_policy_I, &_GLOBAL_31_atm_policy_I, &_GLOBAL_32_atm_policy_I, &_GLOBAL_33_atm_policy_I, &_GLOBAL_34_atm_policy_I, &_GLOBAL_35_atm_policy_I, &_GLOBAL_36_atm_policy_I, &_GLOBAL_37_atm_policy_I, &_GLOBAL_38_atm_policy_I, &_GLOBAL_39_atm_policy_I, &_GLOBAL_40_atm_policy_I, &_GLOBAL_41_atm_policy_I, &_GLOBAL_42_atm_policy_I, &_GLOBAL_43_atm_policy_I, &_GLOBAL_44_atm_policy_I, &_GLOBAL_45_atm_policy_I, &_GLOBAL_46_atm_policy_I, &_GLOBAL_47_atm_policy_I, &_GLOBAL_48_atm_policy_I, &_GLOBAL_49_atm_policy_I, };          
    ...
    struct nlattr **tca, unsigned long *arg)
{
 ...
 struct nlattr *tb[(__TCA_ATM_MAX - 1) + 1];
 struct socket *sock;
 int fd, error, hdr_len;
 void *hdr;

 ({ if (0) printk("<7>" "atm_tc_change(sch %p,[qdisc %p],classid %x,parent %x," "flow %p,opt %p)\n", sch, p, classid, parent, flow, opt); 0; });
 ...
 error = nla_parse_nested(tb, (__TCA_ATM_MAX - 1), opt, (*_GLOBAL_atm_policy_9_A[get_stack_id()]));
 if (error < 0)
  return error;
 ...
 ({ if (0) printk("<7>" "atm_tc_change: fd %d\n", fd); 0; });
 if (tb[TCA_ATM_HDR]) {
 ...
 ({ if (0) printk("<7>" "atm_tc_change: type %d, payload %d, hdr_len %d\n", opt->nla_type, nla_len(opt), hdr_len); 0; });

 sock = sockfd_lookup(fd, &error);
 if (!sock)
  return error;
 ({ if (0) printk("<7>" "atm_tc_change: f_count %d\n", ((&(sock->file)->f_count)->counter)); 0; });
 ...
 if (classid) {
  if (((classid ^ sch->handle)&(0xFFFF0000U))) {
   ({ if (0) printk("<7>" "atm_tc_change: classid mismatch\n"); 0; });
   error = -22;
   goto err_out;
  }
  if (find_flow(p, flow)) {
 ...
 ({ if (0) printk("<7>" "atm_tc_change: new id %x\n", classid); 0; });
 flow = kzalloc(sizeof(struct atm_flow_data) + hdr_len, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 ({ if (0) printk("<7>" "atm_tc_change: flow %p\n", flow); 0; });
 if (!flow) {
  error = -105;
  goto err_out;
 }
 flow->filter_list = ((void *)0);
 flow->q = qdisc_create_dflt(sch->dev, &global_pfifo_qdisc_ops[get_stack_id()], classid);
 if (!flow->q)
  flow->q = &global_noop_qdisc[get_stack_id()];
 ({ if (0) printk("<7>" "atm_tc_change: qdisc %p\n", flow->q); 0; });
 flow->sock = sock;
 flow->vcc = ATM_SD(sock);
 flow->vcc->user_back = flow;
 ({ if (0) printk("<7>" "atm_tc_change: vcc %p\n", flow->vcc); 0; });
 ...
 if (hdr)
  ...
  (__builtin_constant_p(sizeof((*_GLOBAL_llc_oui_ip_8_A[get_stack_id()]))) ? __constant_memcpy((flow->hdr),((*_GLOBAL_llc_oui_ip_8_A[get_stack_id()])),(sizeof((*_GLOBAL_llc_oui_ip_8_A[get_stack_id()])))) : __memcpy((flow->hdr),((*_GLOBAL_llc_oui_ip_8_A[get_stack_id()])),(sizeof((*_GLOBAL_llc_oui_ip_8_A[get_stack_id()])))));
...
static int atm_tc_delete(struct Qdisc *sch, unsigned long arg)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_delete(sch %p,[qdisc %p],flow %p)\n", sch, p, flow); 0; });
...
static void atm_tc_walk(struct Qdisc *sch, struct qdisc_walker *walker)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_walk(sch %p,[qdisc %p],walker %p)\n", sch, p, walker); 0; });
 if (walker->stop)
  return;
 for (flow = p->flows; flow; flow = flow->next) {
...
static struct tcf_proto **atm_tc_find_tcf(struct Qdisc *sch, unsigned long cl)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_find_tcf(sch %p,[qdisc %p],flow %p)\n", sch, p, flow); 0; });
...
static int atm_tc_enqueue(struct sk_buff *skb, struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_enqueue(skb %p,sch %p,[qdisc %p])\n", skb, sch, p); 0; });
 result = 0;
...
# 429 "linux-2.6.26/net/sched/sch_atm.c"
 }

 ret = flow->q->enqueue(skb, flow->q);
 if (ret != 0) {
drop: 
  __attribute__((unused)) sch->qstats.drops++;
  if (flow)
   flow->qstats.drops++;
  return ret;
 }
 ...
 flow->bstats.packets++;
# 452 "linux-2.6.26/net/sched/sch_atm.c"
 if (flow == &p->link) {
  sch->q.qlen++;
  return 0;
 }
...
# 467 "linux-2.6.26/net/sched/sch_atm.c"
static void sch_atm_dequeue(unsigned long data)
{
 ...
 ({ if (0) printk("<7>" "sch_atm_dequeue(sch %p,[qdisc %p])\n", sch, p); 0; });
 for (flow = p->link.next; flow; flow = flow->next)
  ...
  while ((skb = flow->q->dequeue(flow->q))) {
   ...
   ({ if (0) printk("<7>" "atm_tc_dequeue: sending on class %p\n", flow); 0; });
   ...
   ({ if (0) printk("<7>" "sch_atm_dequeue: ip %p, data %p\n", skb_network_header(skb), skb->data); 0; });
...
static struct sk_buff *atm_tc_dequeue(struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_dequeue(sch %p,[qdisc %p])\n", sch, p); 0; });
 tasklet_schedule(&p->task);
...
static int atm_tc_requeue(struct sk_buff *skb, struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_requeue(skb %p,sch %p,[qdisc %p])\n", skb, sch, p); 0; });
...
static unsigned int atm_tc_drop(struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_drop(sch %p,[qdisc %p])\n", sch, p); 0; });
 for (flow = p->flows; flow; flow = flow->next)
...
static int atm_tc_init(struct Qdisc *sch, struct nlattr *opt)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_init(sch %p,[qdisc %p],opt %p)\n", sch, p, opt); 0; });
 p->flows = &p->link;
 p->link.q = qdisc_create_dflt(sch->dev, &global_pfifo_qdisc_ops[get_stack_id()], sch->handle);
 if (!p->link.q)
  p->link.q = &global_noop_qdisc[get_stack_id()];
 ({ if (0) printk("<7>" "atm_tc_init: link (%p) qdisc %p\n", &p->link, p->link.q); 0; });
...
static void atm_tc_reset(struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_reset(sch %p,[qdisc %p])\n", sch, p); 0; });
 for (flow = p->flows; flow; flow = flow->next)
  qdisc_reset(flow->q);
 sch->q.qlen = 0;
}
...
static void atm_tc_destroy(struct Qdisc *sch)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_destroy(sch %p,[qdisc %p])\n", sch, p); 0; });
 for (flow = p->flows; flow; flow = flow->next)
  tcf_destroy_chain(&flow->filter_list);
        ...
        struct sk_buff *skb, struct tcmsg *tcm)
{
 ...
 ({ if (0) printk("<7>" "atm_tc_dump_class(sch %p,[qdisc %p],flow %p,skb %p,tcm %p)\n", sch, p, flow, skb, tcm); 0; });
 ...
 do { if (__builtin_expect(!!(nla_put(skb, TCA_ATM_HDR, flow->hdr_len, flow->hdr) < 0), 0)) goto nla_put_failure; } while(0);
 if (flow->vcc) {
  ...
  do { if (__builtin_expect(!!(nla_put(skb, TCA_ATM_ADDR, sizeof(pvc), &pvc) < 0), 0)) goto nla_put_failure; } while(0);
  ...
  do { u32 __tmp = state; do { if (__builtin_expect(!!(nla_put(skb, TCA_ATM_STATE, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
 }
 if (flow->excess)
  do { u32 __tmp = flow->classid; do { if (__builtin_expect(!!(nla_put(skb, TCA_ATM_EXCESS, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
 else {
  do { u32 __tmp = 0; do { if (__builtin_expect(!!(nla_put(skb, TCA_ATM_EXCESS, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
 }
...
typedef  struct Qdisc_ops   _GLOBAL_205_T; static  _GLOBAL_205_T  global_atm_qdisc_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . cl_ops  = & global_atm_class_ops[0]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[1]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[2]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[3]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[4]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[5]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[6]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[7]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[8]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[9]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[10]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[11]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[12]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[13]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[14]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[15]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[16]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[17]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[18]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[19]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[20]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[21]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[22]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[23]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[24]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[25]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[26]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[27]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[28]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[29]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[30]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[31]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[32]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[33]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[34]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[35]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[36]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[37]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[38]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[39]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[40]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[41]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[42]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[43]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[44]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[45]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[46]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[47]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[48]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_atm_class_ops[49]   , . id  = "atm"   , . priv_size  = sizeof ( struct atm_qdisc_data  )    , . enqueue  = atm_tc_enqueue   , . dequeue  = atm_tc_dequeue   , . requeue  = atm_tc_requeue   , . drop  = atm_tc_drop   , . init  = atm_tc_init   , . reset  = atm_tc_reset   , . destroy  = atm_tc_destroy   , . dump  = atm_tc_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
