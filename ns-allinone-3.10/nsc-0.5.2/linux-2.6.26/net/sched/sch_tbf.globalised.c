# 1 "linux-2.6.26/net/sched/sch_tbf.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/sch_tbf.c"
# 15 "linux-2.6.26/net/sched/sch_tbf.c"
...
{ }
# 16 "linux-2.6.26/net/sched/sch_tbf.c" 2
...
# 21 "linux-2.6.26/net/sched/sch_tbf.c" 2
...
# 22 "linux-2.6.26/net/sched/sch_tbf.c" 2
...
# 23 "linux-2.6.26/net/sched/sch_tbf.c" 2
# 100 "linux-2.6.26/net/sched/sch_tbf.c"
...
static struct sk_buff *tbf_dequeue(struct Qdisc* sch)
{
 ...
 if (skb) {
  ...
  if (q->P_tab) {
   ...
   if (ptoks > (long)q->mtu)
    ptoks = q->mtu;
   ptoks -= qdisc_l2t((q)->P_tab,len);
  }
  toks += q->tokens;
  if (toks > (long)q->buffer)
   toks = q->buffer;
  toks -= qdisc_l2t((q)->R_tab,len);
  ...
  qdisc_watchdog_schedule(&q->watchdog,
     now + ({ long __max1 = (-toks); long __max2 = (-ptoks); __max1 > __max2 ? __max1: __max2; }));
# 222 "linux-2.6.26/net/sched/sch_tbf.c"
...
typedef  const struct nla_policy    _GLOBAL_149_T; static  _GLOBAL_149_T  _GLOBAL_0_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_1_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_2_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_3_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_4_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_5_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_6_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_7_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_8_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_9_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_10_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_11_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_12_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_13_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_14_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_15_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_16_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_17_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_18_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_19_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_20_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_21_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_22_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_23_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_24_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_25_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_26_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_27_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_28_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_29_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_30_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_31_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_32_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_33_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_34_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_35_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_36_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_37_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_38_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_39_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_40_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_41_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_42_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_43_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_44_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_45_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_46_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_47_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_48_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static  _GLOBAL_149_T  _GLOBAL_49_tbf_policy_I [ ( __TCA_TBF_MAX - 1  )  + 1  ]  = { [ TCA_TBF_PARMS ] = { . len  = sizeof ( struct tc_tbf_qopt  )   }  , [ TCA_TBF_RTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , [ TCA_TBF_PTAB ] = { . type  = NLA_BINARY  , . len  = 1024   }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_tbf_policy_I) *_GLOBAL_tbf_policy_8_A[NUM_STACKS] = { &_GLOBAL_0_tbf_policy_I, &_GLOBAL_1_tbf_policy_I, &_GLOBAL_2_tbf_policy_I, &_GLOBAL_3_tbf_policy_I, &_GLOBAL_4_tbf_policy_I, &_GLOBAL_5_tbf_policy_I, &_GLOBAL_6_tbf_policy_I, &_GLOBAL_7_tbf_policy_I, &_GLOBAL_8_tbf_policy_I, &_GLOBAL_9_tbf_policy_I, &_GLOBAL_10_tbf_policy_I, &_GLOBAL_11_tbf_policy_I, &_GLOBAL_12_tbf_policy_I, &_GLOBAL_13_tbf_policy_I, &_GLOBAL_14_tbf_policy_I, &_GLOBAL_15_tbf_policy_I, &_GLOBAL_16_tbf_policy_I, &_GLOBAL_17_tbf_policy_I, &_GLOBAL_18_tbf_policy_I, &_GLOBAL_19_tbf_policy_I, &_GLOBAL_20_tbf_policy_I, &_GLOBAL_21_tbf_policy_I, &_GLOBAL_22_tbf_policy_I, &_GLOBAL_23_tbf_policy_I, &_GLOBAL_24_tbf_policy_I, &_GLOBAL_25_tbf_policy_I, &_GLOBAL_26_tbf_policy_I, &_GLOBAL_27_tbf_policy_I, &_GLOBAL_28_tbf_policy_I, &_GLOBAL_29_tbf_policy_I, &_GLOBAL_30_tbf_policy_I, &_GLOBAL_31_tbf_policy_I, &_GLOBAL_32_tbf_policy_I, &_GLOBAL_33_tbf_policy_I, &_GLOBAL_34_tbf_policy_I, &_GLOBAL_35_tbf_policy_I, &_GLOBAL_36_tbf_policy_I, &_GLOBAL_37_tbf_policy_I, &_GLOBAL_38_tbf_policy_I, &_GLOBAL_39_tbf_policy_I, &_GLOBAL_40_tbf_policy_I, &_GLOBAL_41_tbf_policy_I, &_GLOBAL_42_tbf_policy_I, &_GLOBAL_43_tbf_policy_I, &_GLOBAL_44_tbf_policy_I, &_GLOBAL_45_tbf_policy_I, &_GLOBAL_46_tbf_policy_I, &_GLOBAL_47_tbf_policy_I, &_GLOBAL_48_tbf_policy_I, &_GLOBAL_49_tbf_policy_I, };          
...
static int tbf_change(struct Qdisc* sch, struct nlattr *opt)
{
 ...
 err = nla_parse_nested(tb, TCA_TBF_PTAB, opt, (*_GLOBAL_tbf_policy_8_A[get_stack_id()]));
 if (err < 0)
  return err;
 ...
 if (qopt->limit > 0) {
  if ((child = tbf_create_dflt_qdisc(sch, qopt->limit)) == ((void *)0))
   goto done;
 }
...
static int tbf_dump(struct Qdisc *sch, struct sk_buff *skb)
{
 ...
 opt.mtu = q->mtu;
 opt.buffer = q->buffer;
 do { if (__builtin_expect(!!(nla_put(skb, TCA_TBF_PARMS, sizeof(opt), &opt) < 0), 0)) goto nla_put_failure; } while(0);
...
typedef  const struct Qdisc_class_ops    _GLOBAL_150_T; static  _GLOBAL_150_T  global_tbf_class_ops[NUM_STACKS] = {  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  };      
