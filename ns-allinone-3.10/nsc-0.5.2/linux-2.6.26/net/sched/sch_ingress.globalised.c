# 1 "linux-2.6.26/net/sched/sch_ingress.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/sch_ingress.c"
# 10 "linux-2.6.26/net/sched/sch_ingress.c"
...
{ }
# 11 "linux-2.6.26/net/sched/sch_ingress.c" 2
...
# 14 "linux-2.6.26/net/sched/sch_ingress.c" 2
...
# 15 "linux-2.6.26/net/sched/sch_ingress.c" 2
...
# 16 "linux-2.6.26/net/sched/sch_ingress.c" 2
...
# 17 "linux-2.6.26/net/sched/sch_ingress.c" 2
...
typedef  const struct Qdisc_class_ops    _GLOBAL_149_T; static  _GLOBAL_149_T  global_ingress_class_ops[NUM_STACKS] = {  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  { . graft  = ingress_graft  , . leaf  = ingress_leaf   , . get  = ingress_get   , . put  = ingress_put   , . change  = ingress_change   , . walk  = ingress_walk   , . tcf_chain  = ingress_find_tcf   , . bind_tcf  = ingress_bind_filter   , . unbind_tcf  = ingress_put   , } ,  };       
...
typedef  struct Qdisc_ops   _GLOBAL_150_T; static  _GLOBAL_150_T  global_ingress_qdisc_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . cl_ops  = & global_ingress_class_ops[0]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[1]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[2]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[3]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[4]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[5]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[6]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[7]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[8]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[9]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[10]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[11]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[12]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[13]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[14]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[15]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[16]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[17]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[18]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[19]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[20]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[21]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[22]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[23]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[24]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[25]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[26]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[27]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[28]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[29]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[30]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[31]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[32]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[33]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[34]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[35]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[36]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[37]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[38]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[39]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[40]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[41]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[42]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[43]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[44]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[45]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[46]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[47]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[48]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . cl_ops  = & global_ingress_class_ops[49]   , . id  = "ingress"   , . priv_size  = sizeof ( struct ingress_qdisc_data  )    , . enqueue  = ingress_enqueue   , . destroy  = ingress_destroy   , . dump  = ingress_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) ingress_module_init(void)
{
 return register_qdisc(&global_ingress_qdisc_ops[get_stack_id()]);
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) ingress_module_exit(void)
{
 unregister_qdisc(&global_ingress_qdisc_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_151_T; static  _GLOBAL_151_T  __initcall_ingress_module_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = ingress_module_init ;       
typedef  exitcall_t  _GLOBAL_152_T; static  _GLOBAL_152_T  global___exitcall_ingress_module_exit[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  ingress_module_exit,  };       
;
