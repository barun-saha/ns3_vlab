# 1 "linux-2.6.26/net/sched/cls_rsvp6.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/cls_rsvp6.c"
# 12 "linux-2.6.26/net/sched/cls_rsvp6.c"
...
{ }
# 13 "linux-2.6.26/net/sched/cls_rsvp6.c" 2
...
# 18 "linux-2.6.26/net/sched/cls_rsvp6.c" 2
...
typedef  struct Qdisc   _GLOBAL_204_T; extern  _GLOBAL_204_T  global_noop_qdisc[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_205_T; extern  _GLOBAL_205_T  global_noop_qdisc_ops[NUM_STACKS];    
...
typedef  struct Qdisc_ops   _GLOBAL_206_T; extern  _GLOBAL_206_T  global_pfifo_qdisc_ops[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_207_T; extern  _GLOBAL_207_T  global_bfifo_qdisc_ops[NUM_STACKS];    
...
# 20 "linux-2.6.26/net/sched/cls_rsvp6.c" 2
...
# 21 "linux-2.6.26/net/sched/cls_rsvp6.c" 2
...
typedef  struct tcf_ext_map   _GLOBAL_208_T; static  _GLOBAL_208_T  global_rsvp_ext_map[NUM_STACKS] = {  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  };      
...
# 167 "linux-2.6.26/net/sched/cls_rsvp.h"
...
typedef  const struct nla_policy    _GLOBAL_209_T; static  _GLOBAL_209_T  _GLOBAL_0_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_1_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_2_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_3_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_4_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_5_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_6_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_7_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_8_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_9_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_10_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_11_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_12_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_13_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_14_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_15_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_16_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_17_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_18_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_19_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_20_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_21_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_22_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_23_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_24_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_25_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_26_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_27_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_28_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_29_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_30_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_31_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_32_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_33_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_34_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_35_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_36_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_37_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_38_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_39_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_40_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_41_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_42_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_43_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_44_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_45_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_46_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_47_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_48_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static  _GLOBAL_209_T  _GLOBAL_49_rsvp_policy_I [ ( __TCA_RSVP_MAX - 1  )  + 1  ]  = { [ TCA_RSVP_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_RSVP_DST ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_SRC ] = { . type  = NLA_BINARY  , . len  = 4 * sizeof ( u32 )     }   , [ TCA_RSVP_PINFO ] = { . len  = sizeof ( struct tc_rsvp_pinfo  )   }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_rsvp_policy_I) *_GLOBAL_rsvp_policy_11_A[NUM_STACKS] = { &_GLOBAL_0_rsvp_policy_I, &_GLOBAL_1_rsvp_policy_I, &_GLOBAL_2_rsvp_policy_I, &_GLOBAL_3_rsvp_policy_I, &_GLOBAL_4_rsvp_policy_I, &_GLOBAL_5_rsvp_policy_I, &_GLOBAL_6_rsvp_policy_I, &_GLOBAL_7_rsvp_policy_I, &_GLOBAL_8_rsvp_policy_I, &_GLOBAL_9_rsvp_policy_I, &_GLOBAL_10_rsvp_policy_I, &_GLOBAL_11_rsvp_policy_I, &_GLOBAL_12_rsvp_policy_I, &_GLOBAL_13_rsvp_policy_I, &_GLOBAL_14_rsvp_policy_I, &_GLOBAL_15_rsvp_policy_I, &_GLOBAL_16_rsvp_policy_I, &_GLOBAL_17_rsvp_policy_I, &_GLOBAL_18_rsvp_policy_I, &_GLOBAL_19_rsvp_policy_I, &_GLOBAL_20_rsvp_policy_I, &_GLOBAL_21_rsvp_policy_I, &_GLOBAL_22_rsvp_policy_I, &_GLOBAL_23_rsvp_policy_I, &_GLOBAL_24_rsvp_policy_I, &_GLOBAL_25_rsvp_policy_I, &_GLOBAL_26_rsvp_policy_I, &_GLOBAL_27_rsvp_policy_I, &_GLOBAL_28_rsvp_policy_I, &_GLOBAL_29_rsvp_policy_I, &_GLOBAL_30_rsvp_policy_I, &_GLOBAL_31_rsvp_policy_I, &_GLOBAL_32_rsvp_policy_I, &_GLOBAL_33_rsvp_policy_I, &_GLOBAL_34_rsvp_policy_I, &_GLOBAL_35_rsvp_policy_I, &_GLOBAL_36_rsvp_policy_I, &_GLOBAL_37_rsvp_policy_I, &_GLOBAL_38_rsvp_policy_I, &_GLOBAL_39_rsvp_policy_I, &_GLOBAL_40_rsvp_policy_I, &_GLOBAL_41_rsvp_policy_I, &_GLOBAL_42_rsvp_policy_I, &_GLOBAL_43_rsvp_policy_I, &_GLOBAL_44_rsvp_policy_I, &_GLOBAL_45_rsvp_policy_I, &_GLOBAL_46_rsvp_policy_I, &_GLOBAL_47_rsvp_policy_I, &_GLOBAL_48_rsvp_policy_I, &_GLOBAL_49_rsvp_policy_I, };           
         ...
         unsigned long *arg)
{
 ...
 err = nla_parse_nested(tb, (__TCA_RSVP_MAX - 1 ), opt, (*_GLOBAL_rsvp_policy_11_A[get_stack_id()]));
 if (err < 0)
  return err;
...
typedef  initcall_t  _GLOBAL_211_T; static  _GLOBAL_211_T  __initcall_init_rsvp6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = init_rsvp ;       
typedef  exitcall_t  _GLOBAL_212_T; static  _GLOBAL_212_T  global___exitcall_exit_rsvp[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  };       
# 28 "linux-2.6.26/net/sched/cls_rsvp6.c" 2
;
