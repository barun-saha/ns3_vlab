# 1 "linux-2.6.26/net/sched/cls_u32.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/sched/cls_u32.c"
# 33 "linux-2.6.26/net/sched/cls_u32.c"
...
{ }
# 34 "linux-2.6.26/net/sched/cls_u32.c" 2
...
# 39 "linux-2.6.26/net/sched/cls_u32.c" 2
...
# 41 "linux-2.6.26/net/sched/cls_u32.c" 2
...
# 42 "linux-2.6.26/net/sched/cls_u32.c" 2
...
# 43 "linux-2.6.26/net/sched/cls_u32.c" 2
...
typedef  const struct tcf_ext_map    _GLOBAL_149_T; static  _GLOBAL_149_T  global_u32_ext_map[NUM_STACKS] = {  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  { . action  = TCA_U32_ACT  , . police  = TCA_U32_POLICE   } ,  };       
   
   


typedef  struct tc_u_common   _GLOBAL_150_T; static  _GLOBAL_150_T  * global_u32_list[NUM_STACKS];    

static __inline__  __attribute__((always_inline)) unsigned u32_hash_fold(__be32 key, struct tc_u32_sel *sel, u8 fshift)
{
 unsigned h = __fswab32(( __u32)(__be32)(key & sel->hmask))>>fshift;
...
# 138 "linux-2.6.26/net/sched/cls_u32.c"
...
check_terminal:
    ...
    *res = n->res;
# 163 "linux-2.6.26/net/sched/cls_u32.c"
  ...
  if (n->sel.flags&(2|4)) {
   off2 = n->sel.off + 3;
   if (n->sel.flags&4)
    off2 += __fswab16(( __u16)(__be16)(n->sel.offmask & *(__be16*)(ptr+n->sel.offoff))) >>n->sel.offshift;
   off2 &= ~3;
  }
  if (n->sel.flags&8) {
   ptr += off2;
...
static int u32_destroy_hnode(struct tcf_proto *tp, struct tc_u_hnode *ht)
{
 ...
 do { if (__builtin_expect(!!(!(0)), 0)) { printk("<3>" "KERNEL: assertion (%s) failed at %s (%d)\n", "0", "linux-2.6.26/net/sched/cls_u32.c" , 389); } } while(0);
 return -2;
}
...
typedef  const struct nla_policy    _GLOBAL_151_T; static  _GLOBAL_151_T  _GLOBAL_0_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_1_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_2_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_3_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_4_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_5_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_6_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_7_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_8_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_9_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_10_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_11_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_12_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_13_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_14_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_15_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_16_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_17_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_18_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_19_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_20_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_21_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_22_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_23_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_24_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_25_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_26_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_27_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_28_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_29_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_30_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_31_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_32_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_33_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_34_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_35_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_36_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_37_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_38_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_39_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_40_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_41_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_42_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_43_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_44_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_45_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_46_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_47_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_48_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static  _GLOBAL_151_T  _GLOBAL_49_u32_policy_I [ ( __TCA_U32_MAX - 1  )  + 1  ]  = { [ TCA_U32_CLASSID ] = { . type  = NLA_U32  }  , [ TCA_U32_HASH ] = { . type  = NLA_U32  }   , [ TCA_U32_LINK ] = { . type  = NLA_U32  }   , [ TCA_U32_DIVISOR ] = { . type  = NLA_U32  }   , [ TCA_U32_SEL ] = { . len  = sizeof ( struct tc_u32_sel  )   }   , [ TCA_U32_INDEV ] = { . type  = NLA_STRING  , . len  = 16   }   , [ TCA_U32_MARK ] = { . len  = sizeof ( struct tc_u32_mark  )   }   , }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_u32_policy_I) *_GLOBAL_u32_policy_8_A[NUM_STACKS] = { &_GLOBAL_0_u32_policy_I, &_GLOBAL_1_u32_policy_I, &_GLOBAL_2_u32_policy_I, &_GLOBAL_3_u32_policy_I, &_GLOBAL_4_u32_policy_I, &_GLOBAL_5_u32_policy_I, &_GLOBAL_6_u32_policy_I, &_GLOBAL_7_u32_policy_I, &_GLOBAL_8_u32_policy_I, &_GLOBAL_9_u32_policy_I, &_GLOBAL_10_u32_policy_I, &_GLOBAL_11_u32_policy_I, &_GLOBAL_12_u32_policy_I, &_GLOBAL_13_u32_policy_I, &_GLOBAL_14_u32_policy_I, &_GLOBAL_15_u32_policy_I, &_GLOBAL_16_u32_policy_I, &_GLOBAL_17_u32_policy_I, &_GLOBAL_18_u32_policy_I, &_GLOBAL_19_u32_policy_I, &_GLOBAL_20_u32_policy_I, &_GLOBAL_21_u32_policy_I, &_GLOBAL_22_u32_policy_I, &_GLOBAL_23_u32_policy_I, &_GLOBAL_24_u32_policy_I, &_GLOBAL_25_u32_policy_I, &_GLOBAL_26_u32_policy_I, &_GLOBAL_27_u32_policy_I, &_GLOBAL_28_u32_policy_I, &_GLOBAL_29_u32_policy_I, &_GLOBAL_30_u32_policy_I, &_GLOBAL_31_u32_policy_I, &_GLOBAL_32_u32_policy_I, &_GLOBAL_33_u32_policy_I, &_GLOBAL_34_u32_policy_I, &_GLOBAL_35_u32_policy_I, &_GLOBAL_36_u32_policy_I, &_GLOBAL_37_u32_policy_I, &_GLOBAL_38_u32_policy_I, &_GLOBAL_39_u32_policy_I, &_GLOBAL_40_u32_policy_I, &_GLOBAL_41_u32_policy_I, &_GLOBAL_42_u32_policy_I, &_GLOBAL_43_u32_policy_I, &_GLOBAL_44_u32_policy_I, &_GLOBAL_45_u32_policy_I, &_GLOBAL_46_u32_policy_I, &_GLOBAL_47_u32_policy_I, &_GLOBAL_48_u32_policy_I, &_GLOBAL_49_u32_policy_I, };          
...
# 526 "linux-2.6.26/net/sched/cls_u32.c"
        ...
        unsigned long *arg)
{
 ...
 struct nlattr *tb[(__TCA_U32_MAX - 1) + 1];
 u32 htid;
 int err;
 ...
 err = nla_parse_nested(tb, (__TCA_U32_MAX - 1), opt, (*_GLOBAL_u32_policy_8_A[get_stack_id()]));
 if (err < 0)
  return err;
 ...
 if (n == ((void *)0))
  return -105;
# 629 "linux-2.6.26/net/sched/cls_u32.c"
 ...
 n->ht_up = ht;
 n->handle = handle;
 n->fshift = s->hmask ? ffs(__fswab32(( __u32)(__be32)(s->hmask))) - 1 : 0;
# 644 "linux-2.6.26/net/sched/cls_u32.c"
       ...
       struct sk_buff *skb, struct tcmsg *t)
{
 ...
 if (((n->handle)&0xFFFFF) == 0) {
  ...
  do { u32 __tmp = divisor; do { if (__builtin_expect(!!(nla_put(skb, TCA_U32_DIVISOR, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
 } else {
  do { if (__builtin_expect(!!(nla_put(skb, TCA_U32_SEL, sizeof(n->sel) + n->sel.nkeys*sizeof(struct tc_u32_key), &n->sel) < 0), 0)) goto nla_put_failure; } while(0);


  if (n->ht_up) {
   u32 htid = n->handle & 0xFFFFF000;
   do { u32 __tmp = htid; do { if (__builtin_expect(!!(nla_put(skb, TCA_U32_HASH, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
  }
  if (n->res.classid)
   do { u32 __tmp = n->res.classid; do { if (__builtin_expect(!!(nla_put(skb, TCA_U32_CLASSID, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
  if (n->ht_down)
   do { u32 __tmp = n->ht_down->handle; do { if (__builtin_expect(!!(nla_put(skb, TCA_U32_LINK, sizeof(u32), &__tmp) < 0), 0)) goto nla_put_failure; } while(0); } while(0);
  ...
  if (tcf_exts_dump(skb, &n->exts, &global_u32_ext_map[get_stack_id()]) < 0)
   goto nla_put_failure;
# 750 "linux-2.6.26/net/sched/cls_u32.c"
 }
...
typedef  struct tcf_proto_ops   _GLOBAL_152_T; static  _GLOBAL_152_T  global_cls_u32_ops[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))   = {  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . kind  = "u32"  , . classify  = u32_classify   , . init  = u32_init   , . destroy  = u32_destroy   , . get  = u32_get   , . put  = u32_put   , . change  = u32_change   , . delete  = u32_delete   , . walk  = u32_walk   , . dump  = u32_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };       
