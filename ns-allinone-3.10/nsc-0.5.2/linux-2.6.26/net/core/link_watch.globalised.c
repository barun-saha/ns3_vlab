# 1 "linux-2.6.26/net/core/link_watch.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/core/link_watch.c"
# 14 "linux-2.6.26/net/core/link_watch.c"
...
{ }
# 15 "linux-2.6.26/net/core/link_watch.c" 2
...
# 16 "linux-2.6.26/net/core/link_watch.c" 2
...
# 18 "linux-2.6.26/net/core/link_watch.c" 2
...
typedef  struct Qdisc   _GLOBAL_197_T; extern  _GLOBAL_197_T  global_noop_qdisc[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_198_T; extern  _GLOBAL_198_T  global_noop_qdisc_ops[NUM_STACKS];    
...
typedef  struct Qdisc_ops   _GLOBAL_199_T; extern  _GLOBAL_199_T  global_pfifo_qdisc_ops[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_200_T; extern  _GLOBAL_200_T  global_bfifo_qdisc_ops[NUM_STACKS];    
...
# 19 "linux-2.6.26/net/core/link_watch.c" 2
# 28 "linux-2.6.26/net/core/link_watch.c"
enum lw_bits {
 LW_URGENT = 0,
};

typedef  unsigned long   _GLOBAL_201_T; static  _GLOBAL_201_T  global_linkwatch_flags[NUM_STACKS];    
typedef  unsigned long   _GLOBAL_202_T; static  _GLOBAL_202_T  global_linkwatch_nextevent[NUM_STACKS];    

static void linkwatch_event(struct work_struct *dummy);
typedef  struct delayed_work   _GLOBAL_203_T; static  _GLOBAL_203_T  global_linkwatch_work[NUM_STACKS] = {  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[0] )  . work  )  . entry   , & ( ( global_linkwatch_work[0] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_0_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[1] )  . work  )  . entry   , & ( ( global_linkwatch_work[1] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_1_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[2] )  . work  )  . entry   , & ( ( global_linkwatch_work[2] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_2_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[3] )  . work  )  . entry   , & ( ( global_linkwatch_work[3] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_3_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[4] )  . work  )  . entry   , & ( ( global_linkwatch_work[4] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_4_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[5] )  . work  )  . entry   , & ( ( global_linkwatch_work[5] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_5_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[6] )  . work  )  . entry   , & ( ( global_linkwatch_work[6] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_6_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[7] )  . work  )  . entry   , & ( ( global_linkwatch_work[7] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_7_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[8] )  . work  )  . entry   , & ( ( global_linkwatch_work[8] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_8_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[9] )  . work  )  . entry   , & ( ( global_linkwatch_work[9] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_9_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[10] )  . work  )  . entry   , & ( ( global_linkwatch_work[10] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_10_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[11] )  . work  )  . entry   , & ( ( global_linkwatch_work[11] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_11_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[12] )  . work  )  . entry   , & ( ( global_linkwatch_work[12] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_12_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[13] )  . work  )  . entry   , & ( ( global_linkwatch_work[13] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_13_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[14] )  . work  )  . entry   , & ( ( global_linkwatch_work[14] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_14_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[15] )  . work  )  . entry   , & ( ( global_linkwatch_work[15] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_15_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[16] )  . work  )  . entry   , & ( ( global_linkwatch_work[16] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_16_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[17] )  . work  )  . entry   , & ( ( global_linkwatch_work[17] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_17_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[18] )  . work  )  . entry   , & ( ( global_linkwatch_work[18] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_18_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[19] )  . work  )  . entry   , & ( ( global_linkwatch_work[19] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_19_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[20] )  . work  )  . entry   , & ( ( global_linkwatch_work[20] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_20_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[21] )  . work  )  . entry   , & ( ( global_linkwatch_work[21] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_21_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[22] )  . work  )  . entry   , & ( ( global_linkwatch_work[22] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_22_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[23] )  . work  )  . entry   , & ( ( global_linkwatch_work[23] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_23_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[24] )  . work  )  . entry   , & ( ( global_linkwatch_work[24] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_24_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[25] )  . work  )  . entry   , & ( ( global_linkwatch_work[25] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_25_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[26] )  . work  )  . entry   , & ( ( global_linkwatch_work[26] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_26_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[27] )  . work  )  . entry   , & ( ( global_linkwatch_work[27] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_27_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[28] )  . work  )  . entry   , & ( ( global_linkwatch_work[28] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_28_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[29] )  . work  )  . entry   , & ( ( global_linkwatch_work[29] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_29_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[30] )  . work  )  . entry   , & ( ( global_linkwatch_work[30] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_30_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[31] )  . work  )  . entry   , & ( ( global_linkwatch_work[31] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_31_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[32] )  . work  )  . entry   , & ( ( global_linkwatch_work[32] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_32_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[33] )  . work  )  . entry   , & ( ( global_linkwatch_work[33] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_33_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[34] )  . work  )  . entry   , & ( ( global_linkwatch_work[34] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_34_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[35] )  . work  )  . entry   , & ( ( global_linkwatch_work[35] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_35_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[36] )  . work  )  . entry   , & ( ( global_linkwatch_work[36] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_36_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[37] )  . work  )  . entry   , & ( ( global_linkwatch_work[37] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_37_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[38] )  . work  )  . entry   , & ( ( global_linkwatch_work[38] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_38_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[39] )  . work  )  . entry   , & ( ( global_linkwatch_work[39] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_39_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[40] )  . work  )  . entry   , & ( ( global_linkwatch_work[40] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_40_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[41] )  . work  )  . entry   , & ( ( global_linkwatch_work[41] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_41_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[42] )  . work  )  . entry   , & ( ( global_linkwatch_work[42] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_42_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[43] )  . work  )  . entry   , & ( ( global_linkwatch_work[43] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_43_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[44] )  . work  )  . entry   , & ( ( global_linkwatch_work[44] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_44_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[45] )  . work  )  . entry   , & ( ( global_linkwatch_work[45] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_45_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[46] )  . work  )  . entry   , & ( ( global_linkwatch_work[46] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_46_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[47] )  . work  )  . entry   , & ( ( global_linkwatch_work[47] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_47_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[48] )  . work  )  . entry   , & ( ( global_linkwatch_work[48] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_48_boot_tvec_bases_I    , }    , } ,  { . work  = { . data  = { ( 0 )  }   , . entry  = { & ( ( global_linkwatch_work[49] )  . work  )  . entry   , & ( ( global_linkwatch_work[49] )  . work  )  . entry    }    , . func  = ( ( linkwatch_event )  )    , }   , . timer  = { . entry  = { . prev  = ( ( void *  ) 0x74737461  )   }   , . function  = ( ( ( void *  ) 0  )  )    , . expires  = ( 0 )    , . data  = ( 0 )    , . base  = & _GLOBAL_49_boot_tvec_bases_I    , }    , } ,  };                                                   

typedef  struct net_device   _GLOBAL_204_T; static  _GLOBAL_204_T  * global_lweventlist[NUM_STACKS];    
typedef  spinlock_t  _GLOBAL_205_T; static  _GLOBAL_205_T  global_lweventlist_lock[NUM_STACKS] = {  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  ( spinlock_t ) { . raw_lock  = { }   , } ,  };           
...
static void linkwatch_add_event(struct net_device *dev)
{
 ...
 do { (void)(flags); do { do { } while (0); (void)0; (void)(&global_lweventlist_lock[get_stack_id()]); } while (0); } while (0);
 dev->link_watch_next = global_lweventlist[get_stack_id()];
 global_lweventlist[get_stack_id()] = dev;
 do { (void)(flags); do { do { } while (0); (void)0; (void)(&global_lweventlist_lock[get_stack_id()]); } while (0); } while (0);
}
...
{
 unsigned long delay = global_linkwatch_nextevent[get_stack_id()] - global_jiffies[get_stack_id()];

 if ((__builtin_constant_p((LW_URGENT)) ? constant_test_bit((LW_URGENT), (&global_linkwatch_flags[get_stack_id()])) : variable_test_bit((LW_URGENT), (&global_linkwatch_flags[get_stack_id()]))))
  return;


 if (urgent) {
  if (test_and_set_bit(LW_URGENT, &global_linkwatch_flags[get_stack_id()]))
   return;
  delay = 0;
 }
 ...
 if (schedule_delayed_work(&global_linkwatch_work[get_stack_id()], delay) == !delay)
  return;
 ...
 if (!cancel_delayed_work(&global_linkwatch_work[get_stack_id()]))
  return;


 schedule_delayed_work(&global_linkwatch_work[get_stack_id()], 0);
}
...
# 147 "linux-2.6.26/net/core/link_watch.c"
 if (!urgent_only)
  global_linkwatch_nextevent[get_stack_id()] = global_jiffies[get_stack_id()] + 1000;

 else if ((({ unsigned long __dummy; typeof(global_linkwatch_nextevent[get_stack_id()]) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(global_jiffies[get_stack_id()] + 1000) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(global_jiffies[get_stack_id()] + 1000) - (long)(global_linkwatch_nextevent[get_stack_id()]) < 0)))
  global_linkwatch_nextevent[get_stack_id()] = global_jiffies[get_stack_id()];

 clear_bit(LW_URGENT, &global_linkwatch_flags[get_stack_id()]);

 do { ; do { do { } while (0); (void)0; (void)(&global_lweventlist_lock[get_stack_id()]); } while (0); } while (0);
 next = global_lweventlist[get_stack_id()];
 global_lweventlist[get_stack_id()] = ((void *)0);
 do { ; do { do { } while (0); (void)0; (void)(&global_lweventlist_lock[get_stack_id()]); } while (0); } while (0);
 ...
 while (next) {
  ...
  if (dev->flags & 0x1) {
   if (netif_carrier_ok(dev)) {
    ({ int __ret_warn_on = !!(dev->qdisc_sleeping == &global_noop_qdisc[get_stack_id()]); if (__builtin_expect(!!(__ret_warn_on), 0)) warn_on_slowpath("linux-2.6.26/net/core/link_watch.c", 184); __builtin_expect(!!(__ret_warn_on), 0); });
    dev_activate(dev);
   } else
    dev_deactivate(dev);
 ...
 if (global_lweventlist[get_stack_id()])
...
{
 rtnl_lock();
 __linkwatch_run_queue((({ unsigned long __dummy; typeof(global_linkwatch_nextevent[get_stack_id()]) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(global_jiffies[get_stack_id()]) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(global_jiffies[get_stack_id()]) - (long)(global_linkwatch_nextevent[get_stack_id()]) < 0)));
 rtnl_unlock();
}
