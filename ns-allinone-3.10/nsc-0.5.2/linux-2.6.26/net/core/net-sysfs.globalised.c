# 1 "linux-2.6.26/net/core/net-sysfs.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/core/net-sysfs.c"
# 12 "linux-2.6.26/net/core/net-sysfs.c"
...
# 13 "linux-2.6.26/net/core/net-sysfs.c" 2
...
# 14 "linux-2.6.26/net/core/net-sysfs.c" 2
...
typedef  unsigned int   _GLOBAL_48_T; extern  _GLOBAL_48_T  global___invalid_size_argument_for_IOC[NUM_STACKS];    
...
typedef  int  _GLOBAL_49_T; extern  _GLOBAL_49_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_50_T; extern  _GLOBAL_50_T  global_net_msg_burst[NUM_STACKS];   
...
# 15 "linux-2.6.26/net/core/net-sysfs.c" 2
...
# 16 "linux-2.6.26/net/core/net-sysfs.c" 2
...
# 17 "linux-2.6.26/net/core/net-sysfs.c" 2
...
# 19 "linux-2.6.26/net/core/net-sysfs.c" 2
...
# 20 "linux-2.6.26/net/core/net-sysfs.c" 2
...
# 22 "linux-2.6.26/net/core/net-sysfs.c" 2
# 415 "linux-2.6.26/net/core/net-sysfs.c"
static void netdev_release(struct device *d)
{
 struct net_device *dev = ({ const typeof( ((struct net_device *)0)->dev ) *__mptr = (d); (struct net_device *)( (char *)__mptr - __builtin_offsetof(struct net_device,dev) );});

 do { if (__builtin_expect(!!(dev->reg_state != NETREG_RELEASED), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);

 kfree((char *)dev - dev->padded);
}

typedef  struct class   _GLOBAL_197_T; static  _GLOBAL_197_T  global_net_class[NUM_STACKS] = {  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  { . name  = "net"  , . dev_release  = netdev_release   , } ,  };      
...
int netdev_register_kobject(struct net_device *net)
{
 ...
 dev->class = &global_net_class[get_stack_id()];
 dev->platform_data = net;
 dev->groups = groups;

 ((void)sizeof(char[1 - 2*!!(20 < 16)]));
 strlcpy(dev->bus_id, net->name, 20);
# 469 "linux-2.6.26/net/core/net-sysfs.c"
...
int netdev_kobject_init(void)
{
 return class_register(&global_net_class[get_stack_id()]);
}
