...
typedef  struct atomic_notifier_head   _GLOBAL_103_T; static  _GLOBAL_103_T  global_netevent_notif_chain[NUM_STACKS] = {  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  };                    
