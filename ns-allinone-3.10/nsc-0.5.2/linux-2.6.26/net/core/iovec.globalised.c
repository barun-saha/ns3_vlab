# 1 "linux-2.6.26/net/core/iovec.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/core/iovec.c"
# 19 "linux-2.6.26/net/core/iovec.c"
...
# 20 "linux-2.6.26/net/core/iovec.c" 2
...
{ }
# 21 "linux-2.6.26/net/core/iovec.c" 2
...
# 23 "linux-2.6.26/net/core/iovec.c" 2
...
# 25 "linux-2.6.26/net/core/iovec.c" 2
...
# 26 "linux-2.6.26/net/core/iovec.c" 2
...
# 27 "linux-2.6.26/net/core/iovec.c" 2
...
# 29 "linux-2.6.26/net/core/iovec.c" 2
...
# 30 "linux-2.6.26/net/core/iovec.c" 2
# 39 "linux-2.6.26/net/core/iovec.c"
...
int memcpy_toiovec(struct iovec *iov, unsigned char *kdata, int len)
{
 while (len > 0) {
  if (iov->iov_len) {
   int copy = ({ unsigned int __min1 = (iov->iov_len); unsigned int __min2 = (len); __min1 < __min2 ? __min1: __min2; });
...
int memcpy_fromiovec(unsigned char *kdata, struct iovec *iov, int len)
{
 while (len > 0) {
  if (iov->iov_len) {
   int copy = ({ unsigned int __min1 = (len); unsigned int __min2 = (iov->iov_len); __min1 < __min2 ? __min1: __min2; });
   ...
   int len)
{
 ...
 while (len > 0) {
  ...
  int copy = ({ unsigned int __min1 = (len); unsigned int __min2 = (iov->iov_len - offset); __min1 < __min2 ? __min1: __min2; });
...
# 159 "linux-2.6.26/net/core/iovec.c"
