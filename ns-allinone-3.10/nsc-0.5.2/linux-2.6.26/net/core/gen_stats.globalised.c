# 1 "linux-2.6.26/net/core/gen_stats.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/core/gen_stats.c"
# 16 "linux-2.6.26/net/core/gen_stats.c"
...
# 17 "linux-2.6.26/net/core/gen_stats.c" 2
...
# 18 "linux-2.6.26/net/core/gen_stats.c" 2
...
{ }
# 19 "linux-2.6.26/net/core/gen_stats.c" 2
...
# 20 "linux-2.6.26/net/core/gen_stats.c" 2
...
# 21 "linux-2.6.26/net/core/gen_stats.c" 2
...
# 155 "linux-2.6.26/include/linux/netlink.h"
...
typedef  int  _GLOBAL_113_T; extern  _GLOBAL_113_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_114_T; extern  _GLOBAL_114_T  global_net_msg_burst[NUM_STACKS];   
...
typedef  const struct in6_addr    _GLOBAL_115_T; extern  _GLOBAL_115_T  global_in6addr_any[NUM_STACKS];     

typedef  const struct in6_addr    _GLOBAL_116_T; extern  _GLOBAL_116_T  global_in6addr_loopback[NUM_STACKS];     
...
# 22 "linux-2.6.26/net/core/gen_stats.c" 2
...
# 23 "linux-2.6.26/net/core/gen_stats.c" 2
...
# 24 "linux-2.6.26/net/core/gen_stats.c" 2
...
extern int gen_replace_estimator(struct gnet_stats_basic *bstats,
     struct gnet_stats_rate_est *rate_est,
     spinlock_t *stats_lock, struct nlattr *opt);
# 25 "linux-2.6.26/net/core/gen_stats.c" 2


static inline  __attribute__((always_inline)) int
gnet_stats_copy(struct gnet_dump *d, int type, void *buf, int size)
{
 do { if (__builtin_expect(!!(nla_put(d->skb, type, size, buf) < 0), 0)) goto nla_put_failure; } while(0);
 return 0;
...
# 56 "linux-2.6.26/net/core/gen_stats.c"
int
...
# 90 "linux-2.6.26/net/core/gen_stats.c"
int
...
# 108 "linux-2.6.26/net/core/gen_stats.c"
int
...
# 133 "linux-2.6.26/net/core/gen_stats.c"
int
...
# 158 "linux-2.6.26/net/core/gen_stats.c"
int
...
# 187 "linux-2.6.26/net/core/gen_stats.c"
int
...
# 213 "linux-2.6.26/net/core/gen_stats.c"
int
