# 1 "linux-2.6.26/net/packet/af_packet.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/packet/af_packet.c"
# 52 "linux-2.6.26/net/packet/af_packet.c"
...
# 53 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 54 "linux-2.6.26/net/packet/af_packet.c" 2
...
typedef  const kernel_cap_t   _GLOBAL_91_T; extern  _GLOBAL_91_T  global___cap_empty_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_92_T; extern  _GLOBAL_92_T  global___cap_full_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_93_T; extern  _GLOBAL_93_T  global___cap_init_eff_set[NUM_STACKS];    

kernel_cap_t cap_set_effective(const kernel_cap_t pE_new);

int capable(int cap);
int __capable(struct task_struct *t, int cap);
# 55 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 56 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 57 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 60 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 62 "linux-2.6.26/net/packet/af_packet.c" 2
...
typedef  atomic_t  _GLOBAL_161_T; extern  _GLOBAL_161_T  global_flow_cache_genid[NUM_STACKS];   
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      void *oldval, size_t *oldlenp,
      void *newval, size_t newlen);
# 66 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 67 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 1 "linux-2.6.26/include/asm/uaccess.h" 1
# 73 "linux-2.6.26/net/packet/af_packet.c" 2
# 1 "linux-2.6.26/include/asm/ioctls.h" 1



# 1 "linux-2.6.26/include/asm/ioctl.h" 1
# 5 "linux-2.6.26/include/asm/ioctls.h" 2
# 74 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 76 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 1 "linux-2.6.26/include/asm/io_32.h" 1
# 47 "linux-2.6.26/include/asm/io_32.h"
...
# 48 "linux-2.6.26/include/asm/io_32.h" 2
...
typedef  rwlock_t  _GLOBAL_221_T; extern  _GLOBAL_221_T  global_vmlist_lock[NUM_STACKS];   
typedef  struct vm_struct   _GLOBAL_222_T; extern  _GLOBAL_222_T  * global_vmlist[NUM_STACKS];    

extern const struct seq_operations vmalloc_op;
# 50 "linux-2.6.26/include/asm/io_32.h" 2
# 69 "linux-2.6.26/include/asm/io_32.h"
...
# 87 "linux-2.6.26/include/asm/io_32.h"
...
# 111 "linux-2.6.26/include/asm/io_32.h"
...
# 159 "linux-2.6.26/include/asm/io_32.h"
...
# 181 "linux-2.6.26/include/asm/io_32.h"
...
# 252 "linux-2.6.26/include/asm/io_32.h"
extern void native_io_delay(void);

typedef  int  _GLOBAL_223_T; extern  _GLOBAL_223_T  global_io_delay_type[NUM_STACKS];   
...
# 339 "linux-2.6.26/include/asm/io_32.h"
...
# 8 "linux-2.6.26/include/asm/io.h" 2
...
# 77 "linux-2.6.26/net/packet/af_packet.c" 2
...
# 78 "linux-2.6.26/net/packet/af_packet.c" 2
...
typedef  const struct proto_ops    _GLOBAL_224_T; extern  _GLOBAL_224_T  global_inet_stream_ops[NUM_STACKS];     
typedef  const struct proto_ops    _GLOBAL_225_T; extern  _GLOBAL_225_T  global_inet_dgram_ops[NUM_STACKS];     
...
# 85 "linux-2.6.26/net/packet/af_packet.c" 2
# 140 "linux-2.6.26/net/packet/af_packet.c"
...
# 178 "linux-2.6.26/net/packet/af_packet.c"
...
# 217 "linux-2.6.26/net/packet/af_packet.c"
...
typedef  const struct proto_ops    _GLOBAL_226_T; static  _GLOBAL_226_T  global_packet_ops[NUM_STACKS];     

typedef  const struct proto_ops    _GLOBAL_227_T; static  _GLOBAL_227_T  global_packet_ops_spkt[NUM_STACKS];     
...
# 263 "linux-2.6.26/net/packet/af_packet.c"
 if (skb->pkt_type == 5)
  goto out;
 ...
 spkt = &((struct packet_skb_cb *)((skb)->cb))->sa.pkt;
          ...
          struct msghdr *msg, size_t len)
{
 ...
 err = -105;
 skb = sock_wmalloc(sk, len + ((((dev)->hard_header_len+(dev)->needed_headroom)&~(16 - 1)) + 16), 0, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 ...
 if (skb == ((void *)0))
  goto out_unlock;
# 378 "linux-2.6.26/net/packet/af_packet.c"
...
static inline  __attribute__((always_inline)) unsigned int run_filter(struct sk_buff *skb, struct sock *sk,
          unsigned int res)
{
 struct sk_filter *filter;

 do { local_bh_disable(); (void)0; do { } while (0); } while (0);
 filter = ({ typeof(sk->sk_filter) _________p1 = (*(volatile typeof(sk->sk_filter) *)&(sk->sk_filter)); do { } while (0); (_________p1); });
 if (filter != ((void *)0))
...
# 439 "linux-2.6.26/net/packet/af_packet.c"
static int packet_rcv(struct sk_buff *skb, struct net_device *dev, struct packet_type *pt, struct net_device *orig_dev)
{
 ...
 ((void)sizeof(char[1 - 2*!!(sizeof(*((struct packet_skb_cb *)((skb)->cb))) + 32 - 8 > sizeof(skb->cb))]));


 sll = &((struct packet_skb_cb *)((skb)->cb))->sa.ll;
 sll->sll_family = 17;
 sll->sll_hatype = dev->type;
 sll->sll_protocol = skb->protocol;
 sll->sll_pkttype = skb->pkt_type;
 if (__builtin_expect(!!(po->origdev), 0))
 ...
 ((struct packet_skb_cb *)((skb)->cb))->origlen = skb->len;
...
# 698 "linux-2.6.26/net/packet/af_packet.c"
     ...
     struct msghdr *msg, size_t len)
{
 ...
 skb = sock_alloc_send_skb(sk, len + ((((dev)->hard_header_len+(dev)->needed_headroom+(dev)->needed_tailroom)&~(16 - 1)) + 16),
 ...
 if (sock->type == SOCK_DGRAM &&
     dev_hard_header(skb, dev, __fswab16(( __u16)(__be16)(proto)), addr, ((void *)0), len) < 0)
  goto out_free;
...
static int packet_release(struct socket *sock)
{
 ...
 do { local_bh_disable(); do { do { } while (0); (void)0; (void)(&net->packet.sklist_lock); } while (0); } while (0);
 sk_del_node_init(sk);
 do { do { } while (0); local_bh_enable(); (void)0; (void)(&net->packet.sklist_lock); } while (0);
...
# 838 "linux-2.6.26/net/packet/af_packet.c"
 sock_orphan(sk);
 sock->sk = ((void *)0);
...
typedef  struct proto   _GLOBAL_228_T; static  _GLOBAL_228_T  global_packet_proto[NUM_STACKS] = {  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  { . name  = "PACKET"  , . owner  = ( ( struct module  *  ) 0  )    , . obj_size  = sizeof ( struct packet_sock  )    , } ,  };      
...
static int packet_create(struct net *net, struct socket *sock, int protocol)
{
 ...
 err = -105;
 sk = sk_alloc(net, 17, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)), &global_packet_proto[get_stack_id()]);
 if (sk == ((void *)0))
  goto out;
     ...
     struct msghdr *msg, size_t len, int flags)
{
 ...
 if (flags & ~(2|0x40|0x20|0))
  goto out;
# 1058 "linux-2.6.26/net/packet/af_packet.c"
 ...
 if (msg->msg_name)
  (__builtin_constant_p(msg->msg_namelen) ? __constant_memcpy((msg->msg_name),(&((struct packet_skb_cb *)((skb)->cb))->sa),(msg->msg_namelen)) : __memcpy((msg->msg_name),(&((struct packet_skb_cb *)((skb)->cb))->sa),(msg->msg_namelen)));
 ...
 if (pkt_sk(sk)->auxdata) {
  ...
  if (skb->ip_summed == 3)
   aux.tp_status |= 8;
  aux.tp_len = ((struct packet_skb_cb *)((skb)->cb))->origlen;
  aux.tp_snaplen = skb->len;
  aux.tp_mac = 0;
  aux.tp_net = skb_network_offset(skb);

  put_cmsg(msg, 263, 8, sizeof(aux), &aux);
 }
...
static void packet_flush_mclist(struct sock *sk)
{
 ...
 while ((ml = po->mclist) != ((void *)0)) {
  ...
  po->mclist = ml->next;
  if ((dev = dev_get_by_index(sock_net(sk), ml->ifindex)) != ((void *)0)) {
   packet_dev_mc(dev, ml, -1);
   dev_put(dev);
  }
  kfree(ml);
...
# 1362 "linux-2.6.26/net/packet/af_packet.c"
 case 8:
 {
  int val;
...
static int packet_notifier(struct notifier_block *this, unsigned long msg, void *data)
{
 ...
 do { do { } while (0); (void)0; (void)(&net->packet.sklist_lock); } while (0);
 for (node = (&net->packet.sklist)->first; node && ({ prefetch(node->next); 1;}) && ({ sk = ({ const typeof( ((typeof(*sk) *)0)->__sk_common.skc_node ) *__mptr = (node); (typeof(*sk) *)( (char *)__mptr - __builtin_offsetof(typeof(*sk),__sk_common.skc_node) );}); 1;}); node = node->next) {
  struct packet_sock *po = pkt_sk(sk);
   ...
   unsigned long arg)
{
 ...
 switch(cmd) {
  ...
  case 0x8907:
   return sock_get_timestampns(sk, (struct timespec *)arg);
  ...
  case 0x8918:
  case 0x8914:
   if (sock_net(sk) != &global_init_net[get_stack_id()])
    return -515;
...
# 1806 "linux-2.6.26/net/packet/af_packet.c"
typedef  const struct proto_ops    _GLOBAL_229_T; static  _GLOBAL_229_T  global_packet_ops_spkt[NUM_STACKS] = {  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  { . family  = 17  , . owner  = ( ( struct module  *  ) 0  )    , . release  = packet_release   , . bind  = packet_bind_spkt   , . connect  = sock_no_connect   , . socketpair  = sock_no_socketpair   , . accept  = sock_no_accept   , . getname  = packet_getname_spkt   , . poll  = datagram_poll   , . ioctl  = packet_ioctl   , . listen  = sock_no_listen   , . shutdown  = sock_no_shutdown   , . setsockopt  = sock_no_setsockopt   , . getsockopt  = sock_no_getsockopt   , . sendmsg  = packet_sendmsg_spkt   , . recvmsg  = packet_recvmsg   , . mmap  = sock_no_mmap   , . sendpage  = sock_no_sendpage   , } ,  };       
...
typedef  struct net_proto_family   _GLOBAL_231_T; static  _GLOBAL_231_T  global_packet_family_ops[NUM_STACKS] = {  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . family  = 17  , . create  = packet_create   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };      
   
   
     


typedef  struct notifier_block   _GLOBAL_232_T; static  _GLOBAL_232_T  global_packet_netdev_notifier[NUM_STACKS] = {  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  { . notifier_call  = packet_notifier  , } ,  };      
  

# 1942 "linux-2.6.26/net/packet/af_packet.c"
static int packet_net_init(struct net *net)
{
 do { *(&net->packet.sklist_lock) = (rwlock_t) { .raw_lock = { }, }; } while (0);
 ((&net->packet.sklist)->first = ((void *)0));
...
typedef  struct pernet_operations   _GLOBAL_233_T; static  _GLOBAL_233_T  global_packet_net_ops[NUM_STACKS] = {  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  { . init  = packet_net_init  , . exit  = packet_net_exit   , } ,  };      
   
   



static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) packet_exit(void)
{
 unregister_netdevice_notifier(&global_packet_netdev_notifier[get_stack_id()]);
 unregister_pernet_subsys(&global_packet_net_ops[get_stack_id()]);
 sock_unregister(17);
 proto_unregister(&global_packet_proto[get_stack_id()]);
}

static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) packet_init(void)
{
