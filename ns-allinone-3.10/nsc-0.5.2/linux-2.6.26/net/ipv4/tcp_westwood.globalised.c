# 1 "linux-2.6.26/net/ipv4/tcp_westwood.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/tcp_westwood.c"
# 24 "linux-2.6.26/net/ipv4/tcp_westwood.c"
...
# 25 "linux-2.6.26/net/ipv4/tcp_westwood.c" 2
...
{ }
# 26 "linux-2.6.26/net/ipv4/tcp_westwood.c" 2
...
# 27 "linux-2.6.26/net/ipv4/tcp_westwood.c" 2
...
# 28 "linux-2.6.26/net/ipv4/tcp_westwood.c" 2
...
# 29 "linux-2.6.26/net/ipv4/tcp_westwood.c" 2
...
# 61 "linux-2.6.26/net/ipv4/tcp_westwood.c"
static void tcp_westwood_init(struct sock *sk)
{
 ...
 w->cumul_ack = 0;
 w->reset_rtt_min = 1;
 w->rtt_min = w->rtt = (20*1000);
 w->rtt_win_sx = ((__u32)(global_jiffies[get_stack_id()]));
...
static inline  __attribute__((always_inline)) u32 westwood_do_filter(u32 a, u32 b)
{
 return (((7 * a) + b) >> 3);
}
...
{
 struct westwood *w = inet_csk_ca(sk);
 s32 delta = ((__u32)(global_jiffies[get_stack_id()])) - w->rtt_win_sx;
...
# 139 "linux-2.6.26/net/ipv4/tcp_westwood.c"
 if (w->rtt && delta > ({ u32 __max1 = (w->rtt); u32 __max2 = ((1000/20)); __max1 > __max2 ? __max1: __max2; })) {
...
static inline  __attribute__((always_inline)) void update_rtt_min(struct westwood *w)
{
 if (w->reset_rtt_min) {
  w->rtt_min = w->rtt;
  w->reset_rtt_min = 0;
 } else
  w->rtt_min = ({ typeof(w->rtt) _min1 = (w->rtt); typeof(w->rtt_min) _min2 = (w->rtt_min); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
}
# 163 "linux-2.6.26/net/ipv4/tcp_westwood.c"
static inline  __attribute__((always_inline)) void westwood_fast_bw(struct sock *sk)
{
 const struct tcp_sock *tp = tcp_sk(sk);
 struct westwood *w = inet_csk_ca(sk);
...
static inline  __attribute__((always_inline)) u32 westwood_acked_count(struct sock *sk)
{
 const struct tcp_sock *tp = tcp_sk(sk);
 struct westwood *w = inet_csk_ca(sk);
...
# 218 "linux-2.6.26/net/ipv4/tcp_westwood.c"
static u32 tcp_westwood_bw_rttmin(const struct sock *sk)
{
 const struct tcp_sock *tp = tcp_sk(sk);
 const struct westwood *w = inet_csk_ca(sk);
 return ({ u32 __max1 = ((w->bw_est * w->rtt_min) / tp->mss_cache); u32 __max2 = (2); __max1 > __max2 ? __max1: __max2; });
}
...
typedef  struct tcp_congestion_ops   _GLOBAL_274_T; static  _GLOBAL_274_T  global_tcp_westwood[NUM_STACKS] = {  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  { . init  = tcp_westwood_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_reno_cong_avoid   , . min_cwnd  = tcp_westwood_bw_rttmin   , . cwnd_event  = tcp_westwood_event   , . get_info  = tcp_westwood_info   , . pkts_acked  = tcp_westwood_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "westwood"   } ,  };      
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) tcp_westwood_register(void)
{
 ((void)sizeof(char[1 - 2*!!(sizeof(struct westwood) > (16 * sizeof(u32)))]));
 return tcp_register_congestion_control(&global_tcp_westwood[get_stack_id()]);
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) tcp_westwood_unregister(void)
{
 tcp_unregister_congestion_control(&global_tcp_westwood[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_275_T; static  _GLOBAL_275_T  __initcall_tcp_westwood_register6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tcp_westwood_register ;       ;
typedef  exitcall_t  _GLOBAL_276_T; static  _GLOBAL_276_T  global___exitcall_tcp_westwood_unregister[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  tcp_westwood_unregister,  };       ;
