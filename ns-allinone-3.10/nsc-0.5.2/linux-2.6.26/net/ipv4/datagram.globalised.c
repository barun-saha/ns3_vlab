# 1 "linux-2.6.26/net/ipv4/datagram.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/datagram.c"
# 14 "linux-2.6.26/net/ipv4/datagram.c"
...
# 15 "linux-2.6.26/net/ipv4/datagram.c" 2
...
{ }
# 16 "linux-2.6.26/net/ipv4/datagram.c" 2
...
# 17 "linux-2.6.26/net/ipv4/datagram.c" 2
...
# 18 "linux-2.6.26/net/ipv4/datagram.c" 2
# 1 "linux-2.6.26/include/net/ip.h" 1
# 30 "linux-2.6.26/include/net/ip.h"
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      void *oldval, size_t *oldlenp,
      void *newval, size_t newlen);
# 19 "linux-2.6.26/net/ipv4/datagram.c" 2
...
int ip4_datagram_connect(struct sock *sk, struct sockaddr *uaddr, int addr_len)
{
 ...
 if (err) {
  if (err == -101)
   (({ (void)((0)); (((*_GLOBAL_ip_statistics_10_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_OUTNOROUTES]++);
  return err;
 }
