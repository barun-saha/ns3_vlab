# 1 "linux-2.6.26/net/ipv4/tcp_diag.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/tcp_diag.c"
# 15 "linux-2.6.26/net/ipv4/tcp_diag.c"
...
{ }
# 16 "linux-2.6.26/net/ipv4/tcp_diag.c" 2
...
# 17 "linux-2.6.26/net/ipv4/tcp_diag.c" 2
...
# 19 "linux-2.6.26/net/ipv4/tcp_diag.c" 2
...
# 21 "linux-2.6.26/net/ipv4/tcp_diag.c" 2
...
typedef  struct inet_diag_handler   _GLOBAL_274_T; static  _GLOBAL_274_T  global_tcp_diag_handler[NUM_STACKS] = {  { . idiag_hashinfo  = & global_tcp_hashinfo[0]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[1]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[2]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[3]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[4]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[5]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[6]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[7]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[8]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[9]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[10]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[11]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[12]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[13]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[14]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[15]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[16]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[17]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[18]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[19]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[20]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[21]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[22]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[23]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[24]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[25]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[26]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[27]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[28]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[29]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[30]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[31]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[32]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[33]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[34]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[35]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[36]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[37]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[38]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[39]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[40]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[41]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[42]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[43]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[44]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[45]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[46]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[47]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[48]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  { . idiag_hashinfo  = & global_tcp_hashinfo[49]   , . idiag_get_info  = tcp_diag_get_info   , . idiag_type  = 18   , . idiag_info_size  = sizeof ( struct tcp_info  )    , } ,  };      
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) tcp_diag_init(void)
{
 return inet_diag_register(&global_tcp_diag_handler[get_stack_id()]);
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) tcp_diag_exit(void)
{
 inet_diag_unregister(&global_tcp_diag_handler[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_275_T; static  _GLOBAL_275_T  __initcall_tcp_diag_init6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tcp_diag_init ;       ;
typedef  exitcall_t  _GLOBAL_276_T; static  _GLOBAL_276_T  global___exitcall_tcp_diag_exit[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  tcp_diag_exit,  };       ;
;
;
