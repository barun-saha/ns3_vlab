# 1 "linux-2.6.26/net/ipv4/tcp_yeah.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/tcp_yeah.c"
# 9 "linux-2.6.26/net/ipv4/tcp_yeah.c"
...
# 10 "linux-2.6.26/net/ipv4/tcp_yeah.c" 2
...
typedef  unsigned int   _GLOBAL_91_T; extern  _GLOBAL_91_T  global_vdso_enabled[NUM_STACKS];    
...
typedef  struct desc_ptr   _GLOBAL_92_T; extern  _GLOBAL_92_T  global_idt_descr[NUM_STACKS];    
extern gate_desc idt_table[];
# 54 "linux-2.6.26/include/asm/desc.h"
struct gdt_page {
 struct desc_struct gdt[32];
} __attribute__((aligned(((1UL) << 12)))) ;
typedef  __typeof__ ( struct gdt_page  )   _GLOBAL_93_T; extern  _GLOBAL_93_T  global_per_cpu__gdt_page[NUM_STACKS];    
...
{ }
# 11 "linux-2.6.26/net/ipv4/tcp_yeah.c" 2
...
# 12 "linux-2.6.26/net/ipv4/tcp_yeah.c" 2
# 1 "linux-2.6.26/include/linux/inet_diag.h" 1
# 11 "linux-2.6.26/include/linux/inet_diag.h"
...
# 48 "linux-2.6.26/include/linux/inet_diag.h"
...
# 13 "linux-2.6.26/net/ipv4/tcp_yeah.c" 2

# 1 "linux-2.6.26/include/net/tcp.h" 1
# 25 "linux-2.6.26/include/net/tcp.h"
...
# 49 "linux-2.6.26/include/net/sock.h"
...
# 26 "linux-2.6.26/include/net/tcp.h" 2





# 1 "linux-2.6.26/include/linux/crypto.h" 1
# 20 "linux-2.6.26/include/linux/crypto.h"
# 1 "linux-2.6.26/include/asm/atomic.h" 1
# 21 "linux-2.6.26/include/linux/crypto.h" 2
...
# 27 "linux-2.6.26/include/linux/crypto.h" 2
# 99 "linux-2.6.26/include/linux/crypto.h"
struct scatterlist;
...
# 145 "linux-2.6.26/include/linux/crypto.h"
struct aead_request {
 struct crypto_async_request base;
...
# 277 "linux-2.6.26/include/linux/crypto.h"
struct crypto_alg {
...
# 402 "linux-2.6.26/include/linux/crypto.h"
struct crypto_tfm {
...
static inline  __attribute__((always_inline)) struct crypto_blkcipher *crypto_blkcipher_cast(
 struct crypto_tfm *tfm)
{
 do { if (__builtin_expect(!!(crypto_tfm_alg_type(tfm) != 0x00000004), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
...
{
 (__builtin_constant_p(len) ? __constant_memcpy((crypto_blkcipher_crt(tfm)->iv),(src),(len)) : __memcpy((crypto_blkcipher_crt(tfm)->iv),(src),(len)));
}

static inline  __attribute__((always_inline)) void crypto_blkcipher_get_iv(struct crypto_blkcipher *tfm,
        u8 *dst, unsigned int len)
{
 (__builtin_constant_p(len) ? __constant_memcpy((dst),(crypto_blkcipher_crt(tfm)->iv),(len)) : __memcpy((dst),(crypto_blkcipher_crt(tfm)->iv),(len)));
}
...
{
 do { if (__builtin_expect(!!(crypto_tfm_alg_type(tfm) != 0x00000001), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
...
{
 do { if (__builtin_expect(!!((crypto_tfm_alg_type(tfm) ^ 0x00000003) & 0x0000000e), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
...
{
 do { if (__builtin_expect(!!((crypto_tfm_alg_type(tfm) ^ 0x00000008) & 0x0000000f), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
...
# 32 "linux-2.6.26/include/net/tcp.h" 2
...
# 33 "linux-2.6.26/include/net/tcp.h" 2



# 1 "linux-2.6.26/include/net/inet_hashtables.h" 1
# 19 "linux-2.6.26/include/net/inet_hashtables.h"
...
# 20 "linux-2.6.26/include/net/inet_hashtables.h" 2
...
# 27 "linux-2.6.26/include/net/inet_hashtables.h" 2
...
# 1 "linux-2.6.26/include/asm/atomic.h" 1
# 34 "linux-2.6.26/include/net/inet_hashtables.h" 2
...
# 76 "linux-2.6.26/include/net/inet_hashtables.h"
struct inet_bind_bucket {
 struct net *ib_net;
 unsigned short port;
...
static inline  __attribute__((always_inline)) rwlock_t *inet_ehash_lockp(
 struct inet_hashinfo *hashinfo,
 unsigned int hash)
{
...
static inline  __attribute__((always_inline)) int inet_ehash_locks_alloc(struct inet_hashinfo *hashinfo)
{
 ...
 if (sizeof(rwlock_t) != 0) {
  ...
  if (!hashinfo->ehash_locks)
   return 12;
  for (i = 0; i < size; i++)
   do { *(&hashinfo->ehash_locks[i]) = (rwlock_t) { .raw_lock = { }, }; } while (0);
 }
...
static inline  __attribute__((always_inline)) void inet_listen_unlock(struct inet_hashinfo *hashinfo)
{
 if (atomic_dec_and_test(&hashinfo->lhash_users))
  __wake_up(&hashinfo->lhash_wait, (1 | 2), 1, ((void *)0));
}
...
{
 return __inet_lookup_listener(net, hashinfo, daddr, __fswab16(( __u16)(__be16)(dport)), dif);
}
# 275 "linux-2.6.26/include/net/inet_hashtables.h"
typedef __u32 __portpair;
# 329 "linux-2.6.26/include/net/inet_hashtables.h"
    ...
    const int dif)
{
 return __inet_lookup_established(net, hashinfo, saddr, sport, daddr,
      __fswab16(( __u16)(__be16)(dport)), dif);
}
...
static inline  __attribute__((always_inline)) struct sock *__inet_lookup(struct net *net,
      ...
      const int dif)
{
 u16 hnum = __fswab16(( __u16)(__be16)(dport));
...
extern int inet_hash_connect(struct inet_timewait_death_row *death_row,
        struct sock *sk);
# 37 "linux-2.6.26/include/net/tcp.h" 2
...
# 41 "linux-2.6.26/include/net/tcp.h" 2
...
typedef  struct ip_ra_chain   _GLOBAL_206_T; extern  _GLOBAL_206_T  * global_ip_ra_chain[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_207_T; extern  _GLOBAL_207_T  global_ip_ra_lock[NUM_STACKS];   
...
typedef  struct ipv4_config   _GLOBAL_208_T; extern  _GLOBAL_208_T  global_ipv4_config[NUM_STACKS];    
typedef  __typeof__ ( struct ipstats_mib  )   _GLOBAL_209_T; extern  _GLOBAL_209_T  * _GLOBAL_0_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_1_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_2_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_3_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_4_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_5_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_6_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_7_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_8_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_9_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_10_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_11_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_12_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_13_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_14_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_15_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_16_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_17_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_18_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_19_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_20_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_21_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_22_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_23_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_24_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_25_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_26_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_27_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_28_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_29_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_30_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_31_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_32_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_33_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_34_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_35_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_36_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_37_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_38_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_39_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_40_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_41_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_42_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_43_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_44_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_45_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_46_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_47_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_48_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_209_T  * _GLOBAL_49_ip_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_statistics_I) *_GLOBAL_ip_statistics_11_A[NUM_STACKS];   




typedef  __typeof__ ( struct linux_mib  )   _GLOBAL_210_T; extern  _GLOBAL_210_T  * _GLOBAL_0_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_1_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_2_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_3_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_4_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_5_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_6_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_7_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_8_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_9_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_10_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_11_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_12_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_13_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_14_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_15_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_16_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_17_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_18_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_19_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_20_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_21_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_22_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_23_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_24_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_25_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_26_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_27_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_28_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_29_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_30_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_31_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_32_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_33_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_34_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_35_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_36_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_37_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_38_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_39_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_40_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_41_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_42_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_43_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_44_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_45_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_46_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_47_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_48_net_statistics_I [ 2 ]  ; extern  _GLOBAL_210_T  * _GLOBAL_49_net_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_statistics_I) *_GLOBAL_net_statistics_12_A[NUM_STACKS] = { &_GLOBAL_0_net_statistics_I, &_GLOBAL_1_net_statistics_I, &_GLOBAL_2_net_statistics_I, &_GLOBAL_3_net_statistics_I, &_GLOBAL_4_net_statistics_I, &_GLOBAL_5_net_statistics_I, &_GLOBAL_6_net_statistics_I, &_GLOBAL_7_net_statistics_I, &_GLOBAL_8_net_statistics_I, &_GLOBAL_9_net_statistics_I, &_GLOBAL_10_net_statistics_I, &_GLOBAL_11_net_statistics_I, &_GLOBAL_12_net_statistics_I, &_GLOBAL_13_net_statistics_I, &_GLOBAL_14_net_statistics_I, &_GLOBAL_15_net_statistics_I, &_GLOBAL_16_net_statistics_I, &_GLOBAL_17_net_statistics_I, &_GLOBAL_18_net_statistics_I, &_GLOBAL_19_net_statistics_I, &_GLOBAL_20_net_statistics_I, &_GLOBAL_21_net_statistics_I, &_GLOBAL_22_net_statistics_I, &_GLOBAL_23_net_statistics_I, &_GLOBAL_24_net_statistics_I, &_GLOBAL_25_net_statistics_I, &_GLOBAL_26_net_statistics_I, &_GLOBAL_27_net_statistics_I, &_GLOBAL_28_net_statistics_I, &_GLOBAL_29_net_statistics_I, &_GLOBAL_30_net_statistics_I, &_GLOBAL_31_net_statistics_I, &_GLOBAL_32_net_statistics_I, &_GLOBAL_33_net_statistics_I, &_GLOBAL_34_net_statistics_I, &_GLOBAL_35_net_statistics_I, &_GLOBAL_36_net_statistics_I, &_GLOBAL_37_net_statistics_I, &_GLOBAL_38_net_statistics_I, &_GLOBAL_39_net_statistics_I, &_GLOBAL_40_net_statistics_I, &_GLOBAL_41_net_statistics_I, &_GLOBAL_42_net_statistics_I, &_GLOBAL_43_net_statistics_I, &_GLOBAL_44_net_statistics_I, &_GLOBAL_45_net_statistics_I, &_GLOBAL_46_net_statistics_I, &_GLOBAL_47_net_statistics_I, &_GLOBAL_48_net_statistics_I, &_GLOBAL_49_net_statistics_I, };   
...
typedef  int  _GLOBAL_211_T; extern  _GLOBAL_211_T  global_sysctl_ip_default_ttl[NUM_STACKS];   
typedef  int  _GLOBAL_212_T; extern  _GLOBAL_212_T  global_sysctl_ip_nonlocal_bind[NUM_STACKS];   

typedef  struct ctl_path   _GLOBAL_213_T; extern  _GLOBAL_213_T  _GLOBAL_0_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_1_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_2_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_3_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_4_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_5_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_6_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_7_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_8_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_9_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_10_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_11_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_12_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_13_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_14_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_15_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_16_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_17_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_18_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_19_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_20_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_21_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_22_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_23_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_24_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_25_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_26_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_27_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_28_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_29_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_30_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_31_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_32_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_33_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_34_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_35_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_36_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_37_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_38_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_39_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_40_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_41_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_42_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_43_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_44_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_45_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_46_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_47_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_48_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_213_T  _GLOBAL_49_net_ipv4_ctl_path_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_ipv4_ctl_path_I) *_GLOBAL_net_ipv4_ctl_path_13_A[NUM_STACKS];   


typedef  int  _GLOBAL_214_T; extern  _GLOBAL_214_T  global_inet_peer_threshold[NUM_STACKS];   
typedef  int  _GLOBAL_215_T; extern  _GLOBAL_215_T  global_inet_peer_minttl[NUM_STACKS];   
typedef  int  _GLOBAL_216_T; extern  _GLOBAL_216_T  global_inet_peer_maxttl[NUM_STACKS];   
typedef  int  _GLOBAL_217_T; extern  _GLOBAL_217_T  global_inet_peer_gc_mintime[NUM_STACKS];   
typedef  int  _GLOBAL_218_T; extern  _GLOBAL_218_T  global_inet_peer_gc_maxtime[NUM_STACKS];   


typedef  int  _GLOBAL_219_T; extern  _GLOBAL_219_T  global_sysctl_ip_dynaddr[NUM_STACKS];   
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      void *oldval, size_t *oldlenp,
      void *newval, size_t newlen);
# 42 "linux-2.6.26/include/net/tcp.h" 2

# 1 "linux-2.6.26/include/net/inet_ecn.h" 1
...
# 1 "linux-2.6.26/include/net/dsfield.h" 1
# 15 "linux-2.6.26/include/net/dsfield.h"
...
{
 return __fswab16(( __u16)(__be16)(*(const __be16 *)ipv6h)) >> 4;
}
...
static inline  __attribute__((always_inline)) void ipv4_change_dsfield(struct iphdr *iph,__u8 mask,
    __u8 value)
{
        __u32 check = __fswab16(( __u16)(__be16)(( __be16)iph->check));
 __u8 dsfield;
 ...
 check -= dsfield;
 check += check >> 16;
 iph->check = ( __sum16)(( __be16)__fswab16((check)));
 iph->tos = dsfield;
}
    ...
    __u8 value)
{
 ...
 tmp = __fswab16(( __u16)(__be16)(*(__be16 *) ipv6h));
 tmp = (tmp & ((mask << 4) | 0xf00f)) | (value << 4);
 *(__be16 *) ipv6h = (( __be16)__fswab16((tmp)));
}
# 9 "linux-2.6.26/include/net/inet_ecn.h" 2
...
# 66 "linux-2.6.26/include/net/inet_ecn.h"
 ...
 check += ( u16)(( __be16)__fswab16((0xFFFB))) + ( u16)(( __be16)__fswab16((ecn)));
...
static inline  __attribute__((always_inline)) int IP6_ECN_set_ce(struct ipv6hdr *iph)
{
 if (INET_ECN_is_not_ect(ipv6_get_dsfield(iph)))
  return 0;
 *(__be32*)iph |= (( __be32)__fswab32((INET_ECN_CE << 20)));
 return 1;
}

static inline  __attribute__((always_inline)) void IP6_ECN_clear(struct ipv6hdr *iph)
{
 *(__be32*)iph &= ~(( __be32)__fswab32((INET_ECN_MASK << 20)));
}
...
# 44 "linux-2.6.26/include/net/tcp.h" 2



typedef  struct inet_hashinfo   _GLOBAL_220_T; extern  _GLOBAL_220_T  global_tcp_hashinfo[NUM_STACKS];    

typedef  atomic_t  _GLOBAL_221_T; extern  _GLOBAL_221_T  global_tcp_orphan_count[NUM_STACKS];   
extern void tcp_time_wait(struct sock *sk, int state, int timeo);
# 193 "linux-2.6.26/include/net/tcp.h"
typedef  struct inet_timewait_death_row   _GLOBAL_222_T; extern  _GLOBAL_222_T  global_tcp_death_row[NUM_STACKS];    


typedef  int  _GLOBAL_223_T; extern  _GLOBAL_223_T  global_sysctl_tcp_timestamps[NUM_STACKS];   
typedef  int  _GLOBAL_224_T; extern  _GLOBAL_224_T  global_sysctl_tcp_window_scaling[NUM_STACKS];   
typedef  int  _GLOBAL_225_T; extern  _GLOBAL_225_T  global_sysctl_tcp_sack[NUM_STACKS];   
typedef  int  _GLOBAL_226_T; extern  _GLOBAL_226_T  global_sysctl_tcp_fin_timeout[NUM_STACKS];   
typedef  int  _GLOBAL_227_T; extern  _GLOBAL_227_T  global_sysctl_tcp_keepalive_time[NUM_STACKS];   
typedef  int  _GLOBAL_228_T; extern  _GLOBAL_228_T  global_sysctl_tcp_keepalive_probes[NUM_STACKS];   
typedef  int  _GLOBAL_229_T; extern  _GLOBAL_229_T  global_sysctl_tcp_keepalive_intvl[NUM_STACKS];   
typedef  int  _GLOBAL_230_T; extern  _GLOBAL_230_T  global_sysctl_tcp_syn_retries[NUM_STACKS];   
typedef  int  _GLOBAL_231_T; extern  _GLOBAL_231_T  global_sysctl_tcp_synack_retries[NUM_STACKS];   
typedef  int  _GLOBAL_232_T; extern  _GLOBAL_232_T  global_sysctl_tcp_retries1[NUM_STACKS];   
typedef  int  _GLOBAL_233_T; extern  _GLOBAL_233_T  global_sysctl_tcp_retries2[NUM_STACKS];   
typedef  int  _GLOBAL_234_T; extern  _GLOBAL_234_T  global_sysctl_tcp_orphan_retries[NUM_STACKS];   
typedef  int  _GLOBAL_235_T; extern  _GLOBAL_235_T  global_sysctl_tcp_syncookies[NUM_STACKS];   
typedef  int  _GLOBAL_236_T; extern  _GLOBAL_236_T  global_sysctl_tcp_retrans_collapse[NUM_STACKS];   
typedef  int  _GLOBAL_237_T; extern  _GLOBAL_237_T  global_sysctl_tcp_stdurg[NUM_STACKS];   
typedef  int  _GLOBAL_238_T; extern  _GLOBAL_238_T  global_sysctl_tcp_rfc1337[NUM_STACKS];   
typedef  int  _GLOBAL_239_T; extern  _GLOBAL_239_T  global_sysctl_tcp_abort_on_overflow[NUM_STACKS];   
typedef  int  _GLOBAL_240_T; extern  _GLOBAL_240_T  global_sysctl_tcp_max_orphans[NUM_STACKS];   
typedef  int  _GLOBAL_241_T; extern  _GLOBAL_241_T  global_sysctl_tcp_fack[NUM_STACKS];   
typedef  int  _GLOBAL_242_T; extern  _GLOBAL_242_T  global_sysctl_tcp_reordering[NUM_STACKS];   
typedef  int  _GLOBAL_243_T; extern  _GLOBAL_243_T  global_sysctl_tcp_ecn[NUM_STACKS];   
typedef  int  _GLOBAL_244_T; extern  _GLOBAL_244_T  global_sysctl_tcp_dsack[NUM_STACKS];   
typedef  int  _GLOBAL_245_T; extern  _GLOBAL_245_T  _GLOBAL_0_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_1_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_2_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_3_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_4_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_5_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_6_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_7_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_8_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_9_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_10_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_11_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_12_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_13_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_14_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_15_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_16_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_17_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_18_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_19_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_20_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_21_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_22_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_23_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_24_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_25_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_26_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_27_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_28_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_29_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_30_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_31_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_32_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_33_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_34_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_35_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_36_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_37_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_38_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_39_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_40_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_41_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_42_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_43_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_44_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_45_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_46_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_47_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_48_sysctl_tcp_mem_I [ 3 ] ; extern  _GLOBAL_245_T  _GLOBAL_49_sysctl_tcp_mem_I [ 3 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_tcp_mem_I) *_GLOBAL_sysctl_tcp_mem_14_A[NUM_STACKS] = { &_GLOBAL_0_sysctl_tcp_mem_I, &_GLOBAL_1_sysctl_tcp_mem_I, &_GLOBAL_2_sysctl_tcp_mem_I, &_GLOBAL_3_sysctl_tcp_mem_I, &_GLOBAL_4_sysctl_tcp_mem_I, &_GLOBAL_5_sysctl_tcp_mem_I, &_GLOBAL_6_sysctl_tcp_mem_I, &_GLOBAL_7_sysctl_tcp_mem_I, &_GLOBAL_8_sysctl_tcp_mem_I, &_GLOBAL_9_sysctl_tcp_mem_I, &_GLOBAL_10_sysctl_tcp_mem_I, &_GLOBAL_11_sysctl_tcp_mem_I, &_GLOBAL_12_sysctl_tcp_mem_I, &_GLOBAL_13_sysctl_tcp_mem_I, &_GLOBAL_14_sysctl_tcp_mem_I, &_GLOBAL_15_sysctl_tcp_mem_I, &_GLOBAL_16_sysctl_tcp_mem_I, &_GLOBAL_17_sysctl_tcp_mem_I, &_GLOBAL_18_sysctl_tcp_mem_I, &_GLOBAL_19_sysctl_tcp_mem_I, &_GLOBAL_20_sysctl_tcp_mem_I, &_GLOBAL_21_sysctl_tcp_mem_I, &_GLOBAL_22_sysctl_tcp_mem_I, &_GLOBAL_23_sysctl_tcp_mem_I, &_GLOBAL_24_sysctl_tcp_mem_I, &_GLOBAL_25_sysctl_tcp_mem_I, &_GLOBAL_26_sysctl_tcp_mem_I, &_GLOBAL_27_sysctl_tcp_mem_I, &_GLOBAL_28_sysctl_tcp_mem_I, &_GLOBAL_29_sysctl_tcp_mem_I, &_GLOBAL_30_sysctl_tcp_mem_I, &_GLOBAL_31_sysctl_tcp_mem_I, &_GLOBAL_32_sysctl_tcp_mem_I, &_GLOBAL_33_sysctl_tcp_mem_I, &_GLOBAL_34_sysctl_tcp_mem_I, &_GLOBAL_35_sysctl_tcp_mem_I, &_GLOBAL_36_sysctl_tcp_mem_I, &_GLOBAL_37_sysctl_tcp_mem_I, &_GLOBAL_38_sysctl_tcp_mem_I, &_GLOBAL_39_sysctl_tcp_mem_I, &_GLOBAL_40_sysctl_tcp_mem_I, &_GLOBAL_41_sysctl_tcp_mem_I, &_GLOBAL_42_sysctl_tcp_mem_I, &_GLOBAL_43_sysctl_tcp_mem_I, &_GLOBAL_44_sysctl_tcp_mem_I, &_GLOBAL_45_sysctl_tcp_mem_I, &_GLOBAL_46_sysctl_tcp_mem_I, &_GLOBAL_47_sysctl_tcp_mem_I, &_GLOBAL_48_sysctl_tcp_mem_I, &_GLOBAL_49_sysctl_tcp_mem_I, };  
typedef  int  _GLOBAL_246_T; extern  _GLOBAL_246_T  _GLOBAL_0_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_1_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_2_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_3_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_4_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_5_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_6_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_7_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_8_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_9_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_10_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_11_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_12_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_13_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_14_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_15_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_16_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_17_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_18_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_19_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_20_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_21_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_22_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_23_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_24_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_25_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_26_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_27_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_28_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_29_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_30_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_31_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_32_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_33_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_34_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_35_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_36_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_37_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_38_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_39_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_40_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_41_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_42_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_43_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_44_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_45_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_46_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_47_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_48_sysctl_tcp_wmem_I [ 3 ] ; extern  _GLOBAL_246_T  _GLOBAL_49_sysctl_tcp_wmem_I [ 3 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_tcp_wmem_I) *_GLOBAL_sysctl_tcp_wmem_15_A[NUM_STACKS];  
typedef  int  _GLOBAL_247_T; extern  _GLOBAL_247_T  _GLOBAL_0_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_1_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_2_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_3_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_4_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_5_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_6_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_7_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_8_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_9_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_10_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_11_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_12_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_13_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_14_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_15_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_16_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_17_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_18_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_19_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_20_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_21_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_22_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_23_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_24_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_25_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_26_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_27_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_28_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_29_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_30_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_31_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_32_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_33_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_34_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_35_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_36_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_37_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_38_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_39_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_40_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_41_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_42_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_43_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_44_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_45_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_46_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_47_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_48_sysctl_tcp_rmem_I [ 3 ] ; extern  _GLOBAL_247_T  _GLOBAL_49_sysctl_tcp_rmem_I [ 3 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_tcp_rmem_I) *_GLOBAL_sysctl_tcp_rmem_16_A[NUM_STACKS];  
typedef  int  _GLOBAL_248_T; extern  _GLOBAL_248_T  global_sysctl_tcp_app_win[NUM_STACKS];   
typedef  int  _GLOBAL_249_T; extern  _GLOBAL_249_T  global_sysctl_tcp_adv_win_scale[NUM_STACKS];   
typedef  int  _GLOBAL_250_T; extern  _GLOBAL_250_T  global_sysctl_tcp_tw_reuse[NUM_STACKS];   
typedef  int  _GLOBAL_251_T; extern  _GLOBAL_251_T  global_sysctl_tcp_frto[NUM_STACKS];   
typedef  int  _GLOBAL_252_T; extern  _GLOBAL_252_T  global_sysctl_tcp_frto_response[NUM_STACKS];   
typedef  int  _GLOBAL_253_T; extern  _GLOBAL_253_T  global_sysctl_tcp_low_latency[NUM_STACKS];   
typedef  int  _GLOBAL_254_T; extern  _GLOBAL_254_T  global_sysctl_tcp_dma_copybreak[NUM_STACKS];   
typedef  int  _GLOBAL_255_T; extern  _GLOBAL_255_T  global_sysctl_tcp_nometrics_save[NUM_STACKS];   
typedef  int  _GLOBAL_256_T; extern  _GLOBAL_256_T  global_sysctl_tcp_moderate_rcvbuf[NUM_STACKS];   
typedef  int  _GLOBAL_257_T; extern  _GLOBAL_257_T  global_sysctl_tcp_tso_win_divisor[NUM_STACKS];   
typedef  int  _GLOBAL_258_T; extern  _GLOBAL_258_T  global_sysctl_tcp_abc[NUM_STACKS];   
typedef  int  _GLOBAL_259_T; extern  _GLOBAL_259_T  global_sysctl_tcp_mtu_probing[NUM_STACKS];   
typedef  int  _GLOBAL_260_T; extern  _GLOBAL_260_T  global_sysctl_tcp_base_mss[NUM_STACKS];   
typedef  int  _GLOBAL_261_T; extern  _GLOBAL_261_T  global_sysctl_tcp_workaround_signed_windows[NUM_STACKS];   
typedef  int  _GLOBAL_262_T; extern  _GLOBAL_262_T  global_sysctl_tcp_slow_start_after_idle[NUM_STACKS];   
typedef  int  _GLOBAL_263_T; extern  _GLOBAL_263_T  global_sysctl_tcp_max_ssthresh[NUM_STACKS];   

typedef  atomic_t  _GLOBAL_264_T; extern  _GLOBAL_264_T  global_tcp_memory_allocated[NUM_STACKS];   
typedef  atomic_t  _GLOBAL_265_T; extern  _GLOBAL_265_T  global_tcp_sockets_allocated[NUM_STACKS];   
typedef  int  _GLOBAL_266_T; extern  _GLOBAL_266_T  global_tcp_memory_pressure[NUM_STACKS];   
...
static inline  __attribute__((always_inline)) int tcp_too_many_orphans(struct sock *sk, int num)
{
 return (num > global_sysctl_tcp_max_orphans[get_stack_id()]) ||
  (sk->sk_wmem_queued > 2048 &&
   ((&global_tcp_memory_allocated[get_stack_id()])->counter) > (*_GLOBAL_sysctl_tcp_mem_14_A[get_stack_id()])[2]);
}

typedef  struct proto   _GLOBAL_267_T; extern  _GLOBAL_267_T  global_tcp_prot[NUM_STACKS];    

typedef  __typeof__ ( struct tcp_mib  )   _GLOBAL_268_T; extern  _GLOBAL_268_T  * _GLOBAL_0_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_1_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_2_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_3_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_4_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_5_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_6_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_7_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_8_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_9_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_10_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_11_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_12_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_13_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_14_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_15_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_16_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_17_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_18_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_19_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_20_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_21_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_22_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_23_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_24_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_25_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_26_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_27_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_28_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_29_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_30_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_31_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_32_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_33_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_34_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_35_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_36_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_37_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_38_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_39_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_40_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_41_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_42_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_43_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_44_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_45_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_46_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_47_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_48_tcp_statistics_I [ 2 ]  ; extern  _GLOBAL_268_T  * _GLOBAL_49_tcp_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_tcp_statistics_I) *_GLOBAL_tcp_statistics_17_A[NUM_STACKS] = { &_GLOBAL_0_tcp_statistics_I, &_GLOBAL_1_tcp_statistics_I, &_GLOBAL_2_tcp_statistics_I, &_GLOBAL_3_tcp_statistics_I, &_GLOBAL_4_tcp_statistics_I, &_GLOBAL_5_tcp_statistics_I, &_GLOBAL_6_tcp_statistics_I, &_GLOBAL_7_tcp_statistics_I, &_GLOBAL_8_tcp_statistics_I, &_GLOBAL_9_tcp_statistics_I, &_GLOBAL_10_tcp_statistics_I, &_GLOBAL_11_tcp_statistics_I, &_GLOBAL_12_tcp_statistics_I, &_GLOBAL_13_tcp_statistics_I, &_GLOBAL_14_tcp_statistics_I, &_GLOBAL_15_tcp_statistics_I, &_GLOBAL_16_tcp_statistics_I, &_GLOBAL_17_tcp_statistics_I, &_GLOBAL_18_tcp_statistics_I, &_GLOBAL_19_tcp_statistics_I, &_GLOBAL_20_tcp_statistics_I, &_GLOBAL_21_tcp_statistics_I, &_GLOBAL_22_tcp_statistics_I, &_GLOBAL_23_tcp_statistics_I, &_GLOBAL_24_tcp_statistics_I, &_GLOBAL_25_tcp_statistics_I, &_GLOBAL_26_tcp_statistics_I, &_GLOBAL_27_tcp_statistics_I, &_GLOBAL_28_tcp_statistics_I, &_GLOBAL_29_tcp_statistics_I, &_GLOBAL_30_tcp_statistics_I, &_GLOBAL_31_tcp_statistics_I, &_GLOBAL_32_tcp_statistics_I, &_GLOBAL_33_tcp_statistics_I, &_GLOBAL_34_tcp_statistics_I, &_GLOBAL_35_tcp_statistics_I, &_GLOBAL_36_tcp_statistics_I, &_GLOBAL_37_tcp_statistics_I, &_GLOBAL_38_tcp_statistics_I, &_GLOBAL_39_tcp_statistics_I, &_GLOBAL_40_tcp_statistics_I, &_GLOBAL_41_tcp_statistics_I, &_GLOBAL_42_tcp_statistics_I, &_GLOBAL_43_tcp_statistics_I, &_GLOBAL_44_tcp_statistics_I, &_GLOBAL_45_tcp_statistics_I, &_GLOBAL_46_tcp_statistics_I, &_GLOBAL_47_tcp_statistics_I, &_GLOBAL_48_tcp_statistics_I, &_GLOBAL_49_tcp_statistics_I, };   
...
typedef  __u32  _GLOBAL_269_T; extern  _GLOBAL_269_T  _GLOBAL_0_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_1_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_2_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_3_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_4_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_5_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_6_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_7_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_8_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_9_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_10_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_11_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_12_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_13_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_14_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_15_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_16_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_17_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_18_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_19_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_20_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_21_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_22_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_23_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_24_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_25_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_26_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_27_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_28_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_29_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_30_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_31_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_32_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_33_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_34_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_35_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_36_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_37_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_38_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_39_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_40_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_41_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_42_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_43_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_44_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_45_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_46_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_47_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_48_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; extern  _GLOBAL_269_T  _GLOBAL_49_syncookie_secret_I [ 2 ]  [ 16 - 4  + 5  ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_syncookie_secret_I) *_GLOBAL_syncookie_secret_18_A[NUM_STACKS];  
...
{
 tp->pred_flags = (( __be32)__fswab32(((tp->tcp_header_len << 26) | __fswab32(( __u32)(__be32)(TCP_FLAG_ACK)) | snd_wnd)));
...
# 557 "linux-2.6.26/include/net/tcp.h"
struct tcp_skb_cb {
 union {
 ...
 __u32 when;
 __u8 flags;
# 581 "linux-2.6.26/include/net/tcp.h"
 __u8 sacked;
# 590 "linux-2.6.26/include/net/tcp.h"
 __u16 urg_ptr;
 __u32 ack_seq;
};
...
static inline  __attribute__((always_inline)) void tcp_dec_pcount_approx_int(__u32 *count, const int decr)
{
 if (*count) {
  *count -= decr;
  if ((int)*count < 0)
...
# 646 "linux-2.6.26/include/net/tcp.h"
struct tcp_congestion_ops {
 struct list_head list;
 unsigned long flags;
...
typedef  struct tcp_congestion_ops   _GLOBAL_270_T; extern  _GLOBAL_270_T  global_tcp_init_congestion_ops[NUM_STACKS];    
extern u32 tcp_reno_ssthresh(struct sock *sk);
extern void tcp_reno_cong_avoid(struct sock *sk, u32 ack, u32 in_flight);
extern u32 tcp_reno_min_cwnd(const struct sock *sk);
typedef  struct tcp_congestion_ops   _GLOBAL_271_T; extern  _GLOBAL_271_T  global_tcp_reno[NUM_STACKS];    
...
# 720 "linux-2.6.26/include/net/tcp.h"
...
# 759 "linux-2.6.26/include/net/tcp.h"
...
# 883 "linux-2.6.26/include/net/tcp.h"
static inline  __attribute__((always_inline)) int tcp_prequeue(struct sock *sk, struct sk_buff *skb)
{
 ...
 if (!global_sysctl_tcp_low_latency[get_stack_id()] && tp->ucopy.task) {
  ...
  if (tp->ucopy.memory > sk->sk_rcvbuf) {
   ...
   do { if (__builtin_expect(!!(((sk)->sk_lock.owned)), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);

   while ((skb1 = __skb_dequeue(&tp->ucopy.prequeue)) != ((void *)0)) {
    sk->sk_backlog_rcv(sk, skb1);
    (({ (void)((0)); (((*_GLOBAL_net_statistics_12_A[get_stack_id()])[0])); })->mibs[LINUX_MIB_TCPPREQUEUEDROPPED]++);
   }
...
# 923 "linux-2.6.26/include/net/tcp.h"
...
static inline  __attribute__((always_inline)) int tcp_paws_check(const struct tcp_options_received *rx_opt, int rst)
{
 if ((s32)(rx_opt->rcv_tsval - rx_opt->ts_recent) >= 0)
  return 0;
 if (get_seconds() >= rx_opt->ts_recent_stamp + (60 * 60 * 24 * 24))
  return 0;
# 1020 "linux-2.6.26/include/net/tcp.h"
...
static inline  __attribute__((always_inline)) void tcp_mib_init(void)
{
 ...
 do { ({ (void)((({ do { } while (0); 0; }))); (((*_GLOBAL_tcp_statistics_17_A[get_stack_id()])[1])); })->mibs[TCP_MIB_RTOALGORITHM] += 1; do { } while (0); } while (0);
 do { ({ (void)((({ do { } while (0); 0; }))); (((*_GLOBAL_tcp_statistics_17_A[get_stack_id()])[1])); })->mibs[TCP_MIB_RTOMIN] += ((unsigned)(1000/5))*1000/1000; do { } while (0); } while (0);
 do { ({ (void)((({ do { } while (0); 0; }))); (((*_GLOBAL_tcp_statistics_17_A[get_stack_id()])[1])); })->mibs[TCP_MIB_RTOMAX] += ((unsigned)(120*1000))*1000/1000; do { } while (0); } while (0);
 do { ({ (void)((({ do { } while (0); 0; }))); (((*_GLOBAL_tcp_statistics_17_A[get_stack_id()])[1])); })->mibs[TCP_MIB_MAXCONN] += -1; do { } while (0); } while (0);
}
...
static inline 
__attribute__((always_inline)) struct tcp_md5sig_pool *tcp_get_md5sig_pool(void)
{
...
static inline  __attribute__((always_inline)) void tcp_put_md5sig_pool(void)
{
...
# 1202 "linux-2.6.26/include/net/tcp.h"
...
static inline  __attribute__((always_inline)) int tcp_skb_is_last(const struct sock *sk,
      const struct sk_buff *skb)
{
...
typedef  struct request_sock_ops   _GLOBAL_272_T; extern  _GLOBAL_272_T  global_tcp_request_sock_ops[NUM_STACKS];    
typedef  struct request_sock_ops   _GLOBAL_273_T; extern  _GLOBAL_273_T  global_tcp6_request_sock_ops[NUM_STACKS];    
...
# 1382 "linux-2.6.26/include/net/tcp.h"
};
...
# 15 "linux-2.6.26/net/ipv4/tcp_yeah.c" 2

# 1 "linux-2.6.26/net/ipv4/tcp_vegas.h" 1
...
# 17 "linux-2.6.26/net/ipv4/tcp_yeah.c" 2
# 29 "linux-2.6.26/net/ipv4/tcp_yeah.c"
struct yeah {
 struct vegas vegas;
...
static void tcp_yeah_init(struct sock *sk)
{
 ...
 tp->snd_cwnd_clamp = ({ u32 __min1 = (tp->snd_cwnd_clamp); u32 __min2 = (0xffffffff/128); __min1 < __min2 ? __min1: __min2; });
...
static void tcp_yeah_cong_avoid(struct sock *sk, u32 ack, u32 in_flight)
{
 ...
 if (tp->snd_cwnd <= tp->snd_ssthresh)
  ...
  if (tp->snd_cwnd_cnt > ({ typeof(tp->snd_cwnd) _min1 = (tp->snd_cwnd); typeof(100U) _min2 = (100U); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; })){
...
# 129 "linux-2.6.26/net/ipv4/tcp_yeah.c"
 if (before(yeah->vegas.beg_snd_nxt, ack)) {
# 140 "linux-2.6.26/net/ipv4/tcp_yeah.c"
  if (yeah->vegas.cntRTT > 2) {
   u32 rtt, queue;
   u64 bw;
# 155 "linux-2.6.26/net/ipv4/tcp_yeah.c"
   ...
   ({ unsigned long __upper, __low, __high, __mod, __base; __base = (rtt); asm("":"=a" (__low), "=d" (__high) : "A" (bw)); __upper = __high; if (__high) { __upper = __high % (__base); __high = __high / (__base); } asm("divl %2":"=a" (__low), "=d" (__mod) : "rm" (__base), "0" (__low), "1" (__upper)); asm("":"=A" (bw) : "a" (__low), "d" (__high)); __mod; });
   queue = bw;

   if (queue > 80 ||
       rtt - yeah->vegas.baseRTT > (yeah->vegas.baseRTT / 8)) {
    if (queue > 80
        && tp->snd_cwnd > yeah->reno_count) {
     u32 reduction = ({ typeof(queue / 1) _min1 = (queue / 1); typeof(tp->snd_cwnd >> 1) _min2 = (tp->snd_cwnd >> 1); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });


     tp->snd_cwnd -= reduction;

     tp->snd_cwnd = ({ typeof(tp->snd_cwnd) _max1 = (tp->snd_cwnd); typeof(yeah->reno_count) _max2 = (yeah->reno_count); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
    ...
    if (yeah->reno_count <= 2)
     yeah->reno_count = ({ typeof(tp->snd_cwnd>>1) _max1 = (tp->snd_cwnd>>1); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
    else
     yeah->reno_count++;

    yeah->doing_reno_now = ({ typeof(yeah->doing_reno_now + 1) _min1 = (yeah->doing_reno_now + 1); typeof(0xffffffU) _min2 = (0xffffffU); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });

   } else {
    yeah->fast_count++;

    if (yeah->fast_count > 50) {
     yeah->reno_count = 2;
     yeah->fast_count = 0;
    }
...
static u32 tcp_yeah_ssthresh(struct sock *sk) {
 ...
 if (yeah->doing_reno_now < 16) {
  reduction = yeah->lastQ;

  reduction = ({ typeof(reduction) _min1 = (reduction); typeof(({ typeof(tp->snd_cwnd>>1) _max1 = (tp->snd_cwnd>>1); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; })) _min2 = (({ typeof(tp->snd_cwnd>>1) _max1 = (tp->snd_cwnd>>1); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; })); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });

  reduction = ({ typeof(reduction) _max1 = (reduction); typeof(tp->snd_cwnd >> 3) _max2 = (tp->snd_cwnd >> 3); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
 } else
  reduction = ({ typeof(tp->snd_cwnd>>1) _max1 = (tp->snd_cwnd>>1); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });

 yeah->fast_count = 0;
 yeah->reno_count = ({ typeof(yeah->reno_count>>1) _max1 = (yeah->reno_count>>1); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });

 return tp->snd_cwnd - reduction;
}

typedef  struct tcp_congestion_ops   _GLOBAL_274_T; static  _GLOBAL_274_T  global_tcp_yeah[NUM_STACKS] = {  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  { . flags  = 0x2  , . init  = tcp_yeah_init   , . ssthresh  = tcp_yeah_ssthresh   , . cong_avoid  = tcp_yeah_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . set_state  = tcp_vegas_state   , . cwnd_event  = tcp_vegas_cwnd_event   , . get_info  = tcp_vegas_get_info   , . pkts_acked  = tcp_yeah_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "yeah"   , } ,  };      
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) tcp_yeah_register(void)
{
 do { if (__builtin_expect(!!(sizeof(struct yeah) > (16 * sizeof(u32))), 0)) do { asm volatile("ud2"); for (;;) ; } while (0); } while(0);
 tcp_register_congestion_control(&global_tcp_yeah[get_stack_id()]);
 return 0;
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) tcp_yeah_unregister(void)
{
 tcp_unregister_congestion_control(&global_tcp_yeah[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_275_T; static  _GLOBAL_275_T  __initcall_tcp_yeah_register6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tcp_yeah_register ;       ;
typedef  exitcall_t  _GLOBAL_276_T; static  _GLOBAL_276_T  global___exitcall_tcp_yeah_unregister[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  tcp_yeah_unregister,  };       ;
