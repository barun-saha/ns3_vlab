# 1 "linux-2.6.26/net/ipv4/tcp_veno.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/tcp_veno.c"
# 12 "linux-2.6.26/net/ipv4/tcp_veno.c"
...
# 13 "linux-2.6.26/net/ipv4/tcp_veno.c" 2
...
{ }
# 14 "linux-2.6.26/net/ipv4/tcp_veno.c" 2
...
# 15 "linux-2.6.26/net/ipv4/tcp_veno.c" 2
...
# 16 "linux-2.6.26/net/ipv4/tcp_veno.c" 2
...
# 18 "linux-2.6.26/net/ipv4/tcp_veno.c" 2





typedef  const int   _GLOBAL_274_T; static  _GLOBAL_274_T  global_beta[NUM_STACKS] = {  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  };        
...
# 44 "linux-2.6.26/net/ipv4/tcp_veno.c"
static inline  __attribute__((always_inline)) void veno_enable(struct sock *sk)
{
...
static inline  __attribute__((always_inline)) void veno_disable(struct sock *sk)
{
 struct veno *veno = inet_csk_ca(sk);
...
static void tcp_veno_pkts_acked(struct sock *sk, u32 cnt, s32 rtt_us)
{
 ...
 veno->minrtt = ({ typeof(veno->minrtt) _min1 = (veno->minrtt); typeof(vrtt) _min2 = (vrtt); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
 veno->cntrtt++;
}
...
# 111 "linux-2.6.26/net/ipv4/tcp_veno.c"
...
static void tcp_veno_cong_avoid(struct sock *sk, u32 ack, u32 in_flight)
{
 ...
 if (veno->cntrtt <= 2) {
  ...
  target_cwnd <<= 1;
  ({ unsigned long __upper, __low, __high, __mod, __base; __base = (rtt); asm("":"=a" (__low), "=d" (__high) : "A" (target_cwnd)); __upper = __high; if (__high) { __upper = __high % (__base); __high = __high / (__base); } asm("divl %2":"=a" (__low), "=d" (__mod) : "rm" (__base), "0" (__low), "1" (__upper)); asm("":"=A" (target_cwnd) : "a" (__low), "d" (__high)); __mod; });

  veno->diff = (tp->snd_cwnd << 1) - target_cwnd;
  ...
  if (tp->snd_cwnd <= tp->snd_ssthresh) {
   ...
   if (veno->diff < global_beta[get_stack_id()]) {
...
static u32 tcp_veno_ssthresh(struct sock *sk)
{
 ...
 if (veno->diff < global_beta[get_stack_id()])
  ...
  return ({ typeof(tp->snd_cwnd * 4 / 5) _max1 = (tp->snd_cwnd * 4 / 5); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
 else

  return ({ typeof(tp->snd_cwnd >> 1U) _max1 = (tp->snd_cwnd >> 1U); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
}

typedef  struct tcp_congestion_ops   _GLOBAL_275_T; static  _GLOBAL_275_T  global_tcp_veno[NUM_STACKS] = {  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . flags  = 0x2  , . init  = tcp_veno_init   , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . pkts_acked  = tcp_veno_pkts_acked   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  };      
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) tcp_veno_register(void)
{
 ((void)sizeof(char[1 - 2*!!(sizeof(struct veno) > (16 * sizeof(u32)))]));
 tcp_register_congestion_control(&global_tcp_veno[get_stack_id()]);
 return 0;
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) tcp_veno_unregister(void)
{
 tcp_unregister_congestion_control(&global_tcp_veno[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_276_T; static  _GLOBAL_276_T  __initcall_tcp_veno_register6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tcp_veno_register ;       ;
typedef  exitcall_t  _GLOBAL_277_T; static  _GLOBAL_277_T  global___exitcall_tcp_veno_unregister[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  tcp_veno_unregister,  };       ;
