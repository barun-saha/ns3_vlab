# 1 "linux-2.6.26/net/ipv4/tcp_scalable.c"
...
{ }
# 9 "linux-2.6.26/net/ipv4/tcp_scalable.c" 2
...
# 10 "linux-2.6.26/net/ipv4/tcp_scalable.c" 2
# 18 "linux-2.6.26/net/ipv4/tcp_scalable.c"
static void tcp_scalable_cong_avoid(struct sock *sk, u32 ack, u32 in_flight)
{
 ...
 if (tp->snd_cwnd <= tp->snd_ssthresh)
  ...
  tp->snd_cwnd_cnt++;
  if (tp->snd_cwnd_cnt > ({ typeof(tp->snd_cwnd) _min1 = (tp->snd_cwnd); typeof(50U) _min2 = (50U); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; })){
...
{
 const struct tcp_sock *tp = tcp_sk(sk);
 return ({ typeof(tp->snd_cwnd - (tp->snd_cwnd>>3)) _max1 = (tp->snd_cwnd - (tp->snd_cwnd>>3)); typeof(2U) _max2 = (2U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
}


typedef  struct tcp_congestion_ops   _GLOBAL_274_T; static  _GLOBAL_274_T  global_tcp_scalable[NUM_STACKS] = {  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  { . ssthresh  = tcp_scalable_ssthresh  , . cong_avoid  = tcp_scalable_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "scalable"   , } ,  };      
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) tcp_scalable_register(void)
{
 return tcp_register_congestion_control(&global_tcp_scalable[get_stack_id()]);
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) tcp_scalable_unregister(void)
{
 tcp_unregister_congestion_control(&global_tcp_scalable[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_275_T; static  _GLOBAL_275_T  __initcall_tcp_scalable_register6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tcp_scalable_register ;       ;
typedef  exitcall_t  _GLOBAL_276_T; static  _GLOBAL_276_T  global___exitcall_tcp_scalable_unregister[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  tcp_scalable_unregister,  };       ;
