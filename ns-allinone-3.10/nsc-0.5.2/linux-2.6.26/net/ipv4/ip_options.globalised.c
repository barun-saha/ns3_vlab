# 1 "linux-2.6.26/net/ipv4/ip_options.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/ip_options.c"
# 14 "linux-2.6.26/net/ipv4/ip_options.c"
...
# 15 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
{ }
# 16 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
# 18 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
# 19 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
# 20 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
# 21 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
# 22 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
# 23 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
# 24 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      void *oldval, size_t *oldlenp,
      void *newval, size_t newlen);
# 25 "linux-2.6.26/net/ipv4/ip_options.c" 2
...
# 26 "linux-2.6.26/net/ipv4/ip_options.c" 2

# 1 "linux-2.6.26/include/net/cipso_ipv4.h" 1
# 42 "linux-2.6.26/include/net/cipso_ipv4.h"
# 1 "linux-2.6.26/include/net/netlabel.h" 1
# 37 "linux-2.6.26/include/net/netlabel.h"
# 1 "linux-2.6.26/include/asm/atomic.h" 1
# 38 "linux-2.6.26/include/net/netlabel.h" 2

struct cipso_v4_doi;
# 103 "linux-2.6.26/include/net/netlabel.h"
struct netlbl_audit {
 u32 secid;
 uid_t loginuid;
 u32 sessionid;
};
# 128 "linux-2.6.26/include/net/netlabel.h"
struct netlbl_lsm_cache {
 atomic_t refcount;
 void (*free) (const void *data);
 void *data;
};
# 158 "linux-2.6.26/include/net/netlabel.h"
struct netlbl_lsm_secattr_catmap {
 u32 startbit;
 u64 bitmap[4];
 struct netlbl_lsm_secattr_catmap *next;
};
# 184 "linux-2.6.26/include/net/netlabel.h"
struct netlbl_lsm_secattr {
 u32 flags;
# 200 "linux-2.6.26/include/net/netlabel.h"
 u32 type;
 char *domain;
...
# 225 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) struct netlbl_lsm_cache *netlbl_secattr_cache_alloc(gfp_t flags)
{
 struct netlbl_lsm_cache *cache;

 cache = kzalloc(sizeof(*cache), flags);
 if (cache)
  (((&cache->refcount)->counter) = (1));
 return cache;
}
# 243 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) void netlbl_secattr_cache_free(struct netlbl_lsm_cache *cache)
{
...
# 262 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) struct netlbl_lsm_secattr_catmap *netlbl_secattr_catmap_alloc(
                                                            gfp_t flags)
{
 return kzalloc(sizeof(struct netlbl_lsm_secattr_catmap), flags);
}
# 276 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) void netlbl_secattr_catmap_free(
...
# 296 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) void netlbl_secattr_init(struct netlbl_lsm_secattr *secattr)
{
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(*secattr))) ? __constant_c_and_count_memset(((secattr)),((0x01010101UL*(unsigned char)(0))),((sizeof(*secattr)))) : __constant_c_memset(((secattr)),((0x01010101UL*(unsigned char)(0))),((sizeof(*secattr))))) : (__builtin_constant_p((sizeof(*secattr))) ? __memset_generic((((secattr))),(((0))),(((sizeof(*secattr))))) : __memset_generic(((secattr)),((0)),((sizeof(*secattr))))));
}
# 310 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) void netlbl_secattr_destroy(struct netlbl_lsm_secattr *secattr)
{
 if (secattr->flags & 0x01000000)
  kfree(secattr->domain);
 if (secattr->flags & 0x00000002)
  netlbl_secattr_cache_free(secattr->cache);
 if (secattr->flags & 0x00000008)
  netlbl_secattr_catmap_free(secattr->attr.mls.cat);
}
# 329 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) struct netlbl_lsm_secattr *netlbl_secattr_alloc(gfp_t flags)
{
 return kzalloc(sizeof(struct netlbl_lsm_secattr), flags);
}
# 342 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) void netlbl_secattr_free(struct netlbl_lsm_secattr *secattr)
{
 netlbl_secattr_destroy(secattr);
 kfree(secattr);
}
# 397 "linux-2.6.26/include/net/netlabel.h"
static inline  __attribute__((always_inline)) int netlbl_cfg_map_del(const char *domain,
         struct netlbl_audit *audit_info)
{
 return -38;
}
static inline  __attribute__((always_inline)) int netlbl_cfg_unlbl_add_map(const char *domain,
        struct netlbl_audit *audit_info)
{
 return -38;
}
static inline  __attribute__((always_inline)) int netlbl_cfg_cipsov4_add(struct cipso_v4_doi *doi_def,
      struct netlbl_audit *audit_info)
{
 return -38;
}
static inline  __attribute__((always_inline)) int netlbl_cfg_cipsov4_add_map(struct cipso_v4_doi *doi_def,
          const char *domain,
          struct netlbl_audit *audit_info)
{
 return -38;
}
static inline  __attribute__((always_inline)) int netlbl_cfg_cipsov4_del(u32 doi,
      struct netlbl_audit *audit_info)
{
 return -38;
}
static inline  __attribute__((always_inline)) int netlbl_secattr_catmap_walk(
                               struct netlbl_lsm_secattr_catmap *catmap,
          u32 offset)
{
 return -2;
}
static inline  __attribute__((always_inline)) int netlbl_secattr_catmap_walk_rng(
          struct netlbl_lsm_secattr_catmap *catmap,
          u32 offset)
{
 return -2;
}
static inline  __attribute__((always_inline)) int netlbl_secattr_catmap_setbit(
                               struct netlbl_lsm_secattr_catmap *catmap,
          u32 bit,
          gfp_t flags)
{
...
static inline  __attribute__((always_inline)) int netlbl_secattr_catmap_setrng(
                               struct netlbl_lsm_secattr_catmap *catmap,
          u32 start,
          u32 end,
          gfp_t flags)
...
static inline  __attribute__((always_inline)) int netlbl_enabled(void)
{
 return 0;
}
static inline  __attribute__((always_inline)) int netlbl_sock_setattr(struct sock *sk,
         const struct netlbl_lsm_secattr *secattr)
{
 return -38;
}
static inline  __attribute__((always_inline)) int netlbl_sock_getattr(struct sock *sk,
          struct netlbl_lsm_secattr *secattr)
{
 return -38;
}
static inline  __attribute__((always_inline)) int netlbl_skbuff_getattr(const struct sk_buff *skb,
     u16 family,
     struct netlbl_lsm_secattr *secattr)
{
 return -38;
}
static inline  __attribute__((always_inline)) void netlbl_skbuff_err(struct sk_buff *skb, int error)
{
 return;
}
static inline  __attribute__((always_inline)) void netlbl_cache_invalidate(void)
{
 return;
}
static inline  __attribute__((always_inline)) int netlbl_cache_add(const struct sk_buff *skb,
       const struct netlbl_lsm_secattr *secattr)
{
 return 0;
}
# 43 "linux-2.6.26/include/net/cipso_ipv4.h" 2
# 74 "linux-2.6.26/include/net/cipso_ipv4.h"
struct cipso_v4_doi {
 u32 doi;
 u32 type;
 union {
...
# 142 "linux-2.6.26/include/net/cipso_ipv4.h"
static inline  __attribute__((always_inline)) int cipso_v4_doi_add(struct cipso_v4_doi *doi_def)
{
 return -38;
}

static inline  __attribute__((always_inline)) int cipso_v4_doi_remove(u32 doi,
        struct netlbl_audit *audit_info,
...
static inline  __attribute__((always_inline)) struct cipso_v4_doi *cipso_v4_doi_getdef(u32 doi)
{
 return ((void *)0);
}

static inline  __attribute__((always_inline)) int cipso_v4_doi_walk(u32 *skip_cnt,
...
static inline  __attribute__((always_inline)) int cipso_v4_doi_domhsh_add(struct cipso_v4_doi *doi_def,
       const char *domain)
{
 return -38;
}

static inline  __attribute__((always_inline)) int cipso_v4_doi_domhsh_remove(struct cipso_v4_doi *doi_def,
          const char *domain)
{
 return 0;
}
# 188 "linux-2.6.26/include/net/cipso_ipv4.h"
static inline  __attribute__((always_inline)) void cipso_v4_cache_invalidate(void)
{
 return;
}

static inline  __attribute__((always_inline)) int cipso_v4_cache_add(const struct sk_buff *skb,
         const struct netlbl_lsm_secattr *secattr)
{
 return 0;
}
# 214 "linux-2.6.26/include/net/cipso_ipv4.h"
static inline  __attribute__((always_inline)) void cipso_v4_error(struct sk_buff *skb,
      int error,
      u32 gateway)
{
 return;
...
static inline  __attribute__((always_inline)) int cipso_v4_sock_setattr(struct sock *sk,
...
static inline  __attribute__((always_inline)) int cipso_v4_sock_getattr(struct sock *sk,
     struct netlbl_lsm_secattr *secattr)
{
 return -38;
}

static inline  __attribute__((always_inline)) int cipso_v4_skbuff_getattr(const struct sk_buff *skb,
       struct netlbl_lsm_secattr *secattr)
{
 return -38;
}

static inline  __attribute__((always_inline)) int cipso_v4_validate(unsigned char **option)
{
 return -38;
}
# 28 "linux-2.6.26/net/ipv4/ip_options.c" 2
# 40 "linux-2.6.26/net/ipv4/ip_options.c"
void ip_options_build(struct sk_buff * skb, struct ip_options * opt,
       __be32 daddr, struct rtable *rt, int is_frag)
{
 unsigned char *iph = skb_network_header(skb);

 (__builtin_constant_p(sizeof(struct ip_options)) ? __constant_memcpy((&(((struct inet_skb_parm*)((skb)->cb))->opt)),(opt),(sizeof(struct ip_options))) : __memcpy((&(((struct inet_skb_parm*)((skb)->cb))->opt)),(opt),(sizeof(struct ip_options))));
 (__builtin_constant_p(opt->optlen) ? __constant_memcpy((iph+sizeof(struct iphdr)),(opt->__data),(opt->optlen)) : __memcpy((iph+sizeof(struct iphdr)),(opt->__data),(opt->optlen)));
 opt = &(((struct inet_skb_parm*)((skb)->cb))->opt);

 if (opt->srr)
  (__builtin_constant_p(4) ? __constant_memcpy((iph+opt->srr+iph[opt->srr+1]-4),(&daddr),(4)) : __memcpy((iph+opt->srr+iph[opt->srr+1]-4),(&daddr),(4)));
 ...
 if (!is_frag) {
  ...
  if (opt->ts_needtime) {
   ...
   __be32 midtime;
   getnstimeofday(&tv);
   midtime = (( __be32)__fswab32(((tv.tv_sec % 86400) * 1000L + tv.tv_nsec / 1000000L)));
   (__builtin_constant_p(4) ? __constant_memcpy((iph+opt->ts+iph[opt->ts+2]-5),(&midtime),(4)) : __memcpy((iph+opt->ts+iph[opt->ts+2]-5),(&midtime),(4)));
  }
  return;
 }
 if (opt->rr) {
  (__builtin_constant_p((1 |0x00)) ? (__builtin_constant_p((iph[opt->rr+1])) ? __constant_c_and_count_memset(((iph+opt->rr)),((0x01010101UL*(unsigned char)((1 |0x00)))),((iph[opt->rr+1]))) : __constant_c_memset(((iph+opt->rr)),((0x01010101UL*(unsigned char)((1 |0x00)))),((iph[opt->rr+1])))) : (__builtin_constant_p((iph[opt->rr+1])) ? __memset_generic((((iph+opt->rr))),((((1 |0x00)))),(((iph[opt->rr+1])))) : __memset_generic(((iph+opt->rr)),(((1 |0x00))),((iph[opt->rr+1])))));
  opt->rr = 0;
  opt->rr_needaddr = 0;
 }
 if (opt->ts) {
  (__builtin_constant_p((1 |0x00)) ? (__builtin_constant_p((iph[opt->ts+1])) ? __constant_c_and_count_memset(((iph+opt->ts)),((0x01010101UL*(unsigned char)((1 |0x00)))),((iph[opt->ts+1]))) : __constant_c_memset(((iph+opt->ts)),((0x01010101UL*(unsigned char)((1 |0x00)))),((iph[opt->ts+1])))) : (__builtin_constant_p((iph[opt->ts+1])) ? __memset_generic((((iph+opt->ts))),((((1 |0x00)))),(((iph[opt->ts+1])))) : __memset_generic(((iph+opt->ts)),(((1 |0x00))),((iph[opt->ts+1])))));
  opt->ts = 0;
  opt->ts_needaddr = opt->ts_needtime = 0;
 }
}
# 87 "linux-2.6.26/net/ipv4/ip_options.c"
int ip_options_echo(struct ip_options * dopt, struct sk_buff * skb)
{
 ...
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(struct ip_options))) ? __constant_c_and_count_memset(((dopt)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct ip_options)))) : __constant_c_memset(((dopt)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct ip_options))))) : (__builtin_constant_p((sizeof(struct ip_options))) ? __memset_generic((((dopt))),(((0))),(((sizeof(struct ip_options))))) : __memset_generic(((dopt)),((0)),((sizeof(struct ip_options))))));

 sopt = &(((struct inet_skb_parm*)((skb)->cb))->opt);
 ...
 if (sopt->rr) {
  ...
  (__builtin_constant_p(optlen) ? __constant_memcpy((dptr),(sptr+sopt->rr),(optlen)) : __memcpy((dptr),(sptr+sopt->rr),(optlen)));
 ...
 if (sopt->ts) {
  ...
  (__builtin_constant_p(optlen) ? __constant_memcpy((dptr),(sptr+sopt->ts),(optlen)) : __memcpy((dptr),(sptr+sopt->ts),(optlen)));
  if (soffset <= optlen) {
   if (sopt->ts_needaddr) {
    if (soffset + 3 > optlen)
     return -22;
   ...
   if (sopt->ts_needtime) {
    ...
    if ((dptr[3]&0xF) != 3) {
     ...
     if (soffset + 8 <= optlen) {
      ...
      (__builtin_constant_p(4) ? __constant_memcpy((&addr),(sptr+soffset-1),(4)) : __memcpy((&addr),(sptr+soffset-1),(4)));
 ...
 if (sopt->srr) {
  ...
  soffset -= 4;
  if (soffset > 3) {
   (__builtin_constant_p(4) ? __constant_memcpy((&faddr),(&start[soffset-1]),(4)) : __memcpy((&faddr),(&start[soffset-1]),(4)));
   for (soffset-=4, doffset=4; soffset > 3; soffset-=4, doffset+=4)
    (__builtin_constant_p(4) ? __constant_memcpy((&dptr[doffset-1]),(&start[soffset-1]),(4)) : __memcpy((&dptr[doffset-1]),(&start[soffset-1]),(4)));



   if (__builtin_memcmp(&ip_hdr(skb)->saddr,
       &start[soffset + 3], 4) == 0)
    doffset -= 4;
  }
  if (doffset > 3) {
   (__builtin_constant_p(4) ? __constant_memcpy((&start[doffset-1]),(&daddr),(4)) : __memcpy((&start[doffset-1]),(&daddr),(4)));
   dopt->faddr = faddr;
   dptr[0] = start[0];
   dptr[1] = doffset+3;
   dptr[2] = 4;
 ...
 if (sopt->cipso) {
  ...
  (__builtin_constant_p(optlen) ? __constant_memcpy((dptr),(sptr+sopt->cipso),(optlen)) : __memcpy((dptr),(sptr+sopt->cipso),(optlen)));
  dptr += optlen;
  dopt->optlen += optlen;
 }
 while (dopt->optlen & 3) {
...
void ip_options_fragment(struct sk_buff * skb)
{
 ...
 while (l > 0) {
  ...
  if (optlen<2 || optlen>l)
    return;
  if (!((*optptr)&0x80))
   (__builtin_constant_p((1 |0x00)) ? (__builtin_constant_p((optlen)) ? __constant_c_and_count_memset(((optptr)),((0x01010101UL*(unsigned char)((1 |0x00)))),((optlen))) : __constant_c_memset(((optptr)),((0x01010101UL*(unsigned char)((1 |0x00)))),((optlen)))) : (__builtin_constant_p((optlen)) ? __memset_generic((((optptr))),((((1 |0x00)))),(((optlen)))) : __memset_generic(((optptr)),(((1 |0x00))),((optlen)))));
  l -= optlen;
  optptr += optlen;
 }
 opt->ts = 0;
 ...
 for (l = opt->optlen; l > 0; ) {
  ...
  switch (*optptr) {
   ...
   if (!skb) {
    ...
    (__builtin_constant_p(4) ? __constant_memcpy((&opt->faddr),(&optptr[3]),(4)) : __memcpy((&opt->faddr),(&optptr[3]),(4)));
    if (optlen > 7)
     memmove(&optptr[3], &optptr[7], optlen-7);
   }
   opt->is_strictroute = (optptr[0] == (9 |0x00|0x80));
   opt->srr = optptr - iph;
   break;
        case (7 |0x00):
   if (opt->rr) {
   ...
   if (optptr[2] <= optlen) {
    ...
    if (skb) {
     (__builtin_constant_p(4) ? __constant_memcpy((&optptr[optptr[2]-1]),(&rt->rt_spec_dst),(4)) : __memcpy((&optptr[optptr[2]-1]),(&rt->rt_spec_dst),(4)));
     opt->is_changed = 1;
    }
    optptr[2] += 4;
    opt->rr_needaddr = 1;
   ...
   if (optptr[2] <= optlen) {
    ...
    switch (optptr[3]&0xF) {
     ...
     {
      __be32 addr;
      (__builtin_constant_p(4) ? __constant_memcpy((&addr),(&optptr[optptr[2]-1]),(4)) : __memcpy((&addr),(&optptr[optptr[2]-1]),(4)));
    ...
    if (timeptr) {
     ...
     getnstimeofday(&tv);
     midtime = (( __be32)__fswab32(((tv.tv_sec % 86400) * 1000L + tv.tv_nsec / 1000000L)));
     (__builtin_constant_p(sizeof(__be32)) ? __constant_memcpy((timeptr),(&midtime),(sizeof(__be32))) : __memcpy((timeptr),(&midtime),(sizeof(__be32))));
     opt->is_changed = 1;
    }
   } else {
...
error:
 if (skb) {
  icmp_send(skb, 12, 0, (( __be32)__fswab32(((pp_ptr-iph)<<24))));
 }
 return -22;
}
...
void ip_options_undo(struct ip_options * opt)
{
 if (opt->srr) {
  ...
  (__builtin_constant_p(4) ? __constant_memcpy((optptr+3),(&opt->faddr),(4)) : __memcpy((optptr+3),(&opt->faddr),(4)));
 }
 if (opt->rr_needaddr) {
  unsigned char * optptr = opt->__data+opt->rr-sizeof(struct iphdr);
  optptr[2] -= 4;
  (__builtin_constant_p(0) ? (__builtin_constant_p((4)) ? __constant_c_and_count_memset(((&optptr[optptr[2]-1])),((0x01010101UL*(unsigned char)(0))),((4))) : __constant_c_memset(((&optptr[optptr[2]-1])),((0x01010101UL*(unsigned char)(0))),((4)))) : (__builtin_constant_p((4)) ? __memset_generic((((&optptr[optptr[2]-1]))),(((0))),(((4)))) : __memset_generic(((&optptr[optptr[2]-1])),((0)),((4)))));
 }
 if (opt->ts) {
     ...
     unsigned char *data, int optlen)
{
 ...
 if (!opt)
  return -12;
 if (optlen)
  (__builtin_constant_p(optlen) ? __constant_memcpy((opt->__data),(data),(optlen)) : __memcpy((opt->__data),(data),(optlen)));
 return ip_options_get_finish(net, optp, opt, optlen);
}
 ...
 if (opt->srr_is_hit) {
  ...
  for ( srrptr=optptr[2], srrspace = optptr[1];
   ...
   if (srrptr + 3 > srrspace)
    break;
   if (__builtin_memcmp(&rt->rt_dst, &optptr[srrptr-1], 4) == 0)
    break;
  }
  if (srrptr + 3 <= srrspace) {
   opt->is_changed = 1;
   ...
   printk("<2>" "ip_forward(): Argh! Destination lost!\n");
  if (opt->ts_needaddr) {
   optptr = raw + opt->ts;
...
int ip_options_rcv_srr(struct sk_buff *skb)
{
 ...
 if (rt->rt_type == RTN_UNICAST) {
  if (!opt->is_strictroute)
   return 0;
  icmp_send(skb, 12, 0, (( __be32)__fswab32((16<<24))));
  return -22;
 }
 ...
 for (srrptr=optptr[2], srrspace = optptr[1]; srrptr <= srrspace; srrptr += 4) {
  if (srrptr + 3 > srrspace) {
   icmp_send(skb, 12, 0, (( __be32)__fswab32(((opt->srr+2)<<24))));
   return -22;
  }
  (__builtin_constant_p(4) ? __constant_memcpy((&nexthop),(&optptr[srrptr-1]),(4)) : __memcpy((&nexthop),(&optptr[srrptr-1]),(4)));
  ...
  (__builtin_constant_p(4) ? __constant_memcpy((&iph->daddr),(&optptr[srrptr-1]),(4)) : __memcpy((&iph->daddr),(&optptr[srrptr-1]),(4)));
  opt->is_changed = 1;
 }
 if (srrptr <= srrspace) {
  opt->srr_is_hit = 1;
