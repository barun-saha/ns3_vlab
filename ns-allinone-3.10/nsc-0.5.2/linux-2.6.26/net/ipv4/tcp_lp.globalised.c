# 1 "linux-2.6.26/net/ipv4/tcp_lp.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/tcp_lp.c"
# 36 "linux-2.6.26/net/ipv4/tcp_lp.c"
...
{ }
# 37 "linux-2.6.26/net/ipv4/tcp_lp.c" 2
...
# 38 "linux-2.6.26/net/ipv4/tcp_lp.c" 2
# 52 "linux-2.6.26/net/ipv4/tcp_lp.c"
enum tcp_lp_state {
 LP_VALID_RHZ = (1 << 0),
 LP_VALID_OWD = (1 << 1),
 LP_WITHIN_THR = (1 << 3),
...
# 76 "linux-2.6.26/net/ipv4/tcp_lp.c"
struct lp {
 u32 flag;
 u32 sowd;
 u32 owd_min;
...
# 118 "linux-2.6.26/net/ipv4/tcp_lp.c"
...
# 133 "linux-2.6.26/net/ipv4/tcp_lp.c"
...
# 186 "linux-2.6.26/net/ipv4/tcp_lp.c"
static u32 tcp_lp_owd_calculator(struct sock *sk)
{
 ...
 if (lp->flag & LP_VALID_RHZ) {
  owd =
      tp->rx_opt.rcv_tsval * (1000 / lp->remote_hz) -
      tp->rx_opt.rcv_tsecr * (1000 / 1000);
  if (owd < 0)
   owd = -owd;
 }
...
# 220 "linux-2.6.26/net/ipv4/tcp_lp.c"
...
# 263 "linux-2.6.26/net/ipv4/tcp_lp.c"
static void tcp_lp_pkts_acked(struct sock *sk, u32 num_acked, s32 rtt_us)
{
 ...
 if (((__u32)(global_jiffies[get_stack_id()])) > tp->rx_opt.rcv_tsecr)
  lp->inference = 3 * (((__u32)(global_jiffies[get_stack_id()])) - tp->rx_opt.rcv_tsecr);


 if (lp->last_drop && (((__u32)(global_jiffies[get_stack_id()])) - lp->last_drop < lp->inference))
 ...
 ({ if (0) printk("<7>" "TCP-LP: %05o|%5u|%5u|%15u|%15u|%15u\n", lp->flag, tp->snd_cwnd, lp->remote_hz, lp->owd_min, lp->owd_max, lp->sowd >> 3); 0; });
 ...
 if (lp->flag & LP_WITHIN_INF)
  ...
  tp->snd_cwnd = ({ typeof(tp->snd_cwnd >> 1U) _max1 = (tp->snd_cwnd >> 1U); typeof(1U) _max2 = (1U); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });


 lp->last_drop = ((__u32)(global_jiffies[get_stack_id()]));
}

typedef  struct tcp_congestion_ops   _GLOBAL_274_T; static  _GLOBAL_274_T  global_tcp_lp[NUM_STACKS] = {  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . flags  = 0x2  , . init  = tcp_lp_init   , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  };      
...
static int   __attribute__ ((__section__(".init.text"))) __attribute__((__cold__)) tcp_lp_register(void)
{
 ((void)sizeof(char[1 - 2*!!(sizeof(struct lp) > (16 * sizeof(u32)))]));
 return tcp_register_congestion_control(&global_tcp_lp[get_stack_id()]);
}

static void    __attribute__ ((__section__(".exit.text"))) __attribute__((__used__)) __attribute__((__cold__)) tcp_lp_unregister(void)
{
 tcp_unregister_congestion_control(&global_tcp_lp[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_275_T; static  _GLOBAL_275_T  __initcall_tcp_lp_register6 __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tcp_lp_register ;       ;
typedef  exitcall_t  _GLOBAL_276_T; static  _GLOBAL_276_T  global___exitcall_tcp_lp_unregister[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__(".exitcall.exit")))   = {  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  tcp_lp_unregister,  };       ;
