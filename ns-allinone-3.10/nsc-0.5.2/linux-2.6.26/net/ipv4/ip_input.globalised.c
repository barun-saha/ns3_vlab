# 1 "linux-2.6.26/net/ipv4/ip_input.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/ip_input.c"
# 118 "linux-2.6.26/net/ipv4/ip_input.c"
...
# 119 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
typedef  char  _GLOBAL_15_T; extern  _GLOBAL_15_T  * global_saved_command_line[NUM_STACKS];   
typedef  unsigned int   _GLOBAL_16_T; extern  _GLOBAL_16_T  global_reset_devices[NUM_STACKS];    


void setup_arch(char **);
void prepare_namespace(void);

typedef  void   ( *_GLOBAL_18_T  )  ( void  ) ; extern  _GLOBAL_18_T global_late_time_init[NUM_STACKS];   
...
{ }
# 120 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
typedef  unsigned int   _GLOBAL_77_T; extern  _GLOBAL_77_T  global___invalid_size_argument_for_IOC[NUM_STACKS];    
...
typedef  int  _GLOBAL_78_T; extern  _GLOBAL_78_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_79_T; extern  _GLOBAL_79_T  global_net_msg_burst[NUM_STACKS];   
# 126 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
# 8 "linux-2.6.26/include/linux/inetdevice.h" 2
# 1 "linux-2.6.26/include/linux/netdevice.h" 1
# 29 "linux-2.6.26/include/linux/netdevice.h"
...
# 9 "linux-2.6.26/include/linux/inetdevice.h" 2
...
# 131 "linux-2.6.26/net/ipv4/ip_input.c" 2

# 1 "linux-2.6.26/include/linux/etherdevice.h" 1
# 32 "linux-2.6.26/include/linux/etherdevice.h"
extern __be16 eth_type_trans(struct sk_buff *skb, struct net_device *dev);
typedef  const struct header_ops    _GLOBAL_144_T; extern  _GLOBAL_144_T  global_eth_header_ops[NUM_STACKS];     
...
# 133 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
# 135 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
typedef  atomic_t  _GLOBAL_145_T; extern  _GLOBAL_145_T  global_flow_cache_genid[NUM_STACKS];   
...
typedef  int  _GLOBAL_146_T; extern  _GLOBAL_146_T  global_debug_locks[NUM_STACKS];   
typedef  int  _GLOBAL_147_T; extern  _GLOBAL_147_T  global_debug_locks_silent[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_148_T; extern  _GLOBAL_148_T  global_max_mapnr[NUM_STACKS];    


typedef  unsigned long   _GLOBAL_149_T; extern  _GLOBAL_149_T  global_num_physpages[NUM_STACKS];    
typedef  void  _GLOBAL_150_T; extern  _GLOBAL_150_T  * global_high_memory[NUM_STACKS];    
...
typedef  unsigned long   _GLOBAL_153_T; extern  _GLOBAL_153_T  global_mmap_min_addr[NUM_STACKS];    


# 1 "linux-2.6.26/include/asm/pgtable.h" 1
# 92 "linux-2.6.26/include/asm/pgtable.h"
typedef  pteval_t  _GLOBAL_154_T; extern  _GLOBAL_154_T  global___PAGE_KERNEL[NUM_STACKS]; extern  _GLOBAL_154_T  global___PAGE_KERNEL_EXEC[NUM_STACKS];    
...
typedef  struct list_head   _GLOBAL_156_T; extern  _GLOBAL_156_T  global_pgd_list[NUM_STACKS];    
...
typedef  pteval_t  _GLOBAL_157_T; extern  _GLOBAL_157_T  global___supported_pte_mask[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_158_T; extern  _GLOBAL_158_T  global___FIXADDR_TOP[NUM_STACKS];    
...
typedef  struct kmem_cache   _GLOBAL_159_T; extern  _GLOBAL_159_T  * global_vm_area_cachep[NUM_STACKS];    
...
typedef  struct rb_root   _GLOBAL_160_T; extern  _GLOBAL_160_T  global_nommu_vma_tree[NUM_STACKS];    
typedef  struct rw_semaphore   _GLOBAL_161_T; extern  _GLOBAL_161_T  global_nommu_vma_sem[NUM_STACKS];    
...
typedef  atomic_long_t  _GLOBAL_162_T; extern  _GLOBAL_162_T  vm_stat [ NR_VM_ZONE_STAT_ITEMS ] ;   
...
typedef  unsigned long   _GLOBAL_190_T; extern  _GLOBAL_190_T  global_mmap_min_addr[NUM_STACKS];    
...
typedef  const struct nla_policy    _GLOBAL_191_T; extern  _GLOBAL_191_T  _GLOBAL_0_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_1_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_2_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_3_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_4_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_5_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_6_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_7_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_8_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_9_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_10_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_11_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_12_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_13_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_14_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_15_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_16_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_17_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_18_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_19_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_20_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_21_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_22_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_23_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_24_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_25_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_26_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_27_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_28_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_29_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_30_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_31_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_32_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_33_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_34_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_35_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_36_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_37_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_38_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_39_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_40_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_41_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_42_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_43_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_44_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_45_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_46_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_47_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_48_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; extern  _GLOBAL_191_T  _GLOBAL_49_ifla_policy_I [ ( __IFLA_MAX - 1  )  + 1  ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ifla_policy_I) *_GLOBAL_ifla_policy_7_A[NUM_STACKS];      
...
typedef  int  _GLOBAL_192_T; extern  _GLOBAL_192_T  global_net_msg_warn[NUM_STACKS];   
# 1358 "linux-2.6.26/include/net/sock.h"
typedef  __u32  _GLOBAL_193_T; extern  _GLOBAL_193_T  global_sysctl_wmem_max[NUM_STACKS];   
typedef  __u32  _GLOBAL_194_T; extern  _GLOBAL_194_T  global_sysctl_rmem_max[NUM_STACKS];   

extern void sk_init(void);

typedef  int  _GLOBAL_195_T; extern  _GLOBAL_195_T  global_sysctl_optmem_max[NUM_STACKS];   

typedef  __u32  _GLOBAL_196_T; extern  _GLOBAL_196_T  global_sysctl_wmem_default[NUM_STACKS];   
typedef  __u32  _GLOBAL_197_T; extern  _GLOBAL_197_T  global_sysctl_rmem_default[NUM_STACKS];   
...
typedef  int  _GLOBAL_198_T; extern  _GLOBAL_198_T  global_sysctl_max_syn_backlog[NUM_STACKS];   
...
typedef  spinlock_t  _GLOBAL_199_T; extern  _GLOBAL_199_T  global_inet_peer_idlock[NUM_STACKS];   
...
typedef  struct ip_rt_acct   _GLOBAL_200_T; extern  _GLOBAL_200_T  * global_ip_rt_acct[NUM_STACKS];    
...
typedef  const __u8   _GLOBAL_201_T; extern  _GLOBAL_201_T  _GLOBAL_0_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_1_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_2_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_3_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_4_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_5_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_6_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_7_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_8_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_9_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_10_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_11_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_12_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_13_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_14_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_15_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_16_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_17_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_18_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_19_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_20_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_21_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_22_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_23_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_24_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_25_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_26_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_27_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_28_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_29_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_30_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_31_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_32_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_33_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_34_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_35_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_36_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_37_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_38_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_39_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_40_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_41_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_42_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_43_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_44_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_45_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_46_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_47_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_48_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_201_T  _GLOBAL_49_ip_tos2prio_I [ 16 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_tos2prio_I) *_GLOBAL_ip_tos2prio_8_A[NUM_STACKS] = { &_GLOBAL_0_ip_tos2prio_I, &_GLOBAL_1_ip_tos2prio_I, &_GLOBAL_2_ip_tos2prio_I, &_GLOBAL_3_ip_tos2prio_I, &_GLOBAL_4_ip_tos2prio_I, &_GLOBAL_5_ip_tos2prio_I, &_GLOBAL_6_ip_tos2prio_I, &_GLOBAL_7_ip_tos2prio_I, &_GLOBAL_8_ip_tos2prio_I, &_GLOBAL_9_ip_tos2prio_I, &_GLOBAL_10_ip_tos2prio_I, &_GLOBAL_11_ip_tos2prio_I, &_GLOBAL_12_ip_tos2prio_I, &_GLOBAL_13_ip_tos2prio_I, &_GLOBAL_14_ip_tos2prio_I, &_GLOBAL_15_ip_tos2prio_I, &_GLOBAL_16_ip_tos2prio_I, &_GLOBAL_17_ip_tos2prio_I, &_GLOBAL_18_ip_tos2prio_I, &_GLOBAL_19_ip_tos2prio_I, &_GLOBAL_20_ip_tos2prio_I, &_GLOBAL_21_ip_tos2prio_I, &_GLOBAL_22_ip_tos2prio_I, &_GLOBAL_23_ip_tos2prio_I, &_GLOBAL_24_ip_tos2prio_I, &_GLOBAL_25_ip_tos2prio_I, &_GLOBAL_26_ip_tos2prio_I, &_GLOBAL_27_ip_tos2prio_I, &_GLOBAL_28_ip_tos2prio_I, &_GLOBAL_29_ip_tos2prio_I, &_GLOBAL_30_ip_tos2prio_I, &_GLOBAL_31_ip_tos2prio_I, &_GLOBAL_32_ip_tos2prio_I, &_GLOBAL_33_ip_tos2prio_I, &_GLOBAL_34_ip_tos2prio_I, &_GLOBAL_35_ip_tos2prio_I, &_GLOBAL_36_ip_tos2prio_I, &_GLOBAL_37_ip_tos2prio_I, &_GLOBAL_38_ip_tos2prio_I, &_GLOBAL_39_ip_tos2prio_I, &_GLOBAL_40_ip_tos2prio_I, &_GLOBAL_41_ip_tos2prio_I, &_GLOBAL_42_ip_tos2prio_I, &_GLOBAL_43_ip_tos2prio_I, &_GLOBAL_44_ip_tos2prio_I, &_GLOBAL_45_ip_tos2prio_I, &_GLOBAL_46_ip_tos2prio_I, &_GLOBAL_47_ip_tos2prio_I, &_GLOBAL_48_ip_tos2prio_I, &_GLOBAL_49_ip_tos2prio_I, };   
...
typedef  ctl_table  _GLOBAL_202_T; extern  _GLOBAL_202_T  _GLOBAL_0_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_1_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_2_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_3_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_4_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_5_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_6_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_7_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_8_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_9_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_10_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_11_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_12_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_13_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_14_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_15_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_16_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_17_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_18_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_19_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_20_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_21_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_22_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_23_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_24_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_25_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_26_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_27_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_28_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_29_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_30_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_31_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_32_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_33_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_34_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_35_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_36_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_37_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_38_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_39_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_40_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_41_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_42_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_43_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_44_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_45_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_46_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_47_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_48_ipv4_route_table_I [ ] ; extern  _GLOBAL_202_T  _GLOBAL_49_ipv4_route_table_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv4_route_table_I) *_GLOBAL_ipv4_route_table_9_A[NUM_STACKS];  
...
typedef  u32  _GLOBAL_203_T; extern  _GLOBAL_203_T  global_inet_ehash_secret[NUM_STACKS];   
...
typedef  struct ip_ra_chain   _GLOBAL_204_T; extern  _GLOBAL_204_T  * global_ip_ra_chain[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_205_T; extern  _GLOBAL_205_T  global_ip_ra_lock[NUM_STACKS];   
...
typedef  struct ipv4_config   _GLOBAL_206_T; extern  _GLOBAL_206_T  global_ipv4_config[NUM_STACKS];    
typedef  __typeof__ ( struct ipstats_mib  )   _GLOBAL_207_T; extern  _GLOBAL_207_T  * _GLOBAL_0_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_1_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_2_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_3_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_4_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_5_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_6_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_7_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_8_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_9_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_10_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_11_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_12_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_13_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_14_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_15_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_16_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_17_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_18_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_19_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_20_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_21_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_22_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_23_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_24_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_25_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_26_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_27_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_28_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_29_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_30_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_31_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_32_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_33_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_34_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_35_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_36_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_37_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_38_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_39_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_40_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_41_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_42_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_43_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_44_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_45_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_46_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_47_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_48_ip_statistics_I [ 2 ]  ; extern  _GLOBAL_207_T  * _GLOBAL_49_ip_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_statistics_I) *_GLOBAL_ip_statistics_10_A[NUM_STACKS] = { &_GLOBAL_0_ip_statistics_I, &_GLOBAL_1_ip_statistics_I, &_GLOBAL_2_ip_statistics_I, &_GLOBAL_3_ip_statistics_I, &_GLOBAL_4_ip_statistics_I, &_GLOBAL_5_ip_statistics_I, &_GLOBAL_6_ip_statistics_I, &_GLOBAL_7_ip_statistics_I, &_GLOBAL_8_ip_statistics_I, &_GLOBAL_9_ip_statistics_I, &_GLOBAL_10_ip_statistics_I, &_GLOBAL_11_ip_statistics_I, &_GLOBAL_12_ip_statistics_I, &_GLOBAL_13_ip_statistics_I, &_GLOBAL_14_ip_statistics_I, &_GLOBAL_15_ip_statistics_I, &_GLOBAL_16_ip_statistics_I, &_GLOBAL_17_ip_statistics_I, &_GLOBAL_18_ip_statistics_I, &_GLOBAL_19_ip_statistics_I, &_GLOBAL_20_ip_statistics_I, &_GLOBAL_21_ip_statistics_I, &_GLOBAL_22_ip_statistics_I, &_GLOBAL_23_ip_statistics_I, &_GLOBAL_24_ip_statistics_I, &_GLOBAL_25_ip_statistics_I, &_GLOBAL_26_ip_statistics_I, &_GLOBAL_27_ip_statistics_I, &_GLOBAL_28_ip_statistics_I, &_GLOBAL_29_ip_statistics_I, &_GLOBAL_30_ip_statistics_I, &_GLOBAL_31_ip_statistics_I, &_GLOBAL_32_ip_statistics_I, &_GLOBAL_33_ip_statistics_I, &_GLOBAL_34_ip_statistics_I, &_GLOBAL_35_ip_statistics_I, &_GLOBAL_36_ip_statistics_I, &_GLOBAL_37_ip_statistics_I, &_GLOBAL_38_ip_statistics_I, &_GLOBAL_39_ip_statistics_I, &_GLOBAL_40_ip_statistics_I, &_GLOBAL_41_ip_statistics_I, &_GLOBAL_42_ip_statistics_I, &_GLOBAL_43_ip_statistics_I, &_GLOBAL_44_ip_statistics_I, &_GLOBAL_45_ip_statistics_I, &_GLOBAL_46_ip_statistics_I, &_GLOBAL_47_ip_statistics_I, &_GLOBAL_48_ip_statistics_I, &_GLOBAL_49_ip_statistics_I, };   




typedef  __typeof__ ( struct linux_mib  )   _GLOBAL_208_T; extern  _GLOBAL_208_T  * _GLOBAL_0_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_1_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_2_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_3_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_4_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_5_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_6_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_7_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_8_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_9_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_10_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_11_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_12_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_13_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_14_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_15_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_16_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_17_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_18_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_19_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_20_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_21_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_22_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_23_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_24_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_25_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_26_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_27_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_28_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_29_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_30_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_31_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_32_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_33_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_34_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_35_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_36_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_37_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_38_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_39_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_40_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_41_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_42_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_43_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_44_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_45_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_46_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_47_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_48_net_statistics_I [ 2 ]  ; extern  _GLOBAL_208_T  * _GLOBAL_49_net_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_statistics_I) *_GLOBAL_net_statistics_11_A[NUM_STACKS];   
...
typedef  int  _GLOBAL_209_T; extern  _GLOBAL_209_T  global_sysctl_ip_default_ttl[NUM_STACKS];   
typedef  int  _GLOBAL_210_T; extern  _GLOBAL_210_T  global_sysctl_ip_nonlocal_bind[NUM_STACKS];   

typedef  struct ctl_path   _GLOBAL_211_T; extern  _GLOBAL_211_T  _GLOBAL_0_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_1_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_2_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_3_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_4_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_5_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_6_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_7_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_8_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_9_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_10_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_11_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_12_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_13_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_14_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_15_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_16_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_17_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_18_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_19_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_20_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_21_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_22_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_23_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_24_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_25_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_26_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_27_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_28_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_29_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_30_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_31_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_32_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_33_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_34_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_35_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_36_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_37_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_38_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_39_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_40_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_41_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_42_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_43_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_44_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_45_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_46_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_47_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_48_net_ipv4_ctl_path_I [ ] ; extern  _GLOBAL_211_T  _GLOBAL_49_net_ipv4_ctl_path_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_ipv4_ctl_path_I) *_GLOBAL_net_ipv4_ctl_path_12_A[NUM_STACKS];   


typedef  int  _GLOBAL_212_T; extern  _GLOBAL_212_T  global_inet_peer_threshold[NUM_STACKS];   
typedef  int  _GLOBAL_213_T; extern  _GLOBAL_213_T  global_inet_peer_minttl[NUM_STACKS];   
typedef  int  _GLOBAL_214_T; extern  _GLOBAL_214_T  global_inet_peer_maxttl[NUM_STACKS];   
typedef  int  _GLOBAL_215_T; extern  _GLOBAL_215_T  global_inet_peer_gc_mintime[NUM_STACKS];   
typedef  int  _GLOBAL_216_T; extern  _GLOBAL_216_T  global_inet_peer_gc_maxtime[NUM_STACKS];   


typedef  int  _GLOBAL_217_T; extern  _GLOBAL_217_T  global_sysctl_ip_dynaddr[NUM_STACKS];   
...
typedef  const char   _GLOBAL_218_T; extern  _GLOBAL_218_T  _GLOBAL_0_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_1_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_2_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_3_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_4_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_5_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_6_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_7_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_8_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_9_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_10_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_11_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_12_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_13_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_14_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_15_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_16_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_17_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_18_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_19_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_20_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_21_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_22_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_23_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_24_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_25_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_26_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_27_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_28_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_29_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_30_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_31_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_32_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_33_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_34_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_35_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_36_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_37_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_38_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_39_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_40_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_41_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_42_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_43_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_44_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_45_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_46_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_47_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_48_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_218_T  _GLOBAL_49_inet_csk_timer_bug_msg_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet_csk_timer_bug_msg_I) *_GLOBAL_inet_csk_timer_bug_msg_13_A[NUM_STACKS] = { &_GLOBAL_0_inet_csk_timer_bug_msg_I, &_GLOBAL_1_inet_csk_timer_bug_msg_I, &_GLOBAL_2_inet_csk_timer_bug_msg_I, &_GLOBAL_3_inet_csk_timer_bug_msg_I, &_GLOBAL_4_inet_csk_timer_bug_msg_I, &_GLOBAL_5_inet_csk_timer_bug_msg_I, &_GLOBAL_6_inet_csk_timer_bug_msg_I, &_GLOBAL_7_inet_csk_timer_bug_msg_I, &_GLOBAL_8_inet_csk_timer_bug_msg_I, &_GLOBAL_9_inet_csk_timer_bug_msg_I, &_GLOBAL_10_inet_csk_timer_bug_msg_I, &_GLOBAL_11_inet_csk_timer_bug_msg_I, &_GLOBAL_12_inet_csk_timer_bug_msg_I, &_GLOBAL_13_inet_csk_timer_bug_msg_I, &_GLOBAL_14_inet_csk_timer_bug_msg_I, &_GLOBAL_15_inet_csk_timer_bug_msg_I, &_GLOBAL_16_inet_csk_timer_bug_msg_I, &_GLOBAL_17_inet_csk_timer_bug_msg_I, &_GLOBAL_18_inet_csk_timer_bug_msg_I, &_GLOBAL_19_inet_csk_timer_bug_msg_I, &_GLOBAL_20_inet_csk_timer_bug_msg_I, &_GLOBAL_21_inet_csk_timer_bug_msg_I, &_GLOBAL_22_inet_csk_timer_bug_msg_I, &_GLOBAL_23_inet_csk_timer_bug_msg_I, &_GLOBAL_24_inet_csk_timer_bug_msg_I, &_GLOBAL_25_inet_csk_timer_bug_msg_I, &_GLOBAL_26_inet_csk_timer_bug_msg_I, &_GLOBAL_27_inet_csk_timer_bug_msg_I, &_GLOBAL_28_inet_csk_timer_bug_msg_I, &_GLOBAL_29_inet_csk_timer_bug_msg_I, &_GLOBAL_30_inet_csk_timer_bug_msg_I, &_GLOBAL_31_inet_csk_timer_bug_msg_I, &_GLOBAL_32_inet_csk_timer_bug_msg_I, &_GLOBAL_33_inet_csk_timer_bug_msg_I, &_GLOBAL_34_inet_csk_timer_bug_msg_I, &_GLOBAL_35_inet_csk_timer_bug_msg_I, &_GLOBAL_36_inet_csk_timer_bug_msg_I, &_GLOBAL_37_inet_csk_timer_bug_msg_I, &_GLOBAL_38_inet_csk_timer_bug_msg_I, &_GLOBAL_39_inet_csk_timer_bug_msg_I, &_GLOBAL_40_inet_csk_timer_bug_msg_I, &_GLOBAL_41_inet_csk_timer_bug_msg_I, &_GLOBAL_42_inet_csk_timer_bug_msg_I, &_GLOBAL_43_inet_csk_timer_bug_msg_I, &_GLOBAL_44_inet_csk_timer_bug_msg_I, &_GLOBAL_45_inet_csk_timer_bug_msg_I, &_GLOBAL_46_inet_csk_timer_bug_msg_I, &_GLOBAL_47_inet_csk_timer_bug_msg_I, &_GLOBAL_48_inet_csk_timer_bug_msg_I, &_GLOBAL_49_inet_csk_timer_bug_msg_I, };   
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      void *oldval, size_t *oldlenp,
      void *newval, size_t newlen);
# 136 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
# 137 "linux-2.6.26/net/ipv4/ip_input.c" 2



# 1 "linux-2.6.26/include/net/arp.h" 1
...
# 6 "linux-2.6.26/include/net/arp.h" 2



typedef  struct neigh_table   _GLOBAL_222_T; extern  _GLOBAL_222_T  global_arp_tbl[NUM_STACKS];    

extern void arp_init(void);
extern int arp_find(unsigned char *haddr, struct sk_buff *skb);
extern int arp_ioctl(struct net *net, unsigned int cmd, void *arg);
...
typedef  struct neigh_ops   _GLOBAL_223_T; extern  _GLOBAL_223_T  global_arp_broken_ops[NUM_STACKS];    
# 141 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
typedef  struct icmp_err   _GLOBAL_224_T; extern  _GLOBAL_224_T  _GLOBAL_0_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_1_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_2_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_3_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_4_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_5_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_6_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_7_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_8_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_9_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_10_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_11_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_12_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_13_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_14_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_15_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_16_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_17_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_18_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_19_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_20_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_21_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_22_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_23_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_24_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_25_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_26_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_27_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_28_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_29_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_30_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_31_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_32_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_33_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_34_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_35_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_36_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_37_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_38_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_39_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_40_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_41_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_42_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_43_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_44_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_45_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_46_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_47_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_48_icmp_err_convert_I [ ] ; extern  _GLOBAL_224_T  _GLOBAL_49_icmp_err_convert_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmp_err_convert_I) *_GLOBAL_icmp_err_convert_16_A[NUM_STACKS];   
typedef  __typeof__ ( struct icmp_mib  )   _GLOBAL_225_T; extern  _GLOBAL_225_T  * _GLOBAL_0_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_1_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_2_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_3_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_4_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_5_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_6_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_7_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_8_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_9_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_10_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_11_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_12_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_13_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_14_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_15_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_16_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_17_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_18_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_19_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_20_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_21_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_22_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_23_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_24_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_25_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_26_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_27_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_28_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_29_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_30_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_31_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_32_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_33_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_34_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_35_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_36_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_37_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_38_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_39_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_40_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_41_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_42_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_43_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_44_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_45_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_46_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_47_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_48_icmp_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_49_icmp_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmp_statistics_I) *_GLOBAL_icmp_statistics_17_A[NUM_STACKS];   
typedef  __typeof__ ( struct icmpmsg_mib  )   _GLOBAL_226_T; extern  _GLOBAL_226_T  * _GLOBAL_0_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_1_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_2_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_3_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_4_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_5_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_6_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_7_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_8_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_9_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_10_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_11_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_12_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_13_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_14_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_15_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_16_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_17_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_18_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_19_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_20_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_21_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_22_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_23_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_24_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_25_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_26_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_27_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_28_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_29_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_30_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_31_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_32_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_33_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_34_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_35_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_36_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_37_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_38_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_39_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_40_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_41_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_42_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_43_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_44_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_45_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_46_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_47_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_48_icmpmsg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_49_icmpmsg_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmpmsg_statistics_I) *_GLOBAL_icmpmsg_statistics_18_A[NUM_STACKS];   
...
# 142 "linux-2.6.26/net/ipv4/ip_input.c" 2
# 1 "linux-2.6.26/include/net/raw.h" 1
# 23 "linux-2.6.26/include/net/raw.h"
typedef  struct proto   _GLOBAL_227_T; extern  _GLOBAL_227_T  global_raw_prot[NUM_STACKS];    
...
# 143 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
# 145 "linux-2.6.26/net/ipv4/ip_input.c" 2
# 1 "linux-2.6.26/include/net/xfrm.h" 1
# 10 "linux-2.6.26/include/net/xfrm.h"
# 1 "linux-2.6.26/include/linux/pfkeyv2.h" 1
# 14 "linux-2.6.26/include/linux/pfkeyv2.h"
struct sadb_msg {
...
# 11 "linux-2.6.26/include/net/xfrm.h" 2
# 1 "linux-2.6.26/include/linux/ipsec.h" 1
# 12 "linux-2.6.26/include/linux/ipsec.h"
enum {
 IPSEC_MODE_ANY = 0,
...
# 12 "linux-2.6.26/include/net/xfrm.h" 2
...
# 15 "linux-2.6.26/include/net/xfrm.h" 2
...
typedef  struct ipv6_devconf   _GLOBAL_228_T; extern  _GLOBAL_228_T  global_ipv6_devconf[NUM_STACKS];    
...
typedef  struct neigh_table   _GLOBAL_229_T; extern  _GLOBAL_229_T  global_nd_tbl[NUM_STACKS];    
...
typedef  struct ctl_path   _GLOBAL_231_T; extern  _GLOBAL_231_T  _GLOBAL_0_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_1_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_2_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_3_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_4_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_5_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_6_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_7_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_8_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_9_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_10_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_11_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_12_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_13_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_14_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_15_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_16_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_17_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_18_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_19_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_20_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_21_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_22_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_23_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_24_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_25_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_26_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_27_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_28_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_29_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_30_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_31_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_32_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_33_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_34_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_35_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_36_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_37_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_38_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_39_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_40_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_41_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_42_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_43_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_44_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_45_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_46_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_47_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_48_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_49_net_ipv6_ctl_path_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_ipv6_ctl_path_I) *_GLOBAL_net_ipv6_ctl_path_19_A[NUM_STACKS];   
# 132 "linux-2.6.26/include/net/ipv6.h"
typedef  __typeof__ ( struct ipstats_mib  )   _GLOBAL_232_T; extern  _GLOBAL_232_T  * _GLOBAL_0_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_1_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_2_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_3_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_4_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_5_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_6_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_7_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_8_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_9_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_10_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_11_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_12_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_13_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_14_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_15_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_16_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_17_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_18_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_19_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_20_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_21_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_22_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_23_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_24_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_25_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_26_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_27_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_28_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_29_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_30_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_31_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_32_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_33_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_34_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_35_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_36_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_37_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_38_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_39_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_40_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_41_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_42_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_43_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_44_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_45_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_46_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_47_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_48_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_232_T  * _GLOBAL_49_ipv6_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_statistics_I) *_GLOBAL_ipv6_statistics_20_A[NUM_STACKS];   
...
typedef  __typeof__ ( struct icmpv6_mib  )   _GLOBAL_233_T; extern  _GLOBAL_233_T  * _GLOBAL_0_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_1_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_2_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_3_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_4_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_5_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_6_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_7_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_8_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_9_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_10_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_11_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_12_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_13_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_14_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_15_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_16_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_17_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_18_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_19_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_20_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_21_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_22_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_23_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_24_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_25_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_26_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_27_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_28_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_29_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_30_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_31_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_32_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_33_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_34_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_35_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_36_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_37_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_38_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_39_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_40_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_41_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_42_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_43_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_44_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_45_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_46_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_47_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_48_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_233_T  * _GLOBAL_49_icmpv6_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmpv6_statistics_I) *_GLOBAL_icmpv6_statistics_21_A[NUM_STACKS];   
typedef  __typeof__ ( struct icmpv6msg_mib  )   _GLOBAL_234_T; extern  _GLOBAL_234_T  * _GLOBAL_0_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_1_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_2_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_3_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_4_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_5_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_6_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_7_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_8_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_9_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_10_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_11_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_12_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_13_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_14_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_15_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_16_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_17_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_18_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_19_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_20_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_21_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_22_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_23_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_24_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_25_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_26_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_27_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_28_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_29_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_30_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_31_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_32_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_33_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_34_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_35_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_36_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_37_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_38_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_39_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_40_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_41_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_42_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_43_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_44_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_45_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_46_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_47_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_48_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_234_T  * _GLOBAL_49_icmpv6msg_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmpv6msg_statistics_I) *_GLOBAL_icmpv6msg_statistics_22_A[NUM_STACKS];   
...
typedef  struct ip6_ra_chain   _GLOBAL_235_T; extern  _GLOBAL_235_T  * global_ip6_ra_chain[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_236_T; extern  _GLOBAL_236_T  global_ip6_ra_lock[NUM_STACKS];   
...
typedef  const struct proto_ops    _GLOBAL_237_T; extern  _GLOBAL_237_T  global_inet6_stream_ops[NUM_STACKS];     
typedef  const struct proto_ops    _GLOBAL_238_T; extern  _GLOBAL_238_T  global_inet6_dgram_ops[NUM_STACKS];     
...
typedef  ctl_table  _GLOBAL_239_T; extern  _GLOBAL_239_T  _GLOBAL_0_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_1_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_2_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_3_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_4_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_5_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_6_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_7_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_8_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_9_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_10_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_11_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_12_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_13_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_14_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_15_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_16_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_17_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_18_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_19_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_20_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_21_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_22_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_23_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_24_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_25_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_26_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_27_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_28_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_29_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_30_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_31_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_32_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_33_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_34_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_35_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_36_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_37_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_38_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_39_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_40_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_41_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_42_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_43_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_44_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_45_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_46_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_47_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_48_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_239_T  _GLOBAL_49_ipv6_route_table_template_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_route_table_template_I) *_GLOBAL_ipv6_route_table_template_23_A[NUM_STACKS];  
typedef  ctl_table  _GLOBAL_240_T; extern  _GLOBAL_240_T  _GLOBAL_0_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_1_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_2_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_3_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_4_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_5_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_6_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_7_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_8_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_9_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_10_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_11_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_12_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_13_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_14_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_15_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_16_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_17_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_18_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_19_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_20_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_21_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_22_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_23_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_24_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_25_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_26_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_27_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_28_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_29_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_30_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_31_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_32_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_33_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_34_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_35_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_36_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_37_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_38_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_39_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_40_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_41_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_42_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_43_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_44_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_45_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_46_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_47_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_48_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_240_T  _GLOBAL_49_ipv6_icmp_table_template_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_icmp_table_template_I) *_GLOBAL_ipv6_icmp_table_template_24_A[NUM_STACKS];  

extern struct ctl_table *ipv6_icmp_sysctl_init(struct net *net);
extern struct ctl_table *ipv6_route_sysctl_init(struct net *net);
extern int ipv6_sysctl_register(void);
extern void ipv6_sysctl_unregister(void);
# 21 "linux-2.6.26/include/net/xfrm.h" 2
...
# 22 "linux-2.6.26/include/net/xfrm.h" 2
# 51 "linux-2.6.26/include/net/xfrm.h"
typedef  struct sock   _GLOBAL_241_T; extern  _GLOBAL_241_T  * global_xfrm_nl[NUM_STACKS];    
typedef  u32  _GLOBAL_242_T; extern  _GLOBAL_242_T  global_sysctl_xfrm_aevent_etime[NUM_STACKS];   
typedef  u32  _GLOBAL_243_T; extern  _GLOBAL_243_T  global_sysctl_xfrm_aevent_rseqth[NUM_STACKS];   
typedef  int  _GLOBAL_244_T; extern  _GLOBAL_244_T  global_sysctl_xfrm_larval_drop[NUM_STACKS];   
typedef  u32  _GLOBAL_245_T; extern  _GLOBAL_245_T  global_sysctl_xfrm_acq_expires[NUM_STACKS];   

typedef  struct mutex   _GLOBAL_246_T; extern  _GLOBAL_246_T  global_xfrm_cfg_mutex[NUM_STACKS];    
# 121 "linux-2.6.26/include/net/xfrm.h"
struct xfrm_state
{
...
struct xfrm_mode {
# 342 "linux-2.6.26/include/net/xfrm.h"
 int (*input2)(struct xfrm_state *x, struct sk_buff *skb);
# 352 "linux-2.6.26/include/net/xfrm.h"
 int (*input)(struct xfrm_state *x, struct sk_buff *skb);
# 365 "linux-2.6.26/include/net/xfrm.h"
 int (*output2)(struct xfrm_state *x,struct sk_buff *skb);
# 376 "linux-2.6.26/include/net/xfrm.h"
...
static inline  __attribute__((always_inline)) int xfrm_af2proto(unsigned int family)
{
 switch(family) {
 case 2:
  return IPPROTO_IPIP;
...
static inline  __attribute__((always_inline)) struct xfrm_mode *xfrm_ip2inner_mode(struct xfrm_state *x, int ipproto)
{
...
# 508 "linux-2.6.26/include/net/xfrm.h"
struct xfrm_mgr
{
 struct list_head list;
 char *id;
...
typedef  unsigned int   _GLOBAL_247_T; extern  _GLOBAL_247_T  xfrm_policy_count [ XFRM_POLICY_MAX * 2  ] ;    
...
# 652 "linux-2.6.26/include/net/xfrm.h"
static inline  __attribute__((always_inline)) void xfrm_audit_policy_add(struct xfrm_policy *xp, int result,
      u32 auid, u32 ses, u32 secid)
{
}

static inline  __attribute__((always_inline)) void xfrm_audit_policy_delete(struct xfrm_policy *xp, int result,
      u32 auid, u32 ses, u32 secid)
{
}

static inline  __attribute__((always_inline)) void xfrm_audit_state_add(struct xfrm_state *x, int result,
     u32 auid, u32 ses, u32 secid)
{
}

static inline  __attribute__((always_inline)) void xfrm_audit_state_delete(struct xfrm_state *x, int result,
        u32 auid, u32 ses, u32 secid)
{
}

static inline  __attribute__((always_inline)) void xfrm_audit_state_replay_overflow(struct xfrm_state *x,
          struct sk_buff *skb)
{
}

static inline  __attribute__((always_inline)) void xfrm_audit_state_notfound_simple(struct sk_buff *skb,
          u16 family)
{
}

static inline  __attribute__((always_inline)) void xfrm_audit_state_notfound(struct sk_buff *skb, u16 family,
          __be32 net_spi, __be32 net_seq)
{
}

static inline  __attribute__((always_inline)) void xfrm_audit_state_icvfail(struct xfrm_state *x,
...
# 715 "linux-2.6.26/include/net/xfrm.h"
static inline  __attribute__((always_inline)) void xfrm_pols_put(struct xfrm_policy **pols, int npols)
{
 xfrm_pol_put(pols[0]);
}
...
static __inline__  __attribute__((always_inline)) int addr_match(void *token1, void *token2, int prefixlen)
{
 ...
 if (pbi) {
  ...
  mask = (( __be32)__fswab32(((0xffffffff) << (32 - pbi))));
...
static __inline__ 
__attribute__((always_inline)) __be16 xfrm_flowi_sport(struct flowi *fl)
{
 __be16 port;
 switch(fl->proto) {
 case IPPROTO_TCP:
 ...
 case IPPROTO_ICMP:
 case 58:
  port = (( __be16)__fswab16((fl->uli_u.icmpt.type)));
  break;
 case 135:
  port = (( __be16)__fswab16((fl->uli_u.mht.type)));
  break;
 default:
  port = 0;
 }
...
static __inline__ 
__attribute__((always_inline)) __be16 xfrm_flowi_dport(struct flowi *fl)
{
 __be16 port;
 switch(fl->proto) {
 case IPPROTO_TCP:
 ...
 case IPPROTO_ICMP:
 case 58:
  port = (( __be16)__fswab16((fl->uli_u.icmpt.code)));
  break;
 default:
  port = 0;
 }
...
# 1054 "linux-2.6.26/include/net/xfrm.h"
...
static inline  __attribute__((always_inline)) int xfrm_decode_session_reverse(struct sk_buff *skb,
           struct flowi *fl,
           unsigned int family)
{
 return -38;
}
static inline  __attribute__((always_inline)) int xfrm4_policy_check_reverse(struct sock *sk, int dir,
          struct sk_buff *skb)
{
 return 1;
}
static inline  __attribute__((always_inline)) int xfrm6_policy_check_reverse(struct sock *sk, int dir,
          struct sk_buff *skb)
{
 return 1;
}
...
static __inline__ 
__attribute__((always_inline)) void xfrm_flowi_addr_get(struct flowi *fl,
    xfrm_address_t *saddr, xfrm_address_t *daddr,
    unsigned short family)
{
 switch(family) {
 case 2:
  (__builtin_constant_p(sizeof(saddr->a4)) ? __constant_memcpy((&saddr->a4),(&fl->nl_u.ip4_u.saddr),(sizeof(saddr->a4))) : __memcpy((&saddr->a4),(&fl->nl_u.ip4_u.saddr),(sizeof(saddr->a4))));
  (__builtin_constant_p(sizeof(daddr->a4)) ? __constant_memcpy((&daddr->a4),(&fl->nl_u.ip4_u.daddr),(sizeof(daddr->a4))) : __memcpy((&daddr->a4),(&fl->nl_u.ip4_u.daddr),(sizeof(daddr->a4))));
  break;
 case 10:
  ipv6_addr_copy((struct in6_addr *)&saddr->a6, &fl->nl_u.ip6_u.saddr);
  ipv6_addr_copy((struct in6_addr *)&daddr->a6, &fl->nl_u.ip6_u.daddr);
  break;
 }
}
      ...
      unsigned short family)
{
 ...
 case 2:
  return __xfrm4_state_addr_check(x,
      (xfrm_address_t *)&fl->nl_u.ip4_u.daddr,
      (xfrm_address_t *)&fl->nl_u.ip4_u.saddr);
 case 10:
  return __xfrm6_state_addr_check(x,
      (xfrm_address_t *)&fl->nl_u.ip6_u.daddr,
      (xfrm_address_t *)&fl->nl_u.ip6_u.saddr);
 }
 return 0;
}
...
static inline  __attribute__((always_inline)) int xfrm_id_proto_match(u8 proto, u8 userproto)
{
...
static inline  __attribute__((always_inline)) int xfrm6_init(void)
{
 return 0;
}
static inline  __attribute__((always_inline)) void xfrm6_fini(void)
{
 ;
}
...
static inline  __attribute__((always_inline)) void xfrm_state_walk_init(struct xfrm_state_walk *walk, u8 proto)
{
 walk->proto = proto;
 walk->state = ((void *)0);
 walk->count = 0;
...
static inline  __attribute__((always_inline)) void xfrm_state_walk_done(struct xfrm_state_walk *walk)
{
 if (walk->state != ((void *)0)) {
...
static inline  __attribute__((always_inline)) int xfrm_tmpl_sort(struct xfrm_tmpl **dst, struct xfrm_tmpl **src,
     int n, unsigned short family)
{
 return -38;
}

static inline  __attribute__((always_inline)) int xfrm_state_sort(struct xfrm_state **dst, struct xfrm_state **src,
      int n, unsigned short family)
{
 return -38;
}
...
static inline  __attribute__((always_inline)) int xfrm4_rcv_spi(struct sk_buff *skb, int nexthdr, __be32 spi)
{
...
static inline  __attribute__((always_inline)) int xfrm4_udp_encap_rcv(struct sock *sk, struct sk_buff *skb)
{
...
static inline  __attribute__((always_inline)) void xfrm_policy_walk_init(struct xfrm_policy_walk *walk, u8 type)
{
...
static inline  __attribute__((always_inline)) void xfrm_policy_walk_done(struct xfrm_policy_walk *walk)
{
 if (walk->policy != ((void *)0)) {
...
# 1466 "linux-2.6.26/include/net/xfrm.h"
typedef  wait_queue_head_t  _GLOBAL_248_T; extern  _GLOBAL_248_T  global_km_waitq[NUM_STACKS];   
...
static inline  __attribute__((always_inline)) int xfrm_aevent_is_on(void)
{
 ...
 do { do { } while (0); (void)0; do { } while (0); } while (0);
 nlsk = ({ typeof(global_xfrm_nl[get_stack_id()]) _________p1 = (*(volatile typeof(global_xfrm_nl[get_stack_id()]) *)&(global_xfrm_nl[get_stack_id()])); do { } while (0); (_________p1); });
 if (nlsk)
...
static inline  __attribute__((always_inline)) int xfrm_alg_len(struct xfrm_algo *alg)
{
 return sizeof(*alg) + ((alg->alg_key_len + 7) / 8);
}
# 1553 "linux-2.6.26/include/net/xfrm.h"
static inline  __attribute__((always_inline)) struct xfrm_state *xfrm_input_state(struct sk_buff *skb)
{
 return skb->sp->xvec[skb->sp->len - 1];
}
# 146 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
# 141 "linux-2.6.26/include/linux/mroute.h"
...
# 147 "linux-2.6.26/net/ipv4/ip_input.c" 2
...
typedef  __typeof__ ( struct ipstats_mib  )  _GLOBAL_249_T;  _GLOBAL_249_T  * _GLOBAL_0_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_1_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_2_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_3_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_4_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_5_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_6_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_7_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_8_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_9_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_10_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_11_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_12_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_13_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_14_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_15_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_16_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_17_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_18_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_19_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_20_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_21_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_22_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_23_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_24_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_25_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_26_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_27_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_28_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_29_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_30_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_31_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_32_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_33_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_34_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_35_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_36_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_37_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_38_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_39_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_40_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_41_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_42_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_43_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_44_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_45_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_46_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_47_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_48_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ;  _GLOBAL_249_T  * _GLOBAL_49_ip_statistics_I [ 2 ] __attribute__((__section__(".data.read_mostly")))   ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_statistics_I) *_GLOBAL_ip_statistics_25_A[NUM_STACKS] = { &_GLOBAL_0_ip_statistics_I, &_GLOBAL_1_ip_statistics_I, &_GLOBAL_2_ip_statistics_I, &_GLOBAL_3_ip_statistics_I, &_GLOBAL_4_ip_statistics_I, &_GLOBAL_5_ip_statistics_I, &_GLOBAL_6_ip_statistics_I, &_GLOBAL_7_ip_statistics_I, &_GLOBAL_8_ip_statistics_I, &_GLOBAL_9_ip_statistics_I, &_GLOBAL_10_ip_statistics_I, &_GLOBAL_11_ip_statistics_I, &_GLOBAL_12_ip_statistics_I, &_GLOBAL_13_ip_statistics_I, &_GLOBAL_14_ip_statistics_I, &_GLOBAL_15_ip_statistics_I, &_GLOBAL_16_ip_statistics_I, &_GLOBAL_17_ip_statistics_I, &_GLOBAL_18_ip_statistics_I, &_GLOBAL_19_ip_statistics_I, &_GLOBAL_20_ip_statistics_I, &_GLOBAL_21_ip_statistics_I, &_GLOBAL_22_ip_statistics_I, &_GLOBAL_23_ip_statistics_I, &_GLOBAL_24_ip_statistics_I, &_GLOBAL_25_ip_statistics_I, &_GLOBAL_26_ip_statistics_I, &_GLOBAL_27_ip_statistics_I, &_GLOBAL_28_ip_statistics_I, &_GLOBAL_29_ip_statistics_I, &_GLOBAL_30_ip_statistics_I, &_GLOBAL_31_ip_statistics_I, &_GLOBAL_32_ip_statistics_I, &_GLOBAL_33_ip_statistics_I, &_GLOBAL_34_ip_statistics_I, &_GLOBAL_35_ip_statistics_I, &_GLOBAL_36_ip_statistics_I, &_GLOBAL_37_ip_statistics_I, &_GLOBAL_38_ip_statistics_I, &_GLOBAL_39_ip_statistics_I, &_GLOBAL_40_ip_statistics_I, &_GLOBAL_41_ip_statistics_I, &_GLOBAL_42_ip_statistics_I, &_GLOBAL_43_ip_statistics_I, &_GLOBAL_44_ip_statistics_I, &_GLOBAL_45_ip_statistics_I, &_GLOBAL_46_ip_statistics_I, &_GLOBAL_47_ip_statistics_I, &_GLOBAL_48_ip_statistics_I, &_GLOBAL_49_ip_statistics_I, };   
...
int ip_call_ra_chain(struct sk_buff *skb)
{
 ...
 do { do { } while (0); (void)0; (void)(&global_ip_ra_lock[get_stack_id()]); } while (0);
 for (ra = global_ip_ra_chain[get_stack_id()]; ra; ra = ra->next) {
  ...
  if (sk && inet_sk(sk)->num == protocol &&
   ...
   if (ip_hdr(skb)->frag_off & (( __be16)__fswab16((0x2000 | 0x1FFF)))) {
...
static int ip_local_deliver_finish(struct sk_buff *skb)
{
 ...
 resubmit:
  ...
  hash = protocol & (256 - 1);
  ipprot = ({ typeof((*_GLOBAL_inet_protos_14_A[get_stack_id()])[hash]) _________p1 = (*(volatile typeof((*_GLOBAL_inet_protos_14_A[get_stack_id()])[hash]) *)&((*_GLOBAL_inet_protos_14_A[get_stack_id()])[hash])); do { } while (0); (_________p1); });
  if (ipprot != ((void *)0) && (net == &global_init_net[get_stack_id()] || ipprot->netns_ok)) {
   int ret;
   ...
   (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INDELIVERS]++);
  } else {
   if (!raw) {
    if (xfrm4_policy_check(((void *)0), XFRM_POLICY_IN, skb)) {
     (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INUNKNOWNPROTOS]++);
     icmp_send(skb, 3,
        2, 0);
    }
   } else
...
static inline  __attribute__((always_inline)) int ip_rcv_options(struct sk_buff *skb)
{
 struct ip_options *opt;
 struct iphdr *iph;
 struct net_device *dev = skb->dev;
# 285 "linux-2.6.26/net/ipv4/ip_input.c"
 if (skb_cow(skb, skb_headroom(skb))) {
  (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INDISCARDS]++);
  goto drop;
 }

 iph = ip_hdr(skb);
 opt = &(((struct inet_skb_parm*)((skb)->cb))->opt);
 opt->optlen = iph->ihl*4 - sizeof(struct iphdr);

 if (ip_options_compile(dev_net(dev), opt, skb)) {
  (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INHDRERRORS]++);
  goto drop;
 }

 if (__builtin_expect(!!(opt->srr), 0)) {
  struct in_device *in_dev = in_dev_get(dev);
  if (in_dev) {
   if (!((((*(dev_net((in_dev)->dev))->ipv4.devconf_all)).data[NET_IPV4_CONF_ACCEPT_SOURCE_ROUTE - 1]) && ipv4_devconf_get((((in_dev))), NET_IPV4_CONF_ACCEPT_SOURCE_ROUTE))) {
    if (((((*(dev_net((in_dev)->dev))->ipv4.devconf_all)).data[NET_IPV4_CONF_LOG_MARTIANS - 1]) || ipv4_devconf_get((((in_dev))), NET_IPV4_CONF_LOG_MARTIANS)) &&
        net_ratelimit())
     printk("<6>" "source route option "
            "%u.%u.%u.%u" " -> " "%u.%u.%u.%u" "\n",
...
static int ip_rcv_finish(struct sk_buff *skb)
{
 ...
 if (skb->dst == ((void *)0)) {
  ...
  if (__builtin_expect(!!(err), 0)) {
   if (err == -113)
    (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INADDRERRORS]++);
   else if (err == -101)
    (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INNOROUTES]++);
   goto drop;
  }
 }
# 357 "linux-2.6.26/net/ipv4/ip_input.c"
 if (iph->ihl > 5 && ip_rcv_options(skb))
  goto drop;

 rt = skb->rtable;
 if (rt->rt_type == RTN_MULTICAST)
  (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INMCASTPKTS]++);
 else if (rt->rt_type == RTN_BROADCAST)
  (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INBCASTPKTS]++);
...
int ip_rcv(struct sk_buff *skb, struct net_device *dev, struct packet_type *pt, struct net_device *orig_dev)
{
 ...
 (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INRECEIVES]++);

 if ((skb = skb_share_check(skb, ((( gfp_t)0x20u)))) == ((void *)0)) {
  (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INDISCARDS]++);
  goto out;
 }
 ...
 iph = ip_hdr(skb);
# 410 "linux-2.6.26/net/ipv4/ip_input.c"
 ...
 if (__builtin_expect(!!(ip_fast_csum((u8 *)iph, iph->ihl)), 0))
  goto inhdr_error;

 len = __fswab16(( __u16)(__be16)(iph->tot_len));
 if (skb->len < len) {
  (({ (void)((0)); (((*_GLOBAL_ip_statistics_25_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_INTRUNCATEDPKTS]++);
  goto drop;
 ...
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(struct inet_skb_parm))) ? __constant_c_and_count_memset(((((struct inet_skb_parm*)((skb)->cb)))),((0x01010101UL*(unsigned char)(0))),((sizeof(struct inet_skb_parm)))) : __constant_c_memset(((((struct inet_skb_parm*)((skb)->cb)))),((0x01010101UL*(unsigned char)(0))),((sizeof(struct inet_skb_parm))))) : (__builtin_constant_p((sizeof(struct inet_skb_parm))) ? __memset_generic((((((struct inet_skb_parm*)((skb)->cb))))),(((0))),(((sizeof(struct inet_skb_parm))))) : __memset_generic(((((struct inet_skb_parm*)((skb)->cb)))),((0)),((sizeof(struct inet_skb_parm))))));
