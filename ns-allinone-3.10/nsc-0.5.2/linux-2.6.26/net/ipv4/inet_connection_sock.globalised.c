# 1 "linux-2.6.26/net/ipv4/inet_connection_sock.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/net/ipv4/inet_connection_sock.c"
# 16 "linux-2.6.26/net/ipv4/inet_connection_sock.c"
...
{ }
# 17 "linux-2.6.26/net/ipv4/inet_connection_sock.c" 2
...
# 18 "linux-2.6.26/net/ipv4/inet_connection_sock.c" 2
...
typedef  int  _GLOBAL_78_T; extern  _GLOBAL_78_T  global_sysctl_nr_open[NUM_STACKS];   
...
typedef  struct files_stat_struct   _GLOBAL_79_T; extern  _GLOBAL_79_T  global_files_stat[NUM_STACKS];    
...
typedef  struct inodes_stat_t   _GLOBAL_80_T; extern  _GLOBAL_80_T  global_inodes_stat[NUM_STACKS];    

typedef  int  _GLOBAL_81_T; extern  _GLOBAL_81_T  global_leases_enable[NUM_STACKS]; extern  _GLOBAL_81_T  global_lease_break_time[NUM_STACKS];    
...
extern int rcu_needs_cpu(int cpu);
# 9 "linux-2.6.26/include/linux/dcache.h" 2
...
typedef  struct dentry_stat_t   _GLOBAL_84_T; extern  _GLOBAL_84_T  global_dentry_stat[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_85_T; extern  _GLOBAL_85_T  global_dcache_lock[NUM_STACKS];   
typedef  seqlock_t  _GLOBAL_86_T; extern  _GLOBAL_86_T  global_rename_lock[NUM_STACKS];   
...
typedef  int  _GLOBAL_87_T; extern  _GLOBAL_87_T  global_sysctl_vfs_cache_pressure[NUM_STACKS];   
...
# 7 "linux-2.6.26/include/linux/namei.h" 2
...
# 287 "linux-2.6.26/include/linux/fs.h" 2
...
typedef  struct pid   _GLOBAL_88_T; extern  _GLOBAL_88_T  global_init_struct_pid[NUM_STACKS];    
...
# 289 "linux-2.6.26/include/linux/fs.h" 2
...
typedef  const kernel_cap_t   _GLOBAL_89_T; extern  _GLOBAL_89_T  global___cap_empty_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_90_T; extern  _GLOBAL_90_T  global___cap_full_set[NUM_STACKS];    
typedef  const kernel_cap_t   _GLOBAL_91_T; extern  _GLOBAL_91_T  global___cap_init_eff_set[NUM_STACKS];    

kernel_cap_t cap_set_effective(const kernel_cap_t pE_new);

int capable(int cap);
int __capable(struct task_struct *t, int cap);
# 291 "linux-2.6.26/include/linux/fs.h" 2
...
{
 typedef  struct lock_class_key   _GLOBAL_92_T; static  _GLOBAL_92_T  global___key[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_93_T; extern  _GLOBAL_93_T  global_dq_data_lock[NUM_STACKS];   
...
typedef  struct dqstats   _GLOBAL_94_T; extern  _GLOBAL_94_T  global_dqstats[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_95_T; extern  _GLOBAL_95_T  global_files_lock[NUM_STACKS];   
...
typedef  struct list_head   _GLOBAL_96_T; extern  _GLOBAL_96_T  global_super_blocks[NUM_STACKS];    
typedef  spinlock_t  _GLOBAL_97_T; extern  _GLOBAL_97_T  global_sb_lock[NUM_STACKS];   
...
typedef  struct kobject   _GLOBAL_98_T; extern  _GLOBAL_98_T  * global_fs_kobj[NUM_STACKS];    
...
typedef  struct kmem_cache   _GLOBAL_99_T; extern  _GLOBAL_99_T  * global_names_cachep[NUM_STACKS];    
# 1632 "linux-2.6.26/include/linux/fs.h"
static inline  __attribute__((always_inline)) void bd_forget(struct inode *inode) {}

typedef  const struct file_operations    _GLOBAL_100_T; extern  _GLOBAL_100_T  global_def_blk_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_101_T; extern  _GLOBAL_101_T  global_def_chr_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_102_T; extern  _GLOBAL_102_T  global_bad_sock_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_103_T; extern  _GLOBAL_103_T  global_def_fifo_fops[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_104_T; extern  _GLOBAL_104_T  global_read_fifo_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_105_T; extern  _GLOBAL_105_T  global_write_fifo_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_106_T; extern  _GLOBAL_106_T  global_rdwr_fifo_fops[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_107_T; extern  _GLOBAL_107_T  global_generic_ro_fops[NUM_STACKS];     
...
typedef  const struct inode_operations    _GLOBAL_108_T; extern  _GLOBAL_108_T  global_page_symlink_inode_operations[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_109_T; extern  _GLOBAL_109_T  global_simple_dir_operations[NUM_STACKS];     
typedef  const struct inode_operations    _GLOBAL_110_T; extern  _GLOBAL_110_T  global_simple_dir_inode_operations[NUM_STACKS];     
...
typedef  int  _GLOBAL_111_T; extern  _GLOBAL_111_T  global_show_unhandled_signals[NUM_STACKS];   
...
# 13 "linux-2.6.26/include/linux/poll.h" 2
...
# 24 "linux-2.6.26/include/net/inet_sock.h"
...
typedef  atomic_t  _GLOBAL_138_T; extern  _GLOBAL_138_T  global_flow_cache_genid[NUM_STACKS];   
...
typedef  int  _GLOBAL_139_T; extern  _GLOBAL_139_T  global_net_msg_cost[NUM_STACKS];   
typedef  int  _GLOBAL_140_T; extern  _GLOBAL_140_T  global_net_msg_burst[NUM_STACKS];   
# 26 "linux-2.6.26/include/linux/skbuff.h" 2
# 1 "linux-2.6.26/include/linux/textsearch.h" 1
# 11 "linux-2.6.26/include/linux/textsearch.h"
struct ts_config;
...
typedef  struct resource   _GLOBAL_141_T; extern  _GLOBAL_141_T  global_ioport_resource[NUM_STACKS];    
typedef  struct resource   _GLOBAL_142_T; extern  _GLOBAL_142_T  global_iomem_resource[NUM_STACKS];    
...
typedef  void   ( *_GLOBAL_144_T  )  ( void  ) ; extern  _GLOBAL_144_T global_pm_idle[NUM_STACKS];   
typedef  void   ( *_GLOBAL_146_T  )  ( void  ) ; extern  _GLOBAL_146_T global_pm_power_off[NUM_STACKS];   
typedef  void   ( *_GLOBAL_148_T  )  ( void  ) ; extern  _GLOBAL_148_T global_pm_power_off_prepare[NUM_STACKS];   
...
typedef  unsigned int   _GLOBAL_149_T; extern  _GLOBAL_149_T  global_pm_flags[NUM_STACKS];    
...
typedef  int   ( *_GLOBAL_151_T  )  ( struct device   * dev   ) ; extern  _GLOBAL_151_T global_platform_notify[NUM_STACKS];     

typedef  int   ( *_GLOBAL_153_T  )  ( struct device   * dev   ) ; extern  _GLOBAL_153_T global_platform_notify_remove[NUM_STACKS];     
...
typedef  struct ctl_table   _GLOBAL_154_T; extern  _GLOBAL_154_T  _GLOBAL_0_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_1_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_2_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_3_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_4_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_5_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_6_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_7_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_8_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_9_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_10_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_11_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_12_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_13_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_14_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_15_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_16_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_17_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_18_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_19_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_20_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_21_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_22_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_23_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_24_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_25_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_26_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_27_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_28_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_29_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_30_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_31_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_32_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_33_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_34_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_35_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_36_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_37_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_38_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_39_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_40_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_41_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_42_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_43_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_44_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_45_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_46_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_47_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_48_ether_table_I [ ] ; extern  _GLOBAL_154_T  _GLOBAL_49_ether_table_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ether_table_I) *_GLOBAL_ether_table_6_A[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_155_T; extern  _GLOBAL_155_T  global_loops_per_jiffy[NUM_STACKS];    
...
struct net;
typedef  struct net   _GLOBAL_156_T; extern  _GLOBAL_156_T  global_init_net[NUM_STACKS];    
...
typedef  struct net   _GLOBAL_157_T; extern  _GLOBAL_157_T  global_init_net[NUM_STACKS];    
...
typedef  struct list_head   _GLOBAL_158_T; extern  _GLOBAL_158_T  global_net_namespace_list[NUM_STACKS];    
...
typedef  __typeof__ ( struct netif_rx_stats  )   _GLOBAL_159_T; extern  _GLOBAL_159_T  global_per_cpu__netdev_rx_stat[NUM_STACKS];    
...
typedef  __typeof__ ( struct pt_regs  *  )   _GLOBAL_160_T; extern  _GLOBAL_160_T  global_per_cpu__irq_regs[NUM_STACKS];     
...
typedef  int  _GLOBAL_161_T; extern  _GLOBAL_161_T  global_prof_on[NUM_STACKS] __attribute__((__section__(".data.read_mostly")))  ;    
...
typedef  unsigned long   _GLOBAL_162_T; extern  _GLOBAL_162_T  global_io_apic_irqs[NUM_STACKS];    

typedef  atomic_t  _GLOBAL_163_T; extern  _GLOBAL_163_T  global_irq_err_count[NUM_STACKS];   
typedef  atomic_t  _GLOBAL_164_T; extern  _GLOBAL_164_T  global_irq_mis_count[NUM_STACKS];   
...
typedef  __typeof__ ( irq_cpustat_t )   _GLOBAL_165_T; extern  _GLOBAL_165_T  global_per_cpu__irq_stat[NUM_STACKS];   
...
typedef  rwlock_t  _GLOBAL_166_T; extern  _GLOBAL_166_T  global_dev_base_lock[NUM_STACKS];   
...
typedef  __typeof__ ( struct softnet_data  )   _GLOBAL_167_T; extern  _GLOBAL_167_T  global_per_cpu__softnet_data[NUM_STACKS];    
...
typedef  int  _GLOBAL_168_T; extern  _GLOBAL_168_T  global_netdev_budget[NUM_STACKS];   
...
typedef  int  _GLOBAL_169_T; extern  _GLOBAL_169_T  global_netdev_max_backlog[NUM_STACKS];   
typedef  int  _GLOBAL_170_T; extern  _GLOBAL_170_T  global_weight_p[NUM_STACKS];   
...
typedef  int  _GLOBAL_171_T; extern  _GLOBAL_171_T  global_debug_locks[NUM_STACKS];   
typedef  int  _GLOBAL_172_T; extern  _GLOBAL_172_T  global_debug_locks_silent[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_173_T; extern  _GLOBAL_173_T  global_max_mapnr[NUM_STACKS];    


typedef  unsigned long   _GLOBAL_174_T; extern  _GLOBAL_174_T  global_num_physpages[NUM_STACKS];    
typedef  void  _GLOBAL_175_T; extern  _GLOBAL_175_T  * global_high_memory[NUM_STACKS];    
typedef  int  _GLOBAL_176_T; extern  _GLOBAL_176_T  global_page_cluster[NUM_STACKS];   


typedef  int  _GLOBAL_177_T; extern  _GLOBAL_177_T  global_sysctl_legacy_va_layout[NUM_STACKS];   




typedef  unsigned long   _GLOBAL_178_T; extern  _GLOBAL_178_T  global_mmap_min_addr[NUM_STACKS];    


# 1 "linux-2.6.26/include/asm/pgtable.h" 1
# 92 "linux-2.6.26/include/asm/pgtable.h"
typedef  pteval_t  _GLOBAL_179_T; extern  _GLOBAL_179_T  global___PAGE_KERNEL[NUM_STACKS]; extern  _GLOBAL_179_T  global___PAGE_KERNEL_EXEC[NUM_STACKS];    
...
typedef  struct list_head   _GLOBAL_181_T; extern  _GLOBAL_181_T  global_pgd_list[NUM_STACKS];    
...
typedef  pteval_t  _GLOBAL_182_T; extern  _GLOBAL_182_T  global___supported_pte_mask[NUM_STACKS];   
...
typedef  unsigned long   _GLOBAL_183_T; extern  _GLOBAL_183_T  global___FIXADDR_TOP[NUM_STACKS];    
...
typedef  struct kmem_cache   _GLOBAL_184_T; extern  _GLOBAL_184_T  * global_vm_area_cachep[NUM_STACKS];    
...
typedef  struct rb_root   _GLOBAL_185_T; extern  _GLOBAL_185_T  global_nommu_vma_tree[NUM_STACKS];    
typedef  struct rw_semaphore   _GLOBAL_186_T; extern  _GLOBAL_186_T  global_nommu_vma_sem[NUM_STACKS];    
...
typedef  atomic_long_t  _GLOBAL_187_T; extern  _GLOBAL_187_T  vm_stat [ NR_VM_ZONE_STAT_ITEMS ] ;   
...
extern int inet_csk_compat_setsockopt(struct sock *sk, int level, int optname,
          char *optval, int optlen);
# 20 "linux-2.6.26/net/ipv4/inet_connection_sock.c" 2
...
extern int inet_hash_connect(struct inet_timewait_death_row *death_row,
        struct sock *sk);
# 21 "linux-2.6.26/net/ipv4/inet_connection_sock.c" 2
...
int ipv4_doint_and_flush_strategy(ctl_table *table, int *name, int nlen,
      void *oldval, size_t *oldlenp,
      void *newval, size_t newlen);
# 23 "linux-2.6.26/net/ipv4/inet_connection_sock.c" 2
...
typedef  struct ipv6_devconf   _GLOBAL_220_T; extern  _GLOBAL_220_T  global_ipv6_devconf[NUM_STACKS];    
...
typedef  struct neigh_table   _GLOBAL_221_T; extern  _GLOBAL_221_T  global_nd_tbl[NUM_STACKS];    
...
typedef  int  _GLOBAL_222_T; extern  _GLOBAL_222_T  global_sysctl_mld_max_msf[NUM_STACKS];   
typedef  struct ctl_path   _GLOBAL_223_T; extern  _GLOBAL_223_T  _GLOBAL_0_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_1_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_2_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_3_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_4_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_5_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_6_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_7_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_8_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_9_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_10_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_11_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_12_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_13_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_14_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_15_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_16_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_17_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_18_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_19_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_20_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_21_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_22_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_23_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_24_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_25_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_26_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_27_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_28_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_29_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_30_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_31_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_32_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_33_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_34_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_35_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_36_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_37_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_38_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_39_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_40_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_41_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_42_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_43_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_44_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_45_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_46_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_47_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_48_net_ipv6_ctl_path_I [ ] ; extern  _GLOBAL_223_T  _GLOBAL_49_net_ipv6_ctl_path_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_net_ipv6_ctl_path_I) *_GLOBAL_net_ipv6_ctl_path_14_A[NUM_STACKS];   
# 132 "linux-2.6.26/include/net/ipv6.h"
typedef  __typeof__ ( struct ipstats_mib  )   _GLOBAL_224_T; extern  _GLOBAL_224_T  * _GLOBAL_0_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_1_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_2_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_3_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_4_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_5_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_6_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_7_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_8_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_9_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_10_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_11_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_12_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_13_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_14_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_15_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_16_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_17_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_18_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_19_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_20_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_21_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_22_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_23_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_24_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_25_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_26_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_27_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_28_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_29_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_30_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_31_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_32_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_33_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_34_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_35_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_36_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_37_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_38_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_39_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_40_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_41_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_42_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_43_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_44_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_45_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_46_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_47_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_48_ipv6_statistics_I [ 2 ]  ; extern  _GLOBAL_224_T  * _GLOBAL_49_ipv6_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_statistics_I) *_GLOBAL_ipv6_statistics_15_A[NUM_STACKS];   
...
typedef  __typeof__ ( struct icmpv6_mib  )   _GLOBAL_225_T; extern  _GLOBAL_225_T  * _GLOBAL_0_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_1_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_2_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_3_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_4_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_5_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_6_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_7_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_8_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_9_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_10_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_11_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_12_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_13_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_14_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_15_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_16_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_17_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_18_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_19_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_20_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_21_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_22_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_23_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_24_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_25_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_26_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_27_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_28_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_29_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_30_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_31_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_32_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_33_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_34_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_35_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_36_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_37_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_38_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_39_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_40_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_41_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_42_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_43_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_44_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_45_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_46_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_47_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_48_icmpv6_statistics_I [ 2 ]  ; extern  _GLOBAL_225_T  * _GLOBAL_49_icmpv6_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmpv6_statistics_I) *_GLOBAL_icmpv6_statistics_16_A[NUM_STACKS];   
typedef  __typeof__ ( struct icmpv6msg_mib  )   _GLOBAL_226_T; extern  _GLOBAL_226_T  * _GLOBAL_0_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_1_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_2_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_3_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_4_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_5_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_6_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_7_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_8_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_9_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_10_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_11_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_12_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_13_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_14_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_15_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_16_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_17_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_18_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_19_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_20_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_21_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_22_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_23_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_24_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_25_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_26_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_27_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_28_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_29_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_30_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_31_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_32_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_33_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_34_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_35_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_36_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_37_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_38_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_39_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_40_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_41_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_42_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_43_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_44_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_45_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_46_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_47_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_48_icmpv6msg_statistics_I [ 2 ]  ; extern  _GLOBAL_226_T  * _GLOBAL_49_icmpv6msg_statistics_I [ 2 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_icmpv6msg_statistics_I) *_GLOBAL_icmpv6msg_statistics_17_A[NUM_STACKS];   
...
typedef  struct ip6_ra_chain   _GLOBAL_227_T; extern  _GLOBAL_227_T  * global_ip6_ra_chain[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_228_T; extern  _GLOBAL_228_T  global_ip6_ra_lock[NUM_STACKS];   
...
typedef  const struct proto_ops    _GLOBAL_229_T; extern  _GLOBAL_229_T  global_inet6_stream_ops[NUM_STACKS];     
typedef  const struct proto_ops    _GLOBAL_230_T; extern  _GLOBAL_230_T  global_inet6_dgram_ops[NUM_STACKS];     
...
typedef  ctl_table  _GLOBAL_231_T; extern  _GLOBAL_231_T  _GLOBAL_0_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_1_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_2_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_3_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_4_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_5_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_6_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_7_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_8_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_9_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_10_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_11_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_12_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_13_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_14_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_15_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_16_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_17_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_18_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_19_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_20_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_21_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_22_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_23_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_24_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_25_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_26_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_27_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_28_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_29_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_30_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_31_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_32_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_33_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_34_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_35_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_36_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_37_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_38_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_39_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_40_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_41_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_42_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_43_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_44_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_45_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_46_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_47_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_48_ipv6_route_table_template_I [ ] ; extern  _GLOBAL_231_T  _GLOBAL_49_ipv6_route_table_template_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_route_table_template_I) *_GLOBAL_ipv6_route_table_template_18_A[NUM_STACKS];  
typedef  ctl_table  _GLOBAL_232_T; extern  _GLOBAL_232_T  _GLOBAL_0_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_1_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_2_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_3_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_4_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_5_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_6_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_7_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_8_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_9_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_10_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_11_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_12_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_13_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_14_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_15_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_16_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_17_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_18_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_19_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_20_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_21_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_22_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_23_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_24_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_25_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_26_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_27_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_28_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_29_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_30_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_31_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_32_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_33_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_34_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_35_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_36_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_37_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_38_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_39_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_40_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_41_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_42_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_43_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_44_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_45_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_46_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_47_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_48_ipv6_icmp_table_template_I [ ] ; extern  _GLOBAL_232_T  _GLOBAL_49_ipv6_icmp_table_template_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_icmp_table_template_I) *_GLOBAL_ipv6_icmp_table_template_19_A[NUM_STACKS];  
...
typedef  struct sock   _GLOBAL_233_T; extern  _GLOBAL_233_T  * global_xfrm_nl[NUM_STACKS];    
typedef  u32  _GLOBAL_234_T; extern  _GLOBAL_234_T  global_sysctl_xfrm_aevent_etime[NUM_STACKS];   
typedef  u32  _GLOBAL_235_T; extern  _GLOBAL_235_T  global_sysctl_xfrm_aevent_rseqth[NUM_STACKS];   
typedef  int  _GLOBAL_236_T; extern  _GLOBAL_236_T  global_sysctl_xfrm_larval_drop[NUM_STACKS];   
typedef  u32  _GLOBAL_237_T; extern  _GLOBAL_237_T  global_sysctl_xfrm_acq_expires[NUM_STACKS];   

typedef  struct mutex   _GLOBAL_238_T; extern  _GLOBAL_238_T  global_xfrm_cfg_mutex[NUM_STACKS];    
...
typedef  unsigned int   _GLOBAL_239_T; extern  _GLOBAL_239_T  xfrm_policy_count [ XFRM_POLICY_MAX * 2  ] ;    
...
typedef  wait_queue_head_t  _GLOBAL_240_T; extern  _GLOBAL_240_T  global_km_waitq[NUM_STACKS];   
...
# 26 "linux-2.6.26/net/ipv4/inet_connection_sock.c" 2


typedef  const char  _GLOBAL_241_T;  _GLOBAL_241_T  _GLOBAL_0_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_1_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_2_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_3_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_4_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_5_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_6_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_7_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_8_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_9_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_10_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_11_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_12_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_13_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_14_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_15_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_16_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_17_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_18_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_19_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_20_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_21_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_22_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_23_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_24_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_25_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_26_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_27_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_28_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_29_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_30_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_31_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_32_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_33_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_34_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_35_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_36_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_37_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_38_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_39_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_40_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_41_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_42_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_43_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_44_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_45_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_46_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_47_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_48_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ;  _GLOBAL_241_T  _GLOBAL_49_inet_csk_timer_bug_msg_I [ ]  = "inet_csk BUG: unknown timer value\n" ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet_csk_timer_bug_msg_I) *_GLOBAL_inet_csk_timer_bug_msg_20_A[NUM_STACKS] = { &_GLOBAL_0_inet_csk_timer_bug_msg_I, &_GLOBAL_1_inet_csk_timer_bug_msg_I, &_GLOBAL_2_inet_csk_timer_bug_msg_I, &_GLOBAL_3_inet_csk_timer_bug_msg_I, &_GLOBAL_4_inet_csk_timer_bug_msg_I, &_GLOBAL_5_inet_csk_timer_bug_msg_I, &_GLOBAL_6_inet_csk_timer_bug_msg_I, &_GLOBAL_7_inet_csk_timer_bug_msg_I, &_GLOBAL_8_inet_csk_timer_bug_msg_I, &_GLOBAL_9_inet_csk_timer_bug_msg_I, &_GLOBAL_10_inet_csk_timer_bug_msg_I, &_GLOBAL_11_inet_csk_timer_bug_msg_I, &_GLOBAL_12_inet_csk_timer_bug_msg_I, &_GLOBAL_13_inet_csk_timer_bug_msg_I, &_GLOBAL_14_inet_csk_timer_bug_msg_I, &_GLOBAL_15_inet_csk_timer_bug_msg_I, &_GLOBAL_16_inet_csk_timer_bug_msg_I, &_GLOBAL_17_inet_csk_timer_bug_msg_I, &_GLOBAL_18_inet_csk_timer_bug_msg_I, &_GLOBAL_19_inet_csk_timer_bug_msg_I, &_GLOBAL_20_inet_csk_timer_bug_msg_I, &_GLOBAL_21_inet_csk_timer_bug_msg_I, &_GLOBAL_22_inet_csk_timer_bug_msg_I, &_GLOBAL_23_inet_csk_timer_bug_msg_I, &_GLOBAL_24_inet_csk_timer_bug_msg_I, &_GLOBAL_25_inet_csk_timer_bug_msg_I, &_GLOBAL_26_inet_csk_timer_bug_msg_I, &_GLOBAL_27_inet_csk_timer_bug_msg_I, &_GLOBAL_28_inet_csk_timer_bug_msg_I, &_GLOBAL_29_inet_csk_timer_bug_msg_I, &_GLOBAL_30_inet_csk_timer_bug_msg_I, &_GLOBAL_31_inet_csk_timer_bug_msg_I, &_GLOBAL_32_inet_csk_timer_bug_msg_I, &_GLOBAL_33_inet_csk_timer_bug_msg_I, &_GLOBAL_34_inet_csk_timer_bug_msg_I, &_GLOBAL_35_inet_csk_timer_bug_msg_I, &_GLOBAL_36_inet_csk_timer_bug_msg_I, &_GLOBAL_37_inet_csk_timer_bug_msg_I, &_GLOBAL_38_inet_csk_timer_bug_msg_I, &_GLOBAL_39_inet_csk_timer_bug_msg_I, &_GLOBAL_40_inet_csk_timer_bug_msg_I, &_GLOBAL_41_inet_csk_timer_bug_msg_I, &_GLOBAL_42_inet_csk_timer_bug_msg_I, &_GLOBAL_43_inet_csk_timer_bug_msg_I, &_GLOBAL_44_inet_csk_timer_bug_msg_I, &_GLOBAL_45_inet_csk_timer_bug_msg_I, &_GLOBAL_46_inet_csk_timer_bug_msg_I, &_GLOBAL_47_inet_csk_timer_bug_msg_I, &_GLOBAL_48_inet_csk_timer_bug_msg_I, &_GLOBAL_49_inet_csk_timer_bug_msg_I, };    
;
...
typedef  int _GLOBAL_242_T;  _GLOBAL_242_T  _GLOBAL_0_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_1_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_2_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_3_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_4_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_5_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_6_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_7_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_8_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_9_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_10_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_11_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_12_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_13_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_14_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_15_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_16_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_17_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_18_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_19_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_20_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_21_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_22_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_23_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_24_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_25_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_26_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_27_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_28_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_29_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_30_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_31_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_32_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_33_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_34_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_35_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_36_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_37_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_38_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_39_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_40_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_41_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_42_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_43_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_44_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_45_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_46_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_47_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_48_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ;  _GLOBAL_242_T  _GLOBAL_49_sysctl_local_port_range_I [ 2 ]  = { 32768 , 61000  }  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_local_port_range_I) *_GLOBAL_sysctl_local_port_range_21_A[NUM_STACKS] = { &_GLOBAL_0_sysctl_local_port_range_I, &_GLOBAL_1_sysctl_local_port_range_I, &_GLOBAL_2_sysctl_local_port_range_I, &_GLOBAL_3_sysctl_local_port_range_I, &_GLOBAL_4_sysctl_local_port_range_I, &_GLOBAL_5_sysctl_local_port_range_I, &_GLOBAL_6_sysctl_local_port_range_I, &_GLOBAL_7_sysctl_local_port_range_I, &_GLOBAL_8_sysctl_local_port_range_I, &_GLOBAL_9_sysctl_local_port_range_I, &_GLOBAL_10_sysctl_local_port_range_I, &_GLOBAL_11_sysctl_local_port_range_I, &_GLOBAL_12_sysctl_local_port_range_I, &_GLOBAL_13_sysctl_local_port_range_I, &_GLOBAL_14_sysctl_local_port_range_I, &_GLOBAL_15_sysctl_local_port_range_I, &_GLOBAL_16_sysctl_local_port_range_I, &_GLOBAL_17_sysctl_local_port_range_I, &_GLOBAL_18_sysctl_local_port_range_I, &_GLOBAL_19_sysctl_local_port_range_I, &_GLOBAL_20_sysctl_local_port_range_I, &_GLOBAL_21_sysctl_local_port_range_I, &_GLOBAL_22_sysctl_local_port_range_I, &_GLOBAL_23_sysctl_local_port_range_I, &_GLOBAL_24_sysctl_local_port_range_I, &_GLOBAL_25_sysctl_local_port_range_I, &_GLOBAL_26_sysctl_local_port_range_I, &_GLOBAL_27_sysctl_local_port_range_I, &_GLOBAL_28_sysctl_local_port_range_I, &_GLOBAL_29_sysctl_local_port_range_I, &_GLOBAL_30_sysctl_local_port_range_I, &_GLOBAL_31_sysctl_local_port_range_I, &_GLOBAL_32_sysctl_local_port_range_I, &_GLOBAL_33_sysctl_local_port_range_I, &_GLOBAL_34_sysctl_local_port_range_I, &_GLOBAL_35_sysctl_local_port_range_I, &_GLOBAL_36_sysctl_local_port_range_I, &_GLOBAL_37_sysctl_local_port_range_I, &_GLOBAL_38_sysctl_local_port_range_I, &_GLOBAL_39_sysctl_local_port_range_I, &_GLOBAL_40_sysctl_local_port_range_I, &_GLOBAL_41_sysctl_local_port_range_I, &_GLOBAL_42_sysctl_local_port_range_I, &_GLOBAL_43_sysctl_local_port_range_I, &_GLOBAL_44_sysctl_local_port_range_I, &_GLOBAL_45_sysctl_local_port_range_I, &_GLOBAL_46_sysctl_local_port_range_I, &_GLOBAL_47_sysctl_local_port_range_I, &_GLOBAL_48_sysctl_local_port_range_I, &_GLOBAL_49_sysctl_local_port_range_I, };      
typedef  seqlock_t _GLOBAL_243_T;  _GLOBAL_243_T  global_sysctl_port_range_lock[NUM_STACKS] = {  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  { 0 , ( spinlock_t ) { . raw_lock  = { }   , }   } ,  };             

void inet_get_local_port_range(int *low, int *high)
{
 unsigned seq;
 do {
  seq = read_seqbegin(&global_sysctl_port_range_lock[get_stack_id()]);

  *low = (*_GLOBAL_sysctl_local_port_range_21_A[get_stack_id()])[0];
  *high = (*_GLOBAL_sysctl_local_port_range_21_A[get_stack_id()])[1];
 } while (read_seqretry(&global_sysctl_port_range_lock[get_stack_id()], seq));
}
;
...
# 65 "linux-2.6.26/net/ipv4/inet_connection_sock.c"
...
{
 struct inet_hashinfo *hashinfo = sk->__sk_common.skc_prot->h.hashinfo;
 struct inet_bind_hashbucket *head;
 struct hlist_node *node;
 struct inet_bind_bucket *tb;
 int ret;
...
static int inet_csk_wait_for_connect(struct sock *sk, long timeo)
{
 ...
 int err;
# 204 "linux-2.6.26/net/ipv4/inet_connection_sock.c"
 for (;;) {
         ...
         const struct request_sock *req)
{
 ...
 if (ip_route_output_flow(sock_net(sk), &rt, &fl, sk, 0)) {
  (({ (void)((0)); (((*_GLOBAL_ip_statistics_11_A[get_stack_id()])[0])); })->mibs[IPSTATS_MIB_OUTNOROUTES]++);
  return ((void *)0);
 }
...
static inline  __attribute__((always_inline)) u32 inet_synq_hash(const __be32 raddr, const __be16 rport,
     const u32 rnd, const u32 synq_hsize)
{
 return jhash_2words(( u32)raddr, ( u32)rport, rnd) & (synq_hsize - 1);
}
...
typedef  int  _GLOBAL_244_T; extern  _GLOBAL_244_T  global_sysctl_tcp_synack_retries[NUM_STACKS];   
    ...
    const unsigned long max_rto)
{
 ...
 if (lopt == ((void *)0) || lopt->qlen == 0)
  return;
# 448 "linux-2.6.26/net/ipv4/inet_connection_sock.c"
  ...
  while ((req = *reqp) != ((void *)0)) {
   if ((({ unsigned long __dummy; typeof(now) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ({ unsigned long __dummy; typeof(req->expires) __dummy2; (void)(&__dummy == &__dummy2); 1; }) && ((long)(now) - (long)(req->expires) >= 0))) {
    if ((req->retrans < thresh ||
     ...
     if (req->retrans++ == 0)
      lopt->qlen_young--;
     timeo = ({ typeof((timeout << req->retrans)) _min1 = ((timeout << req->retrans)); typeof(max_rto) _min2 = (max_rto); (void) (&_min1 == &_min2); _min1 < _min2 ? _min1 : _min2; });
...
int inet_csk_listen_start(struct sock *sk, const int nr_table_entries)
{
 ...
 if (!sk->__sk_common.skc_prot->get_port(sk, inet->num)) {
  inet->sport = (( __be16)__fswab16((inet->num)));
...
# 620 "linux-2.6.26/net/ipv4/inet_connection_sock.c"
 ...
 while ((req = acc_req) != ((void *)0)) {
  ...
  do { if (__builtin_expect(!!(!(!((child)->sk_lock.owned))), 0)) { printk("<3>" "KERNEL: assertion (%s) failed at %s (%d)\n", "!sock_owned_by_user(child)", "linux-2.6.26/net/ipv4/inet_connection_sock.c" , 629); } } while(0);
  sock_hold(child);
