...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/lib/rbtree.c"
# 23 "linux-2.6.26/lib/rbtree.c"
# 1 "linux-2.6.26/include/linux/rbtree.h" 1
# 97 "linux-2.6.26/include/linux/rbtree.h"
...
# 98 "linux-2.6.26/include/linux/rbtree.h" 2
...
# 24 "linux-2.6.26/lib/rbtree.c" 2
...
{ }
# 25 "linux-2.6.26/lib/rbtree.c" 2

static void __rb_rotate_left(struct rb_node *node, struct rb_root *root)
{
 struct rb_node *right = node->rb_right;
 struct rb_node *parent = ((struct rb_node *)((node)->rb_parent_color & ~3));
...
void rb_insert_color(struct rb_node *node, struct rb_root *root)
{
 ...
 while ((parent = ((struct rb_node *)((node)->rb_parent_color & ~3))) && (!((parent)->rb_parent_color & 1)))
 {
  ...
  {
   {
    ...
    if (uncle && (!((uncle)->rb_parent_color & 1)))
    {
     do { (uncle)->rb_parent_color |= 1; } while (0);
     do { (parent)->rb_parent_color |= 1; } while (0);
     do { (gparent)->rb_parent_color &= ~1; } while (0);
     node = gparent;
     continue;
    }
   }
 ...
 do { (root->rb_node)->rb_parent_color |= 1; } while (0);
}
;
        ...
        struct rb_root *root)
{
 ...
 while ((!node || ((node)->rb_parent_color & 1)) && node != root->rb_node)
 {
  if (parent->rb_left == node)
  {
   other = parent->rb_right;
   if ((!((other)->rb_parent_color & 1)))
   {
    do { (other)->rb_parent_color |= 1; } while (0);
    do { (parent)->rb_parent_color &= ~1; } while (0);
    __rb_rotate_left(parent, root);
    other = parent->rb_right;
   }
   if ((!other->rb_left || ((other->rb_left)->rb_parent_color & 1)) &&
       (!other->rb_right || ((other->rb_right)->rb_parent_color & 1)))
   {
    do { (other)->rb_parent_color &= ~1; } while (0);
    node = parent;
    parent = ((struct rb_node *)((node)->rb_parent_color & ~3));
   }
   else
   {
    if (!other->rb_right || ((other->rb_right)->rb_parent_color & 1))
    {
     struct rb_node *o_left;
     if ((o_left = other->rb_left))
      do { (o_left)->rb_parent_color |= 1; } while (0);
     do { (other)->rb_parent_color &= ~1; } while (0);
    ...
    do { (parent)->rb_parent_color |= 1; } while (0);
    if (other->rb_right)
     do { (other->rb_right)->rb_parent_color |= 1; } while (0);
    __rb_rotate_left(parent, root);
    node = root->rb_node;
    break;
   }
   ...
   else
   {
    if (!other->rb_left || ((other->rb_left)->rb_parent_color & 1))
    {
     ...
     if ((o_right = other->rb_right))
      do { (o_right)->rb_parent_color |= 1; } while (0);
     do { (other)->rb_parent_color &= ~1; } while (0);
    ...
    do { (parent)->rb_parent_color |= 1; } while (0);
    if (other->rb_left)
     do { (other->rb_left)->rb_parent_color |= 1; } while (0);
    __rb_rotate_right(parent, root);
    node = root->rb_node;
    break;
   }
 ...
 if (node)
  do { (node)->rb_parent_color |= 1; } while (0);
}
...
void rb_erase(struct rb_node *node, struct rb_root *root)
{
 ...
 else
 {
  ...
  if (((struct rb_node *)((old)->rb_parent_color & ~3)))
  {
   if (((struct rb_node *)((old)->rb_parent_color & ~3))->rb_left == old)
    ((struct rb_node *)((old)->rb_parent_color & ~3))->rb_left = node;
   else
    ((struct rb_node *)((old)->rb_parent_color & ~3))->rb_right = node;
  } else
   root->rb_node = node;
...
struct rb_node *rb_next(struct rb_node *node)
{
 ...
 if (((struct rb_node *)((node)->rb_parent_color & ~3)) == node)
  return ((void *)0);
 ...
 while ((parent = ((struct rb_node *)((node)->rb_parent_color & ~3))) && node == parent->rb_right)
  node = parent;
...
struct rb_node *rb_prev(struct rb_node *node)
{
 ...
 while ((parent = ((struct rb_node *)((node)->rb_parent_color & ~3))) && node == parent->rb_left)
  node = parent;
...
void rb_replace_node(struct rb_node *victim, struct rb_node *new,
       struct rb_root *root)
{
 struct rb_node *parent = ((struct rb_node *)((victim)->rb_parent_color & ~3));
