# 1 "linux-2.6.26/lib/find_next_bit.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.26/lib/find_next_bit.c"
# 12 "linux-2.6.26/lib/find_next_bit.c"
...
# 13 "linux-2.6.26/lib/find_next_bit.c" 2
...
{ }
# 14 "linux-2.6.26/lib/find_next_bit.c" 2
# 23 "linux-2.6.26/lib/find_next_bit.c"
unsigned long find_next_bit(const unsigned long *addr, unsigned long size,
       unsigned long offset)
{
 const unsigned long *p = addr + ((offset) / 32);
 unsigned long result = offset & ~(32 -1);
 unsigned long tmp;
