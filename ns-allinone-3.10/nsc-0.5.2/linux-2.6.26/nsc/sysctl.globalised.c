...
int nsc_sysctl_util_get(const char *name, char *value, size_t len)
{
  ...
  for (i=0; i < (sizeof((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])) / sizeof(((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()]))[0]) + (sizeof(char[1 - 2 * !!(__builtin_types_compatible_p(typeof((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])), typeof(&(*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[0])))]) - 1)); i++) {
    size_t buflen;
    int ret;
    char buf[512];
    if (strcmp((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[i].name, name) != 0)
      continue;
    buflen = sizeof(buf);
    ret = do_sysctl((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[i].int_name, 3, buf, &buflen, ((void *)0), 0);
    if (ret == 0) {
      ret = (*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[i].convert_r(buf, buflen, value, len);
      if (ret > 0) {
        return ret;
      }
    }
...
int nsc_sysctl_util_set(const char *name, const char *value)
{
  ...
  for (i=0; i < (sizeof((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])) / sizeof(((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()]))[0]) + (sizeof(char[1 - 2 * !!(__builtin_types_compatible_p(typeof((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])), typeof(&(*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[0])))]) - 1)); i++) {
    ...
    if (strcmp((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[i].name, name) != 0)
      continue;
    ret = (*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[i].convert_w(value, buf, sizeof(buf));
    if (ret == 0)
      break;
    if (ret <= sizeof(buf)) {
      return do_sysctl((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[i].int_name, 3, ((void *)0), ((void *)0), buf, ret);
    }
...
{
  if (idx >= (sizeof((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])) / sizeof(((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()]))[0]) + (sizeof(char[1 - 2 * !!(__builtin_types_compatible_p(typeof((*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])), typeof(&(*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[0])))]) - 1)))
    return -1;

  return strlcpy(name, (*_GLOBAL_nsc_linux_sysctl_map_2_A[get_stack_id()])[idx].name, len);
}
