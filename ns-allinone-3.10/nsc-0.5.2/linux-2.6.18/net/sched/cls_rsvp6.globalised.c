# 1 "linux-2.6.18/net/sched/cls_rsvp6.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sched/cls_rsvp6.c"
# 12 "linux-2.6.18/net/sched/cls_rsvp6.c"
...
# 13 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 14 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 21 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 22 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 24 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 26 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 29 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 30 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 32 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 34 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 37 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
...
# 38 "linux-2.6.18/net/sched/cls_rsvp6.c" 2





# 1 "linux-2.6.18/net/sched/cls_rsvp.h" 1
# 69 "linux-2.6.18/net/sched/cls_rsvp.h"
struct rsvp_head
{
 u32 tmap[256/32];
 u32 hgenerator;
...
static __inline__  __attribute__((always_inline)) unsigned hash_dst(u32 *dst, u8 protocol, u8 tunnelid)
{
 unsigned h = dst[4 -1];
 h ^= h>>16;
 h ^= h>>8;
...
static __inline__  __attribute__((always_inline)) unsigned hash_src(u32 *src)
{
 unsigned h = src[4 -1];
 h ^= h>>16;
 h ^= h>>8;
...
typedef  struct tcf_ext_map   _GLOBAL_266_T; static  _GLOBAL_266_T  global_rsvp_ext_map[NUM_STACKS] = {  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  { . police  = TCA_RSVP_POLICE  , . action  = TCA_RSVP_ACT   } ,  };      
   
   

# 134 "linux-2.6.18/net/sched/cls_rsvp.h"
...
restart:
 ...
 src = &nhptr->saddr.in6_u.u6_addr32[0];
 dst = &nhptr->daddr.in6_u.u6_addr32[0];
 protocol = nhptr->nexthdr;
 xprt = ((u8*)nhptr) + sizeof(struct ipv6hdr);
# 167 "linux-2.6.18/net/sched/cls_rsvp.h"
 h1 = hash_dst(dst, protocol, tunnelid);
 h2 = hash_src(src);

 for (s = sht[h1]; s; s = s->next) {
  if (dst[4 -1] == s->dst[4 -1] &&
      protocol == s->protocol &&
   ...
   for (f = s->ht[h2]; f; f = f->next) {
     ...
     *res = f->res;
     { int r = tcf_exts_exec(skb, &f->exts, res); if (r < 0) continue; else if (r > 0) return r; };
...
static int rsvp_init(struct tcf_proto *tp)
{
 ...
 data = kzalloc(sizeof(struct rsvp_head), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (data) {
  tp->root = data;
  return 0;
 }
...
{
 struct rsvp_head *data = ((__typeof__(*(&tp->root)))__xchg((unsigned long)(((void *)0)),(&tp->root),sizeof(*(&tp->root))));
...
static void tunnel_recycle(struct rsvp_head *data)
{
 ...
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(tmap))) ? __constant_c_and_count_memset(((tmap)),((0x01010101UL*(unsigned char)(0))),((sizeof(tmap)))) : __constant_c_memset(((tmap)),((0x01010101UL*(unsigned char)(0))),((sizeof(tmap))))) : (__builtin_constant_p((sizeof(tmap))) ? __memset_generic((((tmap))),(((0))),(((sizeof(tmap))))) : __memset_generic(((tmap)),((0)),((sizeof(tmap))))));
 ...
 (__builtin_constant_p(sizeof(tmap)) ? __constant_memcpy((data->tmap),(tmap),(sizeof(tmap))) : __memcpy((data->tmap),(tmap),(sizeof(tmap))));
}
         ...
         unsigned long *arg)
{
 ...
 struct tc_rsvp_pinfo *pinfo = ((void *)0);
 struct rtattr *opt = tca[TCA_OPTIONS-1];
 struct rtattr *tb[(__TCA_RSVP_MAX - 1 )];
 struct tcf_exts e;
 unsigned h1, h2;
 u32 *dst;
 int err;
 ...
 if (rtattr_parse((tb), ((__TCA_RSVP_MAX - 1 )), ((void*)(((char*)((opt))) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))), ((int)(((opt))->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))) < 0)
  return -22;

 err = tcf_exts_validate(tp, tb, tca[TCA_RATE-1], &e, &global_rsvp_ext_map[get_stack_id()]);
 if (err < 0)
  return err;

 if ((f = (struct rsvp_filter*)*arg) != ((void *)0)) {


  if (f->handle != handle && handle)
   goto errout2;
  if (tb[TCA_RSVP_CLASSID-1]) {
   f->res.classid = *(u32*)((void*)(((char*)(tb[TCA_RSVP_CLASSID-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 ...
 if (handle)
  goto errout2;
 if (tb[TCA_RSVP_DST-1] == ((void *)0))
  goto errout2;

 err = -105;
 f = kzalloc(sizeof(struct rsvp_filter), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (f == ((void *)0))
  goto errout2;
 ...
 if (tb[TCA_RSVP_SRC-1]) {
  err = -22;
  if (((int)((tb[TCA_RSVP_SRC-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) != sizeof(f->src))
   goto errout;
  (__builtin_constant_p(sizeof(f->src)) ? __constant_memcpy((f->src),(((void*)(((char*)(tb[TCA_RSVP_SRC-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))))),(sizeof(f->src))) : __memcpy((f->src),(((void*)(((char*)(tb[TCA_RSVP_SRC-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))))),(sizeof(f->src))));
  h2 = hash_src(f->src);
 }
 if (tb[TCA_RSVP_PINFO-1]) {
  err = -22;
  if (((int)((tb[TCA_RSVP_PINFO-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(struct tc_rsvp_pinfo))
   goto errout;
  pinfo = ((void*)(((char*)(tb[TCA_RSVP_PINFO-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
  f->spi = pinfo->spi;
  f->tunnelhdr = pinfo->tunnelhdr;
 }
 if (tb[TCA_RSVP_CLASSID-1]) {
  err = -22;
  if (((int)((tb[TCA_RSVP_CLASSID-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) != 4)
   goto errout;
  f->res.classid = *(u32*)((void*)(((char*)(tb[TCA_RSVP_CLASSID-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 }

 err = -22;
 if (((int)((tb[TCA_RSVP_DST-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) != sizeof(f->src))
  goto errout;
 dst = ((void*)(((char*)(tb[TCA_RSVP_DST-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 ...
 for (sp = &data->ht[h1]; (s=*sp) != ((void *)0); sp = &s->next) {
  if (dst[4 -1] == s->dst[4 -1] &&
      pinfo && pinfo->protocol == s->protocol &&
      __builtin_memcmp(&pinfo->dpi, &s->dpi, sizeof(s->dpi)) == 0
...
insert:
 ...
 err = -105;
 s = kzalloc(sizeof(struct rsvp_session), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (s == ((void *)0))
  goto errout;
 (__builtin_constant_p(sizeof(s->dst)) ? __constant_memcpy((s->dst),(dst),(sizeof(s->dst))) : __memcpy((s->dst),(dst),(sizeof(s->dst))));
       ...
       struct sk_buff *skb, struct tcmsg *t)
{
 ...
 ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(s->dst))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_RSVP_DST, sizeof(s->dst), &s->dst); });
 pinfo.dpi = s->dpi;
 pinfo.spi = f->spi;
 ...
 pinfo.pad = 0;
 ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(pinfo))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_RSVP_PINFO, sizeof(pinfo), &pinfo); });
 if (f->res.classid)
  ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (4)))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_RSVP_CLASSID, 4, &f->res.classid); });
 if (((f->handle>>8)&0xFF) != 16)
  ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(f->src))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_RSVP_SRC, sizeof(f->src), f->src); });

 if (tcf_exts_dump(skb, &f->exts, &global_rsvp_ext_map[get_stack_id()]) < 0)
  goto rtattr_failure;

 rta->rta_len = skb->tail - b;

 if (tcf_exts_dump_stats(skb, &f->exts, &global_rsvp_ext_map[get_stack_id()]) < 0)
  goto rtattr_failure;
 return skb->len;
...
typedef  struct tcf_proto_ops   _GLOBAL_267_T; static  _GLOBAL_267_T  global_cls_rsvp6_ops[NUM_STACKS] = {  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp6"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };      
...
static int  __attribute__ ((__section__ (".init.text"))) init_rsvp(void)
{
 return register_tcf_proto_ops(&global_cls_rsvp6_ops[get_stack_id()]);
}

static void   __attribute__((__used__)) __attribute__ ((__section__(".exit.text"))) exit_rsvp(void)
{
 unregister_tcf_proto_ops(&global_cls_rsvp6_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_268_T; static  _GLOBAL_268_T  __initcall_init_rsvp __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = init_rsvp ;       
typedef  exitcall_t  _GLOBAL_269_T; static  _GLOBAL_269_T  global___exitcall_exit_rsvp[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__ (".exitcall.exit")))   = {  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  };       
# 44 "linux-2.6.18/net/sched/cls_rsvp6.c" 2
;
