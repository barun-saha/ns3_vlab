...
static void tunnel_recycle(struct rsvp_head *data)
{
 ...
 ({ size_t __len = (sizeof(tmap)); void *__ret; if (__builtin_constant_p(sizeof(tmap)) && __len >= 64) __ret = __memcpy((data->tmap),(tmap),__len); else __ret = __builtin_memcpy((data->tmap),(tmap),__len); __ret; });
}
         ...
         unsigned long *arg)
{
 ...
 if (tb[TCA_RSVP_SRC-1]) {
  ...
  if (((int)((tb[TCA_RSVP_SRC-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) != sizeof(f->src))
   goto errout;
  ({ size_t __len = (sizeof(f->src)); void *__ret; if (__builtin_constant_p(sizeof(f->src)) && __len >= 64) __ret = __memcpy((f->src),(((void*)(((char*)(tb[TCA_RSVP_SRC-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))))),__len); else __ret = __builtin_memcpy((f->src),(((void*)(((char*)(tb[TCA_RSVP_SRC-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))))),__len); __ret; });
  h2 = hash_src(f->src);
 }
...
insert:
 ...
 if (s == ((void *)0))
  goto errout;
 ({ size_t __len = (sizeof(s->dst)); void *__ret; if (__builtin_constant_p(sizeof(s->dst)) && __len >= 64) __ret = __memcpy((s->dst),(dst),__len); else __ret = __builtin_memcpy((s->dst),(dst),__len); __ret; });
...
typedef  initcall_t  _GLOBAL_243_T; static  _GLOBAL_243_T  __initcall_init_rsvp __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = init_rsvp ;       
typedef  exitcall_t  _GLOBAL_244_T; static  _GLOBAL_244_T  global___exitcall_exit_rsvp[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__ (".exitcall.exit")))   = {  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  exit_rsvp,  };       
