# 1 "linux-2.6.18/net/sched/sch_gred.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sched/sch_gred.c"
# 21 "linux-2.6.18/net/sched/sch_gred.c"
...
# 22 "linux-2.6.18/net/sched/sch_gred.c" 2
...
# 25 "linux-2.6.18/net/sched/sch_gred.c" 2
...
# 27 "linux-2.6.18/net/sched/sch_gred.c" 2
...
# 7 "linux-2.6.18/include/net/red.h" 2
...
# 28 "linux-2.6.18/net/sched/sch_gred.c" 2
...
static inline  __attribute__((always_inline)) int gred_change_table_def(struct Qdisc *sch, struct rtattr *dps)
{
 struct gred_sched *table = qdisc_priv(sch);
 struct tc_gred_sopt *sopt;
 int i;

 if (dps == ((void *)0) || ((int)((dps)->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(*sopt))
  return -22;

 sopt = ((void*)(((char*)(dps)) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
...
static int gred_change(struct Qdisc *sch, struct rtattr *opt)
{
 ...
 struct rtattr *tb[(__TCA_GRED_MAX - 1)];
 int err = -22, prio = (16 / 2);
 u8 *stab;

 if (opt == ((void *)0) || rtattr_parse((tb), ((__TCA_GRED_MAX - 1)), ((void*)(((char*)((opt))) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))), ((int)(((opt))->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))))
  return -22;

 if (tb[TCA_GRED_PARMS-1] == ((void *)0) && tb[TCA_GRED_STAB-1] == ((void *)0))
  return gred_change_table_def(sch, opt);

 if (tb[TCA_GRED_PARMS-1] == ((void *)0) ||
     ((int)((tb[TCA_GRED_PARMS-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(*ctl) ||
     tb[TCA_GRED_STAB-1] == ((void *)0) ||
     ((int)((tb[TCA_GRED_STAB-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < 256)
  return -22;

 ctl = ((void*)(((char*)(tb[TCA_GRED_PARMS-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 stab = ((void*)(((char*)(tb[TCA_GRED_STAB-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
...
{
 struct gred_sched *table = qdisc_priv(sch);
 struct rtattr *parms, *opts = ((void *)0);
 int i;
 struct tc_gred_sopt sopt = {
  .DPs = table->DPs,
  .def_DP = table->def,
 ...
 ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(sopt))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_GRED_DPS, sizeof(sopt), &sopt); });
 parms = ({ struct rtattr *__start = (struct rtattr *) (skb)->tail; ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_GRED_PARMS, 0, ((void *)0)); }); __start; });
...
append_opt:
  ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)(sizeof(opt))), 0)) goto rtattr_failure; (__builtin_constant_p(sizeof(opt)) ? __constant_memcpy((skb_put(skb, sizeof(opt))),(&opt),(sizeof(opt))) : __memcpy((skb_put(skb, sizeof(opt))),(&opt),(sizeof(opt)))); });
 }

 ({ (parms)->rta_len = ((skb)->tail - (unsigned char *) (parms)); (skb)->len; });
