# 1 "linux-2.6.18/net/sched/cls_tcindex.c"
...
# 8 "linux-2.6.18/net/sched/cls_tcindex.c" 2
...
# 11 "linux-2.6.18/net/sched/cls_tcindex.c" 2
...
# 13 "linux-2.6.18/net/sched/cls_tcindex.c" 2
...
# 14 "linux-2.6.18/net/sched/cls_tcindex.c" 2
...
typedef  struct Qdisc   _GLOBAL_254_T; extern  _GLOBAL_254_T  global_noop_qdisc[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_255_T; extern  _GLOBAL_255_T  global_noop_qdisc_ops[NUM_STACKS];    
...
typedef  rwlock_t  _GLOBAL_256_T; extern  _GLOBAL_256_T  global_qdisc_tree_lock[NUM_STACKS];   
...
typedef  struct Qdisc_ops   _GLOBAL_257_T; extern  _GLOBAL_257_T  global_pfifo_qdisc_ops[NUM_STACKS];    
typedef  struct Qdisc_ops   _GLOBAL_258_T; extern  _GLOBAL_258_T  global_bfifo_qdisc_ops[NUM_STACKS];    
...
# 15 "linux-2.6.18/net/sched/cls_tcindex.c" 2
...
# 16 "linux-2.6.18/net/sched/cls_tcindex.c" 2
...
# 17 "linux-2.6.18/net/sched/cls_tcindex.c" 2
# 50 "linux-2.6.18/net/sched/cls_tcindex.c"
...
typedef  struct tcf_ext_map   _GLOBAL_265_T; static  _GLOBAL_265_T  global_tcindex_ext_map[NUM_STACKS] = {  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  { . police  = TCA_TCINDEX_POLICE  , . action  = TCA_TCINDEX_ACT   } ,  };      
...
static int tcindex_classify(struct sk_buff *skb, struct tcf_proto *tp,
       struct tcf_result *res)
{
 struct tcindex_data *p = ((struct tcindex_data *) (tp)->root);
 ...
 if (!f) {
  if (!p->fall_through)
   return -1;
  res->classid = (((((tp->q->handle)&(0xFFFF0000U)))&(0xFFFF0000U))|((key)&(0x0000FFFFU)));
  res->class = 0;
  ;
  return 0;
 }
...
static unsigned long tcindex_get(struct tcf_proto *tp, u32 handle)
{
 ...
 printk("<7>" "tcindex_get(tp %p,handle 0x%08x)\n",tp,handle);
...
{
 printk("<7>" "tcindex_put(tp %p,f 0x%lx)\n",tp,f);
}
...
static int tcindex_init(struct tcf_proto *tp)
{
 ...
 printk("<7>" "tcindex_init(tp %p)\n",tp);
 p = kzalloc(sizeof(struct tcindex_data),((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!p)
  return -12;
...
__tcindex_delete(struct tcf_proto *tp, unsigned long arg, int lock)
{
 ...
 printk("<7>" "tcindex_delete(tp %p,arg 0x%lx),p %p,f %p\n",tp,arg,p,f);
 if (p->perfect) {
  if (!r->res.class)
   return -2;
 } else {
    ...
    struct rtattr **tb, struct rtattr *est)
{
 ...
 err = tcf_exts_validate(tp, tb, est, &e, &global_tcindex_ext_map[get_stack_id()]);
 if (err < 0)
  return err;

 (__builtin_constant_p(sizeof(cp)) ? __constant_memcpy((&cp),(p),(sizeof(cp))) : __memcpy((&cp),(p),(sizeof(cp))));
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(new_filter_result))) ? __constant_c_and_count_memset(((&new_filter_result)),((0x01010101UL*(unsigned char)(0))),((sizeof(new_filter_result)))) : __constant_c_memset(((&new_filter_result)),((0x01010101UL*(unsigned char)(0))),((sizeof(new_filter_result))))) : (__builtin_constant_p((sizeof(new_filter_result))) ? __memset_generic((((&new_filter_result))),(((0))),(((sizeof(new_filter_result))))) : __memset_generic(((&new_filter_result)),((0)),((sizeof(new_filter_result))))));

 if (old_r)
  (__builtin_constant_p(sizeof(cr)) ? __constant_memcpy((&cr),(r),(sizeof(cr))) : __memcpy((&cr),(r),(sizeof(cr))));
 else
  (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(cr))) ? __constant_c_and_count_memset(((&cr)),((0x01010101UL*(unsigned char)(0))),((sizeof(cr)))) : __constant_c_memset(((&cr)),((0x01010101UL*(unsigned char)(0))),((sizeof(cr))))) : (__builtin_constant_p((sizeof(cr))) ? __memset_generic((((&cr))),(((0))),(((sizeof(cr))))) : __memset_generic(((&cr)),((0)),((sizeof(cr))))));

 err = -22;
 if (tb[TCA_TCINDEX_HASH-1]) {
  if (((int)((tb[TCA_TCINDEX_HASH-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(u32))
   goto errout;
  cp.hash = *(u32 *) ((void*)(((char*)(tb[TCA_TCINDEX_HASH-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 }

 if (tb[TCA_TCINDEX_MASK-1]) {
  if (((int)((tb[TCA_TCINDEX_MASK-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(u16))
   goto errout;
  cp.mask = *(u16 *) ((void*)(((char*)(tb[TCA_TCINDEX_MASK-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 }

 if (tb[TCA_TCINDEX_SHIFT-1]) {
  if (((int)((tb[TCA_TCINDEX_SHIFT-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(u16))
   goto errout;
  cp.shift = *(u16 *) ((void*)(((char*)(tb[TCA_TCINDEX_SHIFT-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 }
 ...
 if (tb[TCA_TCINDEX_FALL_THROUGH-1]) {
  if (((int)((tb[TCA_TCINDEX_FALL_THROUGH-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(u32))
   goto errout;
  cp.fall_through =
   *(u32 *) ((void*)(((char*)(tb[TCA_TCINDEX_FALL_THROUGH-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 }
 ...
 if (!cp.perfect && !cp.h) {
  if (valid_perfect_hash(&cp)) {
   cp.perfect = kcalloc(cp.hash, sizeof(*r), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
   if (!cp.perfect)
    goto errout;
   balloc = 1;
  } else {
   cp.h = kcalloc(cp.hash, sizeof(f), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
   if (!cp.h)
    goto errout;
   balloc = 2;
  }
 ...
 if (tb[TCA_TCINDEX_CLASSID-1]) {
  cr.res.classid = *(u32 *) ((void*)(((char*)(tb[TCA_TCINDEX_CLASSID-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 ...
 qdisc_lock_tree((tp)->q->dev);
 if (old_r && old_r != r)
  (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(*old_r))) ? __constant_c_and_count_memset(((old_r)),((0x01010101UL*(unsigned char)(0))),((sizeof(*old_r)))) : __constant_c_memset(((old_r)),((0x01010101UL*(unsigned char)(0))),((sizeof(*old_r))))) : (__builtin_constant_p((sizeof(*old_r))) ? __memset_generic((((old_r))),(((0))),(((sizeof(*old_r))))) : __memset_generic(((old_r)),((0)),((sizeof(*old_r))))));

 (__builtin_constant_p(sizeof(cp)) ? __constant_memcpy((p),(&cp),(sizeof(cp))) : __memcpy((p),(&cp),(sizeof(cp))));
 (__builtin_constant_p(sizeof(cr)) ? __constant_memcpy((r),(&cr),(sizeof(cr))) : __memcpy((r),(&cr),(sizeof(cr))));
        ...
        struct rtattr **tca, unsigned long *arg)
{
 ...
 struct rtattr *tb[(__TCA_TCINDEX_MAX - 1)];
 struct tcindex_data *p = ((struct tcindex_data *) (tp)->root);
 struct tcindex_filter_result *r = (struct tcindex_filter_result *) *arg;

 printk("<7>" "tcindex_change(tp %p,handle 0x%08x,tca %p,arg %p),opt %p," "p %p,r %p,*arg 0x%lx\n", tp, handle, tca, arg, opt, p, r, arg ? *arg : 0L);
 ...
 if (rtattr_parse((tb), ((__TCA_TCINDEX_MAX - 1)), ((void*)(((char*)((opt))) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))), ((int)(((opt))->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))) < 0)
  return -22;
...
static void tcindex_walk(struct tcf_proto *tp, struct tcf_walker *walker)
{
 ...
 printk("<7>" "tcindex_walk(tp %p,walker %p),p %p\n",tp,walker,p);
 if (p->perfect) {
  for (i = 0; i < p->hash; i++) {
...
static void tcindex_destroy(struct tcf_proto *tp)
{
 ...
 printk("<7>" "tcindex_destroy(tp %p),p %p\n",tp,p);
 walker.count = 0;
 walker.skip = 0;
    ...
    struct sk_buff *skb, struct tcmsg *t)
{
 ...
 printk("<7>" "tcindex_dump(tp %p,fh 0x%lx,skb %p,t %p),p %p,r %p,b %p\n", tp,fh,skb,t,p,r,b);

 printk("<7>" "p->perfect %p p->h %p\n",p->perfect,p->h);
 rta = (struct rtattr *) b;
 ...
 if (!fh) {
  t->tcm_handle = ~0;
  ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(p->hash))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_TCINDEX_HASH, sizeof(p->hash), &p->hash); });
  ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(p->mask))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_TCINDEX_MASK, sizeof(p->mask), &p->mask); });
  ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(p->shift))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_TCINDEX_SHIFT, sizeof(p->shift), &p->shift); });
  ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(p->fall_through))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_TCINDEX_FALL_THROUGH, sizeof(p->fall_through), &p->fall_through); });
  ...
  printk("<7>" "handle = %d\n",t->tcm_handle);
  if (r->res.class)
   ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (4)))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_TCINDEX_CLASSID, 4, &r->res.classid); });

  if (tcf_exts_dump(skb, &r->exts, &global_tcindex_ext_map[get_stack_id()]) < 0)
   goto rtattr_failure;
  rta->rta_len = skb->tail-b;

  if (tcf_exts_dump_stats(skb, &r->exts, &global_tcindex_ext_map[get_stack_id()]) < 0)
   goto rtattr_failure;
 }
...
typedef  struct tcf_proto_ops   _GLOBAL_266_T; static  _GLOBAL_266_T  global_cls_tcindex_ops[NUM_STACKS] = {  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "tcindex"   , . classify  = tcindex_classify   , . init  = tcindex_init   , . destroy  = tcindex_destroy   , . get  = tcindex_get   , . put  = tcindex_put   , . change  = tcindex_change   , . delete  = tcindex_delete   , . walk  = tcindex_walk   , . dump  = tcindex_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };      
...
static int  __attribute__ ((__section__ (".init.text"))) init_tcindex(void)
{
 return register_tcf_proto_ops(&global_cls_tcindex_ops[get_stack_id()]);
}

static void   __attribute__((__used__)) __attribute__ ((__section__(".exit.text"))) exit_tcindex(void)
{
 unregister_tcf_proto_ops(&global_cls_tcindex_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_267_T; static  _GLOBAL_267_T  __initcall_init_tcindex __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = init_tcindex ;       
typedef  exitcall_t  _GLOBAL_268_T; static  _GLOBAL_268_T  global___exitcall_exit_tcindex[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__ (".exitcall.exit")))   = {  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  exit_tcindex,  };       
;
