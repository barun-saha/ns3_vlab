# 1 "linux-2.6.18/net/sched/sch_sfq.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sched/sch_sfq.c"
# 12 "linux-2.6.18/net/sched/sch_sfq.c"
...
# 13 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 14 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 21 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 22 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 24 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 26 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 29 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 30 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 33 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 35 "linux-2.6.18/net/sched/sch_sfq.c" 2
...
# 38 "linux-2.6.18/net/sched/sch_sfq.c" 2
# 94 "linux-2.6.18/net/sched/sch_sfq.c"
...
struct sfq_sched_data
{
 ...
 sfq_index next[128];
 short allot[128];
 unsigned short hash[128];
 struct sk_buff_head qs[128];
 struct sfq_head dep[128*2];
};

static __inline__  __attribute__((always_inline)) unsigned sfq_fold_hash(struct sfq_sched_data *q, u32 h, u32 h1)
{
...
static unsigned sfq_hash(struct sfq_sched_data *q, struct sk_buff *skb)
{
 ...
 case (( __be16)((__u16)( (((__u16)((0x0800)) & (__u16)0x00ffU) << 8) | (((__u16)((0x0800)) & (__u16)0xff00U) >> 8) ))):
 {
  ...
  if (!(iph->frag_off&htons(0x2000|0x1FFF)) &&
 ...
 case (( __be16)((__u16)( (((__u16)((0x86DD)) & (__u16)0x00ffU) << 8) | (((__u16)((0x86DD)) & (__u16)0xff00U) >> 8) ))):
 {
  ...
  h = iph->daddr.in6_u.u6_addr32[3];
  h2 = iph->saddr.in6_u.u6_addr32[3]^iph->nexthdr;
...
static inline  __attribute__((always_inline)) void sfq_link(struct sfq_sched_data *q, sfq_index x)
{
 sfq_index p, n;
 int d = q->qs[x].qlen + 128;
...
static inline  __attribute__((always_inline)) void sfq_dec(struct sfq_sched_data *q, sfq_index x)
{
 sfq_index p, n;
...
static inline  __attribute__((always_inline)) void sfq_inc(struct sfq_sched_data *q, sfq_index x)
{
 sfq_index p, n;
 int d;
...
static void sfq_perturbation(unsigned long arg)
{
 ...
 if (q->perturb_period) {
  q->perturb_timer.expires = global_jiffies[get_stack_id()] + q->perturb_period;
...
{
 struct sfq_sched_data *q = qdisc_priv(sch);
 struct tc_sfq_qopt *ctl = ((void*)(((char*)(opt)) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));

 if (opt->rta_len < (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(*ctl))))
  return -22;

 qdisc_lock_tree((sch)->dev);
 q->quantum = ctl->quantum ? : psched_mtu(sch->dev);
 q->perturb_period = ctl->perturb_period*1000;
 if (ctl->limit)
  q->limit = ({ u32 __x = (ctl->limit); u32 __y = (128); __x < __y ? __x: __y; });
...
static int sfq_init(struct Qdisc *sch, struct rtattr *opt)
{
 ...
 for (i=0; i<128; i++) {
  ...
  q->dep[i+128].next = i+128;
  q->dep[i+128].prev = i+128;
 }
 q->limit = 128;
 q->max_depth = 0;
 q->tail = 128;
...
static int sfq_dump(struct Qdisc *sch, struct sk_buff *skb)
{
 ...
 opt.perturb_period = q->perturb_period/1000;
...
typedef  struct Qdisc_ops   _GLOBAL_266_T; static  _GLOBAL_266_T  global_sfq_qdisc_ops[NUM_STACKS] = {  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = ( ( void *  ) 0  )    , . id  = "sfq"   , . priv_size  = sizeof ( struct sfq_sched_data  )    , . enqueue  = sfq_enqueue   , . dequeue  = sfq_dequeue   , . requeue  = sfq_requeue   , . drop  = sfq_drop   , . init  = sfq_init   , . reset  = sfq_reset   , . destroy  = sfq_destroy   , . change  = ( ( void *  ) 0  )    , . dump  = sfq_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };      
...
static int  __attribute__ ((__section__ (".init.text"))) sfq_module_init(void)
{
 return register_qdisc(&global_sfq_qdisc_ops[get_stack_id()]);
}
static void   __attribute__((__used__)) __attribute__ ((__section__(".exit.text"))) sfq_module_exit(void)
{
 unregister_qdisc(&global_sfq_qdisc_ops[get_stack_id()]);
}
typedef  initcall_t  _GLOBAL_267_T; static  _GLOBAL_267_T  __initcall_sfq_module_init __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = sfq_module_init ;       
typedef  exitcall_t  _GLOBAL_268_T; static  _GLOBAL_268_T  global___exitcall_sfq_module_exit[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__ (".exitcall.exit")))   = {  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  sfq_module_exit,  };       
;
