# 1 "linux-2.6.18/net/sched/cls_rsvp.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sched/cls_rsvp.c"
# 12 "linux-2.6.18/net/sched/cls_rsvp.c"
...
# 13 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 14 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 21 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 22 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 24 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 26 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 29 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 30 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 32 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 33 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 36 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
# 37 "linux-2.6.18/net/sched/cls_rsvp.c" 2
...
restart:
 ...
 if (nhptr->frag_off&(( __be16)((__u16)( (((__u16)((0x2000|0x1FFF)) & (__u16)0x00ffU) << 8) | (((__u16)((0x2000|0x1FFF)) & (__u16)0xff00U) >> 8) ))))
  return -1;
...
typedef  struct tcf_proto_ops   _GLOBAL_267_T; static  _GLOBAL_267_T  global_cls_rsvp_ops[NUM_STACKS] = {  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "rsvp"   , . classify  = rsvp_classify   , . init  = rsvp_init   , . destroy  = rsvp_destroy   , . get  = rsvp_get   , . put  = rsvp_put   , . change  = rsvp_change   , . delete  = rsvp_delete   , . walk  = rsvp_walk   , . dump  = rsvp_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };      
...
{
 return register_tcf_proto_ops(&global_cls_rsvp_ops[get_stack_id()]);
}

static void   __attribute__((__used__)) __attribute__ ((__section__(".exit.text"))) exit_rsvp(void)
{
 unregister_tcf_proto_ops(&global_cls_rsvp_ops[get_stack_id()]);
}
...
# 43 "linux-2.6.18/net/sched/cls_rsvp.c" 2
;
