...
typedef  struct tcf_ext_map   _GLOBAL_241_T; static  _GLOBAL_241_T  global_fw_ext_map[NUM_STACKS] = {  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  };      
