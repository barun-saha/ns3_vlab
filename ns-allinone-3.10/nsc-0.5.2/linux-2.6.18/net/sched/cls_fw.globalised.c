# 1 "linux-2.6.18/net/sched/cls_fw.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sched/cls_fw.c"
# 21 "linux-2.6.18/net/sched/cls_fw.c"
...
# 22 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 23 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 30 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 31 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 33 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 35 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 38 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 39 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 41 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 42 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 43 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 46 "linux-2.6.18/net/sched/cls_fw.c" 2
...
# 47 "linux-2.6.18/net/sched/cls_fw.c" 2



struct fw_head
{
 struct fw_filter *ht[((1UL << 12)/sizeof(struct fw_filter *))];
};
...
typedef  struct tcf_ext_map   _GLOBAL_266_T; static  _GLOBAL_266_T  global_fw_ext_map[NUM_STACKS] = {  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  { . action  = TCA_FW_ACT  , . police  = TCA_FW_POLICE   } ,  };      
   
   


static __inline__  __attribute__((always_inline)) int fw_hash(u32 handle)
{
 if (((1UL << 12)/sizeof(struct fw_filter *)) == 4096)
  return ((handle >> 24) & 0xFFF) ^
         ((handle >> 12) & 0xFFF) ^
         (handle & 0xFFF);
 else if (((1UL << 12)/sizeof(struct fw_filter *)) == 2048)
  return ((handle >> 22) & 0x7FF) ^
         ((handle >> 11) & 0x7FF) ^
         (handle & 0x7FF);
 else if (((1UL << 12)/sizeof(struct fw_filter *)) == 1024)
  return ((handle >> 20) & 0x3FF) ^
         ((handle >> 10) & 0x3FF) ^
         (handle & 0x3FF);
 else if (((1UL << 12)/sizeof(struct fw_filter *)) == 512)
  return (handle >> 27) ^
         ((handle >> 18) & 0x1FF) ^
         ((handle >> 9) & 0x1FF) ^
         (handle & 0x1FF);
 else if (((1UL << 12)/sizeof(struct fw_filter *)) == 256) {
  u8 *t = (u8 *) &handle;
  return t[0] ^ t[1] ^ t[2] ^ t[3];
 } else
  return handle & (((1UL << 12)/sizeof(struct fw_filter *)) - 1);
}
     ...
     struct tcf_result *res)
{
 ...
 if (head != ((void *)0)) {
  ...
  if (id && (((id)&(0xFFFF0000U)) == 0 || !(((id^tp->q->handle)&(0xFFFF0000U))))) {
   res->classid = id;
   res->class = 0;
   return 0;
  }
...
{
 struct fw_head *head = (struct fw_head*)((__typeof__(*(&tp->root)))__xchg((unsigned long)(((void *)0)),(&tp->root),sizeof(*(&tp->root))));
 struct fw_filter *f;
 int h;
 ...
 for (h=0; h<((1UL << 12)/sizeof(struct fw_filter *)); h++) {
 ...
 struct rtattr **tb, struct rtattr **tca, unsigned long base)
{
 ...
 err = tcf_exts_validate(tp, tb, tca[TCA_RATE-1], &e, &global_fw_ext_map[get_stack_id()]);
 if (err < 0)
  return err;

 err = -22;
 if (tb[TCA_FW_CLASSID-1]) {
  if (((int)((tb[TCA_FW_CLASSID-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) != sizeof(u32))
   goto errout;
  f->res.classid = *(u32*)((void*)(((char*)(tb[TCA_FW_CLASSID-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
  tcf_bind_filter(tp, &f->res, base);
 }
# 235 "linux-2.6.18/net/sched/cls_fw.c"
       ...
       unsigned long *arg)
{
 ...
 struct rtattr *tb[(__TCA_FW_MAX - 1)];
 int err;

 if (!opt)
  return handle ? -22 : 0;

 if (rtattr_parse((tb), ((__TCA_FW_MAX - 1)), ((void*)(((char*)((opt))) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))), ((int)(((opt))->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))) < 0)
  return -22;
 ...
 if (head == ((void *)0)) {
  head = kzalloc(sizeof(struct fw_head), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (head == ((void *)0))
   return -105;
 ...
 f = kzalloc(sizeof(struct fw_filter), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (f == ((void *)0))
  return -105;
     ...
     struct sk_buff *skb, struct tcmsg *t)
{
 ...
 if (f->res.classid)
  ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (4)))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_FW_CLASSID, 4, &f->res.classid); });





 if (tcf_exts_dump(skb, &f->exts, &global_fw_ext_map[get_stack_id()]) < 0)
  goto rtattr_failure;

 rta->rta_len = skb->tail - b;

 if (tcf_exts_dump_stats(skb, &f->exts, &global_fw_ext_map[get_stack_id()]) < 0)
  goto rtattr_failure;
...
typedef  struct tcf_proto_ops   _GLOBAL_267_T; static  _GLOBAL_267_T  global_cls_fw_ops[NUM_STACKS] = {  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . kind  = "fw"   , . classify  = fw_classify   , . init  = fw_init   , . destroy  = fw_destroy   , . get  = fw_get   , . put  = fw_put   , . change  = fw_change   , . delete  = fw_delete   , . walk  = fw_walk   , . dump  = fw_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };      
...
static int  __attribute__ ((__section__ (".init.text"))) init_fw(void)
{
 return register_tcf_proto_ops(&global_cls_fw_ops[get_stack_id()]);
}

static void   __attribute__((__used__)) __attribute__ ((__section__(".exit.text"))) exit_fw(void)
{
 unregister_tcf_proto_ops(&global_cls_fw_ops[get_stack_id()]);
}

typedef  initcall_t  _GLOBAL_268_T; static  _GLOBAL_268_T  __initcall_init_fw __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = init_fw ;       
typedef  exitcall_t  _GLOBAL_269_T; static  _GLOBAL_269_T  global___exitcall_exit_fw[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__ (".exitcall.exit")))   = {  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  exit_fw,  };       
;
