# 1 "linux-2.6.18/net/sched/sch_red.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sched/sch_red.c"
# 17 "linux-2.6.18/net/sched/sch_red.c"
...
# 18 "linux-2.6.18/net/sched/sch_red.c" 2
...
# 21 "linux-2.6.18/net/sched/sch_red.c" 2
...
# 9 "linux-2.6.18/include/net/sch_generic.h" 2
...
# 23 "linux-2.6.18/net/sched/sch_red.c" 2
...
# 8 "linux-2.6.18/include/net/inet_ecn.h" 2
# 1 "linux-2.6.18/include/net/dsfield.h" 1
# 11 "linux-2.6.18/include/net/dsfield.h"
...
# 24 "linux-2.6.18/net/sched/sch_red.c" 2
# 1 "linux-2.6.18/include/net/red.h" 1
# 93 "linux-2.6.18/include/net/red.h"
struct red_stats
{
 u32 prob_drop;
 u32 prob_mark;
...
static inline  __attribute__((always_inline)) unsigned long red_calc_qavg_from_idle_time(struct red_parms *p)
{
 ...
 do_gettimeofday(&(now));
 us_idle = ({ int __delta_sec = (now).tv_sec - (p->qidlestart).tv_sec; int __delta = (now).tv_usec - (p->qidlestart).tv_usec; switch (__delta_sec) { default: __delta = psched_tod_diff(__delta_sec, p->Scell_max); break; case 2: __delta += 1000000L; case 1: __delta += 1000000L; case 0: if (__delta > p->Scell_max || __delta < 0) __delta = p->Scell_max; } __delta; });
# 203 "linux-2.6.18/include/net/red.h"
...
{
# 236 "linux-2.6.18/include/net/red.h"
...
{
# 271 "linux-2.6.18/include/net/red.h"
...
# 25 "linux-2.6.18/net/sched/sch_red.c" 2
# 40 "linux-2.6.18/net/sched/sch_red.c"
...
static struct Qdisc *red_create_dflt(struct net_device *dev, u32 limit)
{
 ...
 if (q) {
  rta = kmalloc((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(struct tc_fifo_qopt))),
...
{
 struct red_sched_data *q = qdisc_priv(sch);
 struct rtattr *tb[(__TCA_RED_MAX - 1)];
 struct tc_red_qopt *ctl;
 struct Qdisc *child = ((void *)0);

 if (opt == ((void *)0) || rtattr_parse((tb), ((__TCA_RED_MAX - 1)), ((void*)(((char*)((opt))) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))), ((int)(((opt))->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))))
  return -22;

 if (tb[TCA_RED_PARMS-1] == ((void *)0) ||
     ((int)((tb[TCA_RED_PARMS-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(*ctl) ||
     tb[TCA_RED_STAB-1] == ((void *)0) ||
     ((int)((tb[TCA_RED_STAB-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < 256)
  return -22;

 ctl = ((void*)(((char*)(tb[TCA_RED_PARMS-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 ...
 red_set_parms(&q->parms, ctl->qth_min, ctl->qth_max, ctl->Wlog,
     ...
     ((void*)(((char*)(tb[TCA_RED_STAB-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))));
...
static int red_dump(struct Qdisc *sch, struct sk_buff *skb)
{
 ...
 ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(opt))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_RED_PARMS, sizeof(opt), &opt); });
...
typedef  struct Qdisc_class_ops   _GLOBAL_237_T; static  _GLOBAL_237_T  global_red_class_ops[NUM_STACKS] = {  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  { . graft  = red_graft  , . leaf  = red_leaf   , . get  = red_get   , . put  = red_put   , . change  = red_change_class   , . delete  = red_delete   , . walk  = red_walk   , . tcf_chain  = red_find_tcf   , . dump  = red_dump_class   , } ,  };      
