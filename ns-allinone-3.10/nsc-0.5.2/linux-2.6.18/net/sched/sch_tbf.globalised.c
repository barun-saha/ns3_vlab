# 1 "linux-2.6.18/net/sched/sch_tbf.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sched/sch_tbf.c"
# 15 "linux-2.6.18/net/sched/sch_tbf.c"
...
# 16 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 17 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 24 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 25 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 27 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 29 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 32 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 33 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 35 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 36 "linux-2.6.18/net/sched/sch_tbf.c" 2
...
# 39 "linux-2.6.18/net/sched/sch_tbf.c" 2
# 116 "linux-2.6.18/net/sched/sch_tbf.c"
...
static struct sk_buff *tbf_dequeue(struct Qdisc* sch)
{
 ...
 if (skb) {
  ...
  toks = ({ int __delta_sec = (now).tv_sec - (q->t_c).tv_sec; int __delta = (now).tv_usec - (q->t_c).tv_usec; switch (__delta_sec) { default: __delta = psched_tod_diff(__delta_sec, q->buffer); break; case 2: __delta += 1000000L; case 1: __delta += 1000000L; case 0: if (__delta > q->buffer || __delta < 0) __delta = q->buffer; } __delta; });

  if (q->P_tab) {
   ptoks = toks + q->ptokens;
   if (ptoks > (long)q->mtu)
    ptoks = q->mtu;
   ptoks -= ((q)->P_tab->data[(len)>>(q)->P_tab->rate.cell_log]);
  }
  toks += q->tokens;
  if (toks > (long)q->buffer)
   toks = q->buffer;
  toks -= ((q)->R_tab->data[(len)>>(q)->R_tab->rate.cell_log]);
  ...
  delay = usecs_to_jiffies(({ long __x = (-toks); long __y = (-ptoks); __x > __y ? __x: __y; }));

  if (delay == 0)
   delay = 1;

  mod_timer(&q->wd_timer, global_jiffies[get_stack_id()]+delay);
# 251 "linux-2.6.18/net/sched/sch_tbf.c"
...
{
 struct Qdisc *q = qdisc_create_dflt(dev, &global_bfifo_qdisc_ops[get_stack_id()]);
        struct rtattr *rta;
 int ret;

 if (q) {
  rta = kmalloc((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(struct tc_fifo_qopt))), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
  if (rta) {
   rta->rta_type = RTM_NEWQDISC;
   rta->rta_len = (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(struct tc_fifo_qopt)));
   ((struct tc_fifo_qopt *)((void*)(((char*)(rta)) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))))->limit = limit;
...
static int tbf_change(struct Qdisc* sch, struct rtattr *opt)
{
 ...
 if (rtattr_parse((tb), (TCA_TBF_PTAB), ((void*)(((char*)((opt))) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))), ((int)(((opt))->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0)))) ||
     tb[TCA_TBF_PARMS-1] == ((void *)0) ||
     ((int)((tb[TCA_TBF_PARMS-1])->rta_len) - (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))) < sizeof(*qopt))
  goto done;

 qopt = ((void*)(((char*)(tb[TCA_TBF_PARMS-1])) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))));
 ...
 if (qopt->limit > 0) {
  if ((child = tbf_create_dflt_qdisc(sch->dev, qopt->limit)) == ((void *)0))
   goto done;
 }

 qdisc_lock_tree((sch)->dev);
 if (child)
  qdisc_destroy(((__typeof__(*(&q->qdisc)))__xchg((unsigned long)(child),(&q->qdisc),sizeof(*(&q->qdisc)))));
 q->limit = qopt->limit;
 q->mtu = qopt->mtu;
 q->max_size = max_size;
 ...
 q->tokens = q->buffer;
 q->ptokens = q->mtu;
 rtab = ((__typeof__(*(&q->R_tab)))__xchg((unsigned long)(rtab),(&q->R_tab),sizeof(*(&q->R_tab))));
 ptab = ((__typeof__(*(&q->P_tab)))__xchg((unsigned long)(ptab),(&q->P_tab),sizeof(*(&q->P_tab))));
...
static int tbf_init(struct Qdisc* sch, struct rtattr *opt)
{
 ...
 q->qdisc = &global_noop_qdisc[get_stack_id()];
...
static int tbf_dump(struct Qdisc *sch, struct sk_buff *skb)
{
 ...
 if (q->P_tab)
  ...
  (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(opt.peakrate))) ? __constant_c_and_count_memset(((&opt.peakrate)),((0x01010101UL*(unsigned char)(0))),((sizeof(opt.peakrate)))) : __constant_c_memset(((&opt.peakrate)),((0x01010101UL*(unsigned char)(0))),((sizeof(opt.peakrate))))) : (__builtin_constant_p((sizeof(opt.peakrate))) ? __memset_generic((((&opt.peakrate))),(((0))),(((sizeof(opt.peakrate))))) : __memset_generic(((&opt.peakrate)),((0)),((sizeof(opt.peakrate))))));
 opt.mtu = q->mtu;
 opt.buffer = q->buffer;
 ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (sizeof(opt))))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_TBF_PARMS, sizeof(opt), &opt); });
       ...
       struct Qdisc **old)
{
 ...
 if (new == ((void *)0))
  new = &global_noop_qdisc[get_stack_id()];

 qdisc_lock_tree((sch)->dev);
 *old = ((__typeof__(*(&q->qdisc)))__xchg((unsigned long)(new),(&q->qdisc),sizeof(*(&q->qdisc))));
 qdisc_reset(*old);
 sch->q.qlen = 0;
 qdisc_unlock_tree((sch)->dev);
...
typedef  struct Qdisc_class_ops   _GLOBAL_266_T; static  _GLOBAL_266_T  global_tbf_class_ops[NUM_STACKS] = {  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  { . graft  = tbf_graft  , . leaf  = tbf_leaf   , . get  = tbf_get   , . put  = tbf_put   , . change  = tbf_change_class   , . delete  = tbf_delete   , . walk  = tbf_walk   , . tcf_chain  = tbf_find_tcf   , . dump  = tbf_dump_class   , } ,  };     
...
typedef  struct Qdisc_ops   _GLOBAL_267_T; static  _GLOBAL_267_T  global_tbf_qdisc_ops[NUM_STACKS] = {  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[0]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[1]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[2]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[3]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[4]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[5]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[6]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[7]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[8]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[9]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[10]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[11]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[12]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[13]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[14]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[15]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[16]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[17]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[18]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[19]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[20]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[21]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[22]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[23]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[24]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[25]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[26]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[27]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[28]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[29]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[30]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[31]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[32]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[33]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[34]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[35]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[36]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[37]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[38]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[39]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[40]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[41]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[42]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[43]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[44]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[45]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[46]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[47]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[48]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  { . next  = ( ( void *  ) 0  )   , . cl_ops  = & global_tbf_class_ops[49]    , . id  = "tbf"   , . priv_size  = sizeof ( struct tbf_sched_data  )    , . enqueue  = tbf_enqueue   , . dequeue  = tbf_dequeue   , . requeue  = tbf_requeue   , . drop  = tbf_drop   , . init  = tbf_init   , . reset  = tbf_reset   , . destroy  = tbf_destroy   , . change  = tbf_change   , . dump  = tbf_dump   , . owner  = ( ( struct module  *  ) 0  )    , } ,  };      
...
static int  __attribute__ ((__section__ (".init.text"))) tbf_module_init(void)
{
 return register_qdisc(&global_tbf_qdisc_ops[get_stack_id()]);
}

static void   __attribute__((__used__)) __attribute__ ((__section__(".exit.text"))) tbf_module_exit(void)
{
 unregister_qdisc(&global_tbf_qdisc_ops[get_stack_id()]);
}
typedef  initcall_t  _GLOBAL_268_T; static  _GLOBAL_268_T  __initcall_tbf_module_init __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = tbf_module_init ;       
typedef  exitcall_t  _GLOBAL_269_T; static  _GLOBAL_269_T  global___exitcall_tbf_module_exit[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__ (".exitcall.exit")))   = {  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  tbf_module_exit,  };       
;
