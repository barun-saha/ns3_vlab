...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sched/cls_api.c"
# 17 "linux-2.6.18/net/sched/cls_api.c"
...
# 18 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 21 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 26 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 27 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 29 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 31 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 32 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 34 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 37 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 38 "linux-2.6.18/net/sched/cls_api.c" 2
...
# 7 "linux-2.6.18/include/net/pkt_cls.h" 2
...
# 39 "linux-2.6.18/net/sched/cls_api.c" 2
# 48 "linux-2.6.18/net/sched/cls_api.c"
typedef  struct tcf_proto_ops   _GLOBAL_233_T; static  _GLOBAL_233_T  * global_tcf_proto_base[NUM_STACKS];    


typedef  rwlock_t  _GLOBAL_234_T; static  _GLOBAL_234_T  global_cls_mod_lock[NUM_STACKS] = {  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  ( rwlock_t ) { . raw_lock  = { }   , } ,  };           
...
static struct tcf_proto_ops * tcf_proto_lookup_ops(struct rtattr *kind)
{
 ...
 if (kind) {
  do { do { } while (0); (void)0; (void)(&global_cls_mod_lock[get_stack_id()]); } while (0);
  for (t = global_tcf_proto_base[get_stack_id()]; t; t = t->next) {
...
int register_tcf_proto_ops(struct tcf_proto_ops *ops)
{
 ...
 do { do { } while (0); (void)0; (void)(&global_cls_mod_lock[get_stack_id()]); } while (0);
 for (tp = &global_tcf_proto_base[get_stack_id()]; (t = *tp) != ((void *)0); tp = &t->next)
...
static __inline__  __attribute__((always_inline)) u32 tcf_auto_prio(struct tcf_proto *tp)
{
 u32 first = (((0xC0000000U)&(0xFFFF0000U))|((0U)&(0x0000FFFFU)));
...
replay:
 tca = arg;
 t = ((void*)(((char*)n) + ((0)+( ((((int) ( ((sizeof(struct nlmsghdr))+4 -1) & ~(4 -1) )))+4 -1) & ~(4 -1) ))));
 protocol = ((t->tcm_info)&(0x0000FFFFU));
 prio = ((t->tcm_info)&(0xFFFF0000U));
 nprio = prio;
 parent = t->tcm_parent;
 cl = 0;
 ...
 if (prio == 0) {
  ...
  if (n->nlmsg_type != RTM_NEWTFILTER || !(n->nlmsg_flags&0x400))
   return -2;
  prio = (((0x80000000U)&(0xFFFF0000U))|((0U)&(0x0000FFFFU)));
 }




 if ((dev = __dev_get_by_index(t->tcm_ifindex)) == ((void *)0))
  return -19;
 ...
 if (!parent) {
  ...
  parent = q->handle;
 } else if ((q = qdisc_lookup(dev, ((t->tcm_parent)&(0xFFFF0000U)))) == ((void *)0))
  return -22;
 ...
 if (tp == ((void *)0)) {
  ...
  if (tca[TCA_KIND-1] == ((void *)0) || !protocol)
   goto errout;
  ...
  err = -105;
  if ((tp = kmalloc(sizeof(*tp), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)))) == ((void *)0))
   goto errout;
  err = -22;
  tp_ops = tcf_proto_lookup_ops(tca[TCA_KIND-1]);
  if (tp_ops == ((void *)0)) {
# 247 "linux-2.6.18/net/sched/cls_api.c"
   kfree(tp);
   goto errout;
  }
  (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(*tp))) ? __constant_c_and_count_memset(((tp)),((0x01010101UL*(unsigned char)(0))),((sizeof(*tp)))) : __constant_c_memset(((tp)),((0x01010101UL*(unsigned char)(0))),((sizeof(*tp))))) : (__builtin_constant_p((sizeof(*tp))) ? __memset_generic((((tp))),(((0))),(((sizeof(*tp))))) : __memset_generic(((tp)),((0)),((sizeof(*tp))))));
  tp->ops = tp_ops;
       ...
       u32 pid, u32 seq, u16 flags, int event)
{
 ...
 nlh = ({ if (skb_tailroom(skb) < (int)( ((((sizeof(*tcm))+( ((((int) ( ((sizeof(struct nlmsghdr))+4 -1) & ~(4 -1) )))+4 -1) & ~(4 -1) )))+4 -1) & ~(4 -1) )) goto nlmsg_failure; __nlmsg_put(skb, pid, seq, event, sizeof(*tcm), flags); });
 tcm = ((void*)(((char*)nlh) + ((0)+( ((((int) ( ((sizeof(struct nlmsghdr))+4 -1) & ~(4 -1) )))+4 -1) & ~(4 -1) ))));
 tcm->tcm_family = 0;
 tcm->tcm__pad1 = 0;
 tcm->tcm__pad1 = 0;
 tcm->tcm_ifindex = tp->q->dev->ifindex;
 tcm->tcm_parent = tp->classid;
 tcm->tcm_info = (((tp->prio)&(0xFFFF0000U))|((tp->protocol)&(0x0000FFFFU)));
 ({ if (__builtin_expect(!!(skb_tailroom(skb) < (int)( (((( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (16)))+4 -1) & ~(4 -1) )), 0)) goto rtattr_failure; __rta_fill(skb, TCA_KIND, 16, tp->ops->kind); });
 tcm->tcm_handle = fh;
...
{
 struct sk_buff *skb;
 u32 pid = oskb ? (*(struct netlink_skb_parms*)&((oskb)->cb)).pid : 0;

 skb = alloc_skb((((((1UL << 12) << (0)) - (0) - sizeof(struct skb_shared_info)) & ~((1 << (7)) - 1))), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!skb)
  return -105;
 ...
 return rtnetlink_send(skb, pid, RTNLGRP_TC, n->nlmsg_flags&8);
}
...
static int tcf_node_dump(struct tcf_proto *tp, unsigned long n, struct tcf_walker *arg)
{
 ...
 return tcf_fill_node(a->skb, tp, n, (*(struct netlink_skb_parms*)&((a->cb->skb)->cb)).pid,
        a->cb->nlh->nlmsg_seq, 2, RTM_NEWTFILTER);
}
...
static int tc_dump_tfilter(struct sk_buff *skb, struct netlink_callback *cb)
{
 ...
 struct tcmsg *tcm = (struct tcmsg*)((void*)(((char*)cb->nlh) + ((0)+( ((((int) ( ((sizeof(struct nlmsghdr))+4 -1) & ~(4 -1) )))+4 -1) & ~(4 -1) ))));
 unsigned long cl = 0;
 struct Qdisc_class_ops *cops;
 struct tcf_dump_args arg;

 if (cb->nlh->nlmsg_len < ((sizeof(*tcm))+( ((((int) ( ((sizeof(struct nlmsghdr))+4 -1) & ~(4 -1) )))+4 -1) & ~(4 -1) )))
  return skb->len;
 if ((dev = dev_get_by_index(tcm->tcm_ifindex)) == ((void *)0))
  return skb->len;
 ...
 if (!tcm->tcm_parent)
  ...
  q = qdisc_lookup(dev, ((tcm->tcm_parent)&(0xFFFF0000U)));
 if (!q)
  goto out;
 if ((cops = q->ops->cl_ops) == ((void *)0))
  goto errout;
 if (((tcm->tcm_parent)&(0x0000FFFFU))) {
 ...
 for (tp=*chain, t=0; tp; tp = tp->next, t++) {
  if (t < s_t) continue;
  if (((tcm->tcm_info)&(0xFFFF0000U)) &&
      ((tcm->tcm_info)&(0xFFFF0000U)) != tp->prio)
   continue;
  if (((tcm->tcm_info)&(0x0000FFFFU)) &&
      ((tcm->tcm_info)&(0x0000FFFFU)) != tp->protocol)
   continue;
  if (t > s_t)
   (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(cb->args)-sizeof(cb->args[0]))) ? __constant_c_and_count_memset(((&cb->args[1])),((0x01010101UL*(unsigned char)(0))),((sizeof(cb->args)-sizeof(cb->args[0])))) : __constant_c_memset(((&cb->args[1])),((0x01010101UL*(unsigned char)(0))),((sizeof(cb->args)-sizeof(cb->args[0]))))) : (__builtin_constant_p((sizeof(cb->args)-sizeof(cb->args[0]))) ? __memset_generic((((&cb->args[1]))),(((0))),(((sizeof(cb->args)-sizeof(cb->args[0]))))) : __memset_generic(((&cb->args[1])),((0)),((sizeof(cb->args)-sizeof(cb->args[0]))))));
  if (cb->args[1] == 0) {
   if (tcf_fill_node(skb, tp, 0, (*(struct netlink_skb_parms*)&((cb->skb)->cb)).pid,
       cb->nlh->nlmsg_seq, 2, RTM_NEWTFILTER) <= 0) {
    break;
   }
   cb->args[1] = 1;
  }
...
{
# 480 "linux-2.6.18/net/sched/cls_api.c"
}
...
tcf_exts_validate(struct tcf_proto *tp, struct rtattr **tb,
           ...
           struct tcf_ext_map *map)
{
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(*exts))) ? __constant_c_and_count_memset(((exts)),((0x01010101UL*(unsigned char)(0))),((sizeof(*exts)))) : __constant_c_memset(((exts)),((0x01010101UL*(unsigned char)(0))),((sizeof(*exts))))) : (__builtin_constant_p((sizeof(*exts))) ? __memset_generic((((exts))),(((0))),(((sizeof(*exts))))) : __memset_generic(((exts)),((0)),((sizeof(*exts))))));
# 524 "linux-2.6.18/net/sched/cls_api.c"
...
tcf_exts_change(struct tcf_proto *tp, struct tcf_exts *dst,
         struct tcf_exts *src)
{
# 555 "linux-2.6.18/net/sched/cls_api.c"
}
...
tcf_exts_dump(struct sk_buff *skb, struct tcf_exts *exts,
       struct tcf_ext_map *map)
{
# 594 "linux-2.6.18/net/sched/cls_api.c"
 return 0;
rtattr_failure: 
...
tcf_exts_dump_stats(struct sk_buff *skb, struct tcf_exts *exts,
             struct tcf_ext_map *map)
{
# 612 "linux-2.6.18/net/sched/cls_api.c"
 return 0;
rtattr_failure: 
 __attribute__ ((unused)) return -1;
}

static int  __attribute__ ((__section__ (".init.text"))) tc_filter_init(void)
{
 struct rtnetlink_link *link_p = (*_GLOBAL_rtnetlink_links_51_A[get_stack_id()])[0];
...
typedef  initcall_t  _GLOBAL_235_T; static  _GLOBAL_235_T  __initcall_tc_filter_init __attribute__((__used__)) __attribute__((__section__(".initcall" "4" ".init")))  = tc_filter_init ;       
