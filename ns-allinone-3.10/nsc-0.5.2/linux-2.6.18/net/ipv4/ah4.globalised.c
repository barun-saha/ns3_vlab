...
# 2 "linux-2.6.18/net/ipv4/ah4.c" 2
# 1 "linux-2.6.18/include/net/ip.h" 1
# 26 "linux-2.6.18/include/net/ip.h"
...
# 27 "linux-2.6.18/include/net/ip.h" 2
...
typedef  atomic_t  _GLOBAL_120_T; extern  _GLOBAL_120_T  global_flow_cache_genid[NUM_STACKS];   
...
typedef  struct files_stat_struct   _GLOBAL_122_T; extern  _GLOBAL_122_T  global_files_stat[NUM_STACKS];    
...
typedef  struct inodes_stat_t   _GLOBAL_123_T; extern  _GLOBAL_123_T  global_inodes_stat[NUM_STACKS];    

typedef  int  _GLOBAL_124_T; extern  _GLOBAL_124_T  global_leases_enable[NUM_STACKS]; extern  _GLOBAL_124_T  global_lease_break_time[NUM_STACKS];    
...
typedef  struct dentry_stat_t   _GLOBAL_125_T; extern  _GLOBAL_125_T  global_dentry_stat[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_126_T; extern  _GLOBAL_126_T  global_dcache_lock[NUM_STACKS];   
...
typedef  int  _GLOBAL_127_T; extern  _GLOBAL_127_T  global_sysctl_vfs_cache_pressure[NUM_STACKS];   
...
typedef  spinlock_t  _GLOBAL_128_T; extern  _GLOBAL_128_T  global_dq_data_lock[NUM_STACKS];   
...
typedef  struct dqstats   _GLOBAL_129_T; extern  _GLOBAL_129_T  global_dqstats[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_130_T; extern  _GLOBAL_130_T  global_files_lock[NUM_STACKS];   
...
typedef  struct list_head   _GLOBAL_131_T; extern  _GLOBAL_131_T  global_super_blocks[NUM_STACKS];    
typedef  spinlock_t  _GLOBAL_132_T; extern  _GLOBAL_132_T  global_sb_lock[NUM_STACKS];   
...
typedef  struct subsystem   _GLOBAL_133_T; extern  _GLOBAL_133_T  global_fs_subsys[NUM_STACKS];    
...
typedef  const struct file_operations    _GLOBAL_134_T; extern  _GLOBAL_134_T  global_def_blk_fops[NUM_STACKS];     
typedef  const struct address_space_operations    _GLOBAL_135_T; extern  _GLOBAL_135_T  global_def_blk_aops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_136_T; extern  _GLOBAL_136_T  global_def_chr_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_137_T; extern  _GLOBAL_137_T  global_bad_sock_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_138_T; extern  _GLOBAL_138_T  global_def_fifo_fops[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_139_T; extern  _GLOBAL_139_T  global_read_fifo_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_140_T; extern  _GLOBAL_140_T  global_write_fifo_fops[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_141_T; extern  _GLOBAL_141_T  global_rdwr_fifo_fops[NUM_STACKS];     
...
typedef  const struct file_operations    _GLOBAL_142_T; extern  _GLOBAL_142_T  global_generic_ro_fops[NUM_STACKS];     
...
typedef  struct inode_operations   _GLOBAL_143_T; extern  _GLOBAL_143_T  global_page_symlink_inode_operations[NUM_STACKS];    
...
typedef  const struct file_operations    _GLOBAL_144_T; extern  _GLOBAL_144_T  global_simple_dir_operations[NUM_STACKS];     
typedef  struct inode_operations   _GLOBAL_145_T; extern  _GLOBAL_145_T  global_simple_dir_inode_operations[NUM_STACKS];    
...
typedef  unsigned long   _GLOBAL_146_T; extern  _GLOBAL_146_T  global_max_mapnr[NUM_STACKS];    


typedef  unsigned long   _GLOBAL_147_T; extern  _GLOBAL_147_T  global_num_physpages[NUM_STACKS];    
typedef  void  _GLOBAL_148_T; extern  _GLOBAL_148_T  * global_high_memory[NUM_STACKS];    
swapper_pg_dir_I [ 1024 ] ; extern  _GLOBAL_164_T  _GLOBAL_44_swapper_pg_dir_I [ 1024 ] ; extern  _GLOBAL_164_T  _GLOBAL_45_swapper_pg_dir_I [ 1024 ] ; extern  _GLOBAL_164_T  _GLOBAL_46_swapper_pg_dir_I [ 1024 ] ; extern  _GLOBAL_164_T  _GLOBAL_47_swapper_pg_dir_I [ 1024 ] ; extern  _GLOBAL_164_T  _GLOBAL_48_swapper_pg_dir_I [ 1024 ] ; extern  _GLOBAL_164_T  _GLOBAL_49_swapper_pg_dir_I [ 1024 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_swapper_pg_dir_I) *_GLOBAL_swapper_pg_dir_20_A[NUM_STACKS];  
typedef  kmem_cache_t  _GLOBAL_165_T; extern  _GLOBAL_165_T  * global_pgd_cache[NUM_STACKS];   
typedef  kmem_cache_t  _GLOBAL_166_T; extern  _GLOBAL_166_T  * global_pmd_cache[NUM_STACKS];   
typedef  spinlock_t  _GLOBAL_167_T; extern  _GLOBAL_167_T  global_pgd_lock[NUM_STACKS];   
typedef  struct page   _GLOBAL_168_T; extern  _GLOBAL_168_T  * global_pgd_list[NUM_STACKS];    
...
typedef  unsigned long long    _GLOBAL_169_T; extern  _GLOBAL_169_T  global___PAGE_KERNEL[NUM_STACKS]; extern  _GLOBAL_169_T  global___PAGE_KERNEL_EXEC[NUM_STACKS];      
# 203 "linux-2.6.18/include/asm/pgtable.h"
typedef  unsigned long   _GLOBAL_170_T; extern  _GLOBAL_170_T  _GLOBAL_0_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_1_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_2_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_3_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_4_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_5_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_6_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_7_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_8_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_9_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_10_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_11_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_12_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_13_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_14_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_15_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_16_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_17_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_18_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_19_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_20_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_21_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_22_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_23_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_24_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_25_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_26_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_27_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_28_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_29_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_30_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_31_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_32_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_33_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_34_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_35_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_36_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_37_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_38_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_39_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_40_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_41_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_42_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_43_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_44_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_45_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_46_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_47_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_48_pg0_I [ ] ; extern  _GLOBAL_170_T  _GLOBAL_49_pg0_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_pg0_I) *_GLOBAL_pg0_21_A[NUM_STACKS];   
...
typedef  pgprot_t  _GLOBAL_171_T; extern  _GLOBAL_171_T  _GLOBAL_0_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_1_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_2_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_3_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_4_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_5_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_6_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_7_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_8_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_9_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_10_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_11_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_12_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_13_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_14_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_15_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_16_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_17_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_18_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_19_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_20_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_21_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_22_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_23_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_24_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_25_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_26_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_27_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_28_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_29_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_30_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_31_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_32_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_33_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_34_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_35_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_36_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_37_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_38_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_39_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_40_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_41_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_42_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_43_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_44_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_45_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_46_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_47_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_48_protection_map_I [ 16 ] ; extern  _GLOBAL_171_T  _GLOBAL_49_protection_map_I [ 16 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_protection_map_I) *_GLOBAL_protection_map_22_A[NUM_STACKS];  
...
typedef  atomic_long_t  _GLOBAL_172_T; extern  _GLOBAL_172_T  vm_stat [ NR_VM_ZONE_STAT_ITEMS ] ;   
...
typedef  struct page   _GLOBAL_173_T; extern  _GLOBAL_173_T  * global_mem_map[NUM_STACKS];    
...
typedef  struct address_space   _GLOBAL_174_T; extern  _GLOBAL_174_T  global_swapper_space[NUM_STACKS];    
...
typedef  int  _GLOBAL_175_T; extern  _GLOBAL_175_T  global_randomize_va_space[NUM_STACKS];   
...
typedef  struct movsl_mask { int  mask ;  }   _GLOBAL_176_T; extern  _GLOBAL_176_T  global_movsl_mask[NUM_STACKS];    
...
typedef  ctl_table  _GLOBAL_177_T; extern  _GLOBAL_177_T  _GLOBAL_0_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_1_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_2_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_3_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_4_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_5_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_6_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_7_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_8_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_9_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_10_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_11_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_12_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_13_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_14_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_15_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_16_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_17_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_18_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL_19_net_table_I [ ] ; extern  _GLOBAL_177_T  _GLOBAL
] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_sysctl_local_port_range_I) *_GLOBAL_sysctl_local_port_range_57_A[NUM_STACKS];  
typedef  int  _GLOBAL_236_T; extern  _GLOBAL_236_T  global_sysctl_ip_default_ttl[NUM_STACKS];   
typedef  int  _GLOBAL_237_T; extern  _GLOBAL_237_T  global_sysctl_ip_nonlocal_bind[NUM_STACKS];   


typedef  int  _GLOBAL_238_T; extern  _GLOBAL_238_T  global_sysctl_ipfrag_high_thresh[NUM_STACKS];   
typedef  int  _GLOBAL_239_T; extern  _GLOBAL_239_T  global_sysctl_ipfrag_low_thresh[NUM_STACKS];   
typedef  int  _GLOBAL_240_T; extern  _GLOBAL_240_T  global_sysctl_ipfrag_time[NUM_STACKS];   
typedef  int  _GLOBAL_241_T; extern  _GLOBAL_241_T  global_sysctl_ipfrag_secret_interval[NUM_STACKS];   
typedef  int  _GLOBAL_242_T; extern  _GLOBAL_242_T  global_sysctl_ipfrag_max_dist[NUM_STACKS];   


typedef  int  _GLOBAL_243_T; extern  _GLOBAL_243_T  global_inet_peer_threshold[NUM_STACKS];   
typedef  int  _GLOBAL_244_T; extern  _GLOBAL_244_T  global_inet_peer_minttl[NUM_STACKS];   
typedef  int  _GLOBAL_245_T; extern  _GLOBAL_245_T  global_inet_peer_maxttl[NUM_STACKS];   
typedef  int  _GLOBAL_246_T; extern  _GLOBAL_246_T  global_inet_peer_gc_mintime[NUM_STACKS];   
typedef  int  _GLOBAL_247_T; extern  _GLOBAL_247_T  global_inet_peer_gc_maxtime[NUM_STACKS];   


typedef  int  _GLOBAL_248_T; extern  _GLOBAL_248_T  global_sysctl_ip_dynaddr[NUM_STACKS];   
...
typedef  const char   _GLOBAL_249_T; extern  _GLOBAL_249_T  _GLOBAL_0_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_1_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_2_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_3_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_4_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_5_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_6_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_7_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_8_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_9_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_10_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_11_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_12_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_13_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_14_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_15_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_16_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_17_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_18_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_19_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_20_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_21_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_22_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_23_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_24_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_25_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_26_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_27_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_28_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_29_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_30_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_31_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_32_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_33_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_34_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_35_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_36_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_37_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_38_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_39_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_40_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_41_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_42_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_43_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_44_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_45_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_46_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_47_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_48_inet_csk_timer_bug_msg_I [ ] ; extern  _GLOBAL_249_T  _GLOBAL_49_inet_csk_timer_bug_msg_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet_csk_timer_bug_msg_I) *_GLOBAL_inet_csk_timer_bug_msg_58_A[NUM_STACKS];   
...
typedef  struct ipv6_devconf   _GLOBAL_250_T; extern  _GLOBAL_250_T  global_ipv6_devconf[NUM_STACKS];    
...
# 289 "linux-2.6.18/include/net/ip.h" 2
...
typedef  int  _GLOBAL_251_T; extern  _GLOBAL_251_T  global_ip_frag_nqueues[NUM_STACKS];   
typedef  atomic_t  _GLOBAL_252_T; extern  _GLOBAL_252_T  global_ip_frag_mem[NUM_STACKS];   
...
typedef  struct ctl_table   _GLOBAL_253_T; extern  _GLOBAL_253_T  _GLOBAL_0_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_1_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_2_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_3_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_4_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_5_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_6_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_7_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_8_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_9_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_10_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_11_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_12_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_13_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_14_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_15_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_16_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_17_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_18_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_19_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_20_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_21_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_22_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_23_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_24_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_25_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_26_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_27_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_28_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_29_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_30_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_31_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_32_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_33_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_34_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_35_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_36_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_37_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_38_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_39_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_40_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_41_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_42_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_43_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_44_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_45_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_46_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_47_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_48_ipv4_table_I [ ] ; extern  _GLOBAL_253_T  _GLOBAL_49_ipv4_table_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv4_table_I) *_GLOBAL_ipv4_table_59_A[NUM_STACKS];   
# 3 "linux-2.6.18/net/ipv4/ah4.c" 2
...
typedef  spinlock_t  _GLOBAL_254_T; extern  _GLOBAL_254_T  global_inet_peer_unused_lock[NUM_STACKS];   
typedef  struct inet_peer   _GLOBAL_255_T; extern  _GLOBAL_255_T  * *  global_inet_peer_unused_tailp[NUM_STACKS];    
...
typedef  spinlock_t  _GLOBAL_256_T; extern  _GLOBAL_256_T  global_inet_peer_idlock[NUM_STACKS];   
...
typedef  struct ip_rt_acct   _GLOBAL_257_T; extern  _GLOBAL_257_T  * global_ip_rt_acct[NUM_STACKS];    
...
typedef  __u8  _GLOBAL_258_T; extern  _GLOBAL_258_T  _GLOBAL_0_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_1_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_2_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_3_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_4_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_5_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_6_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_7_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_8_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_9_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_10_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_11_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_12_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_13_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_14_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_15_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_16_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_17_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_18_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_19_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_20_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_21_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_22_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_23_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_24_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_25_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_26_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_27_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_28_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_29_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_30_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_31_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_32_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_33_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_34_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_35_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_36_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_37_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_38_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_39_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_40_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_41_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_42_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_43_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_44_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_45_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_46_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_47_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_48_ip_tos2prio_I [ 16 ] ; extern  _GLOBAL_258_T  _GLOBAL_49_ip_tos2prio_I [ 16 ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ip_tos2prio_I) *_GLOBAL_ip_tos2prio_60_A[NUM_STACKS] = { &_GLOBAL_0_ip_tos2prio_I, &_GLOBAL_1_ip_tos2prio_I, &_GLOBAL_2_ip_tos2prio_I, &_GLOBAL_3_ip_tos2prio_I, &_GLOBAL_4_ip_tos2prio_I, &_GLOBAL_5_ip_tos2prio_I, &_GLOBAL_6_ip_tos2prio_I, &_GLOBAL_7_ip_tos2prio_I, &_GLOBAL_8_ip_tos2prio_I, &_GLOBAL_9_ip_tos2prio_I, &_GLOBAL_10_ip_tos2prio_I, &_GLOBAL_11_ip_tos2prio_I, &_GLOBAL_12_ip_tos2prio_I, &_GLOBAL_13_ip_tos2prio_I, &_GLOBAL_14_ip_tos2prio_I, &_GLOBAL_15_ip_tos2prio_I, &_GLOBAL_16_ip_tos2prio_I, &_GLOBAL_17_ip_tos2prio_I, &_GLOBAL_18_ip_tos2prio_I, &_GLOBAL_19_ip_tos2prio_I, &_GLOBAL_20_ip_tos2prio_I, &_GLOBAL_21_ip_tos2prio_I, &_GLOBAL_22_ip_tos2prio_I, &_GLOBAL_23_ip_tos2prio_I, &_GLOBAL_24_ip_tos2prio_I, &_GLOBAL_25_ip_tos2prio_I, &_GLOBAL_26_ip_tos2prio_I, &_GLOBAL_27_ip_tos2prio_I, &_GLOBAL_28_ip_tos2prio_I, &_GLOBAL_29_ip_tos2prio_I, &_GLOBAL_30_ip_tos2prio_I, &_GLOBAL_31_ip_tos2prio_I, &_GLOBAL_32_ip_tos2prio_I, &_GLOBAL_33_ip_tos2prio_I, &_GLOBAL_34_ip_tos2prio_I, &_GLOBAL_35_ip_tos2prio_I, &_GLOBAL_36_ip_tos2prio_I, &_GLOBAL_37_ip_tos2prio_I, &_GLOBAL_38_ip_tos2prio_I, &_GLOBAL_39_ip_tos2prio_I, &_GLOBAL_40_ip_tos2prio_I, &_GLOBAL_41_ip_tos2prio_I, &_GLOBAL_42_ip_tos2prio_I, &_GLOBAL_43_ip_tos2prio_I, &_GLOBAL_44_ip_tos2prio_I, &_GLOBAL_45_ip_tos2prio_I, &_GLOBAL_46_ip_tos2prio_I, &_GLOBAL_47_ip_tos2prio_I, &_GLOBAL_48_ip_tos2prio_I, &_GLOBAL_49_ip_tos2prio_I, };  
...
typedef  ctl_table  _GLOBAL_259_T; extern  _GLOBAL_259_T  _GLOBAL_0_ipv4_route_table_I [ ] ; extern  _GLOBAL_259_T  _GLOBAL
table_I [ ] ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_ipv6_icmp_table_I) *_GLOBAL_ipv6_icmp_table_67_A[NUM_STACKS];  
...
typedef  struct fib6_walker_t   _GLOBAL_279_T; extern  _GLOBAL_279_T  global_fib6_walker_list[NUM_STACKS];    
typedef  rwlock_t  _GLOBAL_280_T; extern  _GLOBAL_280_T  global_fib6_walker_lock[NUM_STACKS];   
...
typedef  struct fib6_node   _GLOBAL_281_T; extern  _GLOBAL_281_T  global_ip6_routing_table[NUM_STACKS];    
...
typedef  struct sock   _GLOBAL_282_T; extern  _GLOBAL_282_T  * global_xfrm_nl[NUM_STACKS];    
typedef  u32  _GLOBAL_283_T; extern  _GLOBAL_283_T  global_sysctl_xfrm_aevent_etime[NUM_STACKS];   
typedef  u32  _GLOBAL_284_T; extern  _GLOBAL_284_T  global_sysctl_xfrm_aevent_rseqth[NUM_STACKS];   

typedef  struct mutex   _GLOBAL_285_T; extern  _GLOBAL_285_T  global_xfrm_cfg_mutex[NUM_STACKS];    
...
typedef  struct xfrm_policy   _GLOBAL_286_T; extern  _GLOBAL_286_T  * _GLOBAL_0_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_1_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_2_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_3_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_4_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_5_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_6_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_7_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_8_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_9_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_10_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_11_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_12_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_13_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_14_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_15_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_16_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_17_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_18_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_19_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_20_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_21_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_22_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_23_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_24_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_25_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_26_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_27_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_28_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_29_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_30_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_31_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_32_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_33_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_34_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_35_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_36_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_37_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_38_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_39_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_40_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_41_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_42_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_43_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_44_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_45_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_46_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_47_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_48_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; extern  _GLOBAL_286_T  * _GLOBAL_49_xfrm_policy_list_I [ XFRM_POLICY_MAX * 2  ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_xfrm_policy_list_I) *_GLOBAL_xfrm_policy_list_68_A[NUM_STACKS];   
...
typedef  wait_queue_head_t  _GLOBAL_287_T; extern  _GLOBAL_287_T  global_km_waitq[NUM_STACKS];   
...
# 4 "linux-2.6.18/net/ipv4/ah4.c" 2
# 1 "linux-2.6.18/include/net/ah.h" 1
# 9 "linux-2.6.18/include/net/ah.h"
struct ah_data
{
 u8 *key;
 int key_len;
...
ah_hmac_digest(struct ah_data *ahp, struct sk_buff *skb, u8 *auth_data)
{
 ...
 (__builtin_constant_p(0) ? (__builtin_constant_p((ahp->icv_trunc_len)) ? __constant_c_and_count_memset(((auth_data)),((0x01010101UL*(unsigned char)(0))),((ahp->icv_trunc_len))) : __constant_c_memset(((auth_data)),((0x01010101UL*(unsigned char)(0))),((ahp->icv_trunc_len)))) : (__builtin_constant_p((ahp->icv_trunc_len)) ? __memset_generic((((auth_data))),(((0))),(((ahp->icv_trunc_len)))) : __memset_generic(((auth_data)),((0)),((ahp->icv_trunc_len)))));
 crypto_hmac_init(tfm, ahp->key, &ahp->key_len);
 skb_icv_walk(skb, tfm, 0, skb->len, crypto_hmac_update);
 crypto_hmac_final(tfm, ahp->key, &ahp->key_len, ahp->work_icv);
 (__builtin_constant_p(ahp->icv_trunc_len) ? __constant_memcpy((auth_data),(ahp->work_icv),(ahp->icv_trunc_len)) : __memcpy((auth_data),(ahp->work_icv),(ahp->icv_trunc_len)));
}
# 5 "linux-2.6.18/net/ipv4/ah4.c" 2
...
typedef  struct icmp_err   _GLOBAL_288_T; extern  _GLOBAL_288_T  _GLOBAL_0_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL_1_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL_2_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL_3_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL_4_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL_5_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL_6_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL_7_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL_8_icmp_err_convert_I [ ] ; extern  _GLOBAL_288_T  _GLOBAL
inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_22_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_23_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_24_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_25_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_26_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_27_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_28_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_29_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_30_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_31_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_32_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_33_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_34_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_35_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_36_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_37_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_38_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_39_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_40_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_41_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_42_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_43_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_44_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_45_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_46_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_47_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_48_inet6_protos_I [ 256 ]  ; extern  _GLOBAL_298_T  * _GLOBAL_49_inet6_protos_I [ 256 ]  ; static __attribute__ ((unused)) __typeof__(_GLOBAL_0_inet6_protos_I) *_GLOBAL_inet6_protos_72_A[NUM_STACKS];   
...
# 9 "linux-2.6.18/net/ipv4/ah4.c" 2
# 1 "linux-2.6.18/include/asm/scatterlist.h" 1
...
# 10 "linux-2.6.18/net/ipv4/ah4.c" 2
...
static int ip_clear_mutable_options(struct iphdr *iph, u32 *daddr)
{
 ...
 while (l > 0) {
  ...
  case (9 |0x00|0x80):
   if (optlen < 6)
    return -22;
   (__builtin_constant_p(4) ? __constant_memcpy((daddr),(optptr+optlen-4),(4)) : __memcpy((daddr),(optptr+optlen-4),(4)));

  default:
   (__builtin_constant_p(0) ? (__builtin_constant_p((optlen-2)) ? __constant_c_and_count_memset(((optptr+2)),((0x01010101UL*(unsigned char)(0))),((optlen-2))) : __constant_c_memset(((optptr+2)),((0x01010101UL*(unsigned char)(0))),((optlen-2)))) : (__builtin_constant_p((optlen-2)) ? __memset_generic((((optptr+2))),(((0))),(((optlen-2)))) : __memset_generic(((optptr+2)),((0)),((optlen-2)))));
  }
  l -= optlen;
  optptr += optlen;
 }
...
static int ah_output(struct xfrm_state *x, struct sk_buff *skb)
{
 ...
 if (top_iph->ihl != 5) {
  ...
  (__builtin_constant_p(top_iph->ihl*4 - sizeof(struct iphdr)) ? __constant_memcpy((iph+1),(top_iph+1),(top_iph->ihl*4 - sizeof(struct iphdr))) : __memcpy((iph+1),(top_iph+1),(top_iph->ihl*4 - sizeof(struct iphdr))));
 ...
 ahp = x->data;
 ah->hdrlen = ((((sizeof(struct ip_auth_hdr) + ahp->icv_trunc_len) + 7) & ~7) >> 2) - 2;
 ...
 if (top_iph->ihl != 5) {
  ...
  (__builtin_constant_p(top_iph->ihl*4 - sizeof(struct iphdr)) ? __constant_memcpy((top_iph+1),(iph+1),(top_iph->ihl*4 - sizeof(struct iphdr))) : __memcpy((top_iph+1),(iph+1),(top_iph->ihl*4 - sizeof(struct iphdr))));
 }
...
static int ah_input(struct xfrm_state *x, struct sk_buff *skb)
{
 ...
 if (ah_hlen != (((sizeof(struct ip_auth_hdr) + ahp->icv_full_len) + 7) & ~7) &&
     ah_hlen != (((sizeof(struct ip_auth_hdr) + ahp->icv_trunc_len) + 7) & ~7))
  goto out;
 ...
 if (skb_cloned(skb) &&
     pskb_expand_head(skb, 0, 0, ((( gfp_t)0x20u))))
  goto out;
 ...
 (__builtin_constant_p(ihl) ? __constant_memcpy((work_buf),(iph),(ihl)) : __memcpy((work_buf),(iph),(ihl)));
 ...
 if (ihl > sizeof(*iph)) {
  ...
  (__builtin_constant_p(ahp->icv_trunc_len) ? __constant_memcpy((auth_data),(ah->auth_data),(ahp->icv_trunc_len)) : __memcpy((auth_data),(ah->auth_data),(ahp->icv_trunc_len)));
  skb_push(skb, ihl);
  ahp->icv(ahp, skb, ah->auth_data);
  if (__builtin_memcmp(ah->auth_data, auth_data, ahp->icv_trunc_len)) {
   x->stats.integrity_failed++;
   goto out;
  }
 }
 ((struct iphdr*)work_buf)->protocol = ah->nexthdr;
 skb->h.raw = (__builtin_constant_p(ihl) ? __constant_memcpy((skb->nh.raw += ah_hlen),(work_buf),(ihl)) : __memcpy((skb->nh.raw += ah_hlen),(work_buf),(ihl)));
...
static void ah4_err(struct sk_buff *skb, u32 info)
{
 ...
 if (skb->h.icmph->type != 3 ||
     skb->h.icmph->code != 4)
  return;

 x = xfrm_state_lookup((xfrm_address_t *)&iph->daddr, ah->spi, IPPROTO_AH, 2);
 if (!x)
  return;
 printk("<7>" "pmtu discovery on SA AH/%08x/%08x\n",
...
static int ah_init_state(struct xfrm_state *x)
{
 ...
 ahp = kzalloc(sizeof(*ahp), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (ahp == ((void *)0))
  return -12;
 ...
 do { if (!aalg_desc) ; } while(0);

 if (aalg_desc->uinfo.auth.icv_fullbits/8 !=
     crypto_tfm_alg_digestsize(ahp->tfm)) {
  printk("<6>" "AH: %s digestsize %u != %hu\n",
 ...
 do { if (ahp->icv_trunc_len > 12) ; } while(0);

 ahp->work_icv = kmalloc(ahp->icv_full_len, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));
 if (!ahp->work_icv)
  goto error;

 x->props.header_len = (((sizeof(struct ip_auth_hdr) + ahp->icv_trunc_len) + 7) & ~7);
 if (x->props.mode)
...
typedef  struct xfrm_type   _GLOBAL_299_T; static  _GLOBAL_299_T  global_ah_type[NUM_STACKS] = {  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  { . description  = "AH4"  , . owner  = ( ( struct module  *  ) 0  )    , . proto  = IPPROTO_AH   , . init_state  = ah_init_state   , . destructor  = ah_destroy   , . input  = ah_input   , . output  = ah_output   } ,  };     
...
typedef  struct net_protocol   _GLOBAL_300_T; static  _GLOBAL_300_T  global_ah4_protocol[NUM_STACKS] = {  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  { . handler  = xfrm4_rcv  , . err_handler  = ah4_err   , . no_policy  = 1   , } ,  };      
   
   
   


static int  __attribute__ ((__section__ (".init.text"))) ah4_init(void)
{
 if (xfrm_register_type(&global_ah_type[get_stack_id()], 2) < 0) {
  printk("<6>" "ip ah init: can't add xfrm type\n");
  return -11;
 }
 if (inet_add_protocol(&global_ah4_protocol[get_stack_id()], IPPROTO_AH) < 0) {
  printk("<6>" "ip ah init: can't add protocol\n");
  xfrm_unregister_type(&global_ah_type[get_stack_id()], 2);
  return -11;
 }
 return 0;
}

static void   __attribute__((__used__)) __attribute__ ((__section__(".exit.text"))) ah4_fini(void)
{
 if (inet_del_protocol(&global_ah4_protocol[get_stack_id()], IPPROTO_AH) < 0)
  printk("<6>" "ip ah close: can't remove protocol\n");
 if (xfrm_unregister_type(&global_ah_type[get_stack_id()], 2) < 0)
  printk("<6>" "ip ah close: can't remove xfrm type\n");
}

typedef  initcall_t  _GLOBAL_301_T; static  _GLOBAL_301_T  __initcall_ah4_init __attribute__((__used__)) __attribute__((__section__(".initcall" "6" ".init")))  = ah4_init ;       ;
typedef  exitcall_t  _GLOBAL_302_T; static  _GLOBAL_302_T  global___exitcall_ah4_fini[NUM_STACKS] __attribute__((__used__)) __attribute__ ((__section__ (".exitcall.exit")))   = {  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  ah4_fini,  };       ;
;
