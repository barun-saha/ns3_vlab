# 1 "linux-2.6.18/net/ipv4/tcp_veno.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/ipv4/tcp_veno.c"
# 13 "linux-2.6.18/net/ipv4/tcp_veno.c"
...
# 14 "linux-2.6.18/net/ipv4/tcp_veno.c" 2
...
# 15 "linux-2.6.18/net/ipv4/tcp_veno.c" 2
...
# 16 "linux-2.6.18/net/ipv4/tcp_veno.c" 2
...
# 17 "linux-2.6.18/net/ipv4/tcp_veno.c" 2
...
# 19 "linux-2.6.18/net/ipv4/tcp_veno.c" 2





typedef  const int   _GLOBAL_310_T; static  _GLOBAL_310_T  global_beta[NUM_STACKS] = {  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  3 << 1 ,  };        
...
# 45 "linux-2.6.18/net/ipv4/tcp_veno.c"
...
static void tcp_veno_rtt_calc(struct sock *sk, u32 usrtt)
{
 ...
 veno->minrtt = ({ typeof(veno->minrtt) _x = (veno->minrtt); typeof(vrtt) _y = (vrtt); (void) (&_x == &_y); _x < _y ? _x : _y; });
 veno->cntrtt++;
}
...
# 106 "linux-2.6.18/net/ipv4/tcp_veno.c"
...
static u32 tcp_veno_ssthresh(struct sock *sk)
{
 ...
 if (veno->diff < global_beta[get_stack_id()])
  ...
  return ({ typeof(tp->snd_cwnd * 4 / 5) _x = (tp->snd_cwnd * 4 / 5); typeof(2U) _y = (2U); (void) (&_x == &_y); _x > _y ? _x : _y; });
 else

  return ({ typeof(tp->snd_cwnd >> 1U) _x = (tp->snd_cwnd >> 1U); typeof(2U) _y = (2U); (void) (&_x == &_y); _x > _y ? _x : _y; });
}

typedef  struct tcp_congestion_ops   _GLOBAL_311_T; static  _GLOBAL_311_T  global_tcp_veno[NUM_STACKS] = {  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  { . init  = tcp_veno_init  , . ssthresh  = tcp_veno_ssthresh   , . cong_avoid  = tcp_veno_cong_avoid   , . rtt_sample  = tcp_veno_rtt_calc   , . set_state  = tcp_veno_state   , . cwnd_event  = tcp_veno_cwnd_event   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "veno"   , } ,  };      
