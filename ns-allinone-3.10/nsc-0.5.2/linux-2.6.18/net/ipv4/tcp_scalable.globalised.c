# 1 "linux-2.6.18/net/ipv4/tcp_scalable.c"
...
# 9 "linux-2.6.18/net/ipv4/tcp_scalable.c" 2
...
# 10 "linux-2.6.18/net/ipv4/tcp_scalable.c" 2
# 18 "linux-2.6.18/net/ipv4/tcp_scalable.c"
        ...
        u32 in_flight, int flag)
{
 ...
 if (tp->snd_cwnd <= tp->snd_ssthresh)
  ...
  tp->snd_cwnd_cnt++;
  if (tp->snd_cwnd_cnt > ({ typeof(tp->snd_cwnd) _x = (tp->snd_cwnd); typeof(50U) _y = (50U); (void) (&_x == &_y); _x < _y ? _x : _y; })){
