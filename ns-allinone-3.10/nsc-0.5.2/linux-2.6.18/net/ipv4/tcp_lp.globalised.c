# 1 "linux-2.6.18/net/ipv4/tcp_lp.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/ipv4/tcp_lp.c"
# 39 "linux-2.6.18/net/ipv4/tcp_lp.c"
...
# 40 "linux-2.6.18/net/ipv4/tcp_lp.c" 2
...
# 41 "linux-2.6.18/net/ipv4/tcp_lp.c" 2
# 55 "linux-2.6.18/net/ipv4/tcp_lp.c"
enum tcp_lp_state {
 LP_VALID_RHZ = (1 << 0),
 LP_VALID_OWD = (1 << 1),
 LP_WITHIN_THR = (1 << 3),
...
# 79 "linux-2.6.18/net/ipv4/tcp_lp.c"
struct lp {
 u32 flag;
 u32 sowd;
 u32 owd_min;
...
# 121 "linux-2.6.18/net/ipv4/tcp_lp.c"
...
# 137 "linux-2.6.18/net/ipv4/tcp_lp.c"
...
# 190 "linux-2.6.18/net/ipv4/tcp_lp.c"
...
# 224 "linux-2.6.18/net/ipv4/tcp_lp.c"
...
# 267 "linux-2.6.18/net/ipv4/tcp_lp.c"
static void tcp_lp_pkts_acked(struct sock *sk, u32 num_acked)
{
 ...
 if (lp->flag & LP_WITHIN_INF)
  ...
  tp->snd_cwnd = ({ typeof(tp->snd_cwnd >> 1U) _x = (tp->snd_cwnd >> 1U); typeof(1U) _y = (1U); (void) (&_x == &_y); _x > _y ? _x : _y; });


 lp->last_drop = ((__u32)(global_jiffies[get_stack_id()]));
}

typedef  struct tcp_congestion_ops   _GLOBAL_310_T; static  _GLOBAL_310_T  global_tcp_lp[NUM_STACKS] = {  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  { . init  = tcp_lp_init  , . ssthresh  = tcp_reno_ssthresh   , . cong_avoid  = tcp_lp_cong_avoid   , . min_cwnd  = tcp_reno_min_cwnd   , . rtt_sample  = tcp_lp_rtt_sample   , . pkts_acked  = tcp_lp_pkts_acked   , . owner  = ( ( struct module  *  ) 0  )    , . name  = "lp"   } ,  };      
