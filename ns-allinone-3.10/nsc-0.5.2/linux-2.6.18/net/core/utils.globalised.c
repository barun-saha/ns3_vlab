# 1 "linux-2.6.18/net/core/utils.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/core/utils.c"
# 16 "linux-2.6.18/net/core/utils.c"
...
# 21 "linux-2.6.18/net/core/utils.c" 2
...
# 22 "linux-2.6.18/net/core/utils.c" 2
...
typedef  struct file_operations   _GLOBAL_176_T; extern  _GLOBAL_176_T  global_random_fops[NUM_STACKS]; extern  _GLOBAL_176_T  global_urandom_fops[NUM_STACKS];     


unsigned int get_random_int(void);
unsigned long randomize_range(unsigned long start, unsigned long end, unsigned long len);
# 25 "linux-2.6.18/net/core/utils.c" 2
...
# 31 "linux-2.6.18/net/core/utils.c" 2
# 66 "linux-2.6.18/net/core/utils.c"
struct nrnd_state {
 u32 s1, s2, s3;
};

typedef  __typeof__ ( struct nrnd_state  )   _GLOBAL_178_T; static  _GLOBAL_178_T  global_per_cpu__net_rand_state[NUM_STACKS];    
...
static void __net_srandom(struct nrnd_state *state, unsigned long s)
{
 ...
 state->s1 = (69069 * s);
 state->s2 = (69069 * state->s1);
 state->s3 = (69069 * state->s2);
...
{
 unsigned long r;
 struct nrnd_state *state = &(*({ do { } while (0); &global_per_cpu__net_rand_state[get_stack_id()]; }));
...
void  __attribute__ ((__section__ (".init.text"))) net_random_init(void)
{
 int i;

 for (((i)) = 0; ((i)) < 1; ((i))++, (void)global_cpu_possible_map[get_stack_id()]) {
  struct nrnd_state *state = &(*((void)(i), &global_per_cpu__net_rand_state[get_stack_id()]));
  __net_srandom(state, i+global_jiffies[get_stack_id()]);
 }
}
...
typedef  initcall_t  _GLOBAL_179_T; static  _GLOBAL_179_T  __initcall_net_random_reseed __attribute__((__used__)) __attribute__((__section__(".initcall" "7" ".init")))  = net_random_reseed ;       

typedef  int _GLOBAL_180_T;  _GLOBAL_180_T  global_net_msg_cost[NUM_STACKS] = {  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  5 * 1000 ,  };    
typedef  int _GLOBAL_181_T;  _GLOBAL_181_T  global_net_msg_burst[NUM_STACKS] = {  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  };    
