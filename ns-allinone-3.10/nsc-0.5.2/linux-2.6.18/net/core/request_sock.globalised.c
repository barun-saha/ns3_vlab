# 1 "linux-2.6.18/net/core/request_sock.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/core/request_sock.c"
# 14 "linux-2.6.18/net/core/request_sock.c"
...
# 15 "linux-2.6.18/net/core/request_sock.c" 2
...
# 16 "linux-2.6.18/net/core/request_sock.c" 2



# 1 "linux-2.6.18/include/net/request_sock.h" 1
# 22 "linux-2.6.18/include/net/request_sock.h"
...
# 23 "linux-2.6.18/include/net/request_sock.h" 2
...
# 20 "linux-2.6.18/net/core/request_sock.c" 2
# 34 "linux-2.6.18/net/core/request_sock.c"
typedef  int _GLOBAL_230_T;  _GLOBAL_230_T  global_sysctl_max_syn_backlog[NUM_STACKS] = {  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  256,  };    
        ...
        const int nr_table_entries)
{
 ...
 struct listen_sock *lopt = kzalloc(lopt_size, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u)));

 if (lopt == ((void *)0))
  return -12;

 for (lopt->max_qlen_log = 6;
      (1 << lopt->max_qlen_log) < global_sysctl_max_syn_backlog[get_stack_id()];
      lopt->max_qlen_log++);

 get_random_bytes(&lopt->hash_rnd, sizeof(lopt->hash_rnd));
 do { *(&queue->syn_wait_lock) = (rwlock_t) { .raw_lock = { }, }; } while (0);
 queue->rskq_accept_head = ((void *)0);
...
void reqsk_queue_destroy(struct request_sock_queue *queue)
{
 ...
 do { if (__builtin_expect(!!(!(lopt->qlen == 0)), 0)) { printk("<3>" "KERNEL: assertion (%s) failed at %s (%d)\n", "lopt->qlen == 0", "linux-2.6.18/net/core/request_sock.c" , 83); } } while(0);
 kfree(lopt);
}
