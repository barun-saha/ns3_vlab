# 1 "linux-2.6.18/net/core/ethtool.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/core/ethtool.c"
# 12 "linux-2.6.18/net/core/ethtool.c"
...
# 13 "linux-2.6.18/net/core/ethtool.c" 2
...
# 17 "linux-2.6.18/net/core/ethtool.c" 2
...
# 18 "linux-2.6.18/net/core/ethtool.c" 2
# 26 "linux-2.6.18/net/core/ethtool.c"
u32 ethtool_op_get_link(struct net_device *dev)
{
...
int ethtool_op_get_perm_addr(struct net_device *dev, struct ethtool_perm_addr *addr, u8 *data)
{
 ...
 addr->size = len;
 (__builtin_constant_p(len) ? __constant_memcpy((data),(dev->perm_addr),(len)) : __memcpy((data),(dev->perm_addr),(len)));
 return 0;
}
...
{
 struct ethtool_value edata = { 0x00000007 };
...
{
 struct ethtool_value edata = { 0x0000000a };
...
static int ethtool_get_eeprom(struct net_device *dev, void *useraddr)
{
 ...
 data = kmalloc(eeprom.len, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u) | (( gfp_t)0x20000u)));
 if (!data)
  return -12;
...
{
 struct ethtool_value edata = { 0x00000014 };
...
{
 struct ethtool_value edata = { 0x00000016 };
...
{
 struct ethtool_value edata = { 0x00000018 };
...
{
 struct ethtool_value edata = { 0x0000001e };
...
static int ethtool_get_ufo(struct net_device *dev, char *useraddr)
{
 struct ethtool_value edata = { 0x00000021 };
...
static int ethtool_self_test(struct net_device *dev, char *useraddr)
{
 ...
 data = kmalloc(test.len * sizeof(u64), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u) | (( gfp_t)0x20000u)));
 if (!data)
  return -12;
...
static int ethtool_get_stats(struct net_device *dev, void *useraddr)
{
 ...
 data = kmalloc(stats.n_stats * sizeof(u64), ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u) | (( gfp_t)0x20000u)));
 if (!data)
  return -12;
...
static int ethtool_get_perm_addr(struct net_device *dev, void *useraddr)
{
 ...
 data = kmalloc(epaddr.size, ((( gfp_t)0x10u) | (( gfp_t)0x40u) | (( gfp_t)0x80u) | (( gfp_t)0x20000u)));
 if (!data)
  return -12;
...
int dev_ethtool(struct ifreq *ifr)
{
 ...
 ioctl:
 if (dev->do_ioctl)
  return dev->do_ioctl(dev, ifr, 0x8946);
 return -95;
}
