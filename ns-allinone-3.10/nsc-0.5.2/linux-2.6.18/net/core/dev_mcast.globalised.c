# 1 "linux-2.6.18/net/core/dev_mcast.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/core/dev_mcast.c"
# 25 "linux-2.6.18/net/core/dev_mcast.c"
...
# 26 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 27 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 34 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 35 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 37 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 39 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 42 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 43 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 44 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 45 "linux-2.6.18/net/core/dev_mcast.c" 2
...
# 47 "linux-2.6.18/net/core/dev_mcast.c" 2
...
typedef  struct neigh_table   _GLOBAL_273_T; extern  _GLOBAL_273_T  global_arp_tbl[NUM_STACKS];    
...
typedef  struct neigh_ops   _GLOBAL_274_T; extern  _GLOBAL_274_T  global_arp_broken_ops[NUM_STACKS];    
# 51 "linux-2.6.18/net/core/dev_mcast.c" 2
# 72 "linux-2.6.18/net/core/dev_mcast.c"
static void __dev_mc_upload(struct net_device *dev)
{
 ...
 if (dev->set_multicast_list == ((void *)0) ||
...
int dev_mc_delete(struct net_device *dev, void *addr, int alen, int glbl)
{
 ...
 for (dmip = &dev->mc_list; (dmi = *dmip) != ((void *)0); dmip = &dmi->next) {




  if (__builtin_memcmp(dmi->dmi_addr, addr, dmi->dmi_addrlen) == 0 &&
...
int dev_mc_add(struct net_device *dev, void *addr, int alen, int glbl)
{
 ...
 dmi1 = kmalloc(sizeof(*dmi), ((( gfp_t)0x20u)));

 netif_tx_lock_bh(dev);
 for (dmi = dev->mc_list; dmi != ((void *)0); dmi = dmi->next) {
  if (__builtin_memcmp(dmi->dmi_addr, addr, dmi->dmi_addrlen) == 0 &&
 ...
 (__builtin_constant_p(alen) ? __constant_memcpy((dmi->dmi_addr),(addr),(alen)) : __memcpy((dmi->dmi_addr),(addr),(alen)));
 dmi->dmi_addrlen = alen;
...
typedef  struct seq_operations   _GLOBAL_275_T; static  _GLOBAL_275_T  global_dev_mc_seq_ops[NUM_STACKS] = {  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  { . start  = dev_mc_seq_start  , . next  = dev_mc_seq_next   , . stop  = dev_mc_seq_stop   , . show  = dev_mc_seq_show   , } ,  };      
...
{
 return seq_open(file, &global_dev_mc_seq_ops[get_stack_id()]);
}

typedef  struct file_operations   _GLOBAL_276_T; static  _GLOBAL_276_T  global_dev_mc_seq_fops[NUM_STACKS] = {  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  { . owner  = ( ( struct module  *  ) 0  )   , . open  = dev_mc_seq_open   , . read  = seq_read   , . llseek  = seq_lseek   , . release  = seq_release   , } ,  };      
...
void  __attribute__ ((__section__ (".init.text"))) dev_mcast_init(void)
{
 proc_net_fops_create("dev_mcast", 0, &global_dev_mc_seq_fops[get_stack_id()]);
}
