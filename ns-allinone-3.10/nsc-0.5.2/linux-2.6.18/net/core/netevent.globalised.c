# 1 "linux-2.6.18/net/core/netevent.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/core/netevent.c"
# 16 "linux-2.6.18/net/core/netevent.c"
...
# 5 "linux-2.6.18/include/linux/uio.h" 2
...
# 6 "linux-2.6.18/include/linux/uio.h" 2
...
# 136 "linux-2.6.18/include/linux/netlink.h" 2
...
# 17 "linux-2.6.18/net/core/netevent.c" 2


typedef  struct atomic_notifier_head   _GLOBAL_181_T; static  _GLOBAL_181_T  global_netevent_notif_chain[NUM_STACKS] = {  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  { . lock  = ( spinlock_t ) { . raw_lock  = { }   , }   , . head  = ( ( void *  ) 0  )    } ,  };                    
# 30 "linux-2.6.18/net/core/netevent.c"
