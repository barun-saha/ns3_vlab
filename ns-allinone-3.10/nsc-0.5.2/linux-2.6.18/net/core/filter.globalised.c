# 1 "linux-2.6.18/net/core/filter.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/core/filter.c"
# 19 "linux-2.6.18/net/core/filter.c"
...
# 20 "linux-2.6.18/net/core/filter.c" 2
...
# 23 "linux-2.6.18/net/core/filter.c" 2
...
# 25 "linux-2.6.18/net/core/filter.c" 2
...
# 28 "linux-2.6.18/net/core/filter.c" 2
...
# 30 "linux-2.6.18/net/core/filter.c" 2
...
# 31 "linux-2.6.18/net/core/filter.c" 2
...
# 38 "linux-2.6.18/net/core/filter.c" 2
...
static void *__load_pointer(struct sk_buff *skb, int k)
{
 ...
 if (k >= (-0x100000))
  ptr = skb->nh.raw + k - (-0x100000);
 else if (k >= (-0x200000))
  ptr = skb->mac.raw + k - (-0x200000);
...
# 78 "linux-2.6.18/net/core/filter.c"
...
# 294 "linux-2.6.18/net/core/filter.c"
...
# 400 "linux-2.6.18/net/core/filter.c"
