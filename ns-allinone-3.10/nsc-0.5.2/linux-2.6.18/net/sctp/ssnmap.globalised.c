# 1 "linux-2.6.18/net/sctp/ssnmap.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sctp/ssnmap.c"
# 39 "linux-2.6.18/net/sctp/ssnmap.c"
...
# 40 "linux-2.6.18/net/sctp/ssnmap.c" 2
...
# 41 "linux-2.6.18/net/sctp/ssnmap.c" 2
...
# 42 "linux-2.6.18/net/sctp/ssnmap.c" 2
...
static inline  __attribute__((always_inline)) size_t sctp_ssnmap_size(__u16 in, __u16 out)
{
...
static struct sctp_ssnmap *sctp_ssnmap_init(struct sctp_ssnmap *map, __u16 in,
         __u16 out)
{
 (__builtin_constant_p(0x00) ? (__builtin_constant_p((sctp_ssnmap_size(in, out))) ? __constant_c_and_count_memset(((map)),((0x01010101UL*(unsigned char)(0x00))),((sctp_ssnmap_size(in, out)))) : __constant_c_memset(((map)),((0x01010101UL*(unsigned char)(0x00))),((sctp_ssnmap_size(in, out))))) : (__builtin_constant_p((sctp_ssnmap_size(in, out))) ? __memset_generic((((map))),(((0x00))),(((sctp_ssnmap_size(in, out))))) : __memset_generic(((map)),((0x00)),((sctp_ssnmap_size(in, out))))));
...
void sctp_ssnmap_clear(struct sctp_ssnmap *map)
{
 ...
 (__builtin_constant_p(0x00) ? (__builtin_constant_p((size)) ? __constant_c_and_count_memset(((map->in.ssn)),((0x01010101UL*(unsigned char)(0x00))),((size))) : __constant_c_memset(((map->in.ssn)),((0x01010101UL*(unsigned char)(0x00))),((size)))) : (__builtin_constant_p((size)) ? __memset_generic((((map->in.ssn))),(((0x00))),(((size)))) : __memset_generic(((map->in.ssn)),((0x00)),((size)))));
}
