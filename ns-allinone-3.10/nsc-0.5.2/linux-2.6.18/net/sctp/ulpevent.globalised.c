# 1 "linux-2.6.18/net/sctp/ulpevent.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sctp/ulpevent.c"
# 45 "linux-2.6.18/net/sctp/ulpevent.c"
...
# 46 "linux-2.6.18/net/sctp/ulpevent.c" 2
...
# 47 "linux-2.6.18/net/sctp/ulpevent.c" 2
# 1 "linux-2.6.18/include/net/sctp/structs.h" 1
# 58 "linux-2.6.18/include/net/sctp/structs.h"
...
# 59 "linux-2.6.18/include/net/sctp/structs.h" 2
...
# 48 "linux-2.6.18/net/sctp/ulpevent.c" 2
...
# 49 "linux-2.6.18/net/sctp/ulpevent.c" 2
...
# 50 "linux-2.6.18/net/sctp/ulpevent.c" 2
...
{
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(struct sctp_ulpevent))) ? __constant_c_and_count_memset(((event)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct sctp_ulpevent)))) : __constant_c_memset(((event)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct sctp_ulpevent))))) : (__builtin_constant_p((sizeof(struct sctp_ulpevent))) ? __memset_generic((((event))),(((0))),(((sizeof(struct sctp_ulpevent))))) : __memset_generic(((event)),((0)),((sizeof(struct sctp_ulpevent))))));
...
static inline  __attribute__((always_inline)) void sctp_ulpevent_set_owner(struct sctp_ulpevent *event,
        const struct sctp_association *asoc)
{
 struct sk_buff *skb;
...
static inline  __attribute__((always_inline)) void sctp_ulpevent_release_owner(struct sctp_ulpevent *event)
{
...
# 129 "linux-2.6.18/net/sctp/ulpevent.c"
struct sctp_ulpevent *sctp_ulpevent_make_assoc_change(
 const struct sctp_association *asoc,
...
# 161 "linux-2.6.18/net/sctp/ulpevent.c"
 sac->sac_state = state;
 ...
 sac->sac_flags = 0;
# 178 "linux-2.6.18/net/sctp/ulpevent.c"
 sac->sac_length = sizeof(struct sctp_assoc_change);
# 190 "linux-2.6.18/net/sctp/ulpevent.c"
 sac->sac_error = error;
# 201 "linux-2.6.18/net/sctp/ulpevent.c"
 sac->sac_outbound_streams = outbound;
 sac->sac_inbound_streams = inbound;
# 213 "linux-2.6.18/net/sctp/ulpevent.c"
...
# 230 "linux-2.6.18/net/sctp/ulpevent.c"
struct sctp_ulpevent *sctp_ulpevent_make_peer_addr_change(
 const struct sctp_association *asoc,
 const struct __kernel_sockaddr_storage *aaddr,
...
# 255 "linux-2.6.18/net/sctp/ulpevent.c"
 spc->spc_type = SCTP_PEER_ADDR_CHANGE;
# 265 "linux-2.6.18/net/sctp/ulpevent.c"
 ...
 spc->spc_flags = 0;
# 283 "linux-2.6.18/net/sctp/ulpevent.c"
 spc->spc_state = state;
# 294 "linux-2.6.18/net/sctp/ulpevent.c"
 spc->spc_error = error;
# 305 "linux-2.6.18/net/sctp/ulpevent.c"
 sctp_ulpevent_set_owner(event, asoc);
 spc->spc_assoc_id = sctp_assoc2id(asoc);
# 316 "linux-2.6.18/net/sctp/ulpevent.c"
 (__builtin_constant_p(sizeof(struct __kernel_sockaddr_storage)) ? __constant_memcpy((&spc->spc_aaddr),(aaddr),(sizeof(struct __kernel_sockaddr_storage))) : __memcpy((&spc->spc_aaddr),(aaddr),(sizeof(struct __kernel_sockaddr_storage))));


 sctp_get_pf_specific(asoc->base.sk->__sk_common.skc_family)->addr_v4map(
...
# 344 "linux-2.6.18/net/sctp/ulpevent.c"
struct sctp_ulpevent *sctp_ulpevent_make_remote_error(
 ...
 __u16 flags, gfp_t gfp)
{
 ...
 cause = ch->cause;
 elen = (((ntohs(ch->length))+3)&~3) - sizeof(sctp_errhdr_t);
...
# 398 "linux-2.6.18/net/sctp/ulpevent.c"
 sre->sre_flags = 0;
# 408 "linux-2.6.18/net/sctp/ulpevent.c"
 sre->sre_length = skb->len;
# 417 "linux-2.6.18/net/sctp/ulpevent.c"
 sre->sre_error = cause;
# 428 "linux-2.6.18/net/sctp/ulpevent.c"
 sctp_ulpevent_set_owner(event, asoc);
...
# 493 "linux-2.6.18/net/sctp/ulpevent.c"
 ssf->ssf_flags = flags;
# 502 "linux-2.6.18/net/sctp/ulpevent.c"
 ssf->ssf_length = sizeof(struct sctp_send_failed) + len;
 skb_trim(skb, ssf->ssf_length);
# 513 "linux-2.6.18/net/sctp/ulpevent.c"
 ssf->ssf_error = error;
# 522 "linux-2.6.18/net/sctp/ulpevent.c"
 (__builtin_constant_p(sizeof(struct sctp_sndrcvinfo)) ? __constant_memcpy((&ssf->ssf_info),(&chunk->sinfo),(sizeof(struct sctp_sndrcvinfo))) : __memcpy((&ssf->ssf_info),(&chunk->sinfo),(sizeof(struct sctp_sndrcvinfo))));




 ssf->ssf_info.sinfo_flags = chunk->chunk_hdr->flags;
# 538 "linux-2.6.18/net/sctp/ulpevent.c"
 sctp_ulpevent_set_owner(event, asoc);
 ...
 __u16 flags, gfp_t gfp)
{
 ...
 sse->sse_flags = 0;
# 591 "linux-2.6.18/net/sctp/ulpevent.c"
 sse->sse_length = sizeof(struct sctp_shutdown_event);
# 601 "linux-2.6.18/net/sctp/ulpevent.c"
 sctp_ulpevent_set_owner(event, asoc);
...
# 651 "linux-2.6.18/net/sctp/ulpevent.c"
struct sctp_ulpevent *sctp_ulpevent_make_rcvmsg(struct sctp_association *asoc,
      struct sctp_chunk *chunk,
      gfp_t gfp)
{
 ...
 if (!skb)
  goto fail;
# 676 "linux-2.6.18/net/sctp/ulpevent.c"
...
# 713 "linux-2.6.18/net/sctp/ulpevent.c"
struct sctp_ulpevent *sctp_ulpevent_make_pdapi(
       ...
       struct msghdr *msghdr)
{
 ...
 if (sctp_ulpevent_is_notification(event))
  return;
# 795 "linux-2.6.18/net/sctp/ulpevent.c"
...
# 812 "linux-2.6.18/net/sctp/ulpevent.c"
 sinfo.sinfo_ppid = event->ppid;
# 823 "linux-2.6.18/net/sctp/ulpevent.c"
...
static void sctp_ulpevent_release_data(struct sctp_ulpevent *event)
{
 struct sk_buff *skb, *frag;
 unsigned int len;
# 897 "linux-2.6.18/net/sctp/ulpevent.c"
 skb = sctp_event2skb(event);
 len = skb->len;
