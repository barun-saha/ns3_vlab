# 1 "linux-2.6.18/net/sctp/command.c"
...
# 1 "<command-line>" 2
# 1 "linux-2.6.18/net/sctp/command.c"
# 41 "linux-2.6.18/net/sctp/command.c"
...
# 42 "linux-2.6.18/net/sctp/command.c" 2
...
# 43 "linux-2.6.18/net/sctp/command.c" 2
...
# 44 "linux-2.6.18/net/sctp/command.c" 2


int sctp_init_cmd_seq(sctp_cmd_seq_t *seq)
{
 (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(sctp_cmd_seq_t))) ? __constant_c_and_count_memset(((seq)),((0x01010101UL*(unsigned char)(0))),((sizeof(sctp_cmd_seq_t)))) : __constant_c_memset(((seq)),((0x01010101UL*(unsigned char)(0))),((sizeof(sctp_cmd_seq_t))))) : (__builtin_constant_p((sizeof(sctp_cmd_seq_t))) ? __memset_generic((((seq))),(((0))),(((sizeof(sctp_cmd_seq_t))))) : __memset_generic(((seq)),((0)),((sizeof(sctp_cmd_seq_t))))));
 return 1;
}
