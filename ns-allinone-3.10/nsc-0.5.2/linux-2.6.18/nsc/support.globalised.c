...
# 20 "linux-2.6.18/nsc/support.c" 2
...
# 24 "linux-2.6.18/nsc/support.c" 2
...
# 25 "linux-2.6.18/nsc/support.c" 2

# 1 "linux-2.6.18/include/linux/delay.h" 1
# 10 "linux-2.6.18/include/linux/delay.h"
typedef  unsigned long   _GLOBAL_217_T; extern  _GLOBAL_217_T  global_loops_per_jiffy[NUM_STACKS];    
...
# 27 "linux-2.6.18/nsc/support.c" 2
...
# 30 "linux-2.6.18/nsc/support.c" 2
...
# 31 "linux-2.6.18/nsc/support.c" 2
...
# 34 "linux-2.6.18/nsc/support.c" 2
 ...
 if (!global_sysctl_tcp_low_latency[get_stack_id()] && tp->ucopy.task) {
  ...
  if (tp->ucopy.memory > sk->sk_rcvbuf) {
   ...
   while ((skb1 = __skb_dequeue(&tp->ucopy.prequeue)) != ((void *)0)) {
    ...
    (({ (void)(0); ((*_GLOBAL_net_statistics_61_A[get_stack_id()])[0]); })->mibs[LINUX_MIB_TCPPREQUEUEDROPPED]++);
   }
...
# 35 "linux-2.6.18/nsc/support.c" 2
...
typedef  struct proc_dir_entry   _GLOBAL_319_T; extern  _GLOBAL_319_T  global_proc_root[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_320_T; extern  _GLOBAL_320_T  * global_proc_root_fs[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_321_T; extern  _GLOBAL_321_T  * global_proc_net[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_322_T; extern  _GLOBAL_322_T  * global_proc_net_stat[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_323_T; extern  _GLOBAL_323_T  * global_proc_bus[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_324_T; extern  _GLOBAL_324_T  * global_proc_root_driver[NUM_STACKS];    
typedef  struct proc_dir_entry   _GLOBAL_325_T; extern  _GLOBAL_325_T  * global_proc_root_kcore[NUM_STACKS];    

typedef  spinlock_t  _GLOBAL_326_T; extern  _GLOBAL_326_T  global_proc_subdir_lock[NUM_STACKS];   
...
typedef  struct vfsmount   _GLOBAL_327_T; extern  _GLOBAL_327_T  * global_proc_mnt[NUM_STACKS];    
...
typedef  const struct file_operations    _GLOBAL_328_T; extern  _GLOBAL_328_T  global_proc_kcore_operations[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_329_T; extern  _GLOBAL_329_T  global_proc_kmsg_operations[NUM_STACKS];     
typedef  const struct file_operations    _GLOBAL_330_T; extern  _GLOBAL_330_T  global_ppc_htab_operations[NUM_STACKS];     
...
# 38 "linux-2.6.18/nsc/support.c" 2
...
# 40 "linux-2.6.18/nsc/support.c" 2
# 1 "sim/sim_errno.h" 1
# 15 "sim/sim_errno.h"
enum nsc_errno {
 NSC_EUNKNOWN = -1,
...
# 41 "linux-2.6.18/nsc/support.c" 2
...
# 42 "linux-2.6.18/nsc/support.c" 2
...
typedef  struct proc_dir_entry   _GLOBAL_331_T; extern  _GLOBAL_331_T  * global_proc_net[NUM_STACKS]; extern  _GLOBAL_331_T  * global_proc_sys_root[NUM_STACKS];     
typedef  int  _GLOBAL_332_T; extern  _GLOBAL_332_T  global_nsc_g_l26_diagnostic[NUM_STACKS];   

void nsc_sysctl_a(void);
struct thread_info *nsc_get_current_thread_info(void);

typedef  struct task_struct  _GLOBAL_333_T;  _GLOBAL_333_T  * global_nsc_task[NUM_STACKS];   
void timekeeping_init(void);
...
void nsc_init(void)
{
    ...
    global_nsc_task[get_stack_id()] = (struct task_struct *)nsc_malloc(sizeof(struct task_struct));
    (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(*global_nsc_task[get_stack_id()]))) ? __constant_c_and_count_memset(((global_nsc_task[get_stack_id()])),((0x01010101UL*(unsigned char)(0))),((sizeof(*global_nsc_task[get_stack_id()])))) : __constant_c_memset(((global_nsc_task[get_stack_id()])),((0x01010101UL*(unsigned char)(0))),((sizeof(*global_nsc_task[get_stack_id()]))))) : (__builtin_constant_p((sizeof(*global_nsc_task[get_stack_id()]))) ? __memset_generic((((global_nsc_task[get_stack_id()]))),(((0))),(((sizeof(*global_nsc_task[get_stack_id()]))))) : __memset_generic(((global_nsc_task[get_stack_id()])),((0)),((sizeof(*global_nsc_task[get_stack_id()]))))));

    get_nsc_task()->cap_effective = 0xFFFFFFFF;
    get_nsc_task()->euid = 0;
    get_nsc_task()->thread_info = (struct thread_info *)nsc_malloc(sizeof(struct thread_info));
    (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(struct thread_info))) ? __constant_c_and_count_memset(((get_nsc_task()->thread_info)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct thread_info)))) : __constant_c_memset(((get_nsc_task()->thread_info)),((0x01010101UL*(unsigned char)(0))),((sizeof(struct thread_info))))) : (__builtin_constant_p((sizeof(struct thread_info))) ? __memset_generic((((get_nsc_task()->thread_info))),(((0))),(((sizeof(struct thread_info))))) : __memset_generic(((get_nsc_task()->thread_info)),((0)),((sizeof(struct thread_info))))));
    get_nsc_task()->thread_info->addr_limit.seg = 0xFFFFFFFF;
    ...
    global_proc_net[get_stack_id()] = proc_mkdir("net", 0);
    global_proc_sys_root[get_stack_id()] = proc_mkdir("sys", 0);
...
struct thread_info *nsc_get_current_thread_info(void)
{
    return global_nsc_task[get_stack_id()]->thread_info;
}

typedef  unsigned long    _GLOBAL_334_T; extern volatile  _GLOBAL_334_T  global_jiffies[NUM_STACKS];     

void nsc_timer_tick(void)
{

    struct pt_regs regs;
    (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(regs))) ? __constant_c_and_count_memset(((&regs)),((0x01010101UL*(unsigned char)(0))),((sizeof(regs)))) : __constant_c_memset(((&regs)),((0x01010101UL*(unsigned char)(0))),((sizeof(regs))))) : (__builtin_constant_p((sizeof(regs))) ? __memset_generic((((&regs))),(((0))),(((sizeof(regs))))) : __memset_generic(((&regs)),((0)),((sizeof(regs))))));

    global_jiffies[get_stack_id()] += 1;
...
# 182 "linux-2.6.18/nsc/support.c"
    if(datalen < 1200) {
...
# 278 "linux-2.6.18/nsc/support.c"
...
{
    struct socket *sock = (struct socket *)so;
# 478 "linux-2.6.18/nsc/support.c"
...
# 502 "linux-2.6.18/nsc/support.c"
void nsc_add_default_gw(unsigned int gw_addr)
{
# 607 "linux-2.6.18/nsc/support.c"
    struct rtentry
    {
    ...
    nsc_assert(
        sock_create(2, SOCK_DGRAM, IPPROTO_IP, &so)
 == 0, "sock_create failed in nsc_add_default_gw");
    ...
    g->sin_family = d->sin_family = m->sin_family = 2;
...
# 725 "linux-2.6.18/nsc/support.c"
    return 0;
}
...
void nsc_sysctl_a()
{
    nsc_sysctl_r(global_proc_sys_root[get_stack_id()], "sys");
}
...
void nsc_sysctl_r(struct proc_dir_entry *p, const char *d)
{
    ...
    while(sys) {
        ...
        if(table->proc_handler)
        {
            ...
            (__builtin_constant_p(0) ? (__builtin_constant_p((5000)) ? __constant_c_and_count_memset(((rbuf)),((0x01010101UL*(unsigned char)(0))),((5000))) : __constant_c_memset(((rbuf)),((0x01010101UL*(unsigned char)(0))),((5000)))) : (__builtin_constant_p((5000)) ? __memset_generic((((rbuf))),(((0))),(((5000)))) : __memset_generic(((rbuf)),((0)),((5000)))));
...
{
  typedef  int  _GLOBAL_335_T; extern  _GLOBAL_335_T  global_nsc_cpuset_netclass_id[NUM_STACKS];   
  global_nsc_cpuset_netclass_id[get_stack_id()] = id;
}
