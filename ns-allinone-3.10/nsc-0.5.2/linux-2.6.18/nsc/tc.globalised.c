...
typedef  int  _GLOBAL_11_T; extern  _GLOBAL_11_T  global_sysctl_somaxconn[NUM_STACKS];   
...
typedef  kernel_cap_t  _GLOBAL_40_T; extern  _GLOBAL_40_T  global_cap_bset[NUM_STACKS];   
...
static int addattr_l(struct nlmsghdr *n, int maxlen, int type, const void *data,
       int alen)
{
  int len = (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (alen));
  struct rtattr *rta;

  if (( ((n->nlmsg_len)+4 -1) & ~(4 -1) ) + ( ((len)+4 -1) & ~(4 -1) ) > maxlen) {
    nsc_assert(0, "addattr_l ERROR: message exceeded bound");
    return -1;
  }
  rta = ((struct rtattr *) (((void *) (n)) + ( (((n)->nlmsg_len)+4 -1) & ~(4 -1) )));
  rta->rta_type = type;
  rta->rta_len = len;
  (__builtin_constant_p(alen) ? __constant_memcpy((((void*)(((char*)(rta)) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))))),(data),(alen)) : __memcpy((((void*)(((char*)(rta)) + (( ((sizeof(struct rtattr))+4 -1) & ~(4 -1) ) + (0))))),(data),(alen)));
  n->nlmsg_len = ( ((n->nlmsg_len)+4 -1) & ~(4 -1) ) + ( ((len)+4 -1) & ~(4 -1) );
  return 0;
}
...
static void parse_classid(char *word, unsigned *classid)
{
  ...
  *classid = strtoul(num, ((void *)0), 10) << 16;

  if (*word)
  {
    num = get_token(&word, ':');
    *classid |= strtoul(num, ((void *)0), 10);
  }
}
...
static struct socket *nsc_create_netlink_socket(void)
{
  ...
  nsc_assert(
      sock_create(16, SOCK_RAW, 0, &so)
      == 0, "sock_create failed for AF_NETLINK socket");



  nsc_assert(
      sock_setsockopt(so, 0, 7, (void *) &sndbuf, sizeof(sndbuf))
      == 0, "sock_setsockopt failed in nsc_do_tc for SO_SNDBUF");

  nsc_assert(
      sock_setsockopt(so, 0, 8, (void *) &rcvbuf, sizeof(rcvbuf))
      == 0, "sock_setsockopt failed in nsc_do_tc for SO_RCVBUF");

  (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(local))) ? __constant_c_and_count_memset(((&local)),((0x01010101UL*(unsigned char)(0))),((sizeof(local)))) : __constant_c_memset(((&local)),((0x01010101UL*(unsigned char)(0))),((sizeof(local))))) : (__builtin_constant_p((sizeof(local))) ? __memset_generic((((&local))),(((0))),(((sizeof(local))))) : __memset_generic(((&local)),((0)),((sizeof(local))))));
  local.nl_family = 16;
  local.nl_groups = 0;
...
static int nsc_get_ifindex(char *ifname)
{
  ...
  nsc_assert(ifname != ((void *)0), "no interface specified to lookup");
...
{
  char *dev = ((void *)0), *action = ((void *)0), *kind = ((void *)0);
  ...
  nsc_assert(dev != ((void *)0), "no device specified for 'tc qdisc' command");
  ...
  req->n.nlmsg_len = ((sizeof(struct tcmsg))+( ((((int) ( ((sizeof(struct nlmsghdr))+4 -1) & ~(4 -1) )))+4 -1) & ~(4 -1) ));
  req->n.nlmsg_flags = 1 | 0x200 | 0x400;
  ...
  while (*cmd)
  {
    ...
    {
      opt.defcls = strtoul(get_token(&cmd, ' '), ((void *)0), 10);
    }
    else
    {
  ...
  tail = ((struct rtattr *) (((void *) (&req->n)) + ( (((&req->n)->nlmsg_len)+4 -1) & ~(4 -1) )));
  addattr_l(&req->n, 1024, TCA_OPTIONS, ((void *)0), 0);
  addattr_l(&req->n, 2024, TCA_HTB_INIT, &opt, ( ((sizeof(opt))+4 -1) & ~(4 -1) ));
  tail->rta_len = (void *) ((struct rtattr *) (((void *) (&req->n)) + ( (((&req->n)->nlmsg_len)+4 -1) & ~(4 -1) ))) - (void *) tail;
}

static void nsc_tc_class(char *cmd, struct tcmsgcmd* req)
{

  char *kind = ((void *)0), *action = ((void *)0);
  ...
  while (*cmd)
  {
    ...
    {
      int prio = strtoul(get_token(&cmd, ' '), ((void *)0), 0);

      opt.prio = prio;
    }
    else if (strcmp(word, "rate") == 0)
    {
      unsigned long rate = strtoul(get_token(&cmd, ' '), ((void *)0), 10);

      opt.rate.rate = rate;
    }
    else if (strcmp(word, "ceil") == 0)
    {
      unsigned long ceil = strtoul(get_token(&cmd, ' '), ((void *)0), 10);
  ...
  struct rtattr *tail = ((struct rtattr *) (((void *) (&req->n)) + ( (((&req->n)->nlmsg_len)+4 -1) & ~(4 -1) )));
  addattr_l(&req->n, 1024, TCA_OPTIONS, ((void *)0), 0);
...
static void nsc_send_netlink_command(struct socket *so, struct tcmsgcmd *req)
{
  ...
  (__builtin_constant_p(0) ? (__builtin_constant_p((sizeof(nladdr))) ? __constant_c_and_count_memset(((&nladdr)),((0x01010101UL*(unsigned char)(0))),((sizeof(nladdr)))) : __constant_c_memset(((&nladdr)),((0x01010101UL*(unsigned char)(0))),((sizeof(nladdr))))) : (__builtin_constant_p((sizeof(nladdr))) ? __memset_generic((((&nladdr))),(((0))),(((sizeof(nladdr))))) : __memset_generic(((&nladdr)),((0)),((sizeof(nladdr))))));
  nladdr.nl_family = 16;
  nladdr.nl_pid = 0;
  nladdr.nl_groups = 0;
...
static int nsc_get_netlink_error(struct socket *so)
{
  ...
  int recved = 0;
  nsc_assert(
      (recved = sock_recvmsg(so, &msg, sizeof(buf), 0x40))
  ...
  if (h->nlmsg_type == 0x2)
  {
    struct nlmsgerr *err = (struct nlmsgerr *)((void*)(((char*)h) + ((0)+( ((((int) ( ((sizeof(struct nlmsghdr))+4 -1) & ~(4 -1) )))+4 -1) & ~(4 -1) ))));
